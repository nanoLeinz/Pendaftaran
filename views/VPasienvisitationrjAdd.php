...
// Page object
$VPasienvisitationrjAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fV_PASIENVISITATIONRJadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fV_PASIENVISITATIONRJadd = currentForm = new ew.Form("fV_PASIENVISITATIONRJadd", "add");
    ...
    fV_PASIENVISITATIONRJadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fV_PASIENVISITATIONRJadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fV_PASIENVISITATIONRJadd.validate = function () {
    ...
    // Form_CustomValidate
    fV_PASIENVISITATIONRJadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fV_PASIENVISITATIONRJadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fV_PASIENVISITATIONRJadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_PASIENVISITATIONRJadd" id="fV_PASIENVISITATIONRJadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fV_PASIENVISITATIONRJadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_PASIENVISITATIONRJadd", "x_date_of_birth", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
