...
loadjs.ready("head", function () {
    ...
    fcv_pasienedit.lists.EDUCATION_TYPE_CODE = <?= $Page->EDUCATION_TYPE_CODE->toClientList($Page) ?>;
    ...
    fcv_pasienedit.lists.KAL_ID = <?= $Page->KAL_ID->toClientList($Page) ?>;
    fcv_pasienedit.lists.JOB_ID = <?= $Page->JOB_ID->toClientList($Page) ?>;
    fcv_pasienedit.lists.STATUS_PASIEN_ID = <?= $Page->STATUS_PASIEN_ID->toClientList($Page) ?>;
    fcv_pasienedit.lists.PAYOR_ID = <?= $Page->PAYOR_ID->toClientList($Page) ?>;
    fcv_pasienedit.lists.CLASS_ID = <?= $Page->CLASS_ID->toClientList($Page) ?>;
    fcv_pasienedit.lists.COVERAGE_ID = <?= $Page->COVERAGE_ID->toClientList($Page) ?>;
...
<input type="hidden" data-table="cv_pasien" data-field="x_NO_REGISTRATION" data-hidden="1" data-page="1" name="x_NO_REGISTRATION" id="x_NO_REGISTRATION" value="<?= HtmlEncode($Page->NO_REGISTRATION->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->PASIEN_ID->getInputTextType() ?>" data-table="cv_pasien" data-field="x_PASIEN_ID" data-page="1" name="x_PASIEN_ID" id="x_PASIEN_ID" size="30" maxlength="30" placeholder="<?= HtmlEncode($Page->PASIEN_ID->getPlaceHolder()) ?>" value="<?= $Page->PASIEN_ID->EditValue ?>"<?= $Page->PASIEN_ID->editAttributes() ?> aria-describedby="x_PASIEN_ID_help">
...
<input type="<?= $Page->KK_NO->getInputTextType() ?>" data-table="cv_pasien" data-field="x_KK_NO" data-page="1" name="x_KK_NO" id="x_KK_NO" size="30" maxlength="30" placeholder="<?= HtmlEncode($Page->KK_NO->getPlaceHolder()) ?>" value="<?= $Page->KK_NO->EditValue ?>"<?= $Page->KK_NO->editAttributes() ?> aria-describedby="x_KK_NO_help">
...
loadjs.ready(["fcv_pasienedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fcv_pasienedit", "x_DATE_OF_BIRTH", {"ignoreReadonly":true,"useCurrent":false,"format":11});
});
</script>
<?php } ?>
</span>
...
<template id="tp_x_GENDER">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="cv_pasien" data-field="x_GENDER" name="x_GENDER" id="x_GENDER"<?= $Page->GENDER->editAttributes() ?>>
...
<?php if ($Page->EDUCATION_TYPE_CODE->Visible) { // EDUCATION_TYPE_CODE ?>
    <div id="r_EDUCATION_TYPE_CODE" class="form-group row">
        <label id="elh_cv_pasien_EDUCATION_TYPE_CODE" for="x_EDUCATION_TYPE_CODE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->EDUCATION_TYPE_CODE->caption() ?><?= $Page->EDUCATION_TYPE_CODE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EDUCATION_TYPE_CODE->cellAttributes() ?>>
<span id="el_cv_pasien_EDUCATION_TYPE_CODE">
    <select
        id="x_EDUCATION_TYPE_CODE"
        name="x_EDUCATION_TYPE_CODE"
        class="form-control ew-select<?= $Page->EDUCATION_TYPE_CODE->isInvalidClass() ?>"
        data-select2-id="cv_pasien_x_EDUCATION_TYPE_CODE"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_EDUCATION_TYPE_CODE']"),
        options = { name: "x_EDUCATION_TYPE_CODE", selectId: "cv_pasien_x_EDUCATION_TYPE_CODE", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.EDUCATION_TYPE_CODE.selectOptions);
...
<?php if ($Page->MARITALSTATUSID->Visible) { // MARITALSTATUSID ?>
    <div id="r_MARITALSTATUSID" class="form-group row">
        <label id="elh_cv_pasien_MARITALSTATUSID" for="x_MARITALSTATUSID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MARITALSTATUSID->caption() ?><?= $Page->MARITALSTATUSID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_cv_pasien_MARITALSTATUSID">
    <select
        ...
        data-select2-id="cv_pasien_x_MARITALSTATUSID"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_MARITALSTATUSID']"),
        options = { name: "x_MARITALSTATUSID", selectId: "cv_pasien_x_MARITALSTATUSID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.MARITALSTATUSID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->KODE_AGAMA->Visible) { // KODE_AGAMA ?>
    <div id="r_KODE_AGAMA" class="form-group row">
        <label id="elh_cv_pasien_KODE_AGAMA" for="x_KODE_AGAMA" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KODE_AGAMA->caption() ?><?= $Page->KODE_AGAMA->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<span id="el_cv_pasien_KODE_AGAMA">
    <select
        ...
        data-select2-id="cv_pasien_x_KODE_AGAMA"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_KODE_AGAMA']"),
        options = { name: "x_KODE_AGAMA", selectId: "cv_pasien_x_KODE_AGAMA", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.KODE_AGAMA.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->KAL_ID->Visible) { // KAL_ID ?>
    <div id="r_KAL_ID" class="form-group row">
        <label id="elh_cv_pasien_KAL_ID" for="x_KAL_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->KAL_ID->caption() ?><?= $Page->KAL_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KAL_ID->cellAttributes() ?>>
<span id="el_cv_pasien_KAL_ID">
    <select
        id="x_KAL_ID"
        name="x_KAL_ID"
        class="form-control ew-select<?= $Page->KAL_ID->isInvalidClass() ?>"
        data-select2-id="cv_pasien_x_KAL_ID"
        data-table="cv_pasien"
        data-field="x_KAL_ID"
        data-page="1"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_KAL_ID']"),
        options = { name: "x_KAL_ID", selectId: "cv_pasien_x_KAL_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.KAL_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_cv_pasien_JOB_ID">
    <select
        ...
        data-select2-id="cv_pasien_x_JOB_ID"
        data-table="cv_pasien"
        data-field="x_JOB_ID"
        data-page="1"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_JOB_ID']"),
        options = { name: "x_JOB_ID", selectId: "cv_pasien_x_JOB_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.JOB_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<span id="el_cv_pasien_STATUS_PASIEN_ID">
    <select
        ...
        data-select2-id="cv_pasien_x_STATUS_PASIEN_ID"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_STATUS_PASIEN_ID']"),
        options = { name: "x_STATUS_PASIEN_ID", selectId: "cv_pasien_x_STATUS_PASIEN_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
...
<?php if ($Page->MOBILE->Visible) { // MOBILE ?>
    <div id="r_MOBILE" class="form-group row">
        <label id="elh_cv_pasien_MOBILE" for="x_MOBILE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MOBILE->caption() ?><?= $Page->MOBILE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MOBILE->cellAttributes() ?>>
<span id="el_cv_pasien_MOBILE">
<input type="<?= $Page->MOBILE->getInputTextType() ?>" data-table="cv_pasien" data-field="x_MOBILE" data-page="1" name="x_MOBILE" id="x_MOBILE" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->MOBILE->getPlaceHolder()) ?>" value="<?= $Page->MOBILE->EditValue ?>"<?= $Page->MOBILE->editAttributes() ?> aria-describedby="x_MOBILE_help">
...
<input type="hidden" data-table="cv_pasien" data-field="x_REGISTRATION_DATE" data-hidden="1" data-page="1" name="x_REGISTRATION_DATE" id="x_REGISTRATION_DATE" value="<?= HtmlEncode($Page->REGISTRATION_DATE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->FAMILY_STATUS_ID->Visible) { // FAMILY_STATUS_ID ?>
    <div id="r_FAMILY_STATUS_ID" class="form-group row">
        <label id="elh_cv_pasien_FAMILY_STATUS_ID" for="x_FAMILY_STATUS_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FAMILY_STATUS_ID->caption() ?><?= $Page->FAMILY_STATUS_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FAMILY_STATUS_ID->cellAttributes() ?>>
<span id="el_cv_pasien_FAMILY_STATUS_ID">
...
<input type="hidden" data-table="cv_pasien" data-field="x_FAMILY_STATUS_ID" data-hidden="1" data-page="1" name="x_FAMILY_STATUS_ID" id="x_FAMILY_STATUS_ID" value="<?= HtmlEncode($Page->FAMILY_STATUS_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <div id="r_PAYOR_ID" class="form-group row">
        <label id="elh_cv_pasien_PAYOR_ID" for="x_PAYOR_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->PAYOR_ID->caption() ?><?= $Page->PAYOR_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PAYOR_ID->cellAttributes() ?>>
<span id="el_cv_pasien_PAYOR_ID">
    <select
        id="x_PAYOR_ID"
        name="x_PAYOR_ID"
        class="form-control ew-select<?= $Page->PAYOR_ID->isInvalidClass() ?>"
        data-select2-id="cv_pasien_x_PAYOR_ID"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_PAYOR_ID']"),
        options = { name: "x_PAYOR_ID", selectId: "cv_pasien_x_PAYOR_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.PAYOR_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <div id="r_CLASS_ID" class="form-group row">
        <label id="elh_cv_pasien_CLASS_ID" for="x_CLASS_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->CLASS_ID->caption() ?><?= $Page->CLASS_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLASS_ID->cellAttributes() ?>>
<span id="el_cv_pasien_CLASS_ID">
    <select
        id="x_CLASS_ID"
        name="x_CLASS_ID"
        class="form-control ew-select<?= $Page->CLASS_ID->isInvalidClass() ?>"
        data-select2-id="cv_pasien_x_CLASS_ID"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_CLASS_ID']"),
        options = { name: "x_CLASS_ID", selectId: "cv_pasien_x_CLASS_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.CLASS_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->ORG_ID->Visible) { // ORG_ID ?>
    <div id="r_ORG_ID" class="form-group row">
        <label id="elh_cv_pasien_ORG_ID" for="x_ORG_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->ORG_ID->caption() ?><?= $Page->ORG_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORG_ID->cellAttributes() ?>>
<span id="el_cv_pasien_ORG_ID">
...
<input type="hidden" data-table="cv_pasien" data-field="x_ORG_ID" data-hidden="1" data-page="1" name="x_ORG_ID" id="x_ORG_ID" value="<?= HtmlEncode($Page->ORG_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->COVERAGE_ID->Visible) { // COVERAGE_ID ?>
    <div id="r_COVERAGE_ID" class="form-group row">
        <label id="elh_cv_pasien_COVERAGE_ID" for="x_COVERAGE_ID" class="<?= $Page->LeftColumnClass ?>"><?= $Page->COVERAGE_ID->caption() ?><?= $Page->COVERAGE_ID->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->COVERAGE_ID->cellAttributes() ?>>
<span id="el_cv_pasien_COVERAGE_ID">
    <select
        id="x_COVERAGE_ID"
        name="x_COVERAGE_ID"
        class="form-control ew-select<?= $Page->COVERAGE_ID->isInvalidClass() ?>"
        data-select2-id="cv_pasien_x_COVERAGE_ID"
        data-table="cv_pasien"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='cv_pasien_x_COVERAGE_ID']"),
        options = { name: "x_COVERAGE_ID", selectId: "cv_pasien_x_COVERAGE_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.cv_pasien.fields.COVERAGE_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->MOTHER->Visible) { // MOTHER ?>
    <div id="r_MOTHER" class="form-group row">
        <label id="elh_cv_pasien_MOTHER" for="x_MOTHER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MOTHER->caption() ?><?= $Page->MOTHER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MOTHER->cellAttributes() ?>>
<span id="el_cv_pasien_MOTHER">
<input type="<?= $Page->MOTHER->getInputTextType() ?>" data-table="cv_pasien" data-field="x_MOTHER" data-page="1" name="x_MOTHER" id="x_MOTHER" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->MOTHER->getPlaceHolder()) ?>" value="<?= $Page->MOTHER->EditValue ?>"<?= $Page->MOTHER->editAttributes() ?> aria-describedby="x_MOTHER_help">
...
<?php if ($Page->FATHER->Visible) { // FATHER ?>
    <div id="r_FATHER" class="form-group row">
        <label id="elh_cv_pasien_FATHER" for="x_FATHER" class="<?= $Page->LeftColumnClass ?>"><?= $Page->FATHER->caption() ?><?= $Page->FATHER->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FATHER->cellAttributes() ?>>
<span id="el_cv_pasien_FATHER">
<input type="<?= $Page->FATHER->getInputTextType() ?>" data-table="cv_pasien" data-field="x_FATHER" data-page="1" name="x_FATHER" id="x_FATHER" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->FATHER->getPlaceHolder()) ?>" value="<?= $Page->FATHER->EditValue ?>"<?= $Page->FATHER->editAttributes() ?> aria-describedby="x_FATHER_help">
...
<?php if ($Page->SPOUSE->Visible) { // SPOUSE ?>
    <div id="r_SPOUSE" class="form-group row">
        <label id="elh_cv_pasien_SPOUSE" for="x_SPOUSE" class="<?= $Page->LeftColumnClass ?>"><?= $Page->SPOUSE->caption() ?><?= $Page->SPOUSE->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SPOUSE->cellAttributes() ?>>
<span id="el_cv_pasien_SPOUSE">
<input type="<?= $Page->SPOUSE->getInputTextType() ?>" data-table="cv_pasien" data-field="x_SPOUSE" data-page="1" name="x_SPOUSE" id="x_SPOUSE" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->SPOUSE->getPlaceHolder()) ?>" value="<?= $Page->SPOUSE->EditValue ?>"<?= $Page->SPOUSE->editAttributes() ?> aria-describedby="x_SPOUSE_help">
...
<?php if ($Page->AKTIF->Visible) { // AKTIF ?>
    <div id="r_AKTIF" class="form-group row">
        <label id="elh_cv_pasien_AKTIF" class="<?= $Page->LeftColumnClass ?>"><?= $Page->AKTIF->caption() ?><?= $Page->AKTIF->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AKTIF->cellAttributes() ?>>
<span id="el_cv_pasien_AKTIF">
...
<input type="hidden" data-table="cv_pasien" data-field="x_AKTIF" data-hidden="1" data-page="1" name="x_AKTIF" id="x_AKTIF" value="<?= HtmlEncode($Page->AKTIF->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->TMT->Visible) { // TMT ?>
    <div id="r_TMT" class="form-group row">
        <label id="elh_cv_pasien_TMT" for="x_TMT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TMT->caption() ?><?= $Page->TMT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TMT->cellAttributes() ?>>
<span id="el_cv_pasien_TMT">
...
<input type="hidden" data-table="cv_pasien" data-field="x_TMT" data-hidden="1" data-page="1" name="x_TMT" id="x_TMT" value="<?= HtmlEncode($Page->TMT->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->TAT->Visible) { // TAT ?>
    <div id="r_TAT" class="form-group row">
        <label id="elh_cv_pasien_TAT" for="x_TAT" class="<?= $Page->LeftColumnClass ?>"><?= $Page->TAT->caption() ?><?= $Page->TAT->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TAT->cellAttributes() ?>>
<span id="el_cv_pasien_TAT">
...
<input type="hidden" data-table="cv_pasien" data-field="x_TAT" data-hidden="1" data-page="1" name="x_TAT" id="x_TAT" value="<?= HtmlEncode($Page->TAT->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
<?php if ($Page->MEDICAL_NOTES->Visible) { // MEDICAL_NOTES ?>
    <div id="r_MEDICAL_NOTES" class="form-group row">
        <label id="elh_cv_pasien_MEDICAL_NOTES" for="x_MEDICAL_NOTES" class="<?= $Page->LeftColumnClass ?>"><?= $Page->MEDICAL_NOTES->caption() ?><?= $Page->MEDICAL_NOTES->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MEDICAL_NOTES->cellAttributes() ?>>
<span id="el_cv_pasien_MEDICAL_NOTES">
<textarea data-table="cv_pasien" data-field="x_MEDICAL_NOTES" data-page="1" name="x_MEDICAL_NOTES" id="x_MEDICAL_NOTES" cols="35" rows="4" placeholder="<?= HtmlEncode($Page->MEDICAL_NOTES->getPlaceHolder()) ?>"<?= $Page->MEDICAL_NOTES->editAttributes() ?> aria-describedby="x_MEDICAL_NOTES_help"><?= $Page->MEDICAL_NOTES->EditValue ?></textarea>
...
<?php if ($Page->cek->Visible) { // cek ?>
    <div id="r_cek" class="form-group row">
        <label id="elh_cv_pasien_cek" for="x_cek" class="<?= $Page->LeftColumnClass ?>"><?= $Page->cek->caption() ?><?= $Page->cek->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->cek->cellAttributes() ?>>
<span id="el_cv_pasien_cek">
<a href="../bridging/get_peserta.php?key=<?php echo urlencode(CurrentPage()->KK_NO->CurrentValue).'&id='.urlencode(CurrentPage()->ID->CurrentValue)?>" class="btn btn-info btn-sm" role="button">Ambil Data</a>
<a href="../bridging/get_peserta.php?key=<?php echo urlencode(CurrentPage()->PASIEN_ID->CurrentValue).'&id='.urlencode(CurrentPage()->ID->CurrentValue)?>" class="btn btn-info btn-sm" role="button">Ambil Data dari NIK</a>
</span>
</div></div>
    </div>
<?php } ?>
