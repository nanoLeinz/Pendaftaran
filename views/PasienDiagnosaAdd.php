...
loadjs.ready("head", function () {
    ...
    fPASIEN_DIAGNOSAadd.lists.DIAGNOSA_ID_02 = <?= $Page->DIAGNOSA_ID_02->toClientList($Page) ?>;
    fPASIEN_DIAGNOSAadd.lists.DIAGNOSA_ID_03 = <?= $Page->DIAGNOSA_ID_03->toClientList($Page) ?>;
    fPASIEN_DIAGNOSAadd.lists.DIAGNOSA_ID_04 = <?= $Page->DIAGNOSA_ID_04->toClientList($Page) ?>;
    fPASIEN_DIAGNOSAadd.lists.DIAGNOSA_ID_05 = <?= $Page->DIAGNOSA_ID_05->toClientList($Page) ?>;
    fPASIEN_DIAGNOSAadd.lists.DIAGNOSA_ID_06 = <?= $Page->DIAGNOSA_ID_06->toClientList($Page) ?>;
