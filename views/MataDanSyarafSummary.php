...
<?php } ?>
<!-- Report grid (begin) -->
<div id="gmp_mata_dan_syaraf" class="<?= ResponsiveTableClass() ?>card-body ew-grid-middle-panel">
<table class="<?= $Page->ReportTableClass ?>">
<thead>
	<!-- Table header -->
    <tr class="ew-table-header">
<?php if ($Page->DIAGNOSA_ID->Visible) { ?>
    <th data-name="DIAGNOSA_ID" class="<?= $Page->DIAGNOSA_ID->headerCellClass() ?>"><div class="mata_dan_syaraf_DIAGNOSA_ID"><?= $Page->renderSort($Page->DIAGNOSA_ID) ?></div></th>
<?php } ?>
<?php if ($Page->GENDER->Visible) { ?>
    <th data-name="GENDER" class="<?= $Page->GENDER->headerCellClass() ?>"><div class="mata_dan_syaraf_GENDER"><?= $Page->renderSort($Page->GENDER) ?></div></th>
<?php } ?>
    </tr>
</thead>
<tbody>
