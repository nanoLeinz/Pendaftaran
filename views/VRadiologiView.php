...
<?php if ($Page->idbooking->Visible) { // idbooking ?>
    <tr id="r_idbooking">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_idbooking"><?= $Page->idbooking->caption() ?></span></td>
...
<?php if ($Page->id_tujuan->Visible) { // id_tujuan ?>
    <tr id="r_id_tujuan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_tujuan"><?= $Page->id_tujuan->caption() ?></span></td>
...
<?php if ($Page->id_penunjang->Visible) { // id_penunjang ?>
    <tr id="r_id_penunjang">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_penunjang"><?= $Page->id_penunjang->caption() ?></span></td>
...
<?php if ($Page->id_pembiayaan->Visible) { // id_pembiayaan ?>
    <tr id="r_id_pembiayaan">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_pembiayaan"><?= $Page->id_pembiayaan->caption() ?></span></td>
...
<?php if ($Page->id_procedure->Visible) { // id_procedure ?>
    <tr id="r_id_procedure">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_procedure"><?= $Page->id_procedure->caption() ?></span></td>
...
<?php if ($Page->id_aspel->Visible) { // id_aspel ?>
    <tr id="r_id_aspel">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_aspel"><?= $Page->id_aspel->caption() ?></span></td>
...
<?php if ($Page->id_kelas->Visible) { // id_kelas ?>
    <tr id="r_id_kelas">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RADIOLOGI_id_kelas"><?= $Page->id_kelas->caption() ?></span></td>
