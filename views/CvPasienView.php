...
<span id="el_cv_pasien_NO_REGISTRATION" data-page="1">
...
<span id="el_cv_pasien_NAME_OF_PASIEN" data-page="1">
...
<span id="el_cv_pasien_PASIEN_ID" data-page="1">
...
<span id="el_cv_pasien_KK_NO" data-page="1">
...
<span id="el_cv_pasien_PLACE_OF_BIRTH" data-page="1">
...
<span id="el_cv_pasien_DATE_OF_BIRTH" data-page="1">
...
<span id="el_cv_pasien_GENDER" data-page="1">
...
<?php if ($Page->EDUCATION_TYPE_CODE->Visible) { // EDUCATION_TYPE_CODE ?>
    <tr id="r_EDUCATION_TYPE_CODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_EDUCATION_TYPE_CODE"><?= $Page->EDUCATION_TYPE_CODE->caption() ?></span></td>
        <td data-name="EDUCATION_TYPE_CODE" <?= $Page->EDUCATION_TYPE_CODE->cellAttributes() ?>>
<span id="el_cv_pasien_EDUCATION_TYPE_CODE" data-page="1">
...
<?php if ($Page->MARITALSTATUSID->Visible) { // MARITALSTATUSID ?>
    <tr id="r_MARITALSTATUSID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_MARITALSTATUSID"><?= $Page->MARITALSTATUSID->caption() ?></span></td>
        <td data-name="MARITALSTATUSID" <?= $Page->MARITALSTATUSID->cellAttributes() ?>>
<span id="el_cv_pasien_MARITALSTATUSID" data-page="1">
...
<?php if ($Page->KODE_AGAMA->Visible) { // KODE_AGAMA ?>
    <tr id="r_KODE_AGAMA">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_KODE_AGAMA"><?= $Page->KODE_AGAMA->caption() ?></span></td>
        <td data-name="KODE_AGAMA" <?= $Page->KODE_AGAMA->cellAttributes() ?>>
<span id="el_cv_pasien_KODE_AGAMA" data-page="1">
...
<?php if ($Page->KAL_ID->Visible) { // KAL_ID ?>
    <tr id="r_KAL_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_KAL_ID"><?= $Page->KAL_ID->caption() ?></span></td>
        <td data-name="KAL_ID" <?= $Page->KAL_ID->cellAttributes() ?>>
<span id="el_cv_pasien_KAL_ID" data-page="1">
...
<?php if ($Page->RT->Visible) { // RT ?>
    <tr id="r_RT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_RT"><?= $Page->RT->caption() ?></span></td>
        <td data-name="RT" <?= $Page->RT->cellAttributes() ?>>
<span id="el_cv_pasien_RT" data-page="1">
...
<?php if ($Page->RW->Visible) { // RW ?>
    <tr id="r_RW">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_RW"><?= $Page->RW->caption() ?></span></td>
        <td data-name="RW" <?= $Page->RW->cellAttributes() ?>>
<span id="el_cv_pasien_RW" data-page="1">
...
<?php if ($Page->JOB_ID->Visible) { // JOB_ID ?>
    <tr id="r_JOB_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_JOB_ID"><?= $Page->JOB_ID->caption() ?></span></td>
        <td data-name="JOB_ID" <?= $Page->JOB_ID->cellAttributes() ?>>
<span id="el_cv_pasien_JOB_ID" data-page="1">
...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
    <tr id="r_STATUS_PASIEN_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_STATUS_PASIEN_ID"><?= $Page->STATUS_PASIEN_ID->caption() ?></span></td>
        <td data-name="STATUS_PASIEN_ID" <?= $Page->STATUS_PASIEN_ID->cellAttributes() ?>>
<span id="el_cv_pasien_STATUS_PASIEN_ID" data-page="1">
...
<?php if ($Page->CONTACT_ADDRESS->Visible) { // CONTACT_ADDRESS ?>
    <tr id="r_CONTACT_ADDRESS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_CONTACT_ADDRESS"><?= $Page->CONTACT_ADDRESS->caption() ?></span></td>
        <td data-name="CONTACT_ADDRESS" <?= $Page->CONTACT_ADDRESS->cellAttributes() ?>>
<span id="el_cv_pasien_CONTACT_ADDRESS" data-page="1">
...
<?php if ($Page->PHONE_NUMBER->Visible) { // PHONE_NUMBER ?>
    <tr id="r_PHONE_NUMBER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_PHONE_NUMBER"><?= $Page->PHONE_NUMBER->caption() ?></span></td>
        <td data-name="PHONE_NUMBER" <?= $Page->PHONE_NUMBER->cellAttributes() ?>>
<span id="el_cv_pasien_PHONE_NUMBER" data-page="1">
...
<?php if ($Page->MOBILE->Visible) { // MOBILE ?>
    <tr id="r_MOBILE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_MOBILE"><?= $Page->MOBILE->caption() ?></span></td>
        <td data-name="MOBILE" <?= $Page->MOBILE->cellAttributes() ?>>
<span id="el_cv_pasien_MOBILE" data-page="1">
...
<?php if ($Page->_EMAIL->Visible) { // EMAIL ?>
    <tr id="r__EMAIL">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien__EMAIL"><?= $Page->_EMAIL->caption() ?></span></td>
        <td data-name="_EMAIL" <?= $Page->_EMAIL->cellAttributes() ?>>
<span id="el_cv_pasien__EMAIL" data-page="1">
...
<?php if ($Page->REGISTRATION_DATE->Visible) { // REGISTRATION_DATE ?>
    <tr id="r_REGISTRATION_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_REGISTRATION_DATE"><?= $Page->REGISTRATION_DATE->caption() ?></span></td>
        <td data-name="REGISTRATION_DATE" <?= $Page->REGISTRATION_DATE->cellAttributes() ?>>
<span id="el_cv_pasien_REGISTRATION_DATE" data-page="1">
...
<?php if ($Page->POSTAL_CODE->Visible) { // POSTAL_CODE ?>
    <tr id="r_POSTAL_CODE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_POSTAL_CODE"><?= $Page->POSTAL_CODE->caption() ?></span></td>
        <td data-name="POSTAL_CODE" <?= $Page->POSTAL_CODE->cellAttributes() ?>>
<span id="el_cv_pasien_POSTAL_CODE" data-page="1">
...
<?php if ($Page->BLOOD_TYPE_ID->Visible) { // BLOOD_TYPE_ID ?>
    <tr id="r_BLOOD_TYPE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_BLOOD_TYPE_ID"><?= $Page->BLOOD_TYPE_ID->caption() ?></span></td>
        <td data-name="BLOOD_TYPE_ID" <?= $Page->BLOOD_TYPE_ID->cellAttributes() ?>>
<span id="el_cv_pasien_BLOOD_TYPE_ID" data-page="1">
...
<?php if ($Page->FAMILY_STATUS_ID->Visible) { // FAMILY_STATUS_ID ?>
    <tr id="r_FAMILY_STATUS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_FAMILY_STATUS_ID"><?= $Page->FAMILY_STATUS_ID->caption() ?></span></td>
        <td data-name="FAMILY_STATUS_ID" <?= $Page->FAMILY_STATUS_ID->cellAttributes() ?>>
<span id="el_cv_pasien_FAMILY_STATUS_ID" data-page="1">
...
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <tr id="r_PAYOR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_PAYOR_ID"><?= $Page->PAYOR_ID->caption() ?></span></td>
        <td data-name="PAYOR_ID" <?= $Page->PAYOR_ID->cellAttributes() ?>>
<span id="el_cv_pasien_PAYOR_ID" data-page="1">
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <tr id="r_CLASS_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_CLASS_ID"><?= $Page->CLASS_ID->caption() ?></span></td>
        <td data-name="CLASS_ID" <?= $Page->CLASS_ID->cellAttributes() ?>>
<span id="el_cv_pasien_CLASS_ID" data-page="1">
...
<?php if ($Page->ORG_ID->Visible) { // ORG_ID ?>
    <tr id="r_ORG_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_ORG_ID"><?= $Page->ORG_ID->caption() ?></span></td>
        <td data-name="ORG_ID" <?= $Page->ORG_ID->cellAttributes() ?>>
<span id="el_cv_pasien_ORG_ID" data-page="1">
...
<?php if ($Page->COVERAGE_ID->Visible) { // COVERAGE_ID ?>
    <tr id="r_COVERAGE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_COVERAGE_ID"><?= $Page->COVERAGE_ID->caption() ?></span></td>
        <td data-name="COVERAGE_ID" <?= $Page->COVERAGE_ID->cellAttributes() ?>>
<span id="el_cv_pasien_COVERAGE_ID" data-page="1">
...
<?php if ($Page->MOTHER->Visible) { // MOTHER ?>
    <tr id="r_MOTHER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_MOTHER"><?= $Page->MOTHER->caption() ?></span></td>
        <td data-name="MOTHER" <?= $Page->MOTHER->cellAttributes() ?>>
<span id="el_cv_pasien_MOTHER" data-page="1">
...
<?php if ($Page->FATHER->Visible) { // FATHER ?>
    <tr id="r_FATHER">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_FATHER"><?= $Page->FATHER->caption() ?></span></td>
        <td data-name="FATHER" <?= $Page->FATHER->cellAttributes() ?>>
<span id="el_cv_pasien_FATHER" data-page="1">
...
<?php if ($Page->SPOUSE->Visible) { // SPOUSE ?>
    <tr id="r_SPOUSE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_SPOUSE"><?= $Page->SPOUSE->caption() ?></span></td>
        <td data-name="SPOUSE" <?= $Page->SPOUSE->cellAttributes() ?>>
<span id="el_cv_pasien_SPOUSE" data-page="1">
...
<?php if ($Page->AKTIF->Visible) { // AKTIF ?>
    <tr id="r_AKTIF">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_AKTIF"><?= $Page->AKTIF->caption() ?></span></td>
        <td data-name="AKTIF" <?= $Page->AKTIF->cellAttributes() ?>>
<span id="el_cv_pasien_AKTIF" data-page="1">
...
<?php if ($Page->TMT->Visible) { // TMT ?>
    <tr id="r_TMT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_TMT"><?= $Page->TMT->caption() ?></span></td>
        <td data-name="TMT" <?= $Page->TMT->cellAttributes() ?>>
<span id="el_cv_pasien_TMT" data-page="1">
...
<?php if ($Page->TAT->Visible) { // TAT ?>
    <tr id="r_TAT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_TAT"><?= $Page->TAT->caption() ?></span></td>
        <td data-name="TAT" <?= $Page->TAT->cellAttributes() ?>>
<span id="el_cv_pasien_TAT" data-page="1">
...
<?php if ($Page->MEDICAL_NOTES->Visible) { // MEDICAL_NOTES ?>
    <tr id="r_MEDICAL_NOTES">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_cv_pasien_MEDICAL_NOTES"><?= $Page->MEDICAL_NOTES->caption() ?></span></td>
        <td data-name="MEDICAL_NOTES" <?= $Page->MEDICAL_NOTES->cellAttributes() ?>>
<span id="el_cv_pasien_MEDICAL_NOTES" data-page="1">
