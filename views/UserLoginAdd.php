...
loadjs.ready("head", function () {
    ...
    fUSER_LOGINadd.lists.EMPLOYEE_ID = <?= $Page->EMPLOYEE_ID->toClientList($Page) ?>;
    fUSER_LOGINadd.lists.userlevelid = <?= $Page->userlevelid->toClientList($Page) ?>;
...
loadjs.ready(["fUSER_LOGINadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fUSER_LOGINadd", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
