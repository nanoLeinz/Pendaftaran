...
// Page object
$InasisJenisPesertaAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fINASIS_JENIS_PESERTAadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fINASIS_JENIS_PESERTAadd = currentForm = new ew.Form("fINASIS_JENIS_PESERTAadd", "add");
    ...
    fINASIS_JENIS_PESERTAadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fINASIS_JENIS_PESERTAadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fINASIS_JENIS_PESERTAadd.validate = function () {
    ...
    // Form_CustomValidate
    fINASIS_JENIS_PESERTAadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fINASIS_JENIS_PESERTAadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fINASIS_JENIS_PESERTAadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fINASIS_JENIS_PESERTAadd" id="fINASIS_JENIS_PESERTAadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
