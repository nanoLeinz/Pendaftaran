...
loadjs.ready("head", function () {
    ...
    fV_FARMASIedit.lists.NO_REGISTRATION = <?= $Page->NO_REGISTRATION->toClientList($Page) ?>;
    fV_FARMASIedit.lists.STATUS_PASIEN_ID = <?= $Page->STATUS_PASIEN_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.RUJUKAN_ID = <?= $Page->RUJUKAN_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.REASON_ID = <?= $Page->REASON_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.WAY_ID = <?= $Page->WAY_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.CLINIC_ID = <?= $Page->CLINIC_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.GENDER = <?= $Page->GENDER->toClientList($Page) ?>;
    fV_FARMASIedit.lists.PAYOR_ID = <?= $Page->PAYOR_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.CLASS_ID = <?= $Page->CLASS_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.COVERAGE_ID = <?= $Page->COVERAGE_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.DIAGNOSA_ID = <?= $Page->DIAGNOSA_ID->toClientList($Page) ?>;
    fV_FARMASIedit.lists.PPKRUJUKAN = <?= $Page->PPKRUJUKAN->toClientList($Page) ?>;
    fV_FARMASIedit.lists.COB = <?= $Page->COB->toClientList($Page) ?>;
...
<input type="hidden" data-table="V_FARMASI" data-field="x_NO_SKP" data-hidden="1" name="x_NO_SKP" id="x_NO_SKP" value="<?= HtmlEncode($Page->NO_SKP->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="V_FARMASI" data-field="x_NO_SKPINAP" data-hidden="1" name="x_NO_SKPINAP" id="x_NO_SKPINAP" value="<?= HtmlEncode($Page->NO_SKPINAP->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" is="selection-list" data-table="V_FARMASI" data-field="x_DIAGNOSA_ID" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->DIAGNOSA_ID->displayValueSeparatorAttribute() ?>" name="x_DIAGNOSA_ID" id="x_DIAGNOSA_ID" value="<?= $Page->DIAGNOSA_ID->CurrentValue ?>"<?= $Page->DIAGNOSA_ID->editAttributes() ?>>
</span>
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="V_FARMASI" data-field="x_NORUJUKAN" data-hidden="1" name="x_NORUJUKAN" id="x_NORUJUKAN" value="<?= HtmlEncode($Page->NORUJUKAN->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" is="selection-list" data-table="V_FARMASI" data-field="x_PPKRUJUKAN" data-type="text" data-multiple="0" data-lookup="1" data-value-separator="<?= $Page->PPKRUJUKAN->displayValueSeparatorAttribute() ?>" name="x_PPKRUJUKAN" id="x_PPKRUJUKAN" value="<?= $Page->PPKRUJUKAN->CurrentValue ?>"<?= $Page->PPKRUJUKAN->editAttributes() ?>>
</span>
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="V_FARMASI" data-field="x_EDIT_SEP" data-hidden="1" name="x_EDIT_SEP" id="x_EDIT_SEP" value="<?= HtmlEncode($Page->EDIT_SEP->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="<?= $Page->DIAG_AWAL->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_DIAG_AWAL" name="x_DIAG_AWAL" id="x_DIAG_AWAL" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->DIAG_AWAL->getPlaceHolder()) ?>" value="<?= $Page->DIAG_AWAL->EditValue ?>"<?= $Page->DIAG_AWAL->editAttributes() ?> aria-describedby="x_DIAG_AWAL_help">
...
<input type="<?= $Page->tgl_kontrol->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_tgl_kontrol" name="x_tgl_kontrol" id="x_tgl_kontrol" placeholder="<?= HtmlEncode($Page->tgl_kontrol->getPlaceHolder()) ?>" value="<?= $Page->tgl_kontrol->EditValue ?>"<?= $Page->tgl_kontrol->editAttributes() ?> aria-describedby="x_tgl_kontrol_help">
...
<script>
loadjs.ready(["fV_FARMASIedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIedit", "x_tgl_kontrol", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->idbooking->Visible) { // idbooking ?>
    <div id="r_idbooking" class="form-group row">
        <label id="elh_V_FARMASI_idbooking" for="x_idbooking" class="<?= $Page->LeftColumnClass ?>"><?= $Page->idbooking->caption() ?><?= $Page->idbooking->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idbooking->cellAttributes() ?>>
<span id="el_V_FARMASI_idbooking">
<input type="<?= $Page->idbooking->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_idbooking" name="x_idbooking" id="x_idbooking" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->idbooking->getPlaceHolder()) ?>" value="<?= $Page->idbooking->EditValue ?>"<?= $Page->idbooking->editAttributes() ?> aria-describedby="x_idbooking_help">
...
<?php if ($Page->id_tujuan->Visible) { // id_tujuan ?>
    <div id="r_id_tujuan" class="form-group row">
        <label id="elh_V_FARMASI_id_tujuan" for="x_id_tujuan" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_tujuan->caption() ?><?= $Page->id_tujuan->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_tujuan->cellAttributes() ?>>
<span id="el_V_FARMASI_id_tujuan">
<input type="<?= $Page->id_tujuan->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_tujuan" name="x_id_tujuan" id="x_id_tujuan" size="30" placeholder="<?= HtmlEncode($Page->id_tujuan->getPlaceHolder()) ?>" value="<?= $Page->id_tujuan->EditValue ?>"<?= $Page->id_tujuan->editAttributes() ?> aria-describedby="x_id_tujuan_help">
...
<?php if ($Page->id_penunjang->Visible) { // id_penunjang ?>
    <div id="r_id_penunjang" class="form-group row">
        <label id="elh_V_FARMASI_id_penunjang" for="x_id_penunjang" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_penunjang->caption() ?><?= $Page->id_penunjang->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_penunjang->cellAttributes() ?>>
<span id="el_V_FARMASI_id_penunjang">
<input type="<?= $Page->id_penunjang->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_penunjang" name="x_id_penunjang" id="x_id_penunjang" size="30" placeholder="<?= HtmlEncode($Page->id_penunjang->getPlaceHolder()) ?>" value="<?= $Page->id_penunjang->EditValue ?>"<?= $Page->id_penunjang->editAttributes() ?> aria-describedby="x_id_penunjang_help">
...
<?php if ($Page->id_procedure->Visible) { // id_procedure ?>
    <div id="r_id_procedure" class="form-group row">
        <label id="elh_V_FARMASI_id_procedure" for="x_id_procedure" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_procedure->caption() ?><?= $Page->id_procedure->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_procedure->cellAttributes() ?>>
<span id="el_V_FARMASI_id_procedure">
<input type="<?= $Page->id_procedure->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_procedure" name="x_id_procedure" id="x_id_procedure" size="30" placeholder="<?= HtmlEncode($Page->id_procedure->getPlaceHolder()) ?>" value="<?= $Page->id_procedure->EditValue ?>"<?= $Page->id_procedure->editAttributes() ?> aria-describedby="x_id_procedure_help">
...
<?php if ($Page->id_aspel->Visible) { // id_aspel ?>
    <div id="r_id_aspel" class="form-group row">
        <label id="elh_V_FARMASI_id_aspel" for="x_id_aspel" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_aspel->caption() ?><?= $Page->id_aspel->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_aspel->cellAttributes() ?>>
<span id="el_V_FARMASI_id_aspel">
<input type="<?= $Page->id_aspel->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_aspel" name="x_id_aspel" id="x_id_aspel" size="30" placeholder="<?= HtmlEncode($Page->id_aspel->getPlaceHolder()) ?>" value="<?= $Page->id_aspel->EditValue ?>"<?= $Page->id_aspel->editAttributes() ?> aria-describedby="x_id_aspel_help">
...
<?php if ($Page->id_kelas->Visible) { // id_kelas ?>
    <div id="r_id_kelas" class="form-group row">
        <label id="elh_V_FARMASI_id_kelas" for="x_id_kelas" class="<?= $Page->LeftColumnClass ?>"><?= $Page->id_kelas->caption() ?><?= $Page->id_kelas->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_kelas->cellAttributes() ?>>
<span id="el_V_FARMASI_id_kelas">
<input type="<?= $Page->id_kelas->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_kelas" name="x_id_kelas" id="x_id_kelas" size="30" placeholder="<?= HtmlEncode($Page->id_kelas->getPlaceHolder()) ?>" value="<?= $Page->id_kelas->EditValue ?>"<?= $Page->id_kelas->editAttributes() ?> aria-describedby="x_id_kelas_help">
