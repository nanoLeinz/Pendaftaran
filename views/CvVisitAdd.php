...
<input type="<?= $Page->idbooking->getInputTextType() ?>" data-table="cv_visit" data-field="x_idbooking" data-page="1" name="x_idbooking" id="x_idbooking" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->idbooking->getPlaceHolder()) ?>" value="<?= $Page->idbooking->EditValue ?>"<?= $Page->idbooking->editAttributes() ?> aria-describedby="x_idbooking_help">
...
<input type="<?= $Page->id_tujuan->getInputTextType() ?>" data-table="cv_visit" data-field="x_id_tujuan" data-page="1" name="x_id_tujuan" id="x_id_tujuan" size="30" placeholder="<?= HtmlEncode($Page->id_tujuan->getPlaceHolder()) ?>" value="<?= $Page->id_tujuan->EditValue ?>"<?= $Page->id_tujuan->editAttributes() ?> aria-describedby="x_id_tujuan_help">
...
<input type="<?= $Page->id_aspel->getInputTextType() ?>" data-table="cv_visit" data-field="x_id_aspel" data-page="1" name="x_id_aspel" id="x_id_aspel" size="30" placeholder="<?= HtmlEncode($Page->id_aspel->getPlaceHolder()) ?>" value="<?= $Page->id_aspel->EditValue ?>"<?= $Page->id_aspel->editAttributes() ?> aria-describedby="x_id_aspel_help">
...
<input type="<?= $Page->id_kelas->getInputTextType() ?>" data-table="cv_visit" data-field="x_id_kelas" data-page="1" name="x_id_kelas" id="x_id_kelas" size="30" placeholder="<?= HtmlEncode($Page->id_kelas->getPlaceHolder()) ?>" value="<?= $Page->id_kelas->EditValue ?>"<?= $Page->id_kelas->editAttributes() ?> aria-describedby="x_id_kelas_help">
