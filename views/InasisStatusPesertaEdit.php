...
// Page object
$InasisStatusPesertaEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fINASIS_STATUS_PESERTAedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fINASIS_STATUS_PESERTAedit = currentForm = new ew.Form("fINASIS_STATUS_PESERTAedit", "edit");
    ...
    fINASIS_STATUS_PESERTAedit.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = fINASIS_STATUS_PESERTAedit,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    fINASIS_STATUS_PESERTAedit.validate = function () {
    ...
    // Form_CustomValidate
    fINASIS_STATUS_PESERTAedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fINASIS_STATUS_PESERTAedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fINASIS_STATUS_PESERTAedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fINASIS_STATUS_PESERTAedit" id="fINASIS_STATUS_PESERTAedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="INASIS_STATUS_PESERTA" data-field="x_STATUS_PESERTA_KODE" data-hidden="1" name="o_STATUS_PESERTA_KODE" id="o_STATUS_PESERTA_KODE" value="<?= HtmlEncode($Page->STATUS_PESERTA_KODE->OldValue ?? $Page->STATUS_PESERTA_KODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
