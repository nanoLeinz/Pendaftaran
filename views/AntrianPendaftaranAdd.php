...
// Page object
$AntrianPendaftaranAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fANTRIAN_PENDAFTARANadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fANTRIAN_PENDAFTARANadd = currentForm = new ew.Form("fANTRIAN_PENDAFTARANadd", "add");
    ...
    fANTRIAN_PENDAFTARANadd.addFields([
    ...
    // Validate form
    fANTRIAN_PENDAFTARANadd.validate = function () {
    ...
    // Form_CustomValidate
    fANTRIAN_PENDAFTARANadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fANTRIAN_PENDAFTARANadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fANTRIAN_PENDAFTARANadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fANTRIAN_PENDAFTARANadd" id="fANTRIAN_PENDAFTARANadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARANadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARANadd", "x_tanggal_daftar", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARANadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARANadd", "x_tanggal_panggil", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARANadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARANadd", "x_tanggal_pesan", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fANTRIAN_PENDAFTARANadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fANTRIAN_PENDAFTARANadd", "x_tanggal_lahir", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
