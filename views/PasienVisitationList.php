...
<?php if ($Page->TICKET_NO->Visible) { // TICKET_NO ?>
        <th data-name="TICKET_NO" class="<?= $Page->TICKET_NO->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_VISITATION_TICKET_NO" class="PASIEN_VISITATION_TICKET_NO"><?= $Page->renderSort($Page->TICKET_NO) ?></div></th>
<?php } ?>
...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
        <th data-name="STATUS_PASIEN_ID" class="<?= $Page->STATUS_PASIEN_ID->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_VISITATION_STATUS_PASIEN_ID" class="PASIEN_VISITATION_STATUS_PASIEN_ID"><?= $Page->renderSort($Page->STATUS_PASIEN_ID) ?></div></th>
<?php } ?>
...
<?php if ($Page->VISIT_DATE->Visible) { // VISIT_DATE ?>
        <th data-name="VISIT_DATE" class="<?= $Page->VISIT_DATE->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_VISITATION_VISIT_DATE" class="PASIEN_VISITATION_VISIT_DATE"><?= $Page->renderSort($Page->VISIT_DATE) ?></div></th>
<?php } ?>
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
...
<?php if ($Page->SEP->Visible) { // SEP ?>
        <th data-name="SEP" class="<?= $Page->SEP->headerCellClass() ?>" style="white-space: nowrap;"><div id="elh_PASIEN_VISITATION_SEP" class="PASIEN_VISITATION_SEP"><?= $Page->renderSort($Page->SEP) ?></div></th>
<?php } ?>
<?php if ($Page->idbooking->Visible) { // idbooking ?>
        <th data-name="idbooking" class="<?= $Page->idbooking->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_idbooking" class="PASIEN_VISITATION_idbooking"><?= $Page->renderSort($Page->idbooking) ?></div></th>
<?php } ?>
<?php if ($Page->id_tujuan->Visible) { // id_tujuan ?>
        <th data-name="id_tujuan" class="<?= $Page->id_tujuan->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_tujuan" class="PASIEN_VISITATION_id_tujuan"><?= $Page->renderSort($Page->id_tujuan) ?></div></th>
<?php } ?>
<?php if ($Page->id_penunjang->Visible) { // id_penunjang ?>
        <th data-name="id_penunjang" class="<?= $Page->id_penunjang->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_penunjang" class="PASIEN_VISITATION_id_penunjang"><?= $Page->renderSort($Page->id_penunjang) ?></div></th>
<?php } ?>
<?php if ($Page->id_pembiayaan->Visible) { // id_pembiayaan ?>
        <th data-name="id_pembiayaan" class="<?= $Page->id_pembiayaan->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_pembiayaan" class="PASIEN_VISITATION_id_pembiayaan"><?= $Page->renderSort($Page->id_pembiayaan) ?></div></th>
<?php } ?>
<?php if ($Page->id_procedure->Visible) { // id_procedure ?>
        <th data-name="id_procedure" class="<?= $Page->id_procedure->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_procedure" class="PASIEN_VISITATION_id_procedure"><?= $Page->renderSort($Page->id_procedure) ?></div></th>
<?php } ?>
<?php if ($Page->id_aspel->Visible) { // id_aspel ?>
        <th data-name="id_aspel" class="<?= $Page->id_aspel->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_aspel" class="PASIEN_VISITATION_id_aspel"><?= $Page->renderSort($Page->id_aspel) ?></div></th>
<?php } ?>
<?php if ($Page->id_kelas->Visible) { // id_kelas ?>
        <th data-name="id_kelas" class="<?= $Page->id_kelas->headerCellClass() ?>"><div id="elh_PASIEN_VISITATION_id_kelas" class="PASIEN_VISITATION_id_kelas"><?= $Page->renderSort($Page->id_kelas) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_TICKET_NO">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_STATUS_PASIEN_ID">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_SEP">
<span<?= $Page->SEP->viewAttributes() ?>>
<?= $Page->SEP->getViewValue() ?></span>
</span>
</td>
    <?php } ?>
    <?php if ($Page->idbooking->Visible) { // idbooking ?>
        <td data-name="idbooking" <?= $Page->idbooking->cellAttributes() ?>>
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_idbooking">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_tujuan">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_penunjang">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_pembiayaan">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_procedure">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_aspel">
...
<span id="el<?= $Page->RowCount ?>_PASIEN_VISITATION_id_kelas">
