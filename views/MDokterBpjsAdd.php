...
var fm_dokter_bpjsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fm_dokter_bpjsadd = currentForm = new ew.Form("fm_dokter_bpjsadd", "add");
    ...
    // Validate form
    fm_dokter_bpjsadd.validate = function () {
    ...
    // Form_CustomValidate
    fm_dokter_bpjsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fm_dokter_bpjsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fm_dokter_bpjsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fm_dokter_bpjsadd" id="fm_dokter_bpjsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
