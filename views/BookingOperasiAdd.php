...
// Page object
$BookingOperasiAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fbooking_operasiadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fbooking_operasiadd = currentForm = new ew.Form("fbooking_operasiadd", "add");
    ...
    // Validate form
    fbooking_operasiadd.validate = function () {
    ...
    // Form_CustomValidate
    fbooking_operasiadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fbooking_operasiadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fbooking_operasiadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fbooking_operasiadd" id="fbooking_operasiadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["fbooking_operasiadd", "datetimepicker"], function() {
    ew.createDateTimePicker("fbooking_operasiadd", "x_tanggal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
