...
// Page object
$ReferensiMobilejknBpjsAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var freferensi_mobilejkn_bpjsadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    freferensi_mobilejkn_bpjsadd = currentForm = new ew.Form("freferensi_mobilejkn_bpjsadd", "add");
    ...
    freferensi_mobilejkn_bpjsadd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = freferensi_mobilejkn_bpjsadd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    freferensi_mobilejkn_bpjsadd.validate = function () {
    ...
    // Form_CustomValidate
    freferensi_mobilejkn_bpjsadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    freferensi_mobilejkn_bpjsadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("freferensi_mobilejkn_bpjsadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="freferensi_mobilejkn_bpjsadd" id="freferensi_mobilejkn_bpjsadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["freferensi_mobilejkn_bpjsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("freferensi_mobilejkn_bpjsadd", "x_tanggalperiksa", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["freferensi_mobilejkn_bpjsadd", "datetimepicker"], function() {
    ew.createDateTimePicker("freferensi_mobilejkn_bpjsadd", "x_validasi", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
