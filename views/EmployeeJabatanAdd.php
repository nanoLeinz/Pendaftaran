...
// Page object
$EmployeeJabatanAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fEMPLOYEE_JABATANadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fEMPLOYEE_JABATANadd = currentForm = new ew.Form("fEMPLOYEE_JABATANadd", "add");
    ...
    fEMPLOYEE_JABATANadd.addFields([
    ...
    // Validate form
    fEMPLOYEE_JABATANadd.validate = function () {
    ...
    // Form_CustomValidate
    fEMPLOYEE_JABATANadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fEMPLOYEE_JABATANadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fEMPLOYEE_JABATANadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fEMPLOYEE_JABATANadd" id="fEMPLOYEE_JABATANadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
