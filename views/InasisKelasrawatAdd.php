...
// Page object
$InasisKelasrawatAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var fINASIS_KELASRAWATadd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    fINASIS_KELASRAWATadd = currentForm = new ew.Form("fINASIS_KELASRAWATadd", "add");
    ...
    fINASIS_KELASRAWATadd.addFields([
    ...
    // Validate form
    fINASIS_KELASRAWATadd.validate = function () {
    ...
    // Form_CustomValidate
    fINASIS_KELASRAWATadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fINASIS_KELASRAWATadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fINASIS_KELASRAWATadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fINASIS_KELASRAWATadd" id="fINASIS_KELASRAWATadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
