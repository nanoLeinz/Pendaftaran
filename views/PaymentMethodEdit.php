...
// Page object
$PaymentMethodEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fPAYMENT_METHODedit;
loadjs.ready("head", function () {
    ...
    // Form_CustomValidate
    fPAYMENT_METHODedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPAYMENT_METHODedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;
...
$Page->showMessage();
?>
<form name="fPAYMENT_METHODedit" id="fPAYMENT_METHODedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="PAYMENT_METHOD" data-field="x_PAY_METHOD_ID" data-hidden="1" name="o_PAY_METHOD_ID" id="o_PAY_METHOD_ID" value="<?= HtmlEncode($Page->PAY_METHOD_ID->OldValue ?? $Page->PAY_METHOD_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
