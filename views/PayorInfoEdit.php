...
loadjs.ready("head", function () {
    ...
    fPAYOR_INFOedit = currentForm = new ew.Form("fPAYOR_INFOedit", "edit");
    ...
    // Validate form
    fPAYOR_INFOedit.validate = function () {
    ...
    // Form_CustomValidate
    fPAYOR_INFOedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPAYOR_INFOedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPAYOR_INFOedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPAYOR_INFOedit" id="fPAYOR_INFOedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="PAYOR_INFO" data-field="x_PAYOR_ID" data-hidden="1" name="o_PAYOR_ID" id="o_PAYOR_ID" value="<?= HtmlEncode($Page->PAYOR_ID->OldValue ?? $Page->PAYOR_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
