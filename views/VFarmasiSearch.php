...
var fV_FARMASIsearch, currentSearchForm, currentAdvancedSearchForm;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object for search
    <?php if ($Page->IsModal) { ?>
    fV_FARMASIsearch = currentAdvancedSearchForm = new ew.Form("fV_FARMASIsearch", "search");
    <?php } else { ?>
    fV_FARMASIsearch = currentForm = new ew.Form("fV_FARMASIsearch", "search");
    <?php } ?>
    ...
    // Set invalid fields
    $(function() {
        fV_FARMASIsearch.setInvalid();
    });

    // Validate form
    fV_FARMASIsearch.validate = function () {
    ...
    // Form_CustomValidate
    fV_FARMASIsearch.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fV_FARMASIsearch.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    fV_FARMASIsearch.lists.NO_REGISTRATION = <?= $Page->NO_REGISTRATION->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.STATUS_PASIEN_ID = <?= $Page->STATUS_PASIEN_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.RUJUKAN_ID = <?= $Page->RUJUKAN_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.REASON_ID = <?= $Page->REASON_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.WAY_ID = <?= $Page->WAY_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.PATIENT_CATEGORY_ID = <?= $Page->PATIENT_CATEGORY_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.ISNEW = <?= $Page->ISNEW->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.CLINIC_ID = <?= $Page->CLINIC_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.CLINIC_ID_FROM = <?= $Page->CLINIC_ID_FROM->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.KELUAR_ID = <?= $Page->KELUAR_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.GENDER = <?= $Page->GENDER->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.EMPLOYEE_ID = <?= $Page->EMPLOYEE_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.PAYOR_ID = <?= $Page->PAYOR_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.CLASS_ID = <?= $Page->CLASS_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.KAL_ID = <?= $Page->KAL_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.COVERAGE_ID = <?= $Page->COVERAGE_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.DIAGNOSA_ID = <?= $Page->DIAGNOSA_ID->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.ISRJ = <?= $Page->ISRJ->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.PPKRUJUKAN = <?= $Page->PPKRUJUKAN->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.KODE_AGAMA = <?= $Page->KODE_AGAMA->toClientList($Page) ?>;
    fV_FARMASIsearch.lists.COB = <?= $Page->COB->toClientList($Page) ?>;
    loadjs.done("fV_FARMASIsearch");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_FARMASIsearch" id="fV_FARMASIsearch" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->ORG_UNIT_CODE->Visible) { // ORG_UNIT_CODE ?>
    <div id="r_ORG_UNIT_CODE" class="form-group row">
        <label for="x_ORG_UNIT_CODE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ORG_UNIT_CODE"><?= $Page->ORG_UNIT_CODE->caption() ?></span>
...
<input type="hidden" name="z_ORG_UNIT_CODE" id="z_ORG_UNIT_CODE" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ORG_UNIT_CODE->cellAttributes() ?>>
            <span id="el_V_FARMASI_ORG_UNIT_CODE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ORG_UNIT_CODE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ORG_UNIT_CODE" name="x_ORG_UNIT_CODE" id="x_ORG_UNIT_CODE" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ORG_UNIT_CODE->getPlaceHolder()) ?>" value="<?= $Page->ORG_UNIT_CODE->EditValue ?>"<?= $Page->ORG_UNIT_CODE->editAttributes() ?>>
...
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <div id="r_NO_REGISTRATION" class="form-group row">
        <label for="x_NO_REGISTRATION" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_NO_REGISTRATION"><?= $Page->NO_REGISTRATION->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_NO_REGISTRATION" id="z_NO_REGISTRATION" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NO_REGISTRATION->cellAttributes() ?>>
            <span id="el_V_FARMASI_NO_REGISTRATION" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->VISIT_ID->Visible) { // VISIT_ID ?>
    <div id="r_VISIT_ID" class="form-group row">
        <label for="x_VISIT_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_VISIT_ID"><?= $Page->VISIT_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_VISIT_ID" id="z_VISIT_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->VISIT_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_VISIT_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->VISIT_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_VISIT_ID" name="x_VISIT_ID" id="x_VISIT_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->VISIT_ID->getPlaceHolder()) ?>" value="<?= $Page->VISIT_ID->EditValue ?>"<?= $Page->VISIT_ID->editAttributes() ?>>
...
<?php if ($Page->STATUS_PASIEN_ID->Visible) { // STATUS_PASIEN_ID ?>
    <div id="r_STATUS_PASIEN_ID" class="form-group row">
        <label for="x_STATUS_PASIEN_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_STATUS_PASIEN_ID"><?= $Page->STATUS_PASIEN_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_STATUS_PASIEN_ID" id="z_STATUS_PASIEN_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STATUS_PASIEN_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_STATUS_PASIEN_ID" class="ew-search-field ew-search-field-single">
    <select
...
<?php if ($Page->RUJUKAN_ID->Visible) { // RUJUKAN_ID ?>
    <div id="r_RUJUKAN_ID" class="form-group row">
        <label for="x_RUJUKAN_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RUJUKAN_ID"><?= $Page->RUJUKAN_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RUJUKAN_ID" id="z_RUJUKAN_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RUJUKAN_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_RUJUKAN_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_RUJUKAN_ID"
        name="x_RUJUKAN_ID"
...
<?php if ($Page->ADDRESS_OF_RUJUKAN->Visible) { // ADDRESS_OF_RUJUKAN ?>
    <div id="r_ADDRESS_OF_RUJUKAN" class="form-group row">
        <label for="x_ADDRESS_OF_RUJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ADDRESS_OF_RUJUKAN"><?= $Page->ADDRESS_OF_RUJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ADDRESS_OF_RUJUKAN" id="z_ADDRESS_OF_RUJUKAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ADDRESS_OF_RUJUKAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_ADDRESS_OF_RUJUKAN" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->REASON_ID->Visible) { // REASON_ID ?>
    <div id="r_REASON_ID" class="form-group row">
        <label for="x_REASON_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_REASON_ID"><?= $Page->REASON_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_REASON_ID" id="z_REASON_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->REASON_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_REASON_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_REASON_ID"
        name="x_REASON_ID"
...
<?php if ($Page->WAY_ID->Visible) { // WAY_ID ?>
    <div id="r_WAY_ID" class="form-group row">
        <label for="x_WAY_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_WAY_ID"><?= $Page->WAY_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_WAY_ID" id="z_WAY_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->WAY_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_WAY_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_WAY_ID"
        name="x_WAY_ID"
...
<?php if ($Page->PATIENT_CATEGORY_ID->Visible) { // PATIENT_CATEGORY_ID ?>
    <div id="r_PATIENT_CATEGORY_ID" class="form-group row">
        <label for="x_PATIENT_CATEGORY_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PATIENT_CATEGORY_ID"><?= $Page->PATIENT_CATEGORY_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_PATIENT_CATEGORY_ID" id="z_PATIENT_CATEGORY_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PATIENT_CATEGORY_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_PATIENT_CATEGORY_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_PATIENT_CATEGORY_ID"
        name="x_PATIENT_CATEGORY_ID"
        class="form-control ew-select<?= $Page->PATIENT_CATEGORY_ID->isInvalidClass() ?>"
        data-select2-id="V_FARMASI_x_PATIENT_CATEGORY_ID"
        data-table="V_FARMASI"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='V_FARMASI_x_PATIENT_CATEGORY_ID']"),
        options = { name: "x_PATIENT_CATEGORY_ID", selectId: "V_FARMASI_x_PATIENT_CATEGORY_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.V_FARMASI.fields.PATIENT_CATEGORY_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->BOOKED_DATE->Visible) { // BOOKED_DATE ?>
    <div id="r_BOOKED_DATE" class="form-group row">
        <label for="x_BOOKED_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_BOOKED_DATE"><?= $Page->BOOKED_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_BOOKED_DATE" id="z_BOOKED_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BOOKED_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_BOOKED_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->BOOKED_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_BOOKED_DATE" name="x_BOOKED_DATE" id="x_BOOKED_DATE" placeholder="<?= HtmlEncode($Page->BOOKED_DATE->getPlaceHolder()) ?>" value="<?= $Page->BOOKED_DATE->EditValue ?>"<?= $Page->BOOKED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_BOOKED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->VISIT_DATE->Visible) { // VISIT_DATE ?>
    <div id="r_VISIT_DATE" class="form-group row">
        <label for="x_VISIT_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_VISIT_DATE"><?= $Page->VISIT_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_VISIT_DATE" id="z_VISIT_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->VISIT_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_VISIT_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->VISIT_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_VISIT_DATE" name="x_VISIT_DATE" id="x_VISIT_DATE" placeholder="<?= HtmlEncode($Page->VISIT_DATE->getPlaceHolder()) ?>" value="<?= $Page->VISIT_DATE->EditValue ?>"<?= $Page->VISIT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_VISIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISNEW->Visible) { // ISNEW ?>
    <div id="r_ISNEW" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ISNEW"><?= $Page->ISNEW->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ISNEW" id="z_ISNEW" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISNEW->cellAttributes() ?>>
            <span id="el_V_FARMASI_ISNEW" class="ew-search-field ew-search-field-single">
<template id="tp_x_ISNEW">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="V_FARMASI" data-field="x_ISNEW" name="x_ISNEW" id="x_ISNEW"<?= $Page->ISNEW->editAttributes() ?>>
...
<?php if ($Page->FOLLOW_UP->Visible) { // FOLLOW_UP ?>
    <div id="r_FOLLOW_UP" class="form-group row">
        <label for="x_FOLLOW_UP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_FOLLOW_UP"><?= $Page->FOLLOW_UP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_FOLLOW_UP" id="z_FOLLOW_UP" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FOLLOW_UP->cellAttributes() ?>>
            <span id="el_V_FARMASI_FOLLOW_UP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->FOLLOW_UP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_FOLLOW_UP" name="x_FOLLOW_UP" id="x_FOLLOW_UP" size="30" placeholder="<?= HtmlEncode($Page->FOLLOW_UP->getPlaceHolder()) ?>" value="<?= $Page->FOLLOW_UP->EditValue ?>"<?= $Page->FOLLOW_UP->editAttributes() ?>>
...
<?php if ($Page->PLACE_TYPE->Visible) { // PLACE_TYPE ?>
    <div id="r_PLACE_TYPE" class="form-group row">
        <label for="x_PLACE_TYPE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PLACE_TYPE"><?= $Page->PLACE_TYPE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_PLACE_TYPE" id="z_PLACE_TYPE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PLACE_TYPE->cellAttributes() ?>>
            <span id="el_V_FARMASI_PLACE_TYPE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->PLACE_TYPE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_PLACE_TYPE" name="x_PLACE_TYPE" id="x_PLACE_TYPE" size="30" placeholder="<?= HtmlEncode($Page->PLACE_TYPE->getPlaceHolder()) ?>" value="<?= $Page->PLACE_TYPE->EditValue ?>"<?= $Page->PLACE_TYPE->editAttributes() ?>>
...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
    <div id="r_CLINIC_ID" class="form-group row">
        <label for="x_CLINIC_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CLINIC_ID"><?= $Page->CLINIC_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CLINIC_ID" id="z_CLINIC_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLINIC_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_CLINIC_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_CLINIC_ID"
        name="x_CLINIC_ID"
...
<?php if ($Page->CLINIC_ID_FROM->Visible) { // CLINIC_ID_FROM ?>
    <div id="r_CLINIC_ID_FROM" class="form-group row">
        <label for="x_CLINIC_ID_FROM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CLINIC_ID_FROM"><?= $Page->CLINIC_ID_FROM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CLINIC_ID_FROM" id="z_CLINIC_ID_FROM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLINIC_ID_FROM->cellAttributes() ?>>
            <span id="el_V_FARMASI_CLINIC_ID_FROM" class="ew-search-field ew-search-field-single">
    <select
        id="x_CLINIC_ID_FROM"
        name="x_CLINIC_ID_FROM"
        class="form-control ew-select<?= $Page->CLINIC_ID_FROM->isInvalidClass() ?>"
        data-select2-id="V_FARMASI_x_CLINIC_ID_FROM"
        data-table="V_FARMASI"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='V_FARMASI_x_CLINIC_ID_FROM']"),
        options = { name: "x_CLINIC_ID_FROM", selectId: "V_FARMASI_x_CLINIC_ID_FROM", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.V_FARMASI.fields.CLINIC_ID_FROM.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->CLASS_ROOM_ID->Visible) { // CLASS_ROOM_ID ?>
    <div id="r_CLASS_ROOM_ID" class="form-group row">
        <label for="x_CLASS_ROOM_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CLASS_ROOM_ID"><?= $Page->CLASS_ROOM_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CLASS_ROOM_ID" id="z_CLASS_ROOM_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLASS_ROOM_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_CLASS_ROOM_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CLASS_ROOM_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CLASS_ROOM_ID" name="x_CLASS_ROOM_ID" id="x_CLASS_ROOM_ID" size="30" maxlength="16" placeholder="<?= HtmlEncode($Page->CLASS_ROOM_ID->getPlaceHolder()) ?>" value="<?= $Page->CLASS_ROOM_ID->EditValue ?>"<?= $Page->CLASS_ROOM_ID->editAttributes() ?>>
...
<?php if ($Page->BED_ID->Visible) { // BED_ID ?>
    <div id="r_BED_ID" class="form-group row">
        <label for="x_BED_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_BED_ID"><?= $Page->BED_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_BED_ID" id="z_BED_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BED_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_BED_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->BED_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_BED_ID" name="x_BED_ID" id="x_BED_ID" size="30" placeholder="<?= HtmlEncode($Page->BED_ID->getPlaceHolder()) ?>" value="<?= $Page->BED_ID->EditValue ?>"<?= $Page->BED_ID->editAttributes() ?>>
...
<?php if ($Page->KELUAR_ID->Visible) { // KELUAR_ID ?>
    <div id="r_KELUAR_ID" class="form-group row">
        <label for="x_KELUAR_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KELUAR_ID"><?= $Page->KELUAR_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_KELUAR_ID" id="z_KELUAR_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KELUAR_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_KELUAR_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_KELUAR_ID"
        name="x_KELUAR_ID"
        class="form-control ew-select<?= $Page->KELUAR_ID->isInvalidClass() ?>"
        data-select2-id="V_FARMASI_x_KELUAR_ID"
        data-table="V_FARMASI"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='V_FARMASI_x_KELUAR_ID']"),
        options = { name: "x_KELUAR_ID", selectId: "V_FARMASI_x_KELUAR_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.V_FARMASI.fields.KELUAR_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->IN_DATE->Visible) { // IN_DATE ?>
    <div id="r_IN_DATE" class="form-group row">
        <label for="x_IN_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_IN_DATE"><?= $Page->IN_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_IN_DATE" id="z_IN_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->IN_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_IN_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->IN_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_IN_DATE" name="x_IN_DATE" id="x_IN_DATE" placeholder="<?= HtmlEncode($Page->IN_DATE->getPlaceHolder()) ?>" value="<?= $Page->IN_DATE->EditValue ?>"<?= $Page->IN_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_IN_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->EXIT_DATE->Visible) { // EXIT_DATE ?>
    <div id="r_EXIT_DATE" class="form-group row">
        <label for="x_EXIT_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_EXIT_DATE"><?= $Page->EXIT_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_EXIT_DATE" id="z_EXIT_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EXIT_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_EXIT_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->EXIT_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_EXIT_DATE" name="x_EXIT_DATE" id="x_EXIT_DATE" placeholder="<?= HtmlEncode($Page->EXIT_DATE->getPlaceHolder()) ?>" value="<?= $Page->EXIT_DATE->EditValue ?>"<?= $Page->EXIT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_EXIT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->DIANTAR_OLEH->Visible) { // DIANTAR_OLEH ?>
    <div id="r_DIANTAR_OLEH" class="form-group row">
        <label for="x_DIANTAR_OLEH" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_DIANTAR_OLEH"><?= $Page->DIANTAR_OLEH->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DIANTAR_OLEH" id="z_DIANTAR_OLEH" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIANTAR_OLEH->cellAttributes() ?>>
            <span id="el_V_FARMASI_DIANTAR_OLEH" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->DIANTAR_OLEH->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_DIANTAR_OLEH" name="x_DIANTAR_OLEH" id="x_DIANTAR_OLEH" size="30" maxlength="255" placeholder="<?= HtmlEncode($Page->DIANTAR_OLEH->getPlaceHolder()) ?>" value="<?= $Page->DIANTAR_OLEH->EditValue ?>"<?= $Page->DIANTAR_OLEH->editAttributes() ?>>
...
<?php if ($Page->GENDER->Visible) { // GENDER ?>
    <div id="r_GENDER" class="form-group row">
        <label for="x_GENDER" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_GENDER"><?= $Page->GENDER->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_GENDER" id="z_GENDER" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->GENDER->cellAttributes() ?>>
            <span id="el_V_FARMASI_GENDER" class="ew-search-field ew-search-field-single">
    <select
        id="x_GENDER"
        name="x_GENDER"
...
<?php if ($Page->DESCRIPTION->Visible) { // DESCRIPTION ?>
    <div id="r_DESCRIPTION" class="form-group row">
        <label for="x_DESCRIPTION" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_DESCRIPTION"><?= $Page->DESCRIPTION->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DESCRIPTION" id="z_DESCRIPTION" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DESCRIPTION->cellAttributes() ?>>
            <span id="el_V_FARMASI_DESCRIPTION" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->DESCRIPTION->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_DESCRIPTION" name="x_DESCRIPTION" id="x_DESCRIPTION" size="30" maxlength="200" placeholder="<?= HtmlEncode($Page->DESCRIPTION->getPlaceHolder()) ?>" value="<?= $Page->DESCRIPTION->EditValue ?>"<?= $Page->DESCRIPTION->editAttributes() ?>>
...
<?php if ($Page->VISITOR_ADDRESS->Visible) { // VISITOR_ADDRESS ?>
    <div id="r_VISITOR_ADDRESS" class="form-group row">
        <label for="x_VISITOR_ADDRESS" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_VISITOR_ADDRESS"><?= $Page->VISITOR_ADDRESS->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_VISITOR_ADDRESS" id="z_VISITOR_ADDRESS" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->VISITOR_ADDRESS->cellAttributes() ?>>
            <span id="el_V_FARMASI_VISITOR_ADDRESS" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->VISITOR_ADDRESS->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_VISITOR_ADDRESS" name="x_VISITOR_ADDRESS" id="x_VISITOR_ADDRESS" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->VISITOR_ADDRESS->getPlaceHolder()) ?>" value="<?= $Page->VISITOR_ADDRESS->EditValue ?>"<?= $Page->VISITOR_ADDRESS->editAttributes() ?>>
...
<?php if ($Page->MODIFIED_BY->Visible) { // MODIFIED_BY ?>
    <div id="r_MODIFIED_BY" class="form-group row">
        <label for="x_MODIFIED_BY" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_MODIFIED_BY"><?= $Page->MODIFIED_BY->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_MODIFIED_BY" id="z_MODIFIED_BY" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODIFIED_BY->cellAttributes() ?>>
            <span id="el_V_FARMASI_MODIFIED_BY" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->MODIFIED_BY->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_MODIFIED_BY" name="x_MODIFIED_BY" id="x_MODIFIED_BY" size="30" maxlength="100" placeholder="<?= HtmlEncode($Page->MODIFIED_BY->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_BY->EditValue ?>"<?= $Page->MODIFIED_BY->editAttributes() ?>>
...
<?php if ($Page->MODIFIED_DATE->Visible) { // MODIFIED_DATE ?>
    <div id="r_MODIFIED_DATE" class="form-group row">
        <label for="x_MODIFIED_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_MODIFIED_DATE"><?= $Page->MODIFIED_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_MODIFIED_DATE" id="z_MODIFIED_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODIFIED_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_MODIFIED_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->MODIFIED_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_MODIFIED_DATE" name="x_MODIFIED_DATE" id="x_MODIFIED_DATE" placeholder="<?= HtmlEncode($Page->MODIFIED_DATE->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_DATE->EditValue ?>"<?= $Page->MODIFIED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->MODIFIED_FROM->Visible) { // MODIFIED_FROM ?>
    <div id="r_MODIFIED_FROM" class="form-group row">
        <label for="x_MODIFIED_FROM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_MODIFIED_FROM"><?= $Page->MODIFIED_FROM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_MODIFIED_FROM" id="z_MODIFIED_FROM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MODIFIED_FROM->cellAttributes() ?>>
            <span id="el_V_FARMASI_MODIFIED_FROM" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->MODIFIED_FROM->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_MODIFIED_FROM" name="x_MODIFIED_FROM" id="x_MODIFIED_FROM" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->MODIFIED_FROM->getPlaceHolder()) ?>" value="<?= $Page->MODIFIED_FROM->EditValue ?>"<?= $Page->MODIFIED_FROM->editAttributes() ?>>
...
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
    <div id="r_EMPLOYEE_ID" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_EMPLOYEE_ID"><?= $Page->EMPLOYEE_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_EMPLOYEE_ID" id="z_EMPLOYEE_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EMPLOYEE_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_EMPLOYEE_ID" class="ew-search-field ew-search-field-single">
<?php
...
<script>
loadjs.ready(["fV_FARMASIsearch"], function() {
    fV_FARMASIsearch.createAutoSuggest(Object.assign({"id":"x_EMPLOYEE_ID","forceSelect":false}, ew.vars.tables.V_FARMASI.fields.EMPLOYEE_ID.autoSuggestOptions));
});
</script>
...
<?php if ($Page->EMPLOYEE_ID_FROM->Visible) { // EMPLOYEE_ID_FROM ?>
    <div id="r_EMPLOYEE_ID_FROM" class="form-group row">
        <label for="x_EMPLOYEE_ID_FROM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_EMPLOYEE_ID_FROM"><?= $Page->EMPLOYEE_ID_FROM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_EMPLOYEE_ID_FROM" id="z_EMPLOYEE_ID_FROM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EMPLOYEE_ID_FROM->cellAttributes() ?>>
            <span id="el_V_FARMASI_EMPLOYEE_ID_FROM" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->RESPONSIBLE_ID->Visible) { // RESPONSIBLE_ID ?>
    <div id="r_RESPONSIBLE_ID" class="form-group row">
        <label for="x_RESPONSIBLE_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONSIBLE_ID"><?= $Page->RESPONSIBLE_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RESPONSIBLE_ID" id="z_RESPONSIBLE_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONSIBLE_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONSIBLE_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONSIBLE_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONSIBLE_ID" name="x_RESPONSIBLE_ID" id="x_RESPONSIBLE_ID" size="30" placeholder="<?= HtmlEncode($Page->RESPONSIBLE_ID->getPlaceHolder()) ?>" value="<?= $Page->RESPONSIBLE_ID->EditValue ?>"<?= $Page->RESPONSIBLE_ID->editAttributes() ?>>
...
<?php if ($Page->RESPONSIBLE->Visible) { // RESPONSIBLE ?>
    <div id="r_RESPONSIBLE" class="form-group row">
        <label for="x_RESPONSIBLE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONSIBLE"><?= $Page->RESPONSIBLE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONSIBLE" id="z_RESPONSIBLE" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONSIBLE->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONSIBLE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONSIBLE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONSIBLE" name="x_RESPONSIBLE" id="x_RESPONSIBLE" size="30" maxlength="150" placeholder="<?= HtmlEncode($Page->RESPONSIBLE->getPlaceHolder()) ?>" value="<?= $Page->RESPONSIBLE->EditValue ?>"<?= $Page->RESPONSIBLE->editAttributes() ?>>
...
<?php if ($Page->FAMILY_STATUS_ID->Visible) { // FAMILY_STATUS_ID ?>
    <div id="r_FAMILY_STATUS_ID" class="form-group row">
        <label for="x_FAMILY_STATUS_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_FAMILY_STATUS_ID"><?= $Page->FAMILY_STATUS_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_FAMILY_STATUS_ID" id="z_FAMILY_STATUS_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->FAMILY_STATUS_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_FAMILY_STATUS_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->FAMILY_STATUS_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_FAMILY_STATUS_ID" name="x_FAMILY_STATUS_ID" id="x_FAMILY_STATUS_ID" size="30" placeholder="<?= HtmlEncode($Page->FAMILY_STATUS_ID->getPlaceHolder()) ?>" value="<?= $Page->FAMILY_STATUS_ID->EditValue ?>"<?= $Page->FAMILY_STATUS_ID->editAttributes() ?>>
...
<?php if ($Page->TICKET_NO->Visible) { // TICKET_NO ?>
    <div id="r_TICKET_NO" class="form-group row">
        <label for="x_TICKET_NO" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_TICKET_NO"><?= $Page->TICKET_NO->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_TICKET_NO" id="z_TICKET_NO" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TICKET_NO->cellAttributes() ?>>
            <span id="el_V_FARMASI_TICKET_NO" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->TICKET_NO->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_TICKET_NO" name="x_TICKET_NO" id="x_TICKET_NO" size="30" placeholder="<?= HtmlEncode($Page->TICKET_NO->getPlaceHolder()) ?>" value="<?= $Page->TICKET_NO->EditValue ?>"<?= $Page->TICKET_NO->editAttributes() ?>>
...
<?php if ($Page->ISATTENDED->Visible) { // ISATTENDED ?>
    <div id="r_ISATTENDED" class="form-group row">
        <label for="x_ISATTENDED" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ISATTENDED"><?= $Page->ISATTENDED->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ISATTENDED" id="z_ISATTENDED" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISATTENDED->cellAttributes() ?>>
            <span id="el_V_FARMASI_ISATTENDED" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ISATTENDED->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ISATTENDED" name="x_ISATTENDED" id="x_ISATTENDED" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISATTENDED->getPlaceHolder()) ?>" value="<?= $Page->ISATTENDED->EditValue ?>"<?= $Page->ISATTENDED->editAttributes() ?>>
...
<?php if ($Page->PAYOR_ID->Visible) { // PAYOR_ID ?>
    <div id="r_PAYOR_ID" class="form-group row">
        <label for="x_PAYOR_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PAYOR_ID"><?= $Page->PAYOR_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_PAYOR_ID" id="z_PAYOR_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PAYOR_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_PAYOR_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_PAYOR_ID"
        name="x_PAYOR_ID"
...
<?php if ($Page->CLASS_ID->Visible) { // CLASS_ID ?>
    <div id="r_CLASS_ID" class="form-group row">
        <label for="x_CLASS_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CLASS_ID"><?= $Page->CLASS_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CLASS_ID" id="z_CLASS_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLASS_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_CLASS_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_CLASS_ID"
        name="x_CLASS_ID"
...
<?php if ($Page->ISPERTARIF->Visible) { // ISPERTARIF ?>
    <div id="r_ISPERTARIF" class="form-group row">
        <label for="x_ISPERTARIF" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ISPERTARIF"><?= $Page->ISPERTARIF->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ISPERTARIF" id="z_ISPERTARIF" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISPERTARIF->cellAttributes() ?>>
            <span id="el_V_FARMASI_ISPERTARIF" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ISPERTARIF->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ISPERTARIF" name="x_ISPERTARIF" id="x_ISPERTARIF" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ISPERTARIF->getPlaceHolder()) ?>" value="<?= $Page->ISPERTARIF->EditValue ?>"<?= $Page->ISPERTARIF->editAttributes() ?>>
...
<?php if ($Page->KAL_ID->Visible) { // KAL_ID ?>
    <div id="r_KAL_ID" class="form-group row">
        <label for="x_KAL_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KAL_ID"><?= $Page->KAL_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KAL_ID" id="z_KAL_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KAL_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_KAL_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_KAL_ID"
        name="x_KAL_ID"
        class="form-control ew-select<?= $Page->KAL_ID->isInvalidClass() ?>"
        data-select2-id="V_FARMASI_x_KAL_ID"
        data-table="V_FARMASI"
        data-field="x_KAL_ID"
...
<script>
loadjs.ready("head", function() {
    var el = document.querySelector("select[data-select2-id='V_FARMASI_x_KAL_ID']"),
        options = { name: "x_KAL_ID", selectId: "V_FARMASI_x_KAL_ID", language: ew.LANGUAGE_ID, dir: ew.IS_RTL ? "rtl" : "ltr" };
    options.dropdownParent = $(el).closest("#ew-modal-dialog, #ew-add-opt-dialog")[0];
    Object.assign(options, ew.vars.tables.V_FARMASI.fields.KAL_ID.selectOptions);
    ew.createSelect(options);
});
</script>
</span>
...
<?php if ($Page->EMPLOYEE_INAP->Visible) { // EMPLOYEE_INAP ?>
    <div id="r_EMPLOYEE_INAP" class="form-group row">
        <label for="x_EMPLOYEE_INAP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_EMPLOYEE_INAP"><?= $Page->EMPLOYEE_INAP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_EMPLOYEE_INAP" id="z_EMPLOYEE_INAP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EMPLOYEE_INAP->cellAttributes() ?>>
            <span id="el_V_FARMASI_EMPLOYEE_INAP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->EMPLOYEE_INAP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_EMPLOYEE_INAP" name="x_EMPLOYEE_INAP" id="x_EMPLOYEE_INAP" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->EMPLOYEE_INAP->getPlaceHolder()) ?>" value="<?= $Page->EMPLOYEE_INAP->EditValue ?>"<?= $Page->EMPLOYEE_INAP->editAttributes() ?>>
...
<?php if ($Page->PASIEN_ID->Visible) { // PASIEN_ID ?>
    <div id="r_PASIEN_ID" class="form-group row">
        <label for="x_PASIEN_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PASIEN_ID"><?= $Page->PASIEN_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_PASIEN_ID" id="z_PASIEN_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PASIEN_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_PASIEN_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->PASIEN_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_PASIEN_ID" name="x_PASIEN_ID" id="x_PASIEN_ID" size="30" maxlength="30" placeholder="<?= HtmlEncode($Page->PASIEN_ID->getPlaceHolder()) ?>" value="<?= $Page->PASIEN_ID->EditValue ?>"<?= $Page->PASIEN_ID->editAttributes() ?>>
...
<?php if ($Page->KARYAWAN->Visible) { // KARYAWAN ?>
    <div id="r_KARYAWAN" class="form-group row">
        <label for="x_KARYAWAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KARYAWAN"><?= $Page->KARYAWAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KARYAWAN" id="z_KARYAWAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KARYAWAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_KARYAWAN" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->KARYAWAN->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_KARYAWAN" name="x_KARYAWAN" id="x_KARYAWAN" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->KARYAWAN->getPlaceHolder()) ?>" value="<?= $Page->KARYAWAN->EditValue ?>"<?= $Page->KARYAWAN->editAttributes() ?>>
...
<?php if ($Page->ACCOUNT_ID->Visible) { // ACCOUNT_ID ?>
    <div id="r_ACCOUNT_ID" class="form-group row">
        <label for="x_ACCOUNT_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ACCOUNT_ID"><?= $Page->ACCOUNT_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ACCOUNT_ID" id="z_ACCOUNT_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ACCOUNT_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_ACCOUNT_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ACCOUNT_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ACCOUNT_ID" name="x_ACCOUNT_ID" id="x_ACCOUNT_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->ACCOUNT_ID->getPlaceHolder()) ?>" value="<?= $Page->ACCOUNT_ID->EditValue ?>"<?= $Page->ACCOUNT_ID->editAttributes() ?>>
...
<?php if ($Page->CLASS_ID_PLAFOND->Visible) { // CLASS_ID_PLAFOND ?>
    <div id="r_CLASS_ID_PLAFOND" class="form-group row">
        <label for="x_CLASS_ID_PLAFOND" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CLASS_ID_PLAFOND"><?= $Page->CLASS_ID_PLAFOND->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CLASS_ID_PLAFOND" id="z_CLASS_ID_PLAFOND" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CLASS_ID_PLAFOND->cellAttributes() ?>>
            <span id="el_V_FARMASI_CLASS_ID_PLAFOND" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CLASS_ID_PLAFOND->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CLASS_ID_PLAFOND" name="x_CLASS_ID_PLAFOND" id="x_CLASS_ID_PLAFOND" size="30" placeholder="<?= HtmlEncode($Page->CLASS_ID_PLAFOND->getPlaceHolder()) ?>" value="<?= $Page->CLASS_ID_PLAFOND->EditValue ?>"<?= $Page->CLASS_ID_PLAFOND->editAttributes() ?>>
...
<?php if ($Page->BACKCHARGE->Visible) { // BACKCHARGE ?>
    <div id="r_BACKCHARGE" class="form-group row">
        <label for="x_BACKCHARGE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_BACKCHARGE"><?= $Page->BACKCHARGE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_BACKCHARGE" id="z_BACKCHARGE" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BACKCHARGE->cellAttributes() ?>>
            <span id="el_V_FARMASI_BACKCHARGE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->BACKCHARGE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_BACKCHARGE" name="x_BACKCHARGE" id="x_BACKCHARGE" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->BACKCHARGE->getPlaceHolder()) ?>" value="<?= $Page->BACKCHARGE->EditValue ?>"<?= $Page->BACKCHARGE->editAttributes() ?>>
...
<?php if ($Page->COVERAGE_ID->Visible) { // COVERAGE_ID ?>
    <div id="r_COVERAGE_ID" class="form-group row">
        <label for="x_COVERAGE_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_COVERAGE_ID"><?= $Page->COVERAGE_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_COVERAGE_ID" id="z_COVERAGE_ID" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->COVERAGE_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_COVERAGE_ID" class="ew-search-field ew-search-field-single">
    <select
        id="x_COVERAGE_ID"
        name="x_COVERAGE_ID"
...
<?php if ($Page->AGEYEAR->Visible) { // AGEYEAR ?>
    <div id="r_AGEYEAR" class="form-group row">
        <label for="x_AGEYEAR" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_AGEYEAR"><?= $Page->AGEYEAR->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_AGEYEAR" id="z_AGEYEAR" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEYEAR->cellAttributes() ?>>
            <span id="el_V_FARMASI_AGEYEAR" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->AGEYEAR->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_AGEYEAR" name="x_AGEYEAR" id="x_AGEYEAR" size="30" placeholder="<?= HtmlEncode($Page->AGEYEAR->getPlaceHolder()) ?>" value="<?= $Page->AGEYEAR->EditValue ?>"<?= $Page->AGEYEAR->editAttributes() ?>>
...
<?php if ($Page->AGEMONTH->Visible) { // AGEMONTH ?>
    <div id="r_AGEMONTH" class="form-group row">
        <label for="x_AGEMONTH" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_AGEMONTH"><?= $Page->AGEMONTH->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_AGEMONTH" id="z_AGEMONTH" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEMONTH->cellAttributes() ?>>
            <span id="el_V_FARMASI_AGEMONTH" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->AGEMONTH->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_AGEMONTH" name="x_AGEMONTH" id="x_AGEMONTH" size="30" placeholder="<?= HtmlEncode($Page->AGEMONTH->getPlaceHolder()) ?>" value="<?= $Page->AGEMONTH->EditValue ?>"<?= $Page->AGEMONTH->editAttributes() ?>>
...
<?php if ($Page->AGEDAY->Visible) { // AGEDAY ?>
    <div id="r_AGEDAY" class="form-group row">
        <label for="x_AGEDAY" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_AGEDAY"><?= $Page->AGEDAY->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_AGEDAY" id="z_AGEDAY" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AGEDAY->cellAttributes() ?>>
            <span id="el_V_FARMASI_AGEDAY" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->AGEDAY->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_AGEDAY" name="x_AGEDAY" id="x_AGEDAY" size="30" placeholder="<?= HtmlEncode($Page->AGEDAY->getPlaceHolder()) ?>" value="<?= $Page->AGEDAY->EditValue ?>"<?= $Page->AGEDAY->editAttributes() ?>>
...
<?php if ($Page->RECOMENDATION->Visible) { // RECOMENDATION ?>
    <div id="r_RECOMENDATION" class="form-group row">
        <label for="x_RECOMENDATION" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RECOMENDATION"><?= $Page->RECOMENDATION->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RECOMENDATION" id="z_RECOMENDATION" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RECOMENDATION->cellAttributes() ?>>
            <span id="el_V_FARMASI_RECOMENDATION" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RECOMENDATION->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RECOMENDATION" name="x_RECOMENDATION" id="x_RECOMENDATION" size="30" maxlength="8000" placeholder="<?= HtmlEncode($Page->RECOMENDATION->getPlaceHolder()) ?>" value="<?= $Page->RECOMENDATION->EditValue ?>"<?= $Page->RECOMENDATION->editAttributes() ?>>
...
<?php if ($Page->CONCLUSION->Visible) { // CONCLUSION ?>
    <div id="r_CONCLUSION" class="form-group row">
        <label for="x_CONCLUSION" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CONCLUSION"><?= $Page->CONCLUSION->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_CONCLUSION" id="z_CONCLUSION" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CONCLUSION->cellAttributes() ?>>
            <span id="el_V_FARMASI_CONCLUSION" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CONCLUSION->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CONCLUSION" name="x_CONCLUSION" id="x_CONCLUSION" size="30" maxlength="8000" placeholder="<?= HtmlEncode($Page->CONCLUSION->getPlaceHolder()) ?>" value="<?= $Page->CONCLUSION->EditValue ?>"<?= $Page->CONCLUSION->editAttributes() ?>>
...
<?php if ($Page->SPECIMENNO->Visible) { // SPECIMENNO ?>
    <div id="r_SPECIMENNO" class="form-group row">
        <label for="x_SPECIMENNO" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_SPECIMENNO"><?= $Page->SPECIMENNO->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_SPECIMENNO" id="z_SPECIMENNO" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SPECIMENNO->cellAttributes() ?>>
            <span id="el_V_FARMASI_SPECIMENNO" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->SPECIMENNO->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_SPECIMENNO" name="x_SPECIMENNO" id="x_SPECIMENNO" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->SPECIMENNO->getPlaceHolder()) ?>" value="<?= $Page->SPECIMENNO->EditValue ?>"<?= $Page->SPECIMENNO->editAttributes() ?>>
...
<?php if ($Page->LOCKED->Visible) { // LOCKED ?>
    <div id="r_LOCKED" class="form-group row">
        <label for="x_LOCKED" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LOCKED"><?= $Page->LOCKED->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LOCKED" id="z_LOCKED" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LOCKED->cellAttributes() ?>>
            <span id="el_V_FARMASI_LOCKED" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LOCKED->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LOCKED" name="x_LOCKED" id="x_LOCKED" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LOCKED->getPlaceHolder()) ?>" value="<?= $Page->LOCKED->EditValue ?>"<?= $Page->LOCKED->editAttributes() ?>>
...
<?php if ($Page->RM_OUT_DATE->Visible) { // RM_OUT_DATE ?>
    <div id="r_RM_OUT_DATE" class="form-group row">
        <label for="x_RM_OUT_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RM_OUT_DATE"><?= $Page->RM_OUT_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RM_OUT_DATE" id="z_RM_OUT_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RM_OUT_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_RM_OUT_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RM_OUT_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RM_OUT_DATE" name="x_RM_OUT_DATE" id="x_RM_OUT_DATE" placeholder="<?= HtmlEncode($Page->RM_OUT_DATE->getPlaceHolder()) ?>" value="<?= $Page->RM_OUT_DATE->EditValue ?>"<?= $Page->RM_OUT_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_RM_OUT_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->RM_IN_DATE->Visible) { // RM_IN_DATE ?>
    <div id="r_RM_IN_DATE" class="form-group row">
        <label for="x_RM_IN_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RM_IN_DATE"><?= $Page->RM_IN_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RM_IN_DATE" id="z_RM_IN_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RM_IN_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_RM_IN_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RM_IN_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RM_IN_DATE" name="x_RM_IN_DATE" id="x_RM_IN_DATE" placeholder="<?= HtmlEncode($Page->RM_IN_DATE->getPlaceHolder()) ?>" value="<?= $Page->RM_IN_DATE->EditValue ?>"<?= $Page->RM_IN_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_RM_IN_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->LAMA_PINJAM->Visible) { // LAMA_PINJAM ?>
    <div id="r_LAMA_PINJAM" class="form-group row">
        <label for="x_LAMA_PINJAM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LAMA_PINJAM"><?= $Page->LAMA_PINJAM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_LAMA_PINJAM" id="z_LAMA_PINJAM" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LAMA_PINJAM->cellAttributes() ?>>
            <span id="el_V_FARMASI_LAMA_PINJAM" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LAMA_PINJAM->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LAMA_PINJAM" name="x_LAMA_PINJAM" id="x_LAMA_PINJAM" placeholder="<?= HtmlEncode($Page->LAMA_PINJAM->getPlaceHolder()) ?>" value="<?= $Page->LAMA_PINJAM->EditValue ?>"<?= $Page->LAMA_PINJAM->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_LAMA_PINJAM", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->STANDAR_RJ->Visible) { // STANDAR_RJ ?>
    <div id="r_STANDAR_RJ" class="form-group row">
        <label for="x_STANDAR_RJ" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_STANDAR_RJ"><?= $Page->STANDAR_RJ->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_STANDAR_RJ" id="z_STANDAR_RJ" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->STANDAR_RJ->cellAttributes() ?>>
            <span id="el_V_FARMASI_STANDAR_RJ" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->STANDAR_RJ->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_STANDAR_RJ" name="x_STANDAR_RJ" id="x_STANDAR_RJ" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->STANDAR_RJ->getPlaceHolder()) ?>" value="<?= $Page->STANDAR_RJ->EditValue ?>"<?= $Page->STANDAR_RJ->editAttributes() ?>>
...
<?php if ($Page->LENGKAP_RJ->Visible) { // LENGKAP_RJ ?>
    <div id="r_LENGKAP_RJ" class="form-group row">
        <label for="x_LENGKAP_RJ" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_RJ"><?= $Page->LENGKAP_RJ->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_RJ" id="z_LENGKAP_RJ" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_RJ->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_RJ" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_RJ->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_RJ" name="x_LENGKAP_RJ" id="x_LENGKAP_RJ" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_RJ->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_RJ->EditValue ?>"<?= $Page->LENGKAP_RJ->editAttributes() ?>>
...
<?php if ($Page->LENGKAP_RI->Visible) { // LENGKAP_RI ?>
    <div id="r_LENGKAP_RI" class="form-group row">
        <label for="x_LENGKAP_RI" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_RI"><?= $Page->LENGKAP_RI->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_RI" id="z_LENGKAP_RI" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_RI->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_RI" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_RI->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_RI" name="x_LENGKAP_RI" id="x_LENGKAP_RI" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_RI->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_RI->EditValue ?>"<?= $Page->LENGKAP_RI->editAttributes() ?>>
...
<?php if ($Page->RESEND_RM_DATE->Visible) { // RESEND_RM_DATE ?>
    <div id="r_RESEND_RM_DATE" class="form-group row">
        <label for="x_RESEND_RM_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESEND_RM_DATE"><?= $Page->RESEND_RM_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_RESEND_RM_DATE" id="z_RESEND_RM_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESEND_RM_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESEND_RM_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESEND_RM_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESEND_RM_DATE" name="x_RESEND_RM_DATE" id="x_RESEND_RM_DATE" placeholder="<?= HtmlEncode($Page->RESEND_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->RESEND_RM_DATE->EditValue ?>"<?= $Page->RESEND_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_RESEND_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->LENGKAP_RM1->Visible) { // LENGKAP_RM1 ?>
    <div id="r_LENGKAP_RM1" class="form-group row">
        <label for="x_LENGKAP_RM1" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_RM1"><?= $Page->LENGKAP_RM1->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_RM1" id="z_LENGKAP_RM1" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_RM1->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_RM1" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_RM1->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_RM1" name="x_LENGKAP_RM1" id="x_LENGKAP_RM1" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_RM1->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_RM1->EditValue ?>"<?= $Page->LENGKAP_RM1->editAttributes() ?>>
...
<?php if ($Page->LENGKAP_RESUME->Visible) { // LENGKAP_RESUME ?>
    <div id="r_LENGKAP_RESUME" class="form-group row">
        <label for="x_LENGKAP_RESUME" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_RESUME"><?= $Page->LENGKAP_RESUME->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_RESUME" id="z_LENGKAP_RESUME" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_RESUME->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_RESUME" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_RESUME->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_RESUME" name="x_LENGKAP_RESUME" id="x_LENGKAP_RESUME" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_RESUME->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_RESUME->EditValue ?>"<?= $Page->LENGKAP_RESUME->editAttributes() ?>>
...
<?php if ($Page->LENGKAP_ANAMNESIS->Visible) { // LENGKAP_ANAMNESIS ?>
    <div id="r_LENGKAP_ANAMNESIS" class="form-group row">
        <label for="x_LENGKAP_ANAMNESIS" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_ANAMNESIS"><?= $Page->LENGKAP_ANAMNESIS->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_ANAMNESIS" id="z_LENGKAP_ANAMNESIS" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_ANAMNESIS->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_ANAMNESIS" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->LENGKAP_CONSENT->Visible) { // LENGKAP_CONSENT ?>
    <div id="r_LENGKAP_CONSENT" class="form-group row">
        <label for="x_LENGKAP_CONSENT" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_CONSENT"><?= $Page->LENGKAP_CONSENT->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_CONSENT" id="z_LENGKAP_CONSENT" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_CONSENT->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_CONSENT" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_CONSENT->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_CONSENT" name="x_LENGKAP_CONSENT" id="x_LENGKAP_CONSENT" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_CONSENT->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_CONSENT->EditValue ?>"<?= $Page->LENGKAP_CONSENT->editAttributes() ?>>
...
<?php if ($Page->LENGKAP_ANESTESI->Visible) { // LENGKAP_ANESTESI ?>
    <div id="r_LENGKAP_ANESTESI" class="form-group row">
        <label for="x_LENGKAP_ANESTESI" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_ANESTESI"><?= $Page->LENGKAP_ANESTESI->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_ANESTESI" id="z_LENGKAP_ANESTESI" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_ANESTESI->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_ANESTESI" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->LENGKAP_OP->Visible) { // LENGKAP_OP ?>
    <div id="r_LENGKAP_OP" class="form-group row">
        <label for="x_LENGKAP_OP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LENGKAP_OP"><?= $Page->LENGKAP_OP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LENGKAP_OP" id="z_LENGKAP_OP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LENGKAP_OP->cellAttributes() ?>>
            <span id="el_V_FARMASI_LENGKAP_OP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LENGKAP_OP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LENGKAP_OP" name="x_LENGKAP_OP" id="x_LENGKAP_OP" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->LENGKAP_OP->getPlaceHolder()) ?>" value="<?= $Page->LENGKAP_OP->EditValue ?>"<?= $Page->LENGKAP_OP->editAttributes() ?>>
...
<?php if ($Page->BACK_RM_DATE->Visible) { // BACK_RM_DATE ?>
    <div id="r_BACK_RM_DATE" class="form-group row">
        <label for="x_BACK_RM_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_BACK_RM_DATE"><?= $Page->BACK_RM_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_BACK_RM_DATE" id="z_BACK_RM_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BACK_RM_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_BACK_RM_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->BACK_RM_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_BACK_RM_DATE" name="x_BACK_RM_DATE" id="x_BACK_RM_DATE" placeholder="<?= HtmlEncode($Page->BACK_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->BACK_RM_DATE->EditValue ?>"<?= $Page->BACK_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_BACK_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->VALID_RM_DATE->Visible) { // VALID_RM_DATE ?>
    <div id="r_VALID_RM_DATE" class="form-group row">
        <label for="x_VALID_RM_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_VALID_RM_DATE"><?= $Page->VALID_RM_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_VALID_RM_DATE" id="z_VALID_RM_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->VALID_RM_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_VALID_RM_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->VALID_RM_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_VALID_RM_DATE" name="x_VALID_RM_DATE" id="x_VALID_RM_DATE" placeholder="<?= HtmlEncode($Page->VALID_RM_DATE->getPlaceHolder()) ?>" value="<?= $Page->VALID_RM_DATE->EditValue ?>"<?= $Page->VALID_RM_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_VALID_RM_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->NO_SKP->Visible) { // NO_SKP ?>
    <div id="r_NO_SKP" class="form-group row">
        <label for="x_NO_SKP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_NO_SKP"><?= $Page->NO_SKP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_NO_SKP" id="z_NO_SKP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NO_SKP->cellAttributes() ?>>
            <span id="el_V_FARMASI_NO_SKP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->NO_SKP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_NO_SKP" name="x_NO_SKP" id="x_NO_SKP" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NO_SKP->getPlaceHolder()) ?>" value="<?= $Page->NO_SKP->EditValue ?>"<?= $Page->NO_SKP->editAttributes() ?>>
...
<?php if ($Page->NO_SKPINAP->Visible) { // NO_SKPINAP ?>
    <div id="r_NO_SKPINAP" class="form-group row">
        <label for="x_NO_SKPINAP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_NO_SKPINAP"><?= $Page->NO_SKPINAP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_NO_SKPINAP" id="z_NO_SKPINAP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NO_SKPINAP->cellAttributes() ?>>
            <span id="el_V_FARMASI_NO_SKPINAP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->NO_SKPINAP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_NO_SKPINAP" name="x_NO_SKPINAP" id="x_NO_SKPINAP" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NO_SKPINAP->getPlaceHolder()) ?>" value="<?= $Page->NO_SKPINAP->EditValue ?>"<?= $Page->NO_SKPINAP->editAttributes() ?>>
...
<?php if ($Page->DIAGNOSA_ID->Visible) { // DIAGNOSA_ID ?>
    <div id="r_DIAGNOSA_ID" class="form-group row">
        <label for="x_DIAGNOSA_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_DIAGNOSA_ID"><?= $Page->DIAGNOSA_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DIAGNOSA_ID" id="z_DIAGNOSA_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIAGNOSA_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_DIAGNOSA_ID" class="ew-search-field ew-search-field-single">
<div class="input-group ew-lookup-list">
...
<?php if ($Page->ticket_all->Visible) { // ticket_all ?>
    <div id="r_ticket_all" class="form-group row">
        <label for="x_ticket_all" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ticket_all"><?= $Page->ticket_all->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_ticket_all" id="z_ticket_all" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ticket_all->cellAttributes() ?>>
            <span id="el_V_FARMASI_ticket_all" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ticket_all->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ticket_all" name="x_ticket_all" id="x_ticket_all" size="30" placeholder="<?= HtmlEncode($Page->ticket_all->getPlaceHolder()) ?>" value="<?= $Page->ticket_all->EditValue ?>"<?= $Page->ticket_all->editAttributes() ?>>
...
<?php if ($Page->tanggal_rujukan->Visible) { // tanggal_rujukan ?>
    <div id="r_tanggal_rujukan" class="form-group row">
        <label for="x_tanggal_rujukan" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_tanggal_rujukan"><?= $Page->tanggal_rujukan->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_tanggal_rujukan" id="z_tanggal_rujukan" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tanggal_rujukan->cellAttributes() ?>>
            <span id="el_V_FARMASI_tanggal_rujukan" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->tanggal_rujukan->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_tanggal_rujukan" name="x_tanggal_rujukan" id="x_tanggal_rujukan" placeholder="<?= HtmlEncode($Page->tanggal_rujukan->getPlaceHolder()) ?>" value="<?= $Page->tanggal_rujukan->EditValue ?>"<?= $Page->tanggal_rujukan->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_tanggal_rujukan", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->ISRJ->Visible) { // ISRJ ?>
    <div id="r_ISRJ" class="form-group row">
        <label for="x_ISRJ" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ISRJ"><?= $Page->ISRJ->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ISRJ" id="z_ISRJ" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ISRJ->cellAttributes() ?>>
            <span id="el_V_FARMASI_ISRJ" class="ew-search-field ew-search-field-single">
    <select
        id="x_ISRJ"
        name="x_ISRJ"
...
<?php if ($Page->NORUJUKAN->Visible) { // NORUJUKAN ?>
    <div id="r_NORUJUKAN" class="form-group row">
        <label for="x_NORUJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_NORUJUKAN"><?= $Page->NORUJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_NORUJUKAN" id="z_NORUJUKAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->NORUJUKAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_NORUJUKAN" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->NORUJUKAN->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_NORUJUKAN" name="x_NORUJUKAN" id="x_NORUJUKAN" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->NORUJUKAN->getPlaceHolder()) ?>" value="<?= $Page->NORUJUKAN->EditValue ?>"<?= $Page->NORUJUKAN->editAttributes() ?>>
...
<?php if ($Page->PPKRUJUKAN->Visible) { // PPKRUJUKAN ?>
    <div id="r_PPKRUJUKAN" class="form-group row">
        <label for="x_PPKRUJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PPKRUJUKAN"><?= $Page->PPKRUJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_PPKRUJUKAN" id="z_PPKRUJUKAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PPKRUJUKAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_PPKRUJUKAN" class="ew-search-field ew-search-field-single">
<div class="input-group ew-lookup-list">
...
<?php if ($Page->LOKASILAKA->Visible) { // LOKASILAKA ?>
    <div id="r_LOKASILAKA" class="form-group row">
        <label for="x_LOKASILAKA" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_LOKASILAKA"><?= $Page->LOKASILAKA->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_LOKASILAKA" id="z_LOKASILAKA" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->LOKASILAKA->cellAttributes() ?>>
            <span id="el_V_FARMASI_LOKASILAKA" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->LOKASILAKA->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_LOKASILAKA" name="x_LOKASILAKA" id="x_LOKASILAKA" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->LOKASILAKA->getPlaceHolder()) ?>" value="<?= $Page->LOKASILAKA->EditValue ?>"<?= $Page->LOKASILAKA->editAttributes() ?>>
...
<?php if ($Page->KDPOLI->Visible) { // KDPOLI ?>
    <div id="r_KDPOLI" class="form-group row">
        <label for="x_KDPOLI" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KDPOLI"><?= $Page->KDPOLI->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KDPOLI" id="z_KDPOLI" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KDPOLI->cellAttributes() ?>>
            <span id="el_V_FARMASI_KDPOLI" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->KDPOLI->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_KDPOLI" name="x_KDPOLI" id="x_KDPOLI" size="30" maxlength="3" placeholder="<?= HtmlEncode($Page->KDPOLI->getPlaceHolder()) ?>" value="<?= $Page->KDPOLI->EditValue ?>"<?= $Page->KDPOLI->editAttributes() ?>>
...
<?php if ($Page->EDIT_SEP->Visible) { // EDIT_SEP ?>
    <div id="r_EDIT_SEP" class="form-group row">
        <label for="x_EDIT_SEP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_EDIT_SEP"><?= $Page->EDIT_SEP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_EDIT_SEP" id="z_EDIT_SEP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->EDIT_SEP->cellAttributes() ?>>
            <span id="el_V_FARMASI_EDIT_SEP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->EDIT_SEP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_EDIT_SEP" name="x_EDIT_SEP" id="x_EDIT_SEP" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->EDIT_SEP->getPlaceHolder()) ?>" value="<?= $Page->EDIT_SEP->EditValue ?>"<?= $Page->EDIT_SEP->editAttributes() ?>>
...
<?php if ($Page->DELETE_SEP->Visible) { // DELETE_SEP ?>
    <div id="r_DELETE_SEP" class="form-group row">
        <label for="x_DELETE_SEP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_DELETE_SEP"><?= $Page->DELETE_SEP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DELETE_SEP" id="z_DELETE_SEP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DELETE_SEP->cellAttributes() ?>>
            <span id="el_V_FARMASI_DELETE_SEP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->DELETE_SEP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_DELETE_SEP" name="x_DELETE_SEP" id="x_DELETE_SEP" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->DELETE_SEP->getPlaceHolder()) ?>" value="<?= $Page->DELETE_SEP->EditValue ?>"<?= $Page->DELETE_SEP->editAttributes() ?>>
...
<?php if ($Page->KODE_AGAMA->Visible) { // KODE_AGAMA ?>
    <div id="r_KODE_AGAMA" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KODE_AGAMA"><?= $Page->KODE_AGAMA->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_KODE_AGAMA" id="z_KODE_AGAMA" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KODE_AGAMA->cellAttributes() ?>>
            <span id="el_V_FARMASI_KODE_AGAMA" class="ew-search-field ew-search-field-single">
<template id="tp_x_KODE_AGAMA">
    <div class="custom-control custom-radio">
        <input type="radio" class="custom-control-input" data-table="V_FARMASI" data-field="x_KODE_AGAMA" name="x_KODE_AGAMA" id="x_KODE_AGAMA"<?= $Page->KODE_AGAMA->editAttributes() ?>>
        <label class="custom-control-label"></label>
    </div>
</template>
...
<?php if ($Page->DIAG_AWAL->Visible) { // DIAG_AWAL ?>
    <div id="r_DIAG_AWAL" class="form-group row">
        <label for="x_DIAG_AWAL" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_DIAG_AWAL"><?= $Page->DIAG_AWAL->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_DIAG_AWAL" id="z_DIAG_AWAL" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->DIAG_AWAL->cellAttributes() ?>>
            <span id="el_V_FARMASI_DIAG_AWAL" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->DIAG_AWAL->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_DIAG_AWAL" name="x_DIAG_AWAL" id="x_DIAG_AWAL" size="30" maxlength="10" placeholder="<?= HtmlEncode($Page->DIAG_AWAL->getPlaceHolder()) ?>" value="<?= $Page->DIAG_AWAL->EditValue ?>"<?= $Page->DIAG_AWAL->editAttributes() ?>>
...
<?php if ($Page->AKTIF->Visible) { // AKTIF ?>
    <div id="r_AKTIF" class="form-group row">
        <label for="x_AKTIF" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_AKTIF"><?= $Page->AKTIF->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_AKTIF" id="z_AKTIF" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->AKTIF->cellAttributes() ?>>
            <span id="el_V_FARMASI_AKTIF" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->AKTIF->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_AKTIF" name="x_AKTIF" id="x_AKTIF" size="30" maxlength="2" placeholder="<?= HtmlEncode($Page->AKTIF->getPlaceHolder()) ?>" value="<?= $Page->AKTIF->EditValue ?>"<?= $Page->AKTIF->editAttributes() ?>>
...
<?php if ($Page->BILL_INAP->Visible) { // BILL_INAP ?>
    <div id="r_BILL_INAP" class="form-group row">
        <label for="x_BILL_INAP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_BILL_INAP"><?= $Page->BILL_INAP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_BILL_INAP" id="z_BILL_INAP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->BILL_INAP->cellAttributes() ?>>
            <span id="el_V_FARMASI_BILL_INAP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->BILL_INAP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_BILL_INAP" name="x_BILL_INAP" id="x_BILL_INAP" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->BILL_INAP->getPlaceHolder()) ?>" value="<?= $Page->BILL_INAP->EditValue ?>"<?= $Page->BILL_INAP->editAttributes() ?>>
...
<?php if ($Page->SEP_PRINTDATE->Visible) { // SEP_PRINTDATE ?>
    <div id="r_SEP_PRINTDATE" class="form-group row">
        <label for="x_SEP_PRINTDATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_SEP_PRINTDATE"><?= $Page->SEP_PRINTDATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_SEP_PRINTDATE" id="z_SEP_PRINTDATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SEP_PRINTDATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_SEP_PRINTDATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->SEP_PRINTDATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_SEP_PRINTDATE" name="x_SEP_PRINTDATE" id="x_SEP_PRINTDATE" placeholder="<?= HtmlEncode($Page->SEP_PRINTDATE->getPlaceHolder()) ?>" value="<?= $Page->SEP_PRINTDATE->EditValue ?>"<?= $Page->SEP_PRINTDATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_SEP_PRINTDATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->MAPPING_SEP->Visible) { // MAPPING_SEP ?>
    <div id="r_MAPPING_SEP" class="form-group row">
        <label for="x_MAPPING_SEP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_MAPPING_SEP"><?= $Page->MAPPING_SEP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_MAPPING_SEP" id="z_MAPPING_SEP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->MAPPING_SEP->cellAttributes() ?>>
            <span id="el_V_FARMASI_MAPPING_SEP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->MAPPING_SEP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_MAPPING_SEP" name="x_MAPPING_SEP" id="x_MAPPING_SEP" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->MAPPING_SEP->getPlaceHolder()) ?>" value="<?= $Page->MAPPING_SEP->EditValue ?>"<?= $Page->MAPPING_SEP->editAttributes() ?>>
...
<?php if ($Page->TRANS_ID->Visible) { // TRANS_ID ?>
    <div id="r_TRANS_ID" class="form-group row">
        <label for="x_TRANS_ID" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_TRANS_ID"><?= $Page->TRANS_ID->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_TRANS_ID" id="z_TRANS_ID" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->TRANS_ID->cellAttributes() ?>>
            <span id="el_V_FARMASI_TRANS_ID" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->TRANS_ID->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_TRANS_ID" name="x_TRANS_ID" id="x_TRANS_ID" size="30" maxlength="50" placeholder="<?= HtmlEncode($Page->TRANS_ID->getPlaceHolder()) ?>" value="<?= $Page->TRANS_ID->EditValue ?>"<?= $Page->TRANS_ID->editAttributes() ?>>
...
<?php if ($Page->KDPOLI_EKS->Visible) { // KDPOLI_EKS ?>
    <div id="r_KDPOLI_EKS" class="form-group row">
        <label for="x_KDPOLI_EKS" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KDPOLI_EKS"><?= $Page->KDPOLI_EKS->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KDPOLI_EKS" id="z_KDPOLI_EKS" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KDPOLI_EKS->cellAttributes() ?>>
            <span id="el_V_FARMASI_KDPOLI_EKS" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->KDPOLI_EKS->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_KDPOLI_EKS" name="x_KDPOLI_EKS" id="x_KDPOLI_EKS" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->KDPOLI_EKS->getPlaceHolder()) ?>" value="<?= $Page->KDPOLI_EKS->EditValue ?>"<?= $Page->KDPOLI_EKS->editAttributes() ?>>
...
<?php if ($Page->COB->Visible) { // COB ?>
    <div id="r_COB" class="form-group row">
        <label class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_COB"><?= $Page->COB->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_COB" id="z_COB" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->COB->cellAttributes() ?>>
            <span id="el_V_FARMASI_COB" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->PENJAMIN->Visible) { // PENJAMIN ?>
    <div id="r_PENJAMIN" class="form-group row">
        <label for="x_PENJAMIN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_PENJAMIN"><?= $Page->PENJAMIN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_PENJAMIN" id="z_PENJAMIN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->PENJAMIN->cellAttributes() ?>>
            <span id="el_V_FARMASI_PENJAMIN" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->PENJAMIN->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_PENJAMIN" name="x_PENJAMIN" id="x_PENJAMIN" size="30" maxlength="25" placeholder="<?= HtmlEncode($Page->PENJAMIN->getPlaceHolder()) ?>" value="<?= $Page->PENJAMIN->EditValue ?>"<?= $Page->PENJAMIN->editAttributes() ?>>
...
<?php if ($Page->ASALRUJUKAN->Visible) { // ASALRUJUKAN ?>
    <div id="r_ASALRUJUKAN" class="form-group row">
        <label for="x_ASALRUJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_ASALRUJUKAN"><?= $Page->ASALRUJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_ASALRUJUKAN" id="z_ASALRUJUKAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->ASALRUJUKAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_ASALRUJUKAN" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->ASALRUJUKAN->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_ASALRUJUKAN" name="x_ASALRUJUKAN" id="x_ASALRUJUKAN" size="30" maxlength="1" placeholder="<?= HtmlEncode($Page->ASALRUJUKAN->getPlaceHolder()) ?>" value="<?= $Page->ASALRUJUKAN->EditValue ?>"<?= $Page->ASALRUJUKAN->editAttributes() ?>>
...
<?php if ($Page->RESPONSEP->Visible) { // RESPONSEP ?>
    <div id="r_RESPONSEP" class="form-group row">
        <label for="x_RESPONSEP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONSEP"><?= $Page->RESPONSEP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONSEP" id="z_RESPONSEP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONSEP->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONSEP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONSEP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONSEP" name="x_RESPONSEP" id="x_RESPONSEP" size="35" placeholder="<?= HtmlEncode($Page->RESPONSEP->getPlaceHolder()) ?>" value="<?= $Page->RESPONSEP->EditValue ?>"<?= $Page->RESPONSEP->editAttributes() ?>>
...
<?php if ($Page->APPROVAL_DESC->Visible) { // APPROVAL_DESC ?>
    <div id="r_APPROVAL_DESC" class="form-group row">
        <label for="x_APPROVAL_DESC" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_APPROVAL_DESC"><?= $Page->APPROVAL_DESC->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_APPROVAL_DESC" id="z_APPROVAL_DESC" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->APPROVAL_DESC->cellAttributes() ?>>
            <span id="el_V_FARMASI_APPROVAL_DESC" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->APPROVAL_DESC->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_APPROVAL_DESC" name="x_APPROVAL_DESC" id="x_APPROVAL_DESC" size="30" maxlength="250" placeholder="<?= HtmlEncode($Page->APPROVAL_DESC->getPlaceHolder()) ?>" value="<?= $Page->APPROVAL_DESC->EditValue ?>"<?= $Page->APPROVAL_DESC->editAttributes() ?>>
...
<?php if ($Page->APPROVAL_RESPONAJUKAN->Visible) { // APPROVAL_RESPONAJUKAN ?>
    <div id="r_APPROVAL_RESPONAJUKAN" class="form-group row">
        <label for="x_APPROVAL_RESPONAJUKAN" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_APPROVAL_RESPONAJUKAN"><?= $Page->APPROVAL_RESPONAJUKAN->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_APPROVAL_RESPONAJUKAN" id="z_APPROVAL_RESPONAJUKAN" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->APPROVAL_RESPONAJUKAN->cellAttributes() ?>>
            <span id="el_V_FARMASI_APPROVAL_RESPONAJUKAN" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->APPROVAL_RESPONAPPROV->Visible) { // APPROVAL_RESPONAPPROV ?>
    <div id="r_APPROVAL_RESPONAPPROV" class="form-group row">
        <label for="x_APPROVAL_RESPONAPPROV" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_APPROVAL_RESPONAPPROV"><?= $Page->APPROVAL_RESPONAPPROV->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_APPROVAL_RESPONAPPROV" id="z_APPROVAL_RESPONAPPROV" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->APPROVAL_RESPONAPPROV->cellAttributes() ?>>
            <span id="el_V_FARMASI_APPROVAL_RESPONAPPROV" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->RESPONTGLPLG_DESC->Visible) { // RESPONTGLPLG_DESC ?>
    <div id="r_RESPONTGLPLG_DESC" class="form-group row">
        <label for="x_RESPONTGLPLG_DESC" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONTGLPLG_DESC"><?= $Page->RESPONTGLPLG_DESC->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONTGLPLG_DESC" id="z_RESPONTGLPLG_DESC" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONTGLPLG_DESC->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONTGLPLG_DESC" class="ew-search-field ew-search-field-single">
...
<?php if ($Page->RESPONPOST_VKLAIM->Visible) { // RESPONPOST_VKLAIM ?>
    <div id="r_RESPONPOST_VKLAIM" class="form-group row">
        <label for="x_RESPONPOST_VKLAIM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONPOST_VKLAIM"><?= $Page->RESPONPOST_VKLAIM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONPOST_VKLAIM" id="z_RESPONPOST_VKLAIM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONPOST_VKLAIM->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONPOST_VKLAIM" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONPOST_VKLAIM->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONPOST_VKLAIM" name="x_RESPONPOST_VKLAIM" id="x_RESPONPOST_VKLAIM" size="35" placeholder="<?= HtmlEncode($Page->RESPONPOST_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONPOST_VKLAIM->EditValue ?>"<?= $Page->RESPONPOST_VKLAIM->editAttributes() ?>>
...
<?php if ($Page->RESPONPUT_VKLAIM->Visible) { // RESPONPUT_VKLAIM ?>
    <div id="r_RESPONPUT_VKLAIM" class="form-group row">
        <label for="x_RESPONPUT_VKLAIM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONPUT_VKLAIM"><?= $Page->RESPONPUT_VKLAIM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONPUT_VKLAIM" id="z_RESPONPUT_VKLAIM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONPUT_VKLAIM->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONPUT_VKLAIM" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONPUT_VKLAIM->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONPUT_VKLAIM" name="x_RESPONPUT_VKLAIM" id="x_RESPONPUT_VKLAIM" size="35" placeholder="<?= HtmlEncode($Page->RESPONPUT_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONPUT_VKLAIM->EditValue ?>"<?= $Page->RESPONPUT_VKLAIM->editAttributes() ?>>
...
<?php if ($Page->RESPONDEL_VKLAIM->Visible) { // RESPONDEL_VKLAIM ?>
    <div id="r_RESPONDEL_VKLAIM" class="form-group row">
        <label for="x_RESPONDEL_VKLAIM" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_RESPONDEL_VKLAIM"><?= $Page->RESPONDEL_VKLAIM->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_RESPONDEL_VKLAIM" id="z_RESPONDEL_VKLAIM" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->RESPONDEL_VKLAIM->cellAttributes() ?>>
            <span id="el_V_FARMASI_RESPONDEL_VKLAIM" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->RESPONDEL_VKLAIM->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_RESPONDEL_VKLAIM" name="x_RESPONDEL_VKLAIM" id="x_RESPONDEL_VKLAIM" size="35" placeholder="<?= HtmlEncode($Page->RESPONDEL_VKLAIM->getPlaceHolder()) ?>" value="<?= $Page->RESPONDEL_VKLAIM->EditValue ?>"<?= $Page->RESPONDEL_VKLAIM->editAttributes() ?>>
...
<?php if ($Page->CALL_TIMES->Visible) { // CALL_TIMES ?>
    <div id="r_CALL_TIMES" class="form-group row">
        <label for="x_CALL_TIMES" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CALL_TIMES"><?= $Page->CALL_TIMES->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CALL_TIMES" id="z_CALL_TIMES" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CALL_TIMES->cellAttributes() ?>>
            <span id="el_V_FARMASI_CALL_TIMES" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CALL_TIMES->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CALL_TIMES" name="x_CALL_TIMES" id="x_CALL_TIMES" size="30" placeholder="<?= HtmlEncode($Page->CALL_TIMES->getPlaceHolder()) ?>" value="<?= $Page->CALL_TIMES->EditValue ?>"<?= $Page->CALL_TIMES->editAttributes() ?>>
...
<?php if ($Page->CALL_DATE->Visible) { // CALL_DATE ?>
    <div id="r_CALL_DATE" class="form-group row">
        <label for="x_CALL_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CALL_DATE"><?= $Page->CALL_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CALL_DATE" id="z_CALL_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CALL_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_CALL_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CALL_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CALL_DATE" name="x_CALL_DATE" id="x_CALL_DATE" placeholder="<?= HtmlEncode($Page->CALL_DATE->getPlaceHolder()) ?>" value="<?= $Page->CALL_DATE->EditValue ?>"<?= $Page->CALL_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_CALL_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->CALL_DATES->Visible) { // CALL_DATES ?>
    <div id="r_CALL_DATES" class="form-group row">
        <label for="x_CALL_DATES" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_CALL_DATES"><?= $Page->CALL_DATES->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_CALL_DATES" id="z_CALL_DATES" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->CALL_DATES->cellAttributes() ?>>
            <span id="el_V_FARMASI_CALL_DATES" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->CALL_DATES->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_CALL_DATES" name="x_CALL_DATES" id="x_CALL_DATES" placeholder="<?= HtmlEncode($Page->CALL_DATES->getPlaceHolder()) ?>" value="<?= $Page->CALL_DATES->EditValue ?>"<?= $Page->CALL_DATES->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_CALL_DATES", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->SERVED_DATE->Visible) { // SERVED_DATE ?>
    <div id="r_SERVED_DATE" class="form-group row">
        <label for="x_SERVED_DATE" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_SERVED_DATE"><?= $Page->SERVED_DATE->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_SERVED_DATE" id="z_SERVED_DATE" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERVED_DATE->cellAttributes() ?>>
            <span id="el_V_FARMASI_SERVED_DATE" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->SERVED_DATE->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_SERVED_DATE" name="x_SERVED_DATE" id="x_SERVED_DATE" placeholder="<?= HtmlEncode($Page->SERVED_DATE->getPlaceHolder()) ?>" value="<?= $Page->SERVED_DATE->EditValue ?>"<?= $Page->SERVED_DATE->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_SERVED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->SERVED_INAP->Visible) { // SERVED_INAP ?>
    <div id="r_SERVED_INAP" class="form-group row">
        <label for="x_SERVED_INAP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_SERVED_INAP"><?= $Page->SERVED_INAP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_SERVED_INAP" id="z_SERVED_INAP" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->SERVED_INAP->cellAttributes() ?>>
            <span id="el_V_FARMASI_SERVED_INAP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->SERVED_INAP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_SERVED_INAP" name="x_SERVED_INAP" id="x_SERVED_INAP" placeholder="<?= HtmlEncode($Page->SERVED_INAP->getPlaceHolder()) ?>" value="<?= $Page->SERVED_INAP->EditValue ?>"<?= $Page->SERVED_INAP->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_SERVED_INAP", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->KDDPJP1->Visible) { // KDDPJP1 ?>
    <div id="r_KDDPJP1" class="form-group row">
        <label for="x_KDDPJP1" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KDDPJP1"><?= $Page->KDDPJP1->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KDDPJP1" id="z_KDDPJP1" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KDDPJP1->cellAttributes() ?>>
            <span id="el_V_FARMASI_KDDPJP1" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->KDDPJP1->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_KDDPJP1" name="x_KDDPJP1" id="x_KDDPJP1" size="30" maxlength="25" placeholder="<?= HtmlEncode($Page->KDDPJP1->getPlaceHolder()) ?>" value="<?= $Page->KDDPJP1->EditValue ?>"<?= $Page->KDDPJP1->editAttributes() ?>>
...
<?php if ($Page->KDDPJP->Visible) { // KDDPJP ?>
    <div id="r_KDDPJP" class="form-group row">
        <label for="x_KDDPJP" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_KDDPJP"><?= $Page->KDDPJP->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_KDDPJP" id="z_KDDPJP" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->KDDPJP->cellAttributes() ?>>
            <span id="el_V_FARMASI_KDDPJP" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->KDDPJP->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_KDDPJP" name="x_KDDPJP" id="x_KDDPJP" size="30" maxlength="25" placeholder="<?= HtmlEncode($Page->KDDPJP->getPlaceHolder()) ?>" value="<?= $Page->KDDPJP->EditValue ?>"<?= $Page->KDDPJP->editAttributes() ?>>
...
<?php if ($Page->IDXDAFTAR->Visible) { // IDXDAFTAR ?>
    <div id="r_IDXDAFTAR" class="form-group row">
        <label for="x_IDXDAFTAR" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_IDXDAFTAR"><?= $Page->IDXDAFTAR->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_IDXDAFTAR" id="z_IDXDAFTAR" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->IDXDAFTAR->cellAttributes() ?>>
            <span id="el_V_FARMASI_IDXDAFTAR" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->IDXDAFTAR->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_IDXDAFTAR" name="x_IDXDAFTAR" id="x_IDXDAFTAR" maxlength="50" placeholder="<?= HtmlEncode($Page->IDXDAFTAR->getPlaceHolder()) ?>" value="<?= $Page->IDXDAFTAR->EditValue ?>"<?= $Page->IDXDAFTAR->editAttributes() ?>>
...
<?php if ($Page->tgl_kontrol->Visible) { // tgl_kontrol ?>
    <div id="r_tgl_kontrol" class="form-group row">
        <label for="x_tgl_kontrol" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_tgl_kontrol"><?= $Page->tgl_kontrol->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_tgl_kontrol" id="z_tgl_kontrol" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->tgl_kontrol->cellAttributes() ?>>
            <span id="el_V_FARMASI_tgl_kontrol" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->tgl_kontrol->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_tgl_kontrol" name="x_tgl_kontrol" id="x_tgl_kontrol" placeholder="<?= HtmlEncode($Page->tgl_kontrol->getPlaceHolder()) ?>" value="<?= $Page->tgl_kontrol->EditValue ?>"<?= $Page->tgl_kontrol->editAttributes() ?>>
...
<script>
loadjs.ready(["fV_FARMASIsearch", "datetimepicker"], function() {
    ew.createDateTimePicker("fV_FARMASIsearch", "x_tgl_kontrol", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<?php if ($Page->idbooking->Visible) { // idbooking ?>
    <div id="r_idbooking" class="form-group row">
        <label for="x_idbooking" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_idbooking"><?= $Page->idbooking->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("LIKE") ?>
<input type="hidden" name="z_idbooking" id="z_idbooking" value="LIKE">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->idbooking->cellAttributes() ?>>
            <span id="el_V_FARMASI_idbooking" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->idbooking->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_idbooking" name="x_idbooking" id="x_idbooking" size="30" maxlength="20" placeholder="<?= HtmlEncode($Page->idbooking->getPlaceHolder()) ?>" value="<?= $Page->idbooking->EditValue ?>"<?= $Page->idbooking->editAttributes() ?>>
...
<?php if ($Page->id_tujuan->Visible) { // id_tujuan ?>
    <div id="r_id_tujuan" class="form-group row">
        <label for="x_id_tujuan" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_tujuan"><?= $Page->id_tujuan->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_tujuan" id="z_id_tujuan" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_tujuan->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_tujuan" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_tujuan->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_tujuan" name="x_id_tujuan" id="x_id_tujuan" size="30" placeholder="<?= HtmlEncode($Page->id_tujuan->getPlaceHolder()) ?>" value="<?= $Page->id_tujuan->EditValue ?>"<?= $Page->id_tujuan->editAttributes() ?>>
...
<?php if ($Page->id_penunjang->Visible) { // id_penunjang ?>
    <div id="r_id_penunjang" class="form-group row">
        <label for="x_id_penunjang" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_penunjang"><?= $Page->id_penunjang->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_penunjang" id="z_id_penunjang" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_penunjang->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_penunjang" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_penunjang->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_penunjang" name="x_id_penunjang" id="x_id_penunjang" size="30" placeholder="<?= HtmlEncode($Page->id_penunjang->getPlaceHolder()) ?>" value="<?= $Page->id_penunjang->EditValue ?>"<?= $Page->id_penunjang->editAttributes() ?>>
...
<?php if ($Page->id_pembiayaan->Visible) { // id_pembiayaan ?>
    <div id="r_id_pembiayaan" class="form-group row">
        <label for="x_id_pembiayaan" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_pembiayaan"><?= $Page->id_pembiayaan->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_pembiayaan" id="z_id_pembiayaan" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_pembiayaan->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_pembiayaan" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_pembiayaan->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_pembiayaan" name="x_id_pembiayaan" id="x_id_pembiayaan" size="30" placeholder="<?= HtmlEncode($Page->id_pembiayaan->getPlaceHolder()) ?>" value="<?= $Page->id_pembiayaan->EditValue ?>"<?= $Page->id_pembiayaan->editAttributes() ?>>
...
<?php if ($Page->id_procedure->Visible) { // id_procedure ?>
    <div id="r_id_procedure" class="form-group row">
        <label for="x_id_procedure" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_procedure"><?= $Page->id_procedure->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_procedure" id="z_id_procedure" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_procedure->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_procedure" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_procedure->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_procedure" name="x_id_procedure" id="x_id_procedure" size="30" placeholder="<?= HtmlEncode($Page->id_procedure->getPlaceHolder()) ?>" value="<?= $Page->id_procedure->EditValue ?>"<?= $Page->id_procedure->editAttributes() ?>>
...
<?php if ($Page->id_aspel->Visible) { // id_aspel ?>
    <div id="r_id_aspel" class="form-group row">
        <label for="x_id_aspel" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_aspel"><?= $Page->id_aspel->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_aspel" id="z_id_aspel" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_aspel->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_aspel" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_aspel->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_aspel" name="x_id_aspel" id="x_id_aspel" size="30" placeholder="<?= HtmlEncode($Page->id_aspel->getPlaceHolder()) ?>" value="<?= $Page->id_aspel->EditValue ?>"<?= $Page->id_aspel->editAttributes() ?>>
...
<?php if ($Page->id_kelas->Visible) { // id_kelas ?>
    <div id="r_id_kelas" class="form-group row">
        <label for="x_id_kelas" class="<?= $Page->LeftColumnClass ?>"><span id="elh_V_FARMASI_id_kelas"><?= $Page->id_kelas->caption() ?></span>
        <span class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_id_kelas" id="z_id_kelas" value="=">
        ...
        <div class="<?= $Page->RightColumnClass ?>"><div <?= $Page->id_kelas->cellAttributes() ?>>
            <span id="el_V_FARMASI_id_kelas" class="ew-search-field ew-search-field-single">
<input type="<?= $Page->id_kelas->getInputTextType() ?>" data-table="V_FARMASI" data-field="x_id_kelas" name="x_id_kelas" id="x_id_kelas" size="30" placeholder="<?= HtmlEncode($Page->id_kelas->getPlaceHolder()) ?>" value="<?= $Page->id_kelas->EditValue ?>"<?= $Page->id_kelas->editAttributes() ?>>
