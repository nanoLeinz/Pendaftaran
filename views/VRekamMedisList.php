...
<?php if ($Page->idbooking->Visible) { // idbooking ?>
        <th data-name="idbooking" class="<?= $Page->idbooking->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_idbooking" class="V_REKAM_MEDIS_idbooking"><?= $Page->renderSort($Page->idbooking) ?></div></th>
<?php } ?>
<?php if ($Page->id_tujuan->Visible) { // id_tujuan ?>
        <th data-name="id_tujuan" class="<?= $Page->id_tujuan->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_tujuan" class="V_REKAM_MEDIS_id_tujuan"><?= $Page->renderSort($Page->id_tujuan) ?></div></th>
<?php } ?>
<?php if ($Page->id_penunjang->Visible) { // id_penunjang ?>
        <th data-name="id_penunjang" class="<?= $Page->id_penunjang->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_penunjang" class="V_REKAM_MEDIS_id_penunjang"><?= $Page->renderSort($Page->id_penunjang) ?></div></th>
<?php } ?>
<?php if ($Page->id_pembiayaan->Visible) { // id_pembiayaan ?>
        <th data-name="id_pembiayaan" class="<?= $Page->id_pembiayaan->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_pembiayaan" class="V_REKAM_MEDIS_id_pembiayaan"><?= $Page->renderSort($Page->id_pembiayaan) ?></div></th>
<?php } ?>
<?php if ($Page->id_procedure->Visible) { // id_procedure ?>
        <th data-name="id_procedure" class="<?= $Page->id_procedure->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_procedure" class="V_REKAM_MEDIS_id_procedure"><?= $Page->renderSort($Page->id_procedure) ?></div></th>
<?php } ?>
<?php if ($Page->id_aspel->Visible) { // id_aspel ?>
        <th data-name="id_aspel" class="<?= $Page->id_aspel->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_aspel" class="V_REKAM_MEDIS_id_aspel"><?= $Page->renderSort($Page->id_aspel) ?></div></th>
<?php } ?>
<?php if ($Page->id_kelas->Visible) { // id_kelas ?>
        <th data-name="id_kelas" class="<?= $Page->id_kelas->headerCellClass() ?>"><div id="elh_V_REKAM_MEDIS_id_kelas" class="V_REKAM_MEDIS_id_kelas"><?= $Page->renderSort($Page->id_kelas) ?></div></th>
<?php } ?>
<?php
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_idbooking">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_tujuan">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_penunjang">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_pembiayaan">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_procedure">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_aspel">
...
<span id="el<?= $Page->RowCount ?>_V_REKAM_MEDIS_id_kelas">
