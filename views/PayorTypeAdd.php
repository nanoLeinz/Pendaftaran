...
loadjs.ready("head", function () {
    ...
    fPAYOR_TYPEadd = currentForm = new ew.Form("fPAYOR_TYPEadd", "add");
    ...
    // Validate form
    fPAYOR_TYPEadd.validate = function () {
    ...
    // Form_CustomValidate
    fPAYOR_TYPEadd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fPAYOR_TYPEadd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fPAYOR_TYPEadd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fPAYOR_TYPEadd" id="fPAYOR_TYPEadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
