...
// Page object
$FamilyStatusEdit = &$Page;
?>
<script>
var currentForm, currentPageID;
var fFAMILY_STATUSedit;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "edit";
    fFAMILY_STATUSedit = currentForm = new ew.Form("fFAMILY_STATUSedit", "edit");
    ...
    // Validate form
    fFAMILY_STATUSedit.validate = function () {
    ...
    // Form_CustomValidate
    fFAMILY_STATUSedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fFAMILY_STATUSedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fFAMILY_STATUSedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fFAMILY_STATUSedit" id="fFAMILY_STATUSedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="FAMILY_STATUS" data-field="x_FAMILY_STATUS_ID" data-hidden="1" name="o_FAMILY_STATUS_ID" id="o_FAMILY_STATUS_ID" value="<?= HtmlEncode($Page->FAMILY_STATUS_ID->OldValue ?? $Page->FAMILY_STATUS_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
