...
loadjs.ready("head", function () {
    ...
    fFAMILYedit = currentForm = new ew.Form("fFAMILYedit", "edit");
    ...
    // Form_CustomValidate
    fFAMILYedit.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    fFAMILYedit.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("fFAMILYedit");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fFAMILYedit" id="fFAMILYedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<input type="hidden" data-table="FAMILY" data-field="x_ORG_UNIT_CODE" data-hidden="1" name="o_ORG_UNIT_CODE" id="o_ORG_UNIT_CODE" value="<?= HtmlEncode($Page->ORG_UNIT_CODE->OldValue ?? $Page->ORG_UNIT_CODE->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="FAMILY" data-field="x_NO_REGISTRATION" data-hidden="1" name="o_NO_REGISTRATION" id="o_NO_REGISTRATION" value="<?= HtmlEncode($Page->NO_REGISTRATION->OldValue ?? $Page->NO_REGISTRATION->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<input type="hidden" data-table="FAMILY" data-field="x_FAMILY_ID" data-hidden="1" name="o_FAMILY_ID" id="o_FAMILY_ID" value="<?= HtmlEncode($Page->FAMILY_ID->OldValue ?? $Page->FAMILY_ID->CurrentValue) ?>">
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fFAMILYedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fFAMILYedit", "x_DATE_OF_BIRTH", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fFAMILYedit", "datetimepicker"], function() {
    ew.createDateTimePicker("fFAMILYedit", "x_MODIFIED_DATE", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
