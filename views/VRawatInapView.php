...
var fV_RAWAT_INAPview;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "view";
    fV_RAWAT_INAPview = currentForm = new ew.Form("fV_RAWAT_INAPview", "view");
    loadjs.done("fV_RAWAT_INAPview");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="fV_RAWAT_INAPview" id="fV_RAWAT_INAPview" class="form-inline ew-form ew-view-form" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<?php if ($Page->NO_REGISTRATION->Visible) { // NO_REGISTRATION ?>
    <tr id="r_NO_REGISTRATION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_NO_REGISTRATION"><?= $Page->NO_REGISTRATION->caption() ?></span></td>
...
<?php if ($Page->THENAME->Visible) { // THENAME ?>
    <tr id="r_THENAME">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_THENAME"><?= $Page->THENAME->caption() ?></span></td>
...
<?php if ($Page->THEADDRESS->Visible) { // THEADDRESS ?>
    <tr id="r_THEADDRESS">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_THEADDRESS"><?= $Page->THEADDRESS->caption() ?></span></td>
...
<?php if ($Page->CLINIC_ID->Visible) { // CLINIC_ID ?>
    <tr id="r_CLINIC_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_CLINIC_ID"><?= $Page->CLINIC_ID->caption() ?></span></td>
...
<?php if ($Page->TREATMENT->Visible) { // TREATMENT ?>
    <tr id="r_TREATMENT">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_TREATMENT"><?= $Page->TREATMENT->caption() ?></span></td>
...
<?php if ($Page->TREAT_DATE->Visible) { // TREAT_DATE ?>
    <tr id="r_TREAT_DATE">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_TREAT_DATE"><?= $Page->TREAT_DATE->caption() ?></span></td>
...
<?php if ($Page->DESCRIPTION->Visible) { // DESCRIPTION ?>
    <tr id="r_DESCRIPTION">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_DESCRIPTION"><?= $Page->DESCRIPTION->caption() ?></span></td>
...
<?php if ($Page->CLASS_ROOM_ID->Visible) { // CLASS_ROOM_ID ?>
    <tr id="r_CLASS_ROOM_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_CLASS_ROOM_ID"><?= $Page->CLASS_ROOM_ID->caption() ?></span></td>
...
<?php if ($Page->KELUAR_ID->Visible) { // KELUAR_ID ?>
    <tr id="r_KELUAR_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_KELUAR_ID"><?= $Page->KELUAR_ID->caption() ?></span></td>
...
<?php if ($Page->BED_ID->Visible) { // BED_ID ?>
    <tr id="r_BED_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_BED_ID"><?= $Page->BED_ID->caption() ?></span></td>
...
<?php if ($Page->EMPLOYEE_ID->Visible) { // EMPLOYEE_ID ?>
    <tr id="r_EMPLOYEE_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_EMPLOYEE_ID"><?= $Page->EMPLOYEE_ID->caption() ?></span></td>
...
<?php if ($Page->NO_SURAT_KET->Visible) { // NO_SURAT_KET ?>
    <tr id="r_NO_SURAT_KET">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_NO_SURAT_KET"><?= $Page->NO_SURAT_KET->caption() ?></span></td>
...
<?php if ($Page->ID->Visible) { // ID ?>
    <tr id="r_ID">
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_V_RAWAT_INAP_ID"><?= $Page->ID->caption() ?></span></td>
