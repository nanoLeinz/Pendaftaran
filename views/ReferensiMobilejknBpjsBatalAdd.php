...
// Page object
$ReferensiMobilejknBpjsBatalAdd = &$Page;
?>
<script>
var currentForm, currentPageID;
var freferensi_mobilejkn_bpjs_bataladd;
loadjs.ready("head", function () {
    var $ = jQuery;
    // Form object
    currentPageID = ew.PAGE_ID = "add";
    freferensi_mobilejkn_bpjs_bataladd = currentForm = new ew.Form("freferensi_mobilejkn_bpjs_bataladd", "add");
    ...
    freferensi_mobilejkn_bpjs_bataladd.addFields([
    ...
    // Set invalid fields
    $(function() {
        var f = freferensi_mobilejkn_bpjs_bataladd,
            fobj = f.getForm(),
            $fobj = $(fobj),
    ...
    // Validate form
    freferensi_mobilejkn_bpjs_bataladd.validate = function () {
    ...
    // Form_CustomValidate
    freferensi_mobilejkn_bpjs_bataladd.customValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
        // Your custom validation code here, return false if invalid.
        return true;
    }

    // Use JavaScript validation or not
    freferensi_mobilejkn_bpjs_bataladd.validateRequired = <?= Config("CLIENT_VALIDATE") ? "true" : "false" ?>;

    // Dynamic selection lists
    loadjs.done("freferensi_mobilejkn_bpjs_bataladd");
});
</script>
<script>
loadjs.ready("head", function () {
...
$Page->showMessage();
?>
<form name="freferensi_mobilejkn_bpjs_bataladd" id="freferensi_mobilejkn_bpjs_bataladd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post">
...
<script>
loadjs.ready(["freferensi_mobilejkn_bpjs_bataladd", "datetimepicker"], function() {
    ew.createDateTimePicker("freferensi_mobilejkn_bpjs_bataladd", "x_tanggalbatal", {"ignoreReadonly":true,"useCurrent":false,"format":0});
});
</script>
<?php } ?>
</span>
