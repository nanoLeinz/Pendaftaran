 ...
 * Page class
 */
class AntrianLoginAdd extends AntrianLogin
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianLoginAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AntrianLoginView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        // TANGGAL_REGIS
        $this->TANGGAL_REGIS->setDbValueDef($rsnew, UnFormatDateTime($this->TANGGAL_REGIS->CurrentValue, 0), null, false);
