...
/**
 * Table class for V_TREATMENTBILL
 */
class VTreatmentbill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_TREATMENTBILL';
        $this->TableName = 'V_TREATMENTBILL';
        $this->TableType = 'VIEW';

        // Update Table
        $this->UpdateTable = "[dbo].[V_TREATMENTBILL]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NAME_OF_PASIEN
        $this->NAME_OF_PASIEN = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_NAME_OF_PASIEN', 'NAME_OF_PASIEN', '[NAME_OF_PASIEN]', '[NAME_OF_PASIEN]', 200, 100, -1, false, '[NAME_OF_PASIEN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // date_of_birth
        $this->date_of_birth = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_date_of_birth', 'date_of_birth', '[date_of_birth]', CastDateFieldForLike("[date_of_birth]", 0, "DB"), 135, 8, 0, false, '[date_of_birth]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTACT_ADDRESS
        $this->CONTACT_ADDRESS = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_CONTACT_ADDRESS', 'CONTACT_ADDRESS', '[CONTACT_ADDRESS]', '[CONTACT_ADDRESS]', 200, 100, -1, false, '[CONTACT_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PHONE_NUMBER
        $this->PHONE_NUMBER = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_PHONE_NUMBER', 'PHONE_NUMBER', '[PHONE_NUMBER]', '[PHONE_NUMBER]', 200, 20, -1, false, '[PHONE_NUMBER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MOBILE
        $this->MOBILE = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_MOBILE', 'MOBILE', '[MOBILE]', '[MOBILE]', 200, 20, -1, false, '[MOBILE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MOBILE->Sortable = true; // Allow sort
        $this->MOBILE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MOBILE->Param, "CustomMsg");
        $this->Fields['MOBILE'] = &$this->MOBILE;

        // KAL_ID
        $this->KAL_ID = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PLACE_OF_BIRTH
        $this->PLACE_OF_BIRTH = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_PLACE_OF_BIRTH', 'PLACE_OF_BIRTH', '[PLACE_OF_BIRTH]', '[PLACE_OF_BIRTH]', 200, 50, -1, false, '[PLACE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KALURAHAN
        $this->KALURAHAN = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_KALURAHAN', 'KALURAHAN', '[KALURAHAN]', '[KALURAHAN]', 200, 200, -1, false, '[KALURAHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name_of_clinic
        $this->name_of_clinic = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_name_of_clinic', 'name_of_clinic', '[name_of_clinic]', '[name_of_clinic]', 200, 100, -1, false, '[name_of_clinic]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // booked_Date
        $this->booked_Date = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_booked_Date', 'booked_Date', '[booked_Date]', CastDateFieldForLike("[booked_Date]", 0, "DB"), 135, 8, 0, false, '[booked_Date]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // visit_date
        $this->visit_date = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_visit_date', 'visit_date', '[visit_date]', CastDateFieldForLike("[visit_date]", 0, "DB"), 135, 8, 0, false, '[visit_date]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // visit_id
        $this->visit_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_visit_id', 'visit_id', '[visit_id]', '[visit_id]', 200, 50, -1, false, '[visit_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // isattended
        $this->isattended = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_isattended', 'isattended', '[isattended]', '[isattended]', 129, 1, -1, false, '[isattended]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // diantar_oleh
        $this->diantar_oleh = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_diantar_oleh', 'diantar_oleh', '[diantar_oleh]', '[diantar_oleh]', 200, 255, -1, false, '[diantar_oleh]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // visitor_address
        $this->visitor_address = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_visitor_address', 'visitor_address', '[visitor_address]', '[visitor_address]', 200, 150, -1, false, '[visitor_address]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // address_of_rujukan
        $this->address_of_rujukan = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_address_of_rujukan', 'address_of_rujukan', '[address_of_rujukan]', '[address_of_rujukan]', 200, 100, -1, false, '[address_of_rujukan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // rujukan_id
        $this->rujukan_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_rujukan_id', 'rujukan_id', '[rujukan_id]', 'CAST([rujukan_id] AS NVARCHAR)', 17, 8, -1, false, '[rujukan_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // patient_category_id
        $this->patient_category_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_patient_category_id', 'patient_category_id', '[patient_category_id]', 'CAST([patient_category_id] AS NVARCHAR)', 17, 1, -1, false, '[patient_category_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // payor_id
        $this->payor_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_payor_id', 'payor_id', '[payor_id]', '[payor_id]', 200, 50, -1, false, '[payor_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // reason_id
        $this->reason_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_reason_id', 'reason_id', '[reason_id]', 'CAST([reason_id] AS NVARCHAR)', 17, 1, -1, false, '[reason_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // way_id
        $this->way_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_way_id', 'way_id', '[way_id]', 'CAST([way_id] AS NVARCHAR)', 17, 1, -1, false, '[way_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // follow_up
        $this->follow_up = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_follow_up', 'follow_up', '[follow_up]', 'CAST([follow_up] AS NVARCHAR)', 17, 1, -1, false, '[follow_up]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // isnew
        $this->isnew = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_isnew', 'isnew', '[isnew]', '[isnew]', 129, 1, -1, false, '[isnew]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // family_status_id
        $this->family_status_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_family_status_id', 'family_status_id', '[family_status_id]', 'CAST([family_status_id] AS NVARCHAR)', 17, 1, -1, false, '[family_status_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // class_room_id
        $this->class_room_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_class_room_id', 'class_room_id', '[class_room_id]', '[class_room_id]', 200, 16, -1, false, '[class_room_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // fullname
        $this->fullname = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_fullname', 'fullname', '[fullname]', '[fullname]', 200, 50, -1, false, '[fullname]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_id
        $this->employee_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_employee_id', 'employee_id', '[employee_id]', '[employee_id]', 200, 15, -1, false, '[employee_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // employee_id_from
        $this->employee_id_from = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_employee_id_from', 'employee_id_from', '[employee_id_from]', '[employee_id_from]', 200, 50, -1, false, '[employee_id_from]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // clinic_id
        $this->clinic_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_clinic_id', 'clinic_id', '[clinic_id]', '[clinic_id]', 200, 15, -1, false, '[clinic_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // clinic_id_FROM
        $this->clinic_id_FROM = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_clinic_id_FROM', 'clinic_id_FROM', '[clinic_id_FROM]', '[clinic_id_FROM]', 200, 15, -1, false, '[clinic_id_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // doctor
        $this->doctor = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_doctor', 'doctor', '[doctor]', '[doctor]', 200, 100, -1, false, '[doctor]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // bed_id
        $this->bed_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_bed_id', 'bed_id', '[bed_id]', 'CAST([bed_id] AS NVARCHAR)', 17, 1, -1, false, '[bed_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // keluar_id
        $this->keluar_id = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_keluar_id', 'keluar_id', '[keluar_id]', 'CAST([keluar_id] AS NVARCHAR)', 17, 1, -1, false, '[keluar_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // treat_date
        $this->treat_date = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_treat_date', 'treat_date', '[treat_date]', CastDateFieldForLike("[treat_date]", 0, "DB"), 135, 8, 0, false, '[treat_date]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // exit_date
        $this->exit_date = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_exit_date', 'exit_date', '[exit_date]', CastDateFieldForLike("[exit_date]", 0, "DB"), 135, 8, 0, false, '[exit_date]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // name_of_class
        $this->name_of_class = new DbField('V_TREATMENTBILL', 'V_TREATMENTBILL', 'x_name_of_class', 'name_of_class', '[name_of_class]', '[name_of_class]', 200, 100, -1, false, '[name_of_class]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[V_TREATMENTBILL]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VTreatmentbillList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VTreatmentbillView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VTreatmentbillEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VTreatmentbillAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VTreatmentbillView";
            case Config("API_ADD_ACTION"):
                return "VTreatmentbillAdd";
            case Config("API_EDIT_ACTION"):
                return "VTreatmentbillEdit";
            case Config("API_DELETE_ACTION"):
                return "VTreatmentbillDelete";
            case Config("API_LIST_ACTION"):
                return "VTreatmentbillList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VTreatmentbillView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VTreatmentbillView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VTreatmentbillAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VTreatmentbillAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VTreatmentbillEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VTreatmentbillAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VTreatmentbillDelete", $this->getUrlParm());
    }
