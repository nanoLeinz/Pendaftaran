...
class UserLogin extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "[dbo].[USER_LOGIN]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // USERNAME
        $this->_USERNAME = new DbField('USER_LOGIN', 'USER_LOGIN', 'x__USERNAME', 'USERNAME', '[USERNAME]', '[USERNAME]', 200, 16, -1, false, '[USERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FULLNAME
        $this->FULLNAME = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_FULLNAME', 'FULLNAME', '[FULLNAME]', '[FULLNAME]', 200, 200, -1, false, '[FULLNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASSWORD
        $this->_PASSWORD = new DbField('USER_LOGIN', 'USER_LOGIN', 'x__PASSWORD', 'PASSWORD', '[PASSWORD]', '[PASSWORD]', 200, 50, -1, false, '[PASSWORD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // userlevelid
        $this->userlevelid = new DbField('USER_LOGIN', 'USER_LOGIN', 'x_userlevelid', 'userlevelid', '[userlevelid]', 'CAST([userlevelid] AS NVARCHAR)', 3, 4, -1, false, '[userlevelid]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->userlevelid->Sortable = true; // Allow sort
        $this->userlevelid->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->userlevelid->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->userlevelid->Lookup = new Lookup('userlevelid', 'USER_LOGIN', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->userlevelid->Lookup = new Lookup('userlevelid', 'USER_LOGIN', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->userlevelid->OptionCount = 8;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[USER_LOGIN]";
    }
...
SORTHTML;
    ...
    public function renderListRow()
    {
        ...
        if ($Security->canAdmin()) { // System admin
            if (strval($this->userlevelid->CurrentValue) != "") {
                $this->userlevelid->ViewValue = $this->userlevelid->optionCaption($this->userlevelid->CurrentValue);
            } else {
    ...
    public function renderEditRow()
    {
        ...
        if (!$Security->canAdmin()) { // System admin
            ...
            $this->userlevelid->EditValue = $this->userlevelid->options(true);
