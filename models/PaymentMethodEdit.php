 ...
 * Page class
 */
class PaymentMethodEdit extends PaymentMethod
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PaymentMethodEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("PAY_METHOD_ID") ?? Key(0) ?? Route(2)) !== null) {
                $this->PAY_METHOD_ID->setQueryStringValue($keyValue);
                $this->PAY_METHOD_ID->setOldValue($this->PAY_METHOD_ID->QueryStringValue);
            } elseif (Post("PAY_METHOD_ID") !== null) {
                $this->PAY_METHOD_ID->setFormValue(Post("PAY_METHOD_ID"));
                $this->PAY_METHOD_ID->setOldValue($this->PAY_METHOD_ID->FormValue);
            } else {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PAY_METHOD_ID
            $this->PAY_METHOD_ID->setDbValueDef($rsnew, $this->PAY_METHOD_ID->CurrentValue, 0, $this->PAY_METHOD_ID->ReadOnly);

            // PAYMETHOD
            $this->PAYMETHOD->setDbValueDef($rsnew, $this->PAYMETHOD->CurrentValue, null, $this->PAYMETHOD->ReadOnly);
