...
class Pasien extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PASIEN', 'PASIEN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('PASIEN', 'PASIEN', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAME_OF_PASIEN
        $this->NAME_OF_PASIEN = new DbField('PASIEN', 'PASIEN', 'x_NAME_OF_PASIEN', 'NAME_OF_PASIEN', '[NAME_OF_PASIEN]', '[NAME_OF_PASIEN]', 200, 100, -1, false, '[NAME_OF_PASIEN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASIEN_ID
        $this->PASIEN_ID = new DbField('PASIEN', 'PASIEN', 'x_PASIEN_ID', 'PASIEN_ID', '[PASIEN_ID]', '[PASIEN_ID]', 200, 30, -1, false, '[PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KK_NO
        $this->KK_NO = new DbField('PASIEN', 'PASIEN', 'x_KK_NO', 'KK_NO', '[KK_NO]', '[KK_NO]', 200, 30, -1, false, '[KK_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('PASIEN', 'PASIEN', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PLACE_OF_BIRTH
        $this->PLACE_OF_BIRTH = new DbField('PASIEN', 'PASIEN', 'x_PLACE_OF_BIRTH', 'PLACE_OF_BIRTH', '[PLACE_OF_BIRTH]', '[PLACE_OF_BIRTH]', 200, 50, -1, false, '[PLACE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DATE_OF_BIRTH
        $this->DATE_OF_BIRTH = new DbField('PASIEN', 'PASIEN', 'x_DATE_OF_BIRTH', 'DATE_OF_BIRTH', '[DATE_OF_BIRTH]', CastDateFieldForLike("[DATE_OF_BIRTH]", 11, "DB"), 135, 8, 11, false, '[DATE_OF_BIRTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('PASIEN', 'PASIEN', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // NATION_ID
        $this->NATION_ID = new DbField('PASIEN', 'PASIEN', 'x_NATION_ID', 'NATION_ID', '[NATION_ID]', 'CAST([NATION_ID] AS NVARCHAR)', 17, 1, -1, false, '[NATION_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDUCATION_TYPE_CODE
        $this->EDUCATION_TYPE_CODE = new DbField('PASIEN', 'PASIEN', 'x_EDUCATION_TYPE_CODE', 'EDUCATION_TYPE_CODE', '[EDUCATION_TYPE_CODE]', 'CAST([EDUCATION_TYPE_CODE] AS NVARCHAR)', 17, 1, -1, false, '[EDUCATION_TYPE_CODE]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // MARITALSTATUSID
        $this->MARITALSTATUSID = new DbField('PASIEN', 'PASIEN', 'x_MARITALSTATUSID', 'MARITALSTATUSID', '[MARITALSTATUSID]', 'CAST([MARITALSTATUSID] AS NVARCHAR)', 17, 1, -1, false, '[MARITALSTATUSID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('PASIEN', 'PASIEN', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('PASIEN', 'PASIEN', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // RT
        $this->RT = new DbField('PASIEN', 'PASIEN', 'x_RT', 'RT', '[RT]', '[RT]', 200, 8, -1, false, '[RT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RW
        $this->RW = new DbField('PASIEN', 'PASIEN', 'x_RW', 'RW', '[RW]', '[RW]', 200, 20, -1, false, '[RW]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JOB_ID
        $this->JOB_ID = new DbField('PASIEN', 'PASIEN', 'x_JOB_ID', 'JOB_ID', '[JOB_ID]', 'CAST([JOB_ID] AS NVARCHAR)', 17, 1, -1, false, '[JOB_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('PASIEN', 'PASIEN', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ANAK_KE
        $this->ANAK_KE = new DbField('PASIEN', 'PASIEN', 'x_ANAK_KE', 'ANAK_KE', '[ANAK_KE]', 'CAST([ANAK_KE] AS NVARCHAR)', 17, 1, -1, false, '[ANAK_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTACT_ADDRESS
        $this->CONTACT_ADDRESS = new DbField('PASIEN', 'PASIEN', 'x_CONTACT_ADDRESS', 'CONTACT_ADDRESS', '[CONTACT_ADDRESS]', '[CONTACT_ADDRESS]', 200, 100, -1, false, '[CONTACT_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // PHONE_NUMBER
        $this->PHONE_NUMBER = new DbField('PASIEN', 'PASIEN', 'x_PHONE_NUMBER', 'PHONE_NUMBER', '[PHONE_NUMBER]', '[PHONE_NUMBER]', 200, 20, -1, false, '[PHONE_NUMBER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MOBILE
        $this->MOBILE = new DbField('PASIEN', 'PASIEN', 'x_MOBILE', 'MOBILE', '[MOBILE]', '[MOBILE]', 200, 20, -1, false, '[MOBILE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PHOTO_LOCATION
        $this->PHOTO_LOCATION = new DbField('PASIEN', 'PASIEN', 'x_PHOTO_LOCATION', 'PHOTO_LOCATION', '[PHOTO_LOCATION]', '[PHOTO_LOCATION]', 200, 50, -1, false, '[PHOTO_LOCATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('PASIEN', 'PASIEN', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 11, "DB"), 135, 8, 11, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('PASIEN', 'PASIEN', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = false; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('PASIEN', 'PASIEN', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POSTAL_CODE
        $this->POSTAL_CODE = new DbField('PASIEN', 'PASIEN', 'x_POSTAL_CODE', 'POSTAL_CODE', '[POSTAL_CODE]', '[POSTAL_CODE]', 200, 10, -1, false, '[POSTAL_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GELAR
        $this->GELAR = new DbField('PASIEN', 'PASIEN', 'x_GELAR', 'GELAR', '[GELAR]', '[GELAR]', 200, 50, -1, false, '[GELAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BLOOD_TYPE_ID
        $this->BLOOD_TYPE_ID = new DbField('PASIEN', 'PASIEN', 'x_BLOOD_TYPE_ID', 'BLOOD_TYPE_ID', '[BLOOD_TYPE_ID]', 'CAST([BLOOD_TYPE_ID] AS NVARCHAR)', 17, 1, -1, false, '[BLOOD_TYPE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ISMENINGGAL
        $this->ISMENINGGAL = new DbField('PASIEN', 'PASIEN', 'x_ISMENINGGAL', 'ISMENINGGAL', '[ISMENINGGAL]', '[ISMENINGGAL]', 129, 1, -1, false, '[ISMENINGGAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DEATH_DATE
        $this->DEATH_DATE = new DbField('PASIEN', 'PASIEN', 'x_DEATH_DATE', 'DEATH_DATE', '[DEATH_DATE]', CastDateFieldForLike("[DEATH_DATE]", 11, "DB"), 135, 8, 11, false, '[DEATH_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('PASIEN', 'PASIEN', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('PASIEN', 'PASIEN', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KARYAWAN
        $this->KARYAWAN = new DbField('PASIEN', 'PASIEN', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('PASIEN', 'PASIEN', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 255, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NEWCARD
        $this->NEWCARD = new DbField('PASIEN', 'PASIEN', 'x_NEWCARD', 'NEWCARD', '[NEWCARD]', CastDateFieldForLike("[NEWCARD]", 0, "DB"), 135, 8, 0, false, '[NEWCARD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BACKCHARGE
        $this->BACKCHARGE = new DbField('PASIEN', 'PASIEN', 'x_BACKCHARGE', 'BACKCHARGE', '[BACKCHARGE]', '[BACKCHARGE]', 129, 1, -1, false, '[BACKCHARGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MOTHER
        $this->MOTHER = new DbField('PASIEN', 'PASIEN', 'x_MOTHER', 'MOTHER', '[MOTHER]', '[MOTHER]', 200, 150, -1, false, '[MOTHER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FATHER
        $this->FATHER = new DbField('PASIEN', 'PASIEN', 'x_FATHER', 'FATHER', '[FATHER]', '[FATHER]', 200, 150, -1, false, '[FATHER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPOUSE
        $this->SPOUSE = new DbField('PASIEN', 'PASIEN', 'x_SPOUSE', 'SPOUSE', '[SPOUSE]', '[SPOUSE]', 200, 150, -1, false, '[SPOUSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('PASIEN', 'PASIEN', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AKTIF
        $this->AKTIF = new DbField('PASIEN', 'PASIEN', 'x_AKTIF', 'AKTIF', '[AKTIF]', '[AKTIF]', 129, 1, -1, false, '[AKTIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('PASIEN', 'PASIEN', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('PASIEN', 'PASIEN', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // FAMILY_STATUS_ID
        $this->FAMILY_STATUS_ID = new DbField('PASIEN', 'PASIEN', 'x_FAMILY_STATUS_ID', 'FAMILY_STATUS_ID', '[FAMILY_STATUS_ID]', 'CAST([FAMILY_STATUS_ID] AS NVARCHAR)', 17, 1, -1, false, '[FAMILY_STATUS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TMT
        $this->TMT = new DbField('PASIEN', 'PASIEN', 'x_TMT', 'TMT', '[TMT]', CastDateFieldForLike("[TMT]", 11, "DB"), 135, 8, 11, false, '[TMT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAT
        $this->TAT = new DbField('PASIEN', 'PASIEN', 'x_TAT', 'TAT', '[TAT]', CastDateFieldForLike("[TAT]", 11, "DB"), 135, 8, 11, false, '[TAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CARD_ID
        $this->CARD_ID = new DbField('PASIEN', 'PASIEN', 'x_CARD_ID', 'CARD_ID', '[CARD_ID]', '[CARD_ID]', 200, 50, -1, false, '[CARD_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REGISTRATION_DATE
        $this->REGISTRATION_DATE = new DbField('PASIEN', 'PASIEN', 'x_REGISTRATION_DATE', 'REGISTRATION_DATE', '[REGISTRATION_DATE]', CastDateFieldForLike("[REGISTRATION_DATE]", 11, "DB"), 135, 8, 11, false, '[REGISTRATION_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEDICAL_NOTES
        $this->MEDICAL_NOTES = new DbField('PASIEN', 'PASIEN', 'x_MEDICAL_NOTES', 'MEDICAL_NOTES', '[MEDICAL_NOTES]', '[MEDICAL_NOTES]', 201, 0, -1, false, '[MEDICAL_NOTES]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ID
        $this->ID = new DbField('PASIEN', 'PASIEN', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 3, 4, -1, false, '[ID]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // newapp
        $this->newapp = new DbField('PASIEN', 'PASIEN', 'x_newapp', 'newapp', '[newapp]', '[newapp]', 129, 1, -1, false, '[newapp]', false, false, false, 'FORMATTED TEXT', 'HIDDEN');
        ...
        // Cek
        $this->Cek = new DbField('PASIEN', 'PASIEN', 'x_Cek', 'Cek', '\'\'', '\'\'', 200, 1, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("*, '' AS [Cek]");
    }
