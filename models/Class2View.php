 ...
 * Page class
 */
class Class2View extends Class2
{
    use MessagesTrait;
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("CLASS_ID") ?? Route("CLASS_ID")) !== null) {
                ...
                $returnUrl = "Class2List"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "Class2List"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "Class2List"; // Not page request, return to list
        }
        if ($returnUrl != "") {
