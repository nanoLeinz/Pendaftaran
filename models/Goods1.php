...
/**
 * Table class for goods1
 */
class Goods1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'goods1';
        $this->TableName = 'goods1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[goods1]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // CODE_5
        $this->CODE_5 = new DbField('goods1', 'goods1', 'x_CODE_5', 'CODE_5', '[CODE_5]', '[CODE_5]', 200, 20, -1, false, '[CODE_5]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CODE_5->IsPrimaryKey = true; // Primary key field
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('goods1', 'goods1', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAME
        $this->NAME = new DbField('goods1', 'goods1', 'x_NAME', 'NAME', '[NAME]', '[NAME]', 200, 255, -1, false, '[NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAME->Sortable = true; // Allow sort
        $this->NAME->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAME->Param, "CustomMsg");
        $this->Fields['NAME'] = &$this->NAME;

        // OTHER_CODE
        $this->OTHER_CODE = new DbField('goods1', 'goods1', 'x_OTHER_CODE', 'OTHER_CODE', '[OTHER_CODE]', '[OTHER_CODE]', 200, 25, -1, false, '[OTHER_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BARCODE
        $this->_BARCODE = new DbField('goods1', 'goods1', 'x__BARCODE', 'BARCODE', '[BARCODE]', '[BARCODE]', 200, 50, -1, false, '[BARCODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('goods1', 'goods1', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // REORDER_POINT
        $this->REORDER_POINT = new DbField('goods1', 'goods1', 'x_REORDER_POINT', 'REORDER_POINT', '[REORDER_POINT]', 'CAST([REORDER_POINT] AS NVARCHAR)', 131, 8, -1, false, '[REORDER_POINT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_GOODS
        $this->SIZE_GOODS = new DbField('goods1', 'goods1', 'x_SIZE_GOODS', 'SIZE_GOODS', '[SIZE_GOODS]', 'CAST([SIZE_GOODS] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_GOODS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_DOSIS
        $this->MEASURE_DOSIS = new DbField('goods1', 'goods1', 'x_MEASURE_DOSIS', 'MEASURE_DOSIS', '[MEASURE_DOSIS]', 'CAST([MEASURE_DOSIS] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_DOSIS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('goods1', 'goods1', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID2
        $this->MEASURE_ID2 = new DbField('goods1', 'goods1', 'x_MEASURE_ID2', 'MEASURE_ID2', '[MEASURE_ID2]', 'CAST([MEASURE_ID2] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_KEMASAN
        $this->SIZE_KEMASAN = new DbField('goods1', 'goods1', 'x_SIZE_KEMASAN', 'SIZE_KEMASAN', '[SIZE_KEMASAN]', 'CAST([SIZE_KEMASAN] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_KEMASAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID3
        $this->MEASURE_ID3 = new DbField('goods1', 'goods1', 'x_MEASURE_ID3', 'MEASURE_ID3', '[MEASURE_ID3]', 'CAST([MEASURE_ID3] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID3]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMPANY_ID
        $this->COMPANY_ID = new DbField('goods1', 'goods1', 'x_COMPANY_ID', 'COMPANY_ID', '[COMPANY_ID]', '[COMPANY_ID]', 200, 50, -1, false, '[COMPANY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NET_PRICE
        $this->NET_PRICE = new DbField('goods1', 'goods1', 'x_NET_PRICE', 'NET_PRICE', '[NET_PRICE]', 'CAST([NET_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[NET_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('goods1', 'goods1', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('goods1', 'goods1', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 25, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // TH
        $this->TH = new DbField('goods1', 'goods1', 'x_TH', 'TH', '[TH]', 'CAST([TH] AS NVARCHAR)', 2, 2, -1, false, '[TH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('goods1', 'goods1', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MATERIAL_ID
        $this->MATERIAL_ID = new DbField('goods1', 'goods1', 'x_MATERIAL_ID', 'MATERIAL_ID', '[MATERIAL_ID]', 'CAST([MATERIAL_ID] AS NVARCHAR)', 17, 1, -1, false, '[MATERIAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FORM_ID
        $this->FORM_ID = new DbField('goods1', 'goods1', 'x_FORM_ID', 'FORM_ID', '[FORM_ID]', 'CAST([FORM_ID] AS NVARCHAR)', 17, 1, -1, false, '[FORM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISGENERIC
        $this->ISGENERIC = new DbField('goods1', 'goods1', 'x_ISGENERIC', 'ISGENERIC', '[ISGENERIC]', '[ISGENERIC]', 129, 1, -1, false, '[ISGENERIC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REGULATE_ID
        $this->REGULATE_ID = new DbField('goods1', 'goods1', 'x_REGULATE_ID', 'REGULATE_ID', '[REGULATE_ID]', 'CAST([REGULATE_ID] AS NVARCHAR)', 17, 1, -1, false, '[REGULATE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PREGNANCY_INDEX
        $this->PREGNANCY_INDEX = new DbField('goods1', 'goods1', 'x_PREGNANCY_INDEX', 'PREGNANCY_INDEX', '[PREGNANCY_INDEX]', '[PREGNANCY_INDEX]', 129, 1, -1, false, '[PREGNANCY_INDEX]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INDICATION
        $this->INDICATION = new DbField('goods1', 'goods1', 'x_INDICATION', 'INDICATION', '[INDICATION]', '[INDICATION]', 200, 255, -1, false, '[INDICATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAKE_RULE
        $this->TAKE_RULE = new DbField('goods1', 'goods1', 'x_TAKE_RULE', 'TAKE_RULE', '[TAKE_RULE]', '[TAKE_RULE]', 200, 255, -1, false, '[TAKE_RULE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIDE_EFFECT
        $this->SIDE_EFFECT = new DbField('goods1', 'goods1', 'x_SIDE_EFFECT', 'SIDE_EFFECT', '[SIDE_EFFECT]', '[SIDE_EFFECT]', 200, 255, -1, false, '[SIDE_EFFECT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INTERACTION
        $this->INTERACTION = new DbField('goods1', 'goods1', 'x_INTERACTION', 'INTERACTION', '[INTERACTION]', '[INTERACTION]', 200, 255, -1, false, '[INTERACTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRA_INDICATION
        $this->CONTRA_INDICATION = new DbField('goods1', 'goods1', 'x_CONTRA_INDICATION', 'CONTRA_INDICATION', '[CONTRA_INDICATION]', '[CONTRA_INDICATION]', 200, 255, -1, false, '[CONTRA_INDICATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // WARNING
        $this->WARNING = new DbField('goods1', 'goods1', 'x_WARNING', 'WARNING', '[WARNING]', '[WARNING]', 200, 255, -1, false, '[WARNING]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK
        $this->STOCK = new DbField('goods1', 'goods1', 'x_STOCK', 'STOCK', '[STOCK]', 'CAST([STOCK] AS NVARCHAR)', 131, 8, -1, false, '[STOCK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISACTIVE
        $this->ISACTIVE = new DbField('goods1', 'goods1', 'x_ISACTIVE', 'ISACTIVE', '[ISACTIVE]', '[ISACTIVE]', 129, 1, -1, false, '[ISACTIVE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISALKES
        $this->ISALKES = new DbField('goods1', 'goods1', 'x_ISALKES', 'ISALKES', '[ISALKES]', '[ISALKES]', 129, 1, -1, false, '[ISALKES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_ORDER
        $this->SIZE_ORDER = new DbField('goods1', 'goods1', 'x_SIZE_ORDER', 'SIZE_ORDER', '[SIZE_ORDER]', 'CAST([SIZE_ORDER] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_ORDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_PRICE
        $this->ORDER_PRICE = new DbField('goods1', 'goods1', 'x_ORDER_PRICE', 'ORDER_PRICE', '[ORDER_PRICE]', 'CAST([ORDER_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[ORDER_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISFORMULARIUM
        $this->ISFORMULARIUM = new DbField('goods1', 'goods1', 'x_ISFORMULARIUM', 'ISFORMULARIUM', '[ISFORMULARIUM]', '[ISFORMULARIUM]', 129, 1, -1, false, '[ISFORMULARIUM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISESSENTIAL
        $this->ISESSENTIAL = new DbField('goods1', 'goods1', 'x_ISESSENTIAL', 'ISESSENTIAL', '[ISESSENTIAL]', '[ISESSENTIAL]', 129, 1, -1, false, '[ISESSENTIAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[goods1]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('CODE_5', $rs)) {
                AddFilter($where, QuotedName('CODE_5', $this->Dbid) . '=' . QuotedValue($rs['CODE_5'], $this->CODE_5->DataType, $this->Dbid));
            }
    ...
    {
        return "[CODE_5] = '@CODE_5@' AND [BRAND_ID] = '@BRAND_ID@'";
    }
    ...
    {
        $keys = [];
        $val = $current ? $this->CODE_5->CurrentValue : $this->CODE_5->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            if ($current) {
                $this->CODE_5->CurrentValue = $keys[0];
            } else {
                $this->CODE_5->OldValue = $keys[0];
            }
            if ($current) {
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('CODE_5', $row) ? $row['CODE_5'] : null;
        } else {
            $val = $this->CODE_5->OldValue !== null ? $this->CODE_5->OldValue : $this->CODE_5->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@CODE_5@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        if (is_array($row)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("Goods1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "Goods1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Goods1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Goods1Add") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Goods1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("Goods1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "Goods1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "Goods1Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("Goods1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Goods1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("Goods1Delete", $this->getUrlParm());
    }
    ...
    {
        $json = "";
        $json .= "CODE_5:" . JsonEncode($this->CODE_5->CurrentValue, "string");
    ...
    {
        if ($this->CODE_5->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->CODE_5->CurrentValue);
        } else {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("CODE_5") ?? Route("CODE_5")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->CODE_5->CurrentValue = $key[0];
            } else {
                $this->CODE_5->OldValue = $key[0];
            }
            if ($setCurrent) {
