 ...
 * Page class
 */
class ReferensiMobilejknBpjsBatalAdd extends ReferensiMobilejknBpjsBatal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReferensiMobilejknBpjsBatalAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($this->OldRecordset)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ReferensiMobilejknBpjsBatalView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->tanggalbatal->CurrentValue = null;
        $this->tanggalbatal->OldValue = $this->tanggalbatal->CurrentValue;
    ...
    protected function newRow()
    {
        ...
        $row['tanggalbatal'] = $this->tanggalbatal->CurrentValue;
    ...
    {
        global $Language, $Security;
        if ($this->nobooking->CurrentValue != "") { // Check field with unique index
            $filter = "([nobooking] = '" . AdjustSql($this->nobooking->CurrentValue, $this->Dbid) . "')";
            $rsChk = $this->loadRs($filter)->fetch();
            if ($rsChk !== false) {
                $idxErrMsg = str_replace("%f", $this->nobooking->caption(), $Language->phrase("DupIndex"));
                $idxErrMsg = str_replace("%v", $this->nobooking->CurrentValue, $idxErrMsg);
        ...
        // nomorreferensi
        $this->nomorreferensi->setDbValueDef($rsnew, $this->nomorreferensi->CurrentValue, null, false);

        // tanggalbatal
        $this->tanggalbatal->setDbValueDef($rsnew, UnFormatDateTime($this->tanggalbatal->CurrentValue, 0), null, false);
        ...
        // nobooking
        $this->nobooking->setDbValueDef($rsnew, $this->nobooking->CurrentValue, "", false);

        // Call Row Inserting event
        $insertRow = $this->rowInserting($rsold, $rsnew);

        // Check if key value entered
        if ($insertRow && $this->ValidateKey && strval($rsnew['nobooking']) == "") {
