...
/**
 * Table class for register_perpoli_harian
 */
class RegisterPerpoliHarian extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'register_perpoli_harian';
        $this->TableName = 'register_perpoli_harian';
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_VISIT_DATE', 'VISIT_DATE', 'Convert(VARCHAR,dbo.PASIEN_VISITATION.VISIT_DATE,111)', 'Convert(VARCHAR,dbo.PASIEN_VISITATION.VISIT_DATE,111)', 200, 30, 5, false, 'Convert(VARCHAR,dbo.PASIEN_VISITATION.VISIT_DATE,111)', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_CLINIC_ID', 'CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 200, 8, -1, false, 'dbo.PASIEN_VISITATION.CLINIC_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // NAME_OF_CLINIC
        $this->NAME_OF_CLINIC = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_NAME_OF_CLINIC', 'NAME_OF_CLINIC', 'dbo.CLINIC.NAME_OF_CLINIC', 'dbo.CLINIC.NAME_OF_CLINIC', 200, 100, -1, false, 'dbo.CLINIC.NAME_OF_CLINIC', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_GENDER', 'GENDER', 'dbo.PASIEN_VISITATION.GENDER', 'dbo.PASIEN_VISITATION.GENDER', 129, 1, -1, false, 'dbo.PASIEN_VISITATION.GENDER', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', 'CAST(dbo.PASIEN_VISITATION.STATUS_PASIEN_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new ReportField('register_perpoli_harian', 'register_perpoli_harian', 'x_VISIT_ID', 'VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->Chart1->ID = "register_perpoli_harian_Chart1"; // Chart ID
