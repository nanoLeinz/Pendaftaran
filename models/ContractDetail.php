...
/**
 * Table class for CONTRACT_DETAIL
 */
class ContractDetail extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CONTRACT_DETAIL';
        $this->TableName = 'CONTRACT_DETAIL';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CONTRACT_DETAIL]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_NAME
        $this->BRAND_NAME = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_BRAND_NAME', 'BRAND_NAME', '[BRAND_NAME]', '[BRAND_NAME]', 200, 150, -1, false, '[BRAND_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_PRICE
        $this->ORDER_PRICE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ORDER_PRICE', 'ORDER_PRICE', '[ORDER_PRICE]', 'CAST([ORDER_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[ORDER_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UNIT_PRICE
        $this->UNIT_PRICE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_UNIT_PRICE', 'UNIT_PRICE', '[UNIT_PRICE]', 'CAST([UNIT_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[UNIT_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT
        $this->DISCOUNT = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_DISCOUNT', 'DISCOUNT', '[DISCOUNT]', 'CAST([DISCOUNT] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_QUANTITY
        $this->ORDER_QUANTITY = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ORDER_QUANTITY', 'ORDER_QUANTITY', '[ORDER_QUANTITY]', 'CAST([ORDER_QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[ORDER_QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RECEIVED_QUANTITY
        $this->RECEIVED_QUANTITY = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_RECEIVED_QUANTITY', 'RECEIVED_QUANTITY', '[RECEIVED_QUANTITY]', 'CAST([RECEIVED_QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[RECEIVED_QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PAID
        $this->AMOUNT_PAID = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_AMOUNT_PAID', 'AMOUNT_PAID', '[AMOUNT_PAID]', 'CAST([AMOUNT_PAID] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LEADTIME
        $this->LEADTIME = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_LEADTIME', 'LEADTIME', '[LEADTIME]', 'CAST([LEADTIME] AS NVARCHAR)', 3, 4, -1, false, '[LEADTIME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ATP_DATE
        $this->ATP_DATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ATP_DATE', 'ATP_DATE', '[ATP_DATE]', CastDateFieldForLike("[ATP_DATE]", 0, "DB"), 135, 8, 0, false, '[ATP_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DELIVERY_DATE
        $this->DELIVERY_DATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_DELIVERY_DATE', 'DELIVERY_DATE', '[DELIVERY_DATE]', CastDateFieldForLike("[DELIVERY_DATE]", 0, "DB"), 135, 8, 0, false, '[DELIVERY_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STARDATE
        $this->STARDATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_STARDATE', 'STARDATE', '[STARDATE]', CastDateFieldForLike("[STARDATE]", 0, "DB"), 135, 8, 0, false, '[STARDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ENDDATE
        $this->ENDDATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ENDDATE', 'ENDDATE', '[ENDDATE]', CastDateFieldForLike("[ENDDATE]", 0, "DB"), 135, 8, 0, false, '[ENDDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRACT_NO
        $this->CONTRACT_NO = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_CONTRACT_NO', 'CONTRACT_NO', '[CONTRACT_NO]', '[CONTRACT_NO]', 200, 50, -1, false, '[CONTRACT_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID3
        $this->MEASURE_ID3 = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MEASURE_ID3', 'MEASURE_ID3', '[MEASURE_ID3]', 'CAST([MEASURE_ID3] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID3]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_KEMASAN
        $this->SIZE_KEMASAN = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_SIZE_KEMASAN', 'SIZE_KEMASAN', '[SIZE_KEMASAN]', 'CAST([SIZE_KEMASAN] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_KEMASAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID2
        $this->MEASURE_ID2 = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MEASURE_ID2', 'MEASURE_ID2', '[MEASURE_ID2]', 'CAST([MEASURE_ID2] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_GOODS
        $this->SIZE_GOODS = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_SIZE_GOODS', 'SIZE_GOODS', '[SIZE_GOODS]', 'CAST([SIZE_GOODS] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_GOODS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_DOSIS
        $this->MEASURE_DOSIS = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MEASURE_DOSIS', 'MEASURE_DOSIS', '[MEASURE_DOSIS]', 'CAST([MEASURE_DOSIS] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_DOSIS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // DISCOUNTOFF
        $this->DISCOUNTOFF = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_DISCOUNTOFF', 'DISCOUNTOFF', '[DISCOUNTOFF]', 'CAST([DISCOUNTOFF] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNTOFF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 3, 4, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 0, "DB"), 135, 8, 0, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MAINCONTRACT_NO
        $this->MAINCONTRACT_NO = new DbField('CONTRACT_DETAIL', 'CONTRACT_DETAIL', 'x_MAINCONTRACT_NO', 'MAINCONTRACT_NO', '[MAINCONTRACT_NO]', '[MAINCONTRACT_NO]', 200, 50, -1, false, '[MAINCONTRACT_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MAINCONTRACT_NO->Sortable = true; // Allow sort
        $this->MAINCONTRACT_NO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MAINCONTRACT_NO->Param, "CustomMsg");
        $this->Fields['MAINCONTRACT_NO'] = &$this->MAINCONTRACT_NO;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CONTRACT_DETAIL]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->MAINCONTRACT_NO->DbValue = $row['MAINCONTRACT_NO'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ContractDetailList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ContractDetailView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ContractDetailEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ContractDetailAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "ContractDetailAdd";
            case Config("API_EDIT_ACTION"):
                return "ContractDetailEdit";
            case Config("API_DELETE_ACTION"):
                return "ContractDetailDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ContractDetailView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ContractDetailView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ContractDetailAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ContractDetailAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContractDetailEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ContractDetailAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ContractDetailDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->MAINCONTRACT_NO->setDbValue($row['MAINCONTRACT_NO']);
    }
    ...
    public function renderListRow()
    {
        ...
        // MAINCONTRACT_NO
        $this->MAINCONTRACT_NO->ViewValue = $this->MAINCONTRACT_NO->CurrentValue;
        $this->MAINCONTRACT_NO->ViewCustomAttributes = "";
        ...
        // MAINCONTRACT_NO
        $this->MAINCONTRACT_NO->LinkCustomAttributes = "";
        $this->MAINCONTRACT_NO->HrefValue = "";
        $this->MAINCONTRACT_NO->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // MAINCONTRACT_NO
        $this->MAINCONTRACT_NO->EditAttrs["class"] = "form-control";
        $this->MAINCONTRACT_NO->EditCustomAttributes = "";
        if (!$this->MAINCONTRACT_NO->Raw) {
            $this->MAINCONTRACT_NO->CurrentValue = HtmlDecode($this->MAINCONTRACT_NO->CurrentValue);
        }
        $this->MAINCONTRACT_NO->EditValue = $this->MAINCONTRACT_NO->CurrentValue;
        $this->MAINCONTRACT_NO->PlaceHolder = RemoveHtml($this->MAINCONTRACT_NO->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->MAINCONTRACT_NO);
                } else {
                    $doc->exportCaption($this->ORG_UNIT_CODE);
                    $doc->exportCaption($this->BRAND_ID);
                    $doc->exportCaption($this->BRAND_NAME);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->MAINCONTRACT_NO);
                    } else {
                        $doc->exportField($this->ORG_UNIT_CODE);
                        $doc->exportField($this->BRAND_ID);
                        $doc->exportField($this->BRAND_NAME);
