...
/**
 * Table class for V_LABORATORIUM
 */
class VLaboratorium extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_LABORATORIUM';
        $this->TableName = 'V_LABORATORIUM';
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // RUJUKAN_ID
        $this->RUJUKAN_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RUJUKAN_ID', 'RUJUKAN_ID', '[RUJUKAN_ID]', 'CAST([RUJUKAN_ID] AS NVARCHAR)', 20, 8, -1, false, '[RUJUKAN_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->RUJUKAN_ID->Sortable = false; // Allow sort
        ...
        // ADDRESS_OF_RUJUKAN
        $this->ADDRESS_OF_RUJUKAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ADDRESS_OF_RUJUKAN', 'ADDRESS_OF_RUJUKAN', '[ADDRESS_OF_RUJUKAN]', '[ADDRESS_OF_RUJUKAN]', 200, 100, -1, false, '[ADDRESS_OF_RUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ADDRESS_OF_RUJUKAN->Sortable = false; // Allow sort
        ...
        // REASON_ID
        $this->REASON_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_REASON_ID', 'REASON_ID', '[REASON_ID]', 'CAST([REASON_ID] AS NVARCHAR)', 17, 1, -1, false, '[REASON_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->REASON_ID->Sortable = false; // Allow sort
        ...
        // WAY_ID
        $this->WAY_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_WAY_ID', 'WAY_ID', '[WAY_ID]', 'CAST([WAY_ID] AS NVARCHAR)', 17, 1, -1, false, '[WAY_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->WAY_ID->Sortable = false; // Allow sort
        ...
        // PATIENT_CATEGORY_ID
        $this->PATIENT_CATEGORY_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PATIENT_CATEGORY_ID', 'PATIENT_CATEGORY_ID', '[PATIENT_CATEGORY_ID]', 'CAST([PATIENT_CATEGORY_ID] AS NVARCHAR)', 17, 1, -1, false, '[PATIENT_CATEGORY_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PATIENT_CATEGORY_ID->Sortable = false; // Allow sort
        ...
        // BOOKED_DATE
        $this->BOOKED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BOOKED_DATE', 'BOOKED_DATE', '[BOOKED_DATE]', CastDateFieldForLike("[BOOKED_DATE]", 0, "DB"), 135, 8, 0, false, '[BOOKED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BOOKED_DATE->Sortable = false; // Allow sort
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_VISIT_DATE', 'VISIT_DATE', '[VISIT_DATE]', CastDateFieldForLike("[VISIT_DATE]", 11, "DB"), 135, 8, 11, false, '[VISIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISNEW
        $this->ISNEW = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ISNEW', 'ISNEW', '[ISNEW]', '[ISNEW]', 129, 1, -1, false, '[ISNEW]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        $this->ISNEW->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->ISNEW->Lookup = new Lookup('ISNEW', 'V_LABORATORIUM', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ISNEW->Lookup = new Lookup('ISNEW', 'V_LABORATORIUM', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // FOLLOW_UP
        $this->FOLLOW_UP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_FOLLOW_UP', 'FOLLOW_UP', '[FOLLOW_UP]', 'CAST([FOLLOW_UP] AS NVARCHAR)', 17, 1, -1, false, '[FOLLOW_UP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->FOLLOW_UP->Sortable = false; // Allow sort
        ...
        // PLACE_TYPE
        $this->PLACE_TYPE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PLACE_TYPE', 'PLACE_TYPE', '[PLACE_TYPE]', 'CAST([PLACE_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[PLACE_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PLACE_TYPE->Sortable = false; // Allow sort
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 8, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 16, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // IN_DATE
        $this->IN_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_IN_DATE', 'IN_DATE', '[IN_DATE]', CastDateFieldForLike("[IN_DATE]", 0, "DB"), 135, 8, 0, false, '[IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->IN_DATE->Sortable = false; // Allow sort
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 0, "DB"), 135, 8, 0, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIANTAR_OLEH
        $this->DIANTAR_OLEH = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_DIANTAR_OLEH', 'DIANTAR_OLEH', '[DIANTAR_OLEH]', '[DIANTAR_OLEH]', 200, 255, -1, false, '[DIANTAR_OLEH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISITOR_ADDRESS
        $this->VISITOR_ADDRESS = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_VISITOR_ADDRESS', 'VISITOR_ADDRESS', '[VISITOR_ADDRESS]', '[VISITOR_ADDRESS]', 200, 150, -1, false, '[VISITOR_ADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->VISITOR_ADDRESS->Sortable = false; // Allow sort
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = false; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', '[EMPLOYEE_ID_FROM]', '[EMPLOYEE_ID_FROM]', 200, 50, -1, false, '[EMPLOYEE_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESPONSIBLE_ID
        $this->RESPONSIBLE_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONSIBLE_ID', 'RESPONSIBLE_ID', '[RESPONSIBLE_ID]', 'CAST([RESPONSIBLE_ID] AS NVARCHAR)', 17, 1, -1, false, '[RESPONSIBLE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESPONSIBLE_ID->Sortable = false; // Allow sort
        ...
        // RESPONSIBLE
        $this->RESPONSIBLE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONSIBLE', 'RESPONSIBLE', '[RESPONSIBLE]', '[RESPONSIBLE]', 200, 150, -1, false, '[RESPONSIBLE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESPONSIBLE->Sortable = false; // Allow sort
        ...
        // FAMILY_STATUS_ID
        $this->FAMILY_STATUS_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_FAMILY_STATUS_ID', 'FAMILY_STATUS_ID', '[FAMILY_STATUS_ID]', 'CAST([FAMILY_STATUS_ID] AS NVARCHAR)', 17, 1, -1, false, '[FAMILY_STATUS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TICKET_NO
        $this->TICKET_NO = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_TICKET_NO', 'TICKET_NO', '[TICKET_NO]', 'CAST([TICKET_NO] AS NVARCHAR)', 2, 2, -1, false, '[TICKET_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TICKET_NO->Sortable = false; // Allow sort
        ...
        // ISATTENDED
        $this->ISATTENDED = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ISATTENDED', 'ISATTENDED', '[ISATTENDED]', '[ISATTENDED]', 129, 1, -1, false, '[ISATTENDED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ISATTENDED->Sortable = false; // Allow sort
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ISPERTARIF
        $this->ISPERTARIF = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ISPERTARIF', 'ISPERTARIF', '[ISPERTARIF]', '[ISPERTARIF]', 129, 1, -1, false, '[ISPERTARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ISPERTARIF->Sortable = false; // Allow sort
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // EMPLOYEE_INAP
        $this->EMPLOYEE_INAP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EMPLOYEE_INAP', 'EMPLOYEE_INAP', '[EMPLOYEE_INAP]', '[EMPLOYEE_INAP]', 200, 50, -1, false, '[EMPLOYEE_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->EMPLOYEE_INAP->Sortable = false; // Allow sort
        ...
        // PASIEN_ID
        $this->PASIEN_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PASIEN_ID', 'PASIEN_ID', '[PASIEN_ID]', '[PASIEN_ID]', 200, 30, -1, false, '[PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KARYAWAN
        $this->KARYAWAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID_PLAFOND
        $this->CLASS_ID_PLAFOND = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CLASS_ID_PLAFOND', 'CLASS_ID_PLAFOND', '[CLASS_ID_PLAFOND]', 'CAST([CLASS_ID_PLAFOND] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BACKCHARGE
        $this->BACKCHARGE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BACKCHARGE', 'BACKCHARGE', '[BACKCHARGE]', '[BACKCHARGE]', 129, 1, -1, false, '[BACKCHARGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COVERAGE_ID
        $this->COVERAGE_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_COVERAGE_ID', 'COVERAGE_ID', '[COVERAGE_ID]', 'CAST([COVERAGE_ID] AS NVARCHAR)', 17, 1, -1, false, '[COVERAGE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 2, 2, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 2, 2, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 2, 2, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RECOMENDATION
        $this->RECOMENDATION = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RECOMENDATION', 'RECOMENDATION', '[RECOMENDATION]', '[RECOMENDATION]', 200, 8000, -1, false, '[RECOMENDATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RECOMENDATION->Sortable = false; // Allow sort
        ...
        // CONCLUSION
        $this->CONCLUSION = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CONCLUSION', 'CONCLUSION', '[CONCLUSION]', '[CONCLUSION]', 200, 8000, -1, false, '[CONCLUSION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CONCLUSION->Sortable = false; // Allow sort
        ...
        // SPECIMENNO
        $this->SPECIMENNO = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_SPECIMENNO', 'SPECIMENNO', '[SPECIMENNO]', '[SPECIMENNO]', 200, 50, -1, false, '[SPECIMENNO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPECIMENNO->Sortable = false; // Allow sort
        ...
        // LOCKED
        $this->LOCKED = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LOCKED', 'LOCKED', '[LOCKED]', '[LOCKED]', 200, 1, -1, false, '[LOCKED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RM_OUT_DATE
        $this->RM_OUT_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RM_OUT_DATE', 'RM_OUT_DATE', '[RM_OUT_DATE]', CastDateFieldForLike("[RM_OUT_DATE]", 0, "DB"), 135, 8, 0, false, '[RM_OUT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RM_OUT_DATE->Sortable = false; // Allow sort
        ...
        // RM_IN_DATE
        $this->RM_IN_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RM_IN_DATE', 'RM_IN_DATE', '[RM_IN_DATE]', CastDateFieldForLike("[RM_IN_DATE]", 0, "DB"), 135, 8, 0, false, '[RM_IN_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RM_IN_DATE->Sortable = false; // Allow sort
        ...
        // LAMA_PINJAM
        $this->LAMA_PINJAM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LAMA_PINJAM', 'LAMA_PINJAM', '[LAMA_PINJAM]', CastDateFieldForLike("[LAMA_PINJAM]", 0, "DB"), 135, 8, 0, false, '[LAMA_PINJAM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LAMA_PINJAM->Sortable = false; // Allow sort
        ...
        // STANDAR_RJ
        $this->STANDAR_RJ = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_STANDAR_RJ', 'STANDAR_RJ', '[STANDAR_RJ]', '[STANDAR_RJ]', 129, 1, -1, false, '[STANDAR_RJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->STANDAR_RJ->Sortable = false; // Allow sort
        ...
        // LENGKAP_RJ
        $this->LENGKAP_RJ = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_RJ', 'LENGKAP_RJ', '[LENGKAP_RJ]', '[LENGKAP_RJ]', 129, 1, -1, false, '[LENGKAP_RJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_RJ->Sortable = false; // Allow sort
        ...
        // LENGKAP_RI
        $this->LENGKAP_RI = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_RI', 'LENGKAP_RI', '[LENGKAP_RI]', '[LENGKAP_RI]', 129, 1, -1, false, '[LENGKAP_RI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_RI->Sortable = false; // Allow sort
        ...
        // RESEND_RM_DATE
        $this->RESEND_RM_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESEND_RM_DATE', 'RESEND_RM_DATE', '[RESEND_RM_DATE]', CastDateFieldForLike("[RESEND_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[RESEND_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESEND_RM_DATE->Sortable = false; // Allow sort
        ...
        // LENGKAP_RM1
        $this->LENGKAP_RM1 = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_RM1', 'LENGKAP_RM1', '[LENGKAP_RM1]', '[LENGKAP_RM1]', 129, 1, -1, false, '[LENGKAP_RM1]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_RM1->Sortable = false; // Allow sort
        ...
        // LENGKAP_RESUME
        $this->LENGKAP_RESUME = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_RESUME', 'LENGKAP_RESUME', '[LENGKAP_RESUME]', '[LENGKAP_RESUME]', 129, 1, -1, false, '[LENGKAP_RESUME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_RESUME->Sortable = false; // Allow sort
        ...
        // LENGKAP_ANAMNESIS
        $this->LENGKAP_ANAMNESIS = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_ANAMNESIS', 'LENGKAP_ANAMNESIS', '[LENGKAP_ANAMNESIS]', '[LENGKAP_ANAMNESIS]', 129, 1, -1, false, '[LENGKAP_ANAMNESIS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_ANAMNESIS->Sortable = false; // Allow sort
        ...
        // LENGKAP_CONSENT
        $this->LENGKAP_CONSENT = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_CONSENT', 'LENGKAP_CONSENT', '[LENGKAP_CONSENT]', '[LENGKAP_CONSENT]', 129, 1, -1, false, '[LENGKAP_CONSENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_CONSENT->Sortable = false; // Allow sort
        ...
        // LENGKAP_ANESTESI
        $this->LENGKAP_ANESTESI = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_ANESTESI', 'LENGKAP_ANESTESI', '[LENGKAP_ANESTESI]', '[LENGKAP_ANESTESI]', 129, 1, -1, false, '[LENGKAP_ANESTESI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_ANESTESI->Sortable = false; // Allow sort
        ...
        // LENGKAP_OP
        $this->LENGKAP_OP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LENGKAP_OP', 'LENGKAP_OP', '[LENGKAP_OP]', '[LENGKAP_OP]', 129, 1, -1, false, '[LENGKAP_OP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LENGKAP_OP->Sortable = false; // Allow sort
        ...
        // BACK_RM_DATE
        $this->BACK_RM_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BACK_RM_DATE', 'BACK_RM_DATE', '[BACK_RM_DATE]', CastDateFieldForLike("[BACK_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[BACK_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BACK_RM_DATE->Sortable = false; // Allow sort
        ...
        // VALID_RM_DATE
        $this->VALID_RM_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_VALID_RM_DATE', 'VALID_RM_DATE', '[VALID_RM_DATE]', CastDateFieldForLike("[VALID_RM_DATE]", 0, "DB"), 135, 8, 0, false, '[VALID_RM_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->VALID_RM_DATE->Sortable = false; // Allow sort
        ...
        // NO_SKP
        $this->NO_SKP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_NO_SKP', 'NO_SKP', '[NO_SKP]', '[NO_SKP]', 200, 50, -1, false, '[NO_SKP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NO_SKP->Sortable = false; // Allow sort
        $this->NO_SKP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NO_SKP->Param, "CustomMsg");
        $this->Fields['NO_SKP'] = &$this->NO_SKP;

        // NO_SKPINAP
        $this->NO_SKPINAP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_NO_SKPINAP', 'NO_SKPINAP', '[NO_SKPINAP]', '[NO_SKPINAP]', 200, 50, -1, false, '[NO_SKPINAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 10, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ticket_all
        $this->ticket_all = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ticket_all', 'ticket_all', '[ticket_all]', 'CAST([ticket_all] AS NVARCHAR)', 20, 8, -1, false, '[ticket_all]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ticket_all->Sortable = false; // Allow sort
        ...
        // tanggal_rujukan
        $this->tanggal_rujukan = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_tanggal_rujukan', 'tanggal_rujukan', '[tanggal_rujukan]', CastDateFieldForLike("[tanggal_rujukan]", 0, "DB"), 135, 8, 0, false, '[tanggal_rujukan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->tanggal_rujukan->Sortable = false; // Allow sort
        ...
        // ISRJ
        $this->ISRJ = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // NORUJUKAN
        $this->NORUJUKAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_NORUJUKAN', 'NORUJUKAN', '[NORUJUKAN]', '[NORUJUKAN]', 200, 50, -1, false, '[NORUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NORUJUKAN->Sortable = false; // Allow sort
        ...
        // PPKRUJUKAN
        $this->PPKRUJUKAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PPKRUJUKAN', 'PPKRUJUKAN', '[PPKRUJUKAN]', '[PPKRUJUKAN]', 200, 50, -1, false, '[PPKRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PPKRUJUKAN->Sortable = false; // Allow sort
        ...
        // LOKASILAKA
        $this->LOKASILAKA = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_LOKASILAKA', 'LOKASILAKA', '[LOKASILAKA]', '[LOKASILAKA]', 200, 50, -1, false, '[LOKASILAKA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->LOKASILAKA->Sortable = false; // Allow sort
        ...
        // KDPOLI
        $this->KDPOLI = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KDPOLI', 'KDPOLI', '[KDPOLI]', '[KDPOLI]', 200, 3, -1, false, '[KDPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EDIT_SEP
        $this->EDIT_SEP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_EDIT_SEP', 'EDIT_SEP', '[EDIT_SEP]', '[EDIT_SEP]', 200, 250, -1, false, '[EDIT_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->EDIT_SEP->Sortable = false; // Allow sort
        ...
        // DELETE_SEP
        $this->DELETE_SEP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_DELETE_SEP', 'DELETE_SEP', '[DELETE_SEP]', '[DELETE_SEP]', 200, 250, -1, false, '[DELETE_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DELETE_SEP->Sortable = false; // Allow sort
        ...
        // KODE_AGAMA
        $this->KODE_AGAMA = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KODE_AGAMA', 'KODE_AGAMA', '[KODE_AGAMA]', 'CAST([KODE_AGAMA] AS NVARCHAR)', 17, 1, -1, false, '[KODE_AGAMA]', false, false, false, 'FORMATTED TEXT', 'RADIO');
        ...
        // DIAG_AWAL
        $this->DIAG_AWAL = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_DIAG_AWAL', 'DIAG_AWAL', '[DIAG_AWAL]', '[DIAG_AWAL]', 200, 10, -1, false, '[DIAG_AWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIAG_AWAL->Sortable = false; // Allow sort
        ...
        // AKTIF
        $this->AKTIF = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_AKTIF', 'AKTIF', '[AKTIF]', '[AKTIF]', 200, 2, -1, false, '[AKTIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_INAP
        $this->BILL_INAP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_BILL_INAP', 'BILL_INAP', '[BILL_INAP]', '[BILL_INAP]', 200, 50, -1, false, '[BILL_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BILL_INAP->Sortable = false; // Allow sort
        ...
        // SEP_PRINTDATE
        $this->SEP_PRINTDATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_SEP_PRINTDATE', 'SEP_PRINTDATE', '[SEP_PRINTDATE]', CastDateFieldForLike("[SEP_PRINTDATE]", 0, "DB"), 135, 8, 0, false, '[SEP_PRINTDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SEP_PRINTDATE->Sortable = false; // Allow sort
        ...
        // MAPPING_SEP
        $this->MAPPING_SEP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_MAPPING_SEP', 'MAPPING_SEP', '[MAPPING_SEP]', '[MAPPING_SEP]', 200, 250, -1, false, '[MAPPING_SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDPOLI_EKS
        $this->KDPOLI_EKS = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KDPOLI_EKS', 'KDPOLI_EKS', '[KDPOLI_EKS]', '[KDPOLI_EKS]', 129, 1, -1, false, '[KDPOLI_EKS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->KDPOLI_EKS->Sortable = false; // Allow sort
        ...
        // COB
        $this->COB = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_COB', 'COB', '[COB]', '[COB]', 129, 1, -1, false, '[COB]', false, false, false, 'FORMATTED TEXT', 'CHECKBOX');
        $this->COB->Sortable = false; // Allow sort
        switch ($CurrentLanguage) {
            case "en":
                $this->COB->Lookup = new Lookup('COB', 'V_LABORATORIUM', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->COB->Lookup = new Lookup('COB', 'V_LABORATORIUM', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // PENJAMIN
        $this->PENJAMIN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_PENJAMIN', 'PENJAMIN', '[PENJAMIN]', '[PENJAMIN]', 200, 25, -1, false, '[PENJAMIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PENJAMIN->Sortable = false; // Allow sort
        ...
        // ASALRUJUKAN
        $this->ASALRUJUKAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_ASALRUJUKAN', 'ASALRUJUKAN', '[ASALRUJUKAN]', '[ASALRUJUKAN]', 129, 1, -1, false, '[ASALRUJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ASALRUJUKAN->Sortable = false; // Allow sort
        ...
        // RESPONSEP
        $this->RESPONSEP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONSEP', 'RESPONSEP', '[RESPONSEP]', '[RESPONSEP]', 200, 0, -1, false, '[RESPONSEP]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->RESPONSEP->Sortable = false; // Allow sort
        ...
        // APPROVAL_DESC
        $this->APPROVAL_DESC = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_APPROVAL_DESC', 'APPROVAL_DESC', '[APPROVAL_DESC]', '[APPROVAL_DESC]', 200, 250, -1, false, '[APPROVAL_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->APPROVAL_DESC->Sortable = false; // Allow sort
        ...
        $this->APPROVAL_RESPONAJUKAN = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_APPROVAL_RESPONAJUKAN', 'APPROVAL_RESPONAJUKAN', '[APPROVAL_RESPONAJUKAN]', '[APPROVAL_RESPONAJUKAN]', 200, 250, -1, false, '[APPROVAL_RESPONAJUKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->APPROVAL_RESPONAJUKAN->Sortable = false; // Allow sort
        ...
        $this->APPROVAL_RESPONAPPROV = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_APPROVAL_RESPONAPPROV', 'APPROVAL_RESPONAPPROV', '[APPROVAL_RESPONAPPROV]', '[APPROVAL_RESPONAPPROV]', 200, 250, -1, false, '[APPROVAL_RESPONAPPROV]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->APPROVAL_RESPONAPPROV->Sortable = false; // Allow sort
        ...
        // RESPONTGLPLG_DESC
        $this->RESPONTGLPLG_DESC = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONTGLPLG_DESC', 'RESPONTGLPLG_DESC', '[RESPONTGLPLG_DESC]', '[RESPONTGLPLG_DESC]', 200, 250, -1, false, '[RESPONTGLPLG_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->RESPONTGLPLG_DESC->Sortable = false; // Allow sort
        ...
        // RESPONPOST_VKLAIM
        $this->RESPONPOST_VKLAIM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONPOST_VKLAIM', 'RESPONPOST_VKLAIM', '[RESPONPOST_VKLAIM]', '[RESPONPOST_VKLAIM]', 200, 0, -1, false, '[RESPONPOST_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->RESPONPOST_VKLAIM->Sortable = false; // Allow sort
        ...
        // RESPONPUT_VKLAIM
        $this->RESPONPUT_VKLAIM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONPUT_VKLAIM', 'RESPONPUT_VKLAIM', '[RESPONPUT_VKLAIM]', '[RESPONPUT_VKLAIM]', 200, 0, -1, false, '[RESPONPUT_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->RESPONPUT_VKLAIM->Sortable = false; // Allow sort
        ...
        // RESPONDEL_VKLAIM
        $this->RESPONDEL_VKLAIM = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_RESPONDEL_VKLAIM', 'RESPONDEL_VKLAIM', '[RESPONDEL_VKLAIM]', '[RESPONDEL_VKLAIM]', 200, 0, -1, false, '[RESPONDEL_VKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->RESPONDEL_VKLAIM->Sortable = false; // Allow sort
        ...
        // CALL_TIMES
        $this->CALL_TIMES = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CALL_TIMES', 'CALL_TIMES', '[CALL_TIMES]', 'CAST([CALL_TIMES] AS NVARCHAR)', 3, 4, -1, false, '[CALL_TIMES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CALL_TIMES->Sortable = false; // Allow sort
        ...
        // CALL_DATE
        $this->CALL_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CALL_DATE', 'CALL_DATE', '[CALL_DATE]', CastDateFieldForLike("[CALL_DATE]", 0, "DB"), 135, 8, 0, false, '[CALL_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CALL_DATE->Sortable = false; // Allow sort
        ...
        // CALL_DATES
        $this->CALL_DATES = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_CALL_DATES', 'CALL_DATES', '[CALL_DATES]', CastDateFieldForLike("[CALL_DATES]", 0, "DB"), 135, 8, 0, false, '[CALL_DATES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->CALL_DATES->Sortable = false; // Allow sort
        ...
        // SERVED_DATE
        $this->SERVED_DATE = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_SERVED_DATE', 'SERVED_DATE', '[SERVED_DATE]', CastDateFieldForLike("[SERVED_DATE]", 0, "DB"), 135, 8, 0, false, '[SERVED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SERVED_DATE->Sortable = false; // Allow sort
        ...
        // SERVED_INAP
        $this->SERVED_INAP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_SERVED_INAP', 'SERVED_INAP', '[SERVED_INAP]', CastDateFieldForLike("[SERVED_INAP]", 0, "DB"), 135, 8, 0, false, '[SERVED_INAP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SERVED_INAP->Sortable = false; // Allow sort
        ...
        // KDDPJP1
        $this->KDDPJP1 = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KDDPJP1', 'KDDPJP1', '[KDDPJP1]', '[KDDPJP1]', 200, 25, -1, false, '[KDDPJP1]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->KDDPJP1->Sortable = false; // Allow sort
        $this->KDDPJP1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->KDDPJP1->Param, "CustomMsg");
        $this->Fields['KDDPJP1'] = &$this->KDDPJP1;

        // KDDPJP
        $this->KDDPJP = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_KDDPJP', 'KDDPJP', '[KDDPJP]', '[KDDPJP]', 200, 25, -1, false, '[KDDPJP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->KDDPJP->Sortable = false; // Allow sort
        $this->KDDPJP->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->KDDPJP->Param, "CustomMsg");
        $this->Fields['KDDPJP'] = &$this->KDDPJP;

        // IDXDAFTAR
        $this->IDXDAFTAR = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_IDXDAFTAR', 'IDXDAFTAR', '[IDXDAFTAR]', 'CAST([IDXDAFTAR] AS NVARCHAR)', 3, 4, -1, false, '[IDXDAFTAR]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // tgl_kontrol
        $this->tgl_kontrol = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_tgl_kontrol', 'tgl_kontrol', '[tgl_kontrol]', CastDateFieldForLike("[tgl_kontrol]", 0, "DB"), 135, 8, 0, false, '[tgl_kontrol]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idbooking
        $this->idbooking = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_idbooking', 'idbooking', '[idbooking]', '[idbooking]', 200, 20, -1, false, '[idbooking]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_tujuan
        $this->id_tujuan = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_tujuan', 'id_tujuan', '[id_tujuan]', 'CAST([id_tujuan] AS NVARCHAR)', 3, 4, -1, false, '[id_tujuan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_penunjang
        $this->id_penunjang = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_penunjang', 'id_penunjang', '[id_penunjang]', 'CAST([id_penunjang] AS NVARCHAR)', 3, 4, -1, false, '[id_penunjang]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_pembiayaan
        $this->id_pembiayaan = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_pembiayaan', 'id_pembiayaan', '[id_pembiayaan]', 'CAST([id_pembiayaan] AS NVARCHAR)', 3, 4, -1, false, '[id_pembiayaan]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_procedure
        $this->id_procedure = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_procedure', 'id_procedure', '[id_procedure]', 'CAST([id_procedure] AS NVARCHAR)', 3, 4, -1, false, '[id_procedure]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_aspel
        $this->id_aspel = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_aspel', 'id_aspel', '[id_aspel]', 'CAST([id_aspel] AS NVARCHAR)', 3, 4, -1, false, '[id_aspel]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // id_kelas
        $this->id_kelas = new DbField('V_LABORATORIUM', 'V_LABORATORIUM', 'x_id_kelas', 'id_kelas', '[id_kelas]', 'CAST([id_kelas] AS NVARCHAR)', 3, 4, -1, false, '[id_kelas]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VLaboratoriumList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "VLaboratoriumEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VLaboratoriumAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VLaboratoriumView";
            case Config("API_ADD_ACTION"):
                return "VLaboratoriumAdd";
            case Config("API_EDIT_ACTION"):
                return "VLaboratoriumEdit";
            case Config("API_DELETE_ACTION"):
                return "VLaboratoriumDelete";
            case Config("API_LIST_ACTION"):
                return "VLaboratoriumList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VLaboratoriumView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VLaboratoriumView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VLaboratoriumAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VLaboratoriumAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VLaboratoriumEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VLaboratoriumEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VLaboratoriumAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VLaboratoriumAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VLaboratoriumDelete", $this->getUrlParm());
    }
