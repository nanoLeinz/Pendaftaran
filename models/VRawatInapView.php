 ...
 * Page class
 */
class VRawatInapView extends VRawatInap
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRawatInapView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "VRawatInapList"; // Return to list
            }
            if (($keyValue = Get("BILL_ID") ?? Route("BILL_ID")) !== null) {
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VRawatInapList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VRawatInapList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VRawatInapList"), "", $this->TableVar, true);
        $pageId = "view";
