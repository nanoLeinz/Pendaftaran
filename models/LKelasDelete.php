 ...
 * Page class
 */
class LKelasDelete extends LKelas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LKelasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LKelasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LKelasList"); // Return to list
                return;
            }
        }
