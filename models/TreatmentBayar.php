...
/**
 * Table class for TREATMENT_BAYAR
 */
class TreatmentBayar extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREATMENT_BAYAR';
        $this->TableName = 'TREATMENT_BAYAR';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREATMENT_BAYAR]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_BILL_ID', 'BILL_ID', '[BILL_ID]', '[BILL_ID]', 200, 50, -1, false, '[BILL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 15, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 15, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TREATMENT', 'TREATMENT', '[TREATMENT]', '[TREATMENT]', 200, 200, -1, false, '[TREATMENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TREAT_DATE', 'TREAT_DATE', '[TREAT_DATE]', CastDateFieldForLike("[TREAT_DATE]", 0, "DB"), 135, 8, 0, false, '[TREAT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POKOK_JUAL
        $this->POKOK_JUAL = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_POKOK_JUAL', 'POKOK_JUAL', '[POKOK_JUAL]', 'CAST([POKOK_JUAL] AS NVARCHAR)', 131, 8, -1, false, '[POKOK_JUAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPN
        $this->PPN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PPN', 'PPN', '[PPN]', 'CAST([PPN] AS NVARCHAR)', 131, 8, -1, false, '[PPN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARGIN
        $this->MARGIN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MARGIN', 'MARGIN', '[MARGIN]', 'CAST([MARGIN] AS NVARCHAR)', 131, 8, -1, false, '[MARGIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUBSIDI
        $this->SUBSIDI = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SUBSIDI', 'SUBSIDI', '[SUBSIDI]', 'CAST([SUBSIDI] AS NVARCHAR)', 6, 8, -1, false, '[SUBSIDI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMBALACE
        $this->EMBALACE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_EMBALACE', 'EMBALACE', '[EMBALACE]', 'CAST([EMBALACE] AS NVARCHAR)', 6, 8, -1, false, '[EMBALACE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROFESI
        $this->PROFESI = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PROFESI', 'PROFESI', '[PROFESI]', 'CAST([PROFESI] AS NVARCHAR)', 6, 8, -1, false, '[PROFESI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT
        $this->DISCOUNT = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DISCOUNT', 'DISCOUNT', '[DISCOUNT]', 'CAST([DISCOUNT] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAY_METHOD_ID
        $this->PAY_METHOD_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PAY_METHOD_ID', 'PAY_METHOD_ID', '[PAY_METHOD_ID]', 'CAST([PAY_METHOD_ID] AS NVARCHAR)', 17, 1, -1, false, '[PAY_METHOD_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYMENT_DATE
        $this->PAYMENT_DATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PAYMENT_DATE', 'PAYMENT_DATE', '[PAYMENT_DATE]', CastDateFieldForLike("[PAYMENT_DATE]", 0, "DB"), 135, 8, 0, false, '[PAYMENT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISLUNAS
        $this->ISLUNAS = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ISLUNAS', 'ISLUNAS', '[ISLUNAS]', '[ISLUNAS]', 129, 1, -1, false, '[ISLUNAS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DUEDATE_ANGSURAN
        $this->DUEDATE_ANGSURAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DUEDATE_ANGSURAN', 'DUEDATE_ANGSURAN', '[DUEDATE_ANGSURAN]', CastDateFieldForLike("[DUEDATE_ANGSURAN]", 0, "DB"), 135, 8, 0, false, '[DUEDATE_ANGSURAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // KUITANSI_ID
        $this->KUITANSI_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_KUITANSI_ID', 'KUITANSI_ID', '[KUITANSI_ID]', '[KUITANSI_ID]', 200, 100, -1, false, '[KUITANSI_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_NOTA_NO', 'NOTA_NO', '[NOTA_NO]', '[NOTA_NO]', 200, 50, -1, false, '[NOTA_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 0, "DB"), 135, 8, 0, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESEP_NO
        $this->RESEP_NO = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_RESEP_NO', 'RESEP_NO', '[RESEP_NO]', '[RESEP_NO]', 200, 50, -1, false, '[RESEP_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RESEP_KE
        $this->RESEP_KE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_RESEP_KE', 'RESEP_KE', '[RESEP_KE]', 'CAST([RESEP_KE] AS NVARCHAR)', 17, 1, -1, false, '[RESEP_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOSE
        $this->DOSE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DOSE', 'DOSE', '[DOSE]', 'CAST([DOSE] AS NVARCHAR)', 131, 8, -1, false, '[DOSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORIG_DOSE
        $this->ORIG_DOSE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ORIG_DOSE', 'ORIG_DOSE', '[ORIG_DOSE]', 'CAST([ORIG_DOSE] AS NVARCHAR)', 131, 8, -1, false, '[ORIG_DOSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOSE_PRESC
        $this->DOSE_PRESC = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DOSE_PRESC', 'DOSE_PRESC', '[DOSE_PRESC]', 'CAST([DOSE_PRESC] AS NVARCHAR)', 131, 8, -1, false, '[DOSE_PRESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITER
        $this->ITER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ITER', 'ITER', '[ITER]', 'CAST([ITER] AS NVARCHAR)', 17, 1, -1, false, '[ITER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITER_KE
        $this->ITER_KE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ITER_KE', 'ITER_KE', '[ITER_KE]', 'CAST([ITER_KE] AS NVARCHAR)', 17, 1, -1, false, '[ITER_KE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SOLD_STATUS
        $this->SOLD_STATUS = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SOLD_STATUS', 'SOLD_STATUS', '[SOLD_STATUS]', 'CAST([SOLD_STATUS] AS NVARCHAR)', 17, 1, -1, false, '[SOLD_STATUS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RACIKAN
        $this->RACIKAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_RACIKAN', 'RACIKAN', '[RACIKAN]', 'CAST([RACIKAN] AS NVARCHAR)', 2, 2, -1, false, '[RACIKAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 16, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PERDA_ID
        $this->PERDA_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PERDA_ID', 'PERDA_ID', '[PERDA_ID]', 'CAST([PERDA_ID] AS NVARCHAR)', 17, 1, -1, false, '[PERDA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION2
        $this->DESCRIPTION2 = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DESCRIPTION2', 'DESCRIPTION2', '[DESCRIPTION2]', '[DESCRIPTION2]', 200, 50, -1, false, '[DESCRIPTION2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 200, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR
        $this->DOCTOR = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DOCTOR', 'DOCTOR', '[DOCTOR]', '[DOCTOR]', 200, 100, -1, false, '[DOCTOR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JML_BKS
        $this->JML_BKS = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_JML_BKS', 'JML_BKS', '[JML_BKS]', 'CAST([JML_BKS] AS NVARCHAR)', 17, 1, -1, false, '[JML_BKS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 0, "DB"), 135, 8, 0, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FA_V
        $this->FA_V = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_FA_V', 'FA_V', '[FA_V]', 'CAST([FA_V] AS NVARCHAR)', 2, 2, -1, false, '[FA_V]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TASK_ID
        $this->TASK_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TASK_ID', 'TASK_ID', '[TASK_ID]', 'CAST([TASK_ID] AS NVARCHAR)', 2, 2, -1, false, '[TASK_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', '[EMPLOYEE_ID_FROM]', '[EMPLOYEE_ID_FROM]', 200, 50, -1, false, '[EMPLOYEE_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR_FROM
        $this->DOCTOR_FROM = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_DOCTOR_FROM', 'DOCTOR_FROM', '[DOCTOR_FROM]', '[DOCTOR_FROM]', 200, 50, -1, false, '[DOCTOR_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_pasien_id
        $this->status_pasien_id = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_status_pasien_id', 'status_pasien_id', '[status_pasien_id]', 'CAST([status_pasien_id] AS NVARCHAR)', 17, 1, -1, false, '[status_pasien_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // amount_paid
        $this->amount_paid = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_amount_paid', 'amount_paid', '[amount_paid]', 'CAST([amount_paid] AS NVARCHAR)', 6, 8, -1, false, '[amount_paid]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 150, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_THEID', 'THEID', '[THEID]', '[THEID]', 200, 25, -1, false, '[THEID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // serial_nb
        $this->serial_nb = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_serial_nb', 'serial_nb', '[serial_nb]', '[serial_nb]', 200, 50, -1, false, '[serial_nb]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT_PLAFOND
        $this->TREATMENT_PLAFOND = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TREATMENT_PLAFOND', 'TREATMENT_PLAFOND', '[TREATMENT_PLAFOND]', '[TREATMENT_PLAFOND]', 200, 150, -1, false, '[TREATMENT_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PLAFOND
        $this->AMOUNT_PLAFOND = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AMOUNT_PLAFOND', 'AMOUNT_PLAFOND', '[AMOUNT_PLAFOND]', 'CAST([AMOUNT_PLAFOND] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PAID_PLAFOND
        $this->AMOUNT_PAID_PLAFOND = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AMOUNT_PAID_PLAFOND', 'AMOUNT_PAID_PLAFOND', '[AMOUNT_PAID_PLAFOND]', 'CAST([AMOUNT_PAID_PLAFOND] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID_PLAFOND
        $this->CLASS_ID_PLAFOND = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLASS_ID_PLAFOND', 'CLASS_ID_PLAFOND', '[CLASS_ID_PLAFOND]', 'CAST([CLASS_ID_PLAFOND] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID_PLAFOND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PEMBULATAN
        $this->PEMBULATAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PEMBULATAN', 'PEMBULATAN', '[PEMBULATAN]', 'CAST([PEMBULATAN] AS NVARCHAR)', 6, 8, -1, false, '[PEMBULATAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 17, 1, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 17, 1, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 17, 1, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // KAL_ID
        $this->KAL_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_ID
        $this->CORRECTION_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CORRECTION_ID', 'CORRECTION_ID', '[CORRECTION_ID]', '[CORRECTION_ID]', 200, 50, -1, false, '[CORRECTION_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_BY
        $this->CORRECTION_BY = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CORRECTION_BY', 'CORRECTION_BY', '[CORRECTION_BY]', '[CORRECTION_BY]', 200, 50, -1, false, '[CORRECTION_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KARYAWAN
        $this->KARYAWAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // sell_price
        $this->sell_price = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_sell_price', 'sell_price', '[sell_price]', 'CAST([sell_price] AS NVARCHAR)', 6, 8, -1, false, '[sell_price]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // diskon
        $this->diskon = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_diskon', 'diskon', '[diskon]', 'CAST([diskon] AS NVARCHAR)', 6, 8, -1, false, '[diskon]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INVOICE_ID
        $this->INVOICE_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_INVOICE_ID', 'INVOICE_ID', '[INVOICE_ID]', '[INVOICE_ID]', 200, 50, -1, false, '[INVOICE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NUMER
        $this->NUMER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_NUMER', 'NUMER', '[NUMER]', '[NUMER]', 200, 15, -1, false, '[NUMER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID2
        $this->MEASURE_ID2 = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MEASURE_ID2', 'MEASURE_ID2', '[MEASURE_ID2]', 'CAST([MEASURE_ID2] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POTONGAN
        $this->POTONGAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_POTONGAN', 'POTONGAN', '[POTONGAN]', 'CAST([POTONGAN] AS NVARCHAR)', 6, 8, -1, false, '[POTONGAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BAYAR
        $this->BAYAR = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_BAYAR', 'BAYAR', '[BAYAR]', 'CAST([BAYAR] AS NVARCHAR)', 6, 8, -1, false, '[BAYAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RETUR
        $this->RETUR = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_RETUR', 'RETUR', '[RETUR]', 'CAST([RETUR] AS NVARCHAR)', 6, 8, -1, false, '[RETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_TYPE
        $this->TARIF_TYPE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TARIF_TYPE', 'TARIF_TYPE', '[TARIF_TYPE]', '[TARIF_TYPE]', 200, 50, -1, false, '[TARIF_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPNVALUE
        $this->PPNVALUE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PPNVALUE', 'PPNVALUE', '[PPNVALUE]', 'CAST([PPNVALUE] AS NVARCHAR)', 6, 8, -1, false, '[PPNVALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAGIHAN
        $this->TAGIHAN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TAGIHAN', 'TAGIHAN', '[TAGIHAN]', 'CAST([TAGIHAN] AS NVARCHAR)', 6, 8, -1, false, '[TAGIHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KOREKSI
        $this->KOREKSI = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_KOREKSI', 'KOREKSI', '[KOREKSI]', 'CAST([KOREKSI] AS NVARCHAR)', 6, 8, -1, false, '[KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_OBAT
        $this->STATUS_OBAT = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_STATUS_OBAT', 'STATUS_OBAT', '[STATUS_OBAT]', 'CAST([STATUS_OBAT] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_OBAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUBSIDISAT
        $this->SUBSIDISAT = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SUBSIDISAT', 'SUBSIDISAT', '[SUBSIDISAT]', 'CAST([SUBSIDISAT] AS NVARCHAR)', 6, 8, -1, false, '[SUBSIDISAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 2, 2, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_AVAILABLE
        $this->STOCK_AVAILABLE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_STOCK_AVAILABLE', 'STOCK_AVAILABLE', '[STOCK_AVAILABLE]', 'CAST([STOCK_AVAILABLE] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_AVAILABLE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_TARIF
        $this->STATUS_TARIF = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_STATUS_TARIF', 'STATUS_TARIF', '[STATUS_TARIF]', 'CAST([STATUS_TARIF] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_TARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_TYPE
        $this->CLINIC_TYPE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CLINIC_TYPE', 'CLINIC_TYPE', '[CLINIC_TYPE]', 'CAST([CLINIC_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[CLINIC_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PACKAGE_ID
        $this->PACKAGE_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PACKAGE_ID', 'PACKAGE_ID', '[PACKAGE_ID]', '[PACKAGE_ID]', 200, 50, -1, false, '[PACKAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODULE_ID
        $this->MODULE_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_MODULE_ID', 'MODULE_ID', '[MODULE_ID]', '[MODULE_ID]', 200, 50, -1, false, '[MODULE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // profession
        $this->profession = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_profession', 'profession', '[profession]', 'CAST([profession] AS NVARCHAR)', 131, 8, -1, false, '[profession]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEORDER
        $this->THEORDER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_THEORDER', 'THEORDER', '[THEORDER]', 'CAST([THEORDER] AS NVARCHAR)', 2, 2, -1, false, '[THEORDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIER
        $this->CASHIER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_CASHIER', 'CASHIER', '[CASHIER]', '[CASHIER]', 200, 50, -1, false, '[CASHIER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPFEE
        $this->SPPFEE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPFEE', 'SPPFEE', '[SPPFEE]', '[SPPFEE]', 200, 50, -1, false, '[SPPFEE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPFEE->Sortable = true; // Allow sort
        $this->SPPFEE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPPFEE->Param, "CustomMsg");
        $this->Fields['SPPFEE'] = &$this->SPPFEE;

        // SPPBILL
        $this->SPPBILL = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPBILL', 'SPPBILL', '[SPPBILL]', '[SPPBILL]', 200, 50, -1, false, '[SPPBILL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPBILL->Sortable = true; // Allow sort
        $this->SPPBILL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPPBILL->Param, "CustomMsg");
        $this->Fields['SPPBILL'] = &$this->SPPBILL;

        // SPPRJK
        $this->SPPRJK = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPRJK', 'SPPRJK', '[SPPRJK]', '[SPPRJK]', 200, 50, -1, false, '[SPPRJK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPRJK->Sortable = true; // Allow sort
        $this->SPPRJK->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPPRJK->Param, "CustomMsg");
        $this->Fields['SPPRJK'] = &$this->SPPRJK;

        // SPPJMN
        $this->SPPJMN = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPJMN', 'SPPJMN', '[SPPJMN]', '[SPPJMN]', 200, 50, -1, false, '[SPPJMN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPJMN->Sortable = true; // Allow sort
        $this->SPPJMN->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPPJMN->Param, "CustomMsg");
        $this->Fields['SPPJMN'] = &$this->SPPJMN;

        // SPPKASIR
        $this->SPPKASIR = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPKASIR', 'SPPKASIR', '[SPPKASIR]', '[SPPKASIR]', 200, 50, -1, false, '[SPPKASIR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PERUJUK
        $this->PERUJUK = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PERUJUK', 'PERUJUK', '[PERUJUK]', '[PERUJUK]', 200, 50, -1, false, '[PERUJUK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PERUJUK->Sortable = true; // Allow sort
        $this->PERUJUK->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PERUJUK->Param, "CustomMsg");
        $this->Fields['PERUJUK'] = &$this->PERUJUK;

        // PERUJUKFEE
        $this->PERUJUKFEE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_PERUJUKFEE', 'PERUJUKFEE', '[PERUJUKFEE]', 'CAST([PERUJUKFEE] AS NVARCHAR)', 6, 8, -1, false, '[PERUJUKFEE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PERUJUKFEE->Sortable = true; // Allow sort
        ...
        // modified_datesys
        $this->modified_datesys = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_modified_datesys', 'modified_datesys', '[modified_datesys]', CastDateFieldForLike("[modified_datesys]", 0, "DB"), 135, 8, 0, false, '[modified_datesys]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->modified_datesys->Sortable = true; // Allow sort
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPBILLDATE
        $this->SPPBILLDATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPBILLDATE', 'SPPBILLDATE', '[SPPBILLDATE]', CastDateFieldForLike("[SPPBILLDATE]", 0, "DB"), 135, 8, 0, false, '[SPPBILLDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPBILLDATE->Sortable = true; // Allow sort
        ...
        // SPPBILLUSER
        $this->SPPBILLUSER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPBILLUSER', 'SPPBILLUSER', '[SPPBILLUSER]', '[SPPBILLUSER]', 200, 50, -1, false, '[SPPBILLUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPBILLUSER->Sortable = true; // Allow sort
        ...
        // SPPKASIRDATE
        $this->SPPKASIRDATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPKASIRDATE', 'SPPKASIRDATE', '[SPPKASIRDATE]', CastDateFieldForLike("[SPPKASIRDATE]", 0, "DB"), 135, 8, 0, false, '[SPPKASIRDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPKASIRUSER
        $this->SPPKASIRUSER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPKASIRUSER', 'SPPKASIRUSER', '[SPPKASIRUSER]', '[SPPKASIRUSER]', 200, 50, -1, false, '[SPPKASIRUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPPPOLI
        $this->SPPPOLI = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPPOLI', 'SPPPOLI', '[SPPPOLI]', '[SPPPOLI]', 200, 50, -1, false, '[SPPPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPPOLI->Sortable = true; // Allow sort
        $this->SPPPOLI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPPPOLI->Param, "CustomMsg");
        $this->Fields['SPPPOLI'] = &$this->SPPPOLI;

        // SPPPOLIUSER
        $this->SPPPOLIUSER = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPPOLIUSER', 'SPPPOLIUSER', '[SPPPOLIUSER]', '[SPPPOLIUSER]', 200, 50, -1, false, '[SPPPOLIUSER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPPOLIUSER->Sortable = true; // Allow sort
        ...
        // SPPPOLIDATE
        $this->SPPPOLIDATE = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_SPPPOLIDATE', 'SPPPOLIDATE', '[SPPPOLIDATE]', CastDateFieldForLike("[SPPPOLIDATE]", 0, "DB"), 135, 8, 0, false, '[SPPPOLIDATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPPPOLIDATE->Sortable = true; // Allow sort
        ...
        // ID
        $this->ID = new DbField('TREATMENT_BAYAR', 'TREATMENT_BAYAR', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 3, 4, -1, false, '[ID]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREATMENT_BAYAR]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatmentBayarList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "TreatmentBayarEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatmentBayarAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatmentBayarView";
            case Config("API_ADD_ACTION"):
                return "TreatmentBayarAdd";
            case Config("API_EDIT_ACTION"):
                return "TreatmentBayarEdit";
            case Config("API_DELETE_ACTION"):
                return "TreatmentBayarDelete";
            case Config("API_LIST_ACTION"):
                return "TreatmentBayarList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatmentBayarView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatmentBayarView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatmentBayarAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatmentBayarAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatmentBayarEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatmentBayarAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatmentBayarDelete", $this->getUrlParm());
    }
