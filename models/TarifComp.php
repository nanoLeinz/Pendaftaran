...
/**
 * Table class for TARIF_COMP
 */
class TarifComp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TARIF_COMP';
        $this->TableName = 'TARIF_COMP';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TARIF_COMP]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_ID
        $this->COMP_ID = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_COMP_ID', 'COMP_ID', '[COMP_ID]', 'CAST([COMP_ID] AS NVARCHAR)', 17, 1, -1, false, '[COMP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_TYPE
        $this->COMP_TYPE = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_COMP_TYPE', 'COMP_TYPE', '[COMP_TYPE]', 'CAST([COMP_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[COMP_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_NAME
        $this->COMP_NAME = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_COMP_NAME', 'COMP_NAME', '[COMP_NAME]', '[COMP_NAME]', 200, 200, -1, false, '[COMP_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TARIF_COMP', 'TARIF_COMP', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TARIF_COMP]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [TARIF_ID] = '@TARIF_ID@' AND [COMP_ID] = @COMP_ID@";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 3) {
            ...
            if ($current) {
                $this->COMP_ID->CurrentValue = $keys[2];
            } else {
                $this->COMP_ID->OldValue = $keys[2];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifCompList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TarifCompView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifCompEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifCompAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TarifCompView";
            case Config("API_ADD_ACTION"):
                return "TarifCompAdd";
            case Config("API_EDIT_ACTION"):
                return "TarifCompEdit";
            case Config("API_DELETE_ACTION"):
                return "TarifCompDelete";
            case Config("API_LIST_ACTION"):
                return "TarifCompList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifCompView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifCompView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifCompAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TarifCompAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TarifCompEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifCompAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifCompDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->COMP_ID->CurrentValue = $key[2];
            } else {
                $this->COMP_ID->OldValue = $key[2];
            }
