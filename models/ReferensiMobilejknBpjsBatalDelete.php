 ...
 * Page class
 */
class ReferensiMobilejknBpjsBatalDelete extends ReferensiMobilejknBpjsBatal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReferensiMobilejknBpjsBatalDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ReferensiMobilejknBpjsBatalList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ReferensiMobilejknBpjsBatalList"); // Return to list
                return;
            }
        }
