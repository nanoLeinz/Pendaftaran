 ...
 * Page class
 */
class ReferensiMobilejknBpjsBatalView extends ReferensiMobilejknBpjsBatal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReferensiMobilejknBpjsBatalView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("nobooking") ?? Route("nobooking")) !== null) {
            $this->RecKey["nobooking"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("nobooking") ?? Route("nobooking")) !== null) {
                ...
                $this->RecKey["nobooking"] = $this->nobooking->QueryStringValue;
            } elseif (Post("nobooking") !== null) {
                $this->nobooking->setFormValue(Post("nobooking"));
                $this->RecKey["nobooking"] = $this->nobooking->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->nobooking->setQueryStringValue($keyValue);
                $this->RecKey["nobooking"] = $this->nobooking->QueryStringValue;
            } else {
                $returnUrl = "ReferensiMobilejknBpjsBatalList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ReferensiMobilejknBpjsBatalList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ReferensiMobilejknBpjsBatalList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
