 ...
 * Page class
 */
class TreatmentObatView extends TreatmentObat
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentObatView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "TreatmentObatList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentObatList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentObatList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
