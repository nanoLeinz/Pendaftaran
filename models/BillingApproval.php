...
/**
 * Table class for BILLING_APPROVAL
 */
class BillingApproval extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'BILLING_APPROVAL';
        $this->TableName = 'BILLING_APPROVAL';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[BILLING_APPROVAL]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TRANS_ID
        $this->TRANS_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_TRANS_ID', 'TRANS_ID', '[TRANS_ID]', '[TRANS_ID]', 200, 50, -1, false, '[TRANS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMPANY_ID
        $this->COMPANY_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_COMPANY_ID', 'COMPANY_ID', '[COMPANY_ID]', '[COMPANY_ID]', 200, 50, -1, false, '[COMPANY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMPANY
        $this->COMPANY = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_COMPANY', 'COMPANY', '[COMPANY]', '[COMPANY]', 200, 100, -1, false, '[COMPANY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REF_TYPE
        $this->REF_TYPE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_REF_TYPE', 'REF_TYPE', '[REF_TYPE]', 'CAST([REF_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[REF_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_TRANS
        $this->VISIT_TRANS = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_VISIT_TRANS', 'VISIT_TRANS', '[VISIT_TRANS]', '[VISIT_TRANS]', 200, 50, -1, false, '[VISIT_TRANS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_NOTA_NO', 'NOTA_NO', '[NOTA_NO]', '[NOTA_NO]', 200, 50, -1, false, '[NOTA_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 100, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEAGE
        $this->THEAGE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_THEAGE', 'THEAGE', '[THEAGE]', '[THEAGE]', 200, 100, -1, false, '[THEAGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_PAYOR_ID', 'PAYOR_ID', '[PAYOR_ID]', '[PAYOR_ID]', 200, 50, -1, false, '[PAYOR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_TREATMENT', 'TREATMENT', '[TREATMENT]', '[TREATMENT]', 200, 100, -1, false, '[TREATMENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAGIHAN
        $this->TAGIHAN = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_TAGIHAN', 'TAGIHAN', '[TAGIHAN]', 'CAST([TAGIHAN] AS NVARCHAR)', 6, 8, -1, false, '[TAGIHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISKON
        $this->DISKON = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_DISKON', 'DISKON', '[DISKON]', 'CAST([DISKON] AS NVARCHAR)', 6, 8, -1, false, '[DISKON]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PAID
        $this->AMOUNT_PAID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_AMOUNT_PAID', 'AMOUNT_PAID', '[AMOUNT_PAID]', 'CAST([AMOUNT_PAID] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BAYAR
        $this->BAYAR = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_BAYAR', 'BAYAR', '[BAYAR]', 'CAST([BAYAR] AS NVARCHAR)', 6, 8, -1, false, '[BAYAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RETUR
        $this->RETUR = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_RETUR', 'RETUR', '[RETUR]', 'CAST([RETUR] AS NVARCHAR)', 6, 8, -1, false, '[RETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FEE
        $this->FEE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_FEE', 'FEE', '[FEE]', 'CAST([FEE] AS NVARCHAR)', 6, 8, -1, false, '[FEE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 3, 4, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACTIVITY_ID
        $this->ACTIVITY_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_ACTIVITY_ID', 'ACTIVITY_ID', '[ACTIVITY_ID]', 'CAST([ACTIVITY_ID] AS NVARCHAR)', 2, 2, -1, false, '[ACTIVITY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MONTH_ID
        $this->MONTH_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_MONTH_ID', 'MONTH_ID', '[MONTH_ID]', 'CAST([MONTH_ID] AS NVARCHAR)', 17, 1, -1, false, '[MONTH_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_TREAT_DATE', 'TREAT_DATE', '[TREAT_DATE]', CastDateFieldForLike("[TREAT_DATE]", 0, "DB"), 135, 8, 0, false, '[TREAT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FA_V_DEBIT
        $this->FA_V_DEBIT = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_FA_V_DEBIT', 'FA_V_DEBIT', '[FA_V_DEBIT]', '[FA_V_DEBIT]', 200, 50, -1, false, '[FA_V_DEBIT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FA_V_CREDIT
        $this->FA_V_CREDIT = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_FA_V_CREDIT', 'FA_V_CREDIT', '[FA_V_CREDIT]', '[FA_V_CREDIT]', 200, 50, -1, false, '[FA_V_CREDIT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // APPROVED_DATE
        $this->APPROVED_DATE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_APPROVED_DATE', 'APPROVED_DATE', '[APPROVED_DATE]', CastDateFieldForLike("[APPROVED_DATE]", 0, "DB"), 135, 8, 0, false, '[APPROVED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPP_ID
        $this->SPP_ID = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_SPP_ID', 'SPP_ID', '[SPP_ID]', '[SPP_ID]', 200, 50, -1, false, '[SPP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPP_NO
        $this->SPP_NO = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_SPP_NO', 'SPP_NO', '[SPP_NO]', '[SPP_NO]', 200, 50, -1, false, '[SPP_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPP_DATE
        $this->SPP_DATE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_SPP_DATE', 'SPP_DATE', '[SPP_DATE]', CastDateFieldForLike("[SPP_DATE]", 0, "DB"), 135, 8, 0, false, '[SPP_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPP_TYPE
        $this->SPP_TYPE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_SPP_TYPE', 'SPP_TYPE', '[SPP_TYPE]', 'CAST([SPP_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[SPP_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INVOICE_NO
        $this->INVOICE_NO = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_INVOICE_NO', 'INVOICE_NO', '[INVOICE_NO]', '[INVOICE_NO]', 200, 50, -1, false, '[INVOICE_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIER
        $this->CASHIER = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_CASHIER', 'CASHIER', '[CASHIER]', '[CASHIER]', 200, 50, -1, false, '[CASHIER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('BILLING_APPROVAL', 'BILLING_APPROVAL', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[BILLING_APPROVAL]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BillingApprovalList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BillingApprovalView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BillingApprovalEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BillingApprovalAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BillingApprovalView";
            case Config("API_ADD_ACTION"):
                return "BillingApprovalAdd";
            case Config("API_EDIT_ACTION"):
                return "BillingApprovalEdit";
            case Config("API_DELETE_ACTION"):
                return "BillingApprovalDelete";
            case Config("API_LIST_ACTION"):
                return "BillingApprovalList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BillingApprovalView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BillingApprovalView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BillingApprovalAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BillingApprovalAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BillingApprovalEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BillingApprovalAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BillingApprovalDelete", $this->getUrlParm());
    }
