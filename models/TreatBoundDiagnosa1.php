...
/**
 * Table class for TREAT_BOUND_DIAGNOSA1
 */
class TreatBoundDiagnosa1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREAT_BOUND_DIAGNOSA1';
        $this->TableName = 'TREAT_BOUND_DIAGNOSA1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREAT_BOUND_DIAGNOSA1]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 203, 0, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // BOUND_ID
        $this->BOUND_ID = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_BOUND_ID', 'BOUND_ID', '[BOUND_ID]', '[BOUND_ID]', 203, 0, -1, false, '[BOUND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // REAGENT_ID
        $this->REAGENT_ID = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_REAGENT_ID', 'REAGENT_ID', '[REAGENT_ID]', '[REAGENT_ID]', 203, 0, -1, false, '[REAGENT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // BOUND
        $this->BOUND = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_BOUND', 'BOUND', '[BOUND]', '[BOUND]', 203, 0, -1, false, '[BOUND]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 203, 0, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // DIAGNOSA
        $this->DIAGNOSA = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_DIAGNOSA', 'DIAGNOSA', '[DIAGNOSA]', '[DIAGNOSA]', 203, 0, -1, false, '[DIAGNOSA]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // ISNORMAL
        $this->ISNORMAL = new DbField('TREAT_BOUND_DIAGNOSA1', 'TREAT_BOUND_DIAGNOSA1', 'x_ISNORMAL', 'ISNORMAL', '[ISNORMAL]', '[ISNORMAL]', 202, 255, -1, false, '[ISNORMAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREAT_BOUND_DIAGNOSA1]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatBoundDiagnosa1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "TreatBoundDiagnosa1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "TreatBoundDiagnosa1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatBoundDiagnosa1Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatBoundDiagnosa1View";
            case Config("API_ADD_ACTION"):
                return "TreatBoundDiagnosa1Add";
            case Config("API_EDIT_ACTION"):
                return "TreatBoundDiagnosa1Edit";
            case Config("API_DELETE_ACTION"):
                return "TreatBoundDiagnosa1Delete";
            case Config("API_LIST_ACTION"):
                return "TreatBoundDiagnosa1List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatBoundDiagnosa1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatBoundDiagnosa1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatBoundDiagnosa1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatBoundDiagnosa1Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatBoundDiagnosa1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatBoundDiagnosa1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatBoundDiagnosa1Delete", $this->getUrlParm());
    }
