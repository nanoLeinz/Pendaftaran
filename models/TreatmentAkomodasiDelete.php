 ...
 * Page class
 */
class TreatmentAkomodasiDelete extends TreatmentAkomodasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentAkomodasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("TreatmentAkomodasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("TreatmentAkomodasiList"); // Return to list
                return;
            }
        }
