...
/**
 * Table class for YEARS
 */
class Years extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('YEARS', 'YEARS', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // START_DATE
        $this->START_DATE = new DbField('YEARS', 'YEARS', 'x_START_DATE', 'START_DATE', '[START_DATE]', CastDateFieldForLike("[START_DATE]", 0, "DB"), 135, 8, 0, false, '[START_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // END_DATE
        $this->END_DATE = new DbField('YEARS', 'YEARS', 'x_END_DATE', 'END_DATE', '[END_DATE]', CastDateFieldForLike("[END_DATE]", 0, "DB"), 135, 8, 0, false, '[END_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[YEARS]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("YearsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "YearsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "YearsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "YearsAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("YearsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("YearsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "YearsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "YearsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("YearsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("YearsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("YearsDelete", $this->getUrlParm());
    }
