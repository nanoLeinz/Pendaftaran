 ...
 * Page class
 */
class PasienVisitationView extends PasienVisitation
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PasienVisitationView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("IDXDAFTAR") ?? Route("IDXDAFTAR")) !== null) {
                ...
                $returnUrl = "PasienVisitationList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "PasienVisitationList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "PasienVisitationList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
