...
/**
 * Table class for INASIS_GET_REFKAMAR
 */
class InasisGetRefkamar extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'INASIS_GET_REFKAMAR';
        $this->TableName = 'INASIS_GET_REFKAMAR';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[INASIS_GET_REFKAMAR]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // KODEKELAS
        $this->KODEKELAS = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_KODEKELAS', 'KODEKELAS', '[KODEKELAS]', '[KODEKELAS]', 200, 8, -1, false, '[KODEKELAS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMAKELAS
        $this->NAMAKELAS = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_NAMAKELAS', 'NAMAKELAS', '[NAMAKELAS]', '[NAMAKELAS]', 200, 50, -1, false, '[NAMAKELAS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_CODE
        $this->REST_CODE = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_REST_CODE', 'REST_CODE', '[REST_CODE]', '[REST_CODE]', 129, 3, -1, false, '[REST_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_MESSAGE
        $this->REST_MESSAGE = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_REST_MESSAGE', 'REST_MESSAGE', '[REST_MESSAGE]', '[REST_MESSAGE]', 201, 0, -1, false, '[REST_MESSAGE]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // REST_DATE
        $this->REST_DATE = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_REST_DATE', 'REST_DATE', '[REST_DATE]', CastDateFieldForLike("[REST_DATE]", 0, "DB"), 135, 8, 0, false, '[REST_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_METHOD
        $this->REST_METHOD = new DbField('INASIS_GET_REFKAMAR', 'INASIS_GET_REFKAMAR', 'x_REST_METHOD', 'REST_METHOD', '[REST_METHOD]', '[REST_METHOD]', 200, 10, -1, false, '[REST_METHOD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[INASIS_GET_REFKAMAR]";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->KODEKELAS->CurrentValue = $keys[0];
            } else {
                $this->KODEKELAS->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("InasisGetRefkamarList");
    }
    ...
    {
        global $Language;
        if ($pageName == "InasisGetRefkamarView") {
            return $Language->phrase("View");
        } elseif ($pageName == "InasisGetRefkamarEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "InasisGetRefkamarAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "InasisGetRefkamarView";
            case Config("API_ADD_ACTION"):
                return "InasisGetRefkamarAdd";
            case Config("API_EDIT_ACTION"):
                return "InasisGetRefkamarEdit";
            case Config("API_DELETE_ACTION"):
                return "InasisGetRefkamarDelete";
            case Config("API_LIST_ACTION"):
                return "InasisGetRefkamarList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("InasisGetRefkamarView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("InasisGetRefkamarView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "InasisGetRefkamarAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "InasisGetRefkamarAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetRefkamarEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetRefkamarAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("InasisGetRefkamarDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->KODEKELAS->CurrentValue = $key;
            } else {
                $this->KODEKELAS->OldValue = $key;
            }
