...
/**
 * Table class for HEALTH_CENTER_AREA
 */
class HealthCenterArea extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'HEALTH_CENTER_AREA';
        $this->TableName = 'HEALTH_CENTER_AREA';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[HEALTH_CENTER_AREA]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('HEALTH_CENTER_AREA', 'HEALTH_CENTER_AREA', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('HEALTH_CENTER_AREA', 'HEALTH_CENTER_AREA', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 8, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[HEALTH_CENTER_AREA]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [KAL_ID] = '@KAL_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("HealthCenterAreaList");
    }
    ...
    {
        global $Language;
        if ($pageName == "HealthCenterAreaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "HealthCenterAreaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "HealthCenterAreaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "HealthCenterAreaView";
            case Config("API_ADD_ACTION"):
                return "HealthCenterAreaAdd";
            case Config("API_EDIT_ACTION"):
                return "HealthCenterAreaEdit";
            case Config("API_DELETE_ACTION"):
                return "HealthCenterAreaDelete";
            case Config("API_LIST_ACTION"):
                return "HealthCenterAreaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("HealthCenterAreaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("HealthCenterAreaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "HealthCenterAreaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "HealthCenterAreaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthCenterAreaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("HealthCenterAreaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("HealthCenterAreaDelete", $this->getUrlParm());
    }
