...
/**
 * Table class for AKSES_OPERATOR
 */
class AksesOperator extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'AKSES_OPERATOR';
        $this->TableName = 'AKSES_OPERATOR';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[AKSES_OPERATOR]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // USERNAME
        $this->_USERNAME = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x__USERNAME', 'USERNAME', '[USERNAME]', '[USERNAME]', 200, 16, -1, false, '[USERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('AKSES_OPERATOR', 'AKSES_OPERATOR', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[AKSES_OPERATOR]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AksesOperatorList");
    }
    ...
    {
        global $Language;
        if ($pageName == "AksesOperatorView") {
            return $Language->phrase("View");
        } elseif ($pageName == "AksesOperatorEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AksesOperatorAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AksesOperatorView";
            case Config("API_ADD_ACTION"):
                return "AksesOperatorAdd";
            case Config("API_EDIT_ACTION"):
                return "AksesOperatorEdit";
            case Config("API_DELETE_ACTION"):
                return "AksesOperatorDelete";
            case Config("API_LIST_ACTION"):
                return "AksesOperatorList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AksesOperatorView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AksesOperatorView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AksesOperatorAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AksesOperatorAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AksesOperatorEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AksesOperatorAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AksesOperatorDelete", $this->getUrlParm());
    }
