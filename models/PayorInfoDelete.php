 ...
 * Page class
 */
class PayorInfoDelete extends PayorInfo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PayorInfoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PayorInfoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PayorInfoList"); // Return to list
                return;
            }
        }
