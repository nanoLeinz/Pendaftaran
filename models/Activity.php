...
class Activity extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('ACTIVITY', 'ACTIVITY', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACTIVITY_ID
        $this->ACTIVITY_ID = new DbField('ACTIVITY', 'ACTIVITY', 'x_ACTIVITY_ID', 'ACTIVITY_ID', '[ACTIVITY_ID]', 'CAST([ACTIVITY_ID] AS NVARCHAR)', 2, 2, -1, false, '[ACTIVITY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACTIVITY
        $this->ACTIVITY = new DbField('ACTIVITY', 'ACTIVITY', 'x_ACTIVITY', 'ACTIVITY', '[ACTIVITY]', '[ACTIVITY]', 200, 75, -1, false, '[ACTIVITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ACTIVITY->Sortable = true; // Allow sort
        $this->ACTIVITY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ACTIVITY->Param, "CustomMsg");
        $this->Fields['ACTIVITY'] = &$this->ACTIVITY;

        // BUDGET_TYPE
        $this->BUDGET_TYPE = new DbField('ACTIVITY', 'ACTIVITY', 'x_BUDGET_TYPE', 'BUDGET_TYPE', '[BUDGET_TYPE]', 'CAST([BUDGET_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[BUDGET_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACTIVITY_TYPE
        $this->ACTIVITY_TYPE = new DbField('ACTIVITY', 'ACTIVITY', 'x_ACTIVITY_TYPE', 'ACTIVITY_TYPE', '[ACTIVITY_TYPE]', 'CAST([ACTIVITY_TYPE] AS NVARCHAR)', 2, 2, -1, false, '[ACTIVITY_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEORDER
        $this->THEORDER = new DbField('ACTIVITY', 'ACTIVITY', 'x_THEORDER', 'THEORDER', '[THEORDER]', 'CAST([THEORDER] AS NVARCHAR)', 3, 4, -1, false, '[THEORDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[ACTIVITY]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [ACTIVITY_ID] = @ACTIVITY_ID@";
    }
