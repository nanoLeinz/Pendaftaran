...
/**
 * Table class for DIAGNOSA_TREAT
 */
class DiagnosaTreat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'DIAGNOSA_TREAT';
        $this->TableName = 'DIAGNOSA_TREAT';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[DIAGNOSA_TREAT]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('DIAGNOSA_TREAT', 'DIAGNOSA_TREAT', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('DIAGNOSA_TREAT', 'DIAGNOSA_TREAT', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 50, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('DIAGNOSA_TREAT', 'DIAGNOSA_TREAT', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('DIAGNOSA_TREAT', 'DIAGNOSA_TREAT', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 100, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[DIAGNOSA_TREAT]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [DIAGNOSA_ID] = '@DIAGNOSA_ID@' AND [TARIF_ID] = '@TARIF_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DiagnosaTreatList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DiagnosaTreatView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DiagnosaTreatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DiagnosaTreatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DiagnosaTreatView";
            case Config("API_ADD_ACTION"):
                return "DiagnosaTreatAdd";
            case Config("API_EDIT_ACTION"):
                return "DiagnosaTreatEdit";
            case Config("API_DELETE_ACTION"):
                return "DiagnosaTreatDelete";
            case Config("API_LIST_ACTION"):
                return "DiagnosaTreatList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DiagnosaTreatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DiagnosaTreatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DiagnosaTreatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DiagnosaTreatAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DiagnosaTreatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DiagnosaTreatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DiagnosaTreatDelete", $this->getUrlParm());
    }
