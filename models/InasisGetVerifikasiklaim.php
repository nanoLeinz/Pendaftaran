...
/**
 * Table class for INASIS_GET_VERIFIKASIKLAIM
 */
class InasisGetVerifikasiklaim extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'INASIS_GET_VERIFIKASIKLAIM';
        $this->TableName = 'INASIS_GET_VERIFIKASIKLAIM';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[INASIS_GET_VERIFIKASIKLAIM]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // NOKARTU
        $this->NOKARTU = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NOKARTU', 'NOKARTU', '[NOKARTU]', '[NOKARTU]', 200, 50, -1, false, '[NOKARTU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOSEP
        $this->NOSEP = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NOSEP', 'NOSEP', '[NOSEP]', '[NOSEP]', 200, 50, -1, false, '[NOSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDINACBG
        $this->KDINACBG = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_KDINACBG', 'KDINACBG', '[KDINACBG]', '[KDINACBG]', 200, 25, -1, false, '[KDINACBG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDSEVERITY
        $this->KDSEVERITY = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_KDSEVERITY', 'KDSEVERITY', '[KDSEVERITY]', '[KDSEVERITY]', 200, 50, -1, false, '[KDSEVERITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NMINACBG
        $this->NMINACBG = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NMINACBG', 'NMINACBG', '[NMINACBG]', '[NMINACBG]', 200, 250, -1, false, '[NMINACBG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BYTAGIHAN
        $this->BYTAGIHAN = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_BYTAGIHAN', 'BYTAGIHAN', '[BYTAGIHAN]', '[BYTAGIHAN]', 200, 50, -1, false, '[BYTAGIHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BYTARIFGRUPER
        $this->BYTARIFGRUPER = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_BYTARIFGRUPER', 'BYTARIFGRUPER', '[BYTARIFGRUPER]', '[BYTARIFGRUPER]', 200, 50, -1, false, '[BYTARIFGRUPER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BYTARIFRS
        $this->BYTARIFRS = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_BYTARIFRS', 'BYTARIFRS', '[BYTARIFRS]', '[BYTARIFRS]', 200, 50, -1, false, '[BYTARIFRS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BYTOPUP
        $this->BYTOPUP = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_BYTOPUP', 'BYTOPUP', '[BYTOPUP]', '[BYTOPUP]', 200, 50, -1, false, '[BYTOPUP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // JNSPELAYANAN
        $this->JNSPELAYANAN = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_JNSPELAYANAN', 'JNSPELAYANAN', '[JNSPELAYANAN]', '[JNSPELAYANAN]', 200, 10, -1, false, '[JNSPELAYANAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->JNSPELAYANAN->IsPrimaryKey = true; // Primary key field
        ...
        // NOMR
        $this->NOMR = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NOMR', 'NOMR', '[NOMR]', '[NOMR]', 200, 50, -1, false, '[NOMR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NOMR->IsPrimaryKey = true; // Primary key field
        $this->NOMR->Nullable = false; // NOT NULL field
        $this->NOMR->Required = true; // Required field
        ...
        // NAMA
        $this->NAMA = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NAMA', 'NAMA', '[NAMA]', '[NAMA]', 200, 250, -1, false, '[NAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = true; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // KDSTATSEP
        $this->KDSTATSEP = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_KDSTATSEP', 'KDSTATSEP', '[KDSTATSEP]', '[KDSTATSEP]', 200, 10, -1, false, '[KDSTATSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NMSTATSEP
        $this->NMSTATSEP = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NMSTATSEP', 'NMSTATSEP', '[NMSTATSEP]', '[NMSTATSEP]', 200, 250, -1, false, '[NMSTATSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TGLPULANG
        $this->TGLPULANG = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_TGLPULANG', 'TGLPULANG', '[TGLPULANG]', CastDateFieldForLike("[TGLPULANG]", 0, "DB"), 135, 8, 0, false, '[TGLPULANG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TGLPULANG->Nullable = false; // NOT NULL field
        $this->TGLPULANG->Required = true; // Required field
        ...
        // TGLSEP
        $this->TGLSEP = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_TGLSEP', 'TGLSEP', '[TGLSEP]', CastDateFieldForLike("[TGLSEP]", 0, "DB"), 135, 8, 0, false, '[TGLSEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_CODE
        $this->REST_CODE = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_REST_CODE', 'REST_CODE', '[REST_CODE]', '[REST_CODE]', 129, 3, -1, false, '[REST_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_MESSAGE
        $this->REST_MESSAGE = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_REST_MESSAGE', 'REST_MESSAGE', '[REST_MESSAGE]', '[REST_MESSAGE]', 200, 150, -1, false, '[REST_MESSAGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_DATE
        $this->REST_DATE = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_REST_DATE', 'REST_DATE', '[REST_DATE]', CastDateFieldForLike("[REST_DATE]", 0, "DB"), 135, 8, 0, false, '[REST_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_METHOD
        $this->REST_METHOD = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_REST_METHOD', 'REST_METHOD', '[REST_METHOD]', '[REST_METHOD]', 200, 10, -1, false, '[REST_METHOD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELASRAWAT
        $this->KELASRAWAT = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_KELASRAWAT', 'KELASRAWAT', '[KELASRAWAT]', '[KELASRAWAT]', 200, 6, -1, false, '[KELASRAWAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOFPK
        $this->NOFPK = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NOFPK', 'NOFPK', '[NOFPK]', '[NOFPK]', 200, 25, -1, false, '[NOFPK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NOFPK->Sortable = true; // Allow sort
        $this->NOFPK->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NOFPK->Param, "CustomMsg");
        $this->Fields['NOFPK'] = &$this->NOFPK;

        // NMPOLI
        $this->NMPOLI = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_NMPOLI', 'NMPOLI', '[NMPOLI]', '[NMPOLI]', 200, 100, -1, false, '[NMPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUSKLAIM
        $this->STATUSKLAIM = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_STATUSKLAIM', 'STATUSKLAIM', '[STATUSKLAIM]', '[STATUSKLAIM]', 200, 250, -1, false, '[STATUSKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->STATUSKLAIM->Sortable = true; // Allow sort
        $this->STATUSKLAIM->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->STATUSKLAIM->Param, "CustomMsg");
        $this->Fields['STATUSKLAIM'] = &$this->STATUSKLAIM;

        // RESPON
        $this->RESPON = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_RESPON', 'RESPON', '[RESPON]', '[RESPON]', 201, 0, -1, false, '[RESPON]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // BYSETUJUI
        $this->BYSETUJUI = new DbField('INASIS_GET_VERIFIKASIKLAIM', 'INASIS_GET_VERIFIKASIKLAIM', 'x_BYSETUJUI', 'BYSETUJUI', '[BYSETUJUI]', '[BYSETUJUI]', 200, 50, -1, false, '[BYSETUJUI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BYSETUJUI->Sortable = true; // Allow sort
        $this->BYSETUJUI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BYSETUJUI->Param, "CustomMsg");
        $this->Fields['BYSETUJUI'] = &$this->BYSETUJUI;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[INASIS_GET_VERIFIKASIKLAIM]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('JNSPELAYANAN', $rs)) {
                AddFilter($where, QuotedName('JNSPELAYANAN', $this->Dbid) . '=' . QuotedValue($rs['JNSPELAYANAN'], $this->JNSPELAYANAN->DataType, $this->Dbid));
            }
            if (array_key_exists('NOMR', $rs)) {
                AddFilter($where, QuotedName('NOMR', $this->Dbid) . '=' . QuotedValue($rs['NOMR'], $this->NOMR->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->NOFPK->DbValue = $row['NOFPK'];
        $this->NMPOLI->DbValue = $row['NMPOLI'];
        $this->STATUSKLAIM->DbValue = $row['STATUSKLAIM'];
        $this->RESPON->DbValue = $row['RESPON'];
        $this->BYSETUJUI->DbValue = $row['BYSETUJUI'];
    }
    ...
    {
        return "[NOKARTU] = '@NOKARTU@' AND [NOSEP] = '@NOSEP@' AND [JNSPELAYANAN] = '@JNSPELAYANAN@' AND [NOMR] = '@NOMR@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->JNSPELAYANAN->CurrentValue : $this->JNSPELAYANAN->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
        }
        $val = $current ? $this->NOMR->CurrentValue : $this->NOMR->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 4) {
            ...
            if ($current) {
                $this->JNSPELAYANAN->CurrentValue = $keys[2];
            } else {
                $this->JNSPELAYANAN->OldValue = $keys[2];
            }
            if ($current) {
                $this->NOMR->CurrentValue = $keys[3];
            } else {
                $this->NOMR->OldValue = $keys[3];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('JNSPELAYANAN', $row) ? $row['JNSPELAYANAN'] : null;
        } else {
            $val = $this->JNSPELAYANAN->OldValue !== null ? $this->JNSPELAYANAN->OldValue : $this->JNSPELAYANAN->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@JNSPELAYANAN@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        if (is_array($row)) {
            $val = array_key_exists('NOMR', $row) ? $row['NOMR'] : null;
        } else {
            $val = $this->NOMR->OldValue !== null ? $this->NOMR->OldValue : $this->NOMR->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@NOMR@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("InasisGetVerifikasiklaimList");
    }
    ...
    {
        global $Language;
        if ($pageName == "InasisGetVerifikasiklaimView") {
            return $Language->phrase("View");
        } elseif ($pageName == "InasisGetVerifikasiklaimEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "InasisGetVerifikasiklaimAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "InasisGetVerifikasiklaimView";
            case Config("API_ADD_ACTION"):
                return "InasisGetVerifikasiklaimAdd";
            case Config("API_EDIT_ACTION"):
                return "InasisGetVerifikasiklaimEdit";
            case Config("API_DELETE_ACTION"):
                return "InasisGetVerifikasiklaimDelete";
            case Config("API_LIST_ACTION"):
                return "InasisGetVerifikasiklaimList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("InasisGetVerifikasiklaimView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("InasisGetVerifikasiklaimView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "InasisGetVerifikasiklaimAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "InasisGetVerifikasiklaimAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetVerifikasiklaimEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetVerifikasiklaimAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("InasisGetVerifikasiklaimDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",JNSPELAYANAN:" . JsonEncode($this->JNSPELAYANAN->CurrentValue, "string");
        $json .= ",NOMR:" . JsonEncode($this->NOMR->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->JNSPELAYANAN->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->JNSPELAYANAN->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($this->NOMR->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->NOMR->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("JNSPELAYANAN") ?? Route("JNSPELAYANAN")) !== null) {
                $arKey[] = $keyValue;
            ...
            if (($keyValue = Param("NOMR") ?? Route("NOMR")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->JNSPELAYANAN->CurrentValue = $key[2];
            } else {
                $this->JNSPELAYANAN->OldValue = $key[2];
            }
            if ($setCurrent) {
                $this->NOMR->CurrentValue = $key[3];
            } else {
                $this->NOMR->OldValue = $key[3];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->NOFPK->setDbValue($row['NOFPK']);
        $this->NMPOLI->setDbValue($row['NMPOLI']);
        $this->STATUSKLAIM->setDbValue($row['STATUSKLAIM']);
        $this->RESPON->setDbValue($row['RESPON']);
        $this->BYSETUJUI->setDbValue($row['BYSETUJUI']);
    }
    ...
    public function renderListRow()
    {
        ...
        // NOFPK
        $this->NOFPK->ViewValue = $this->NOFPK->CurrentValue;
        $this->NOFPK->ViewCustomAttributes = "";
        ...
        // STATUSKLAIM
        $this->STATUSKLAIM->ViewValue = $this->STATUSKLAIM->CurrentValue;
        $this->STATUSKLAIM->ViewCustomAttributes = "";
        ...
        // BYSETUJUI
        $this->BYSETUJUI->ViewValue = $this->BYSETUJUI->CurrentValue;
        $this->BYSETUJUI->ViewCustomAttributes = "";
        ...
        // NOFPK
        $this->NOFPK->LinkCustomAttributes = "";
        $this->NOFPK->HrefValue = "";
        $this->NOFPK->TooltipValue = "";
        ...
        // STATUSKLAIM
        $this->STATUSKLAIM->LinkCustomAttributes = "";
        $this->STATUSKLAIM->HrefValue = "";
        $this->STATUSKLAIM->TooltipValue = "";
        ...
        // BYSETUJUI
        $this->BYSETUJUI->LinkCustomAttributes = "";
        $this->BYSETUJUI->HrefValue = "";
        $this->BYSETUJUI->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // NOFPK
        $this->NOFPK->EditAttrs["class"] = "form-control";
        $this->NOFPK->EditCustomAttributes = "";
        if (!$this->NOFPK->Raw) {
            $this->NOFPK->CurrentValue = HtmlDecode($this->NOFPK->CurrentValue);
        }
        $this->NOFPK->EditValue = $this->NOFPK->CurrentValue;
        $this->NOFPK->PlaceHolder = RemoveHtml($this->NOFPK->caption());
        ...
        // STATUSKLAIM
        $this->STATUSKLAIM->EditAttrs["class"] = "form-control";
        $this->STATUSKLAIM->EditCustomAttributes = "";
        if (!$this->STATUSKLAIM->Raw) {
            $this->STATUSKLAIM->CurrentValue = HtmlDecode($this->STATUSKLAIM->CurrentValue);
        }
        $this->STATUSKLAIM->EditValue = $this->STATUSKLAIM->CurrentValue;
        $this->STATUSKLAIM->PlaceHolder = RemoveHtml($this->STATUSKLAIM->caption());
        ...
        // BYSETUJUI
        $this->BYSETUJUI->EditAttrs["class"] = "form-control";
        $this->BYSETUJUI->EditCustomAttributes = "";
        if (!$this->BYSETUJUI->Raw) {
            $this->BYSETUJUI->CurrentValue = HtmlDecode($this->BYSETUJUI->CurrentValue);
        }
        $this->BYSETUJUI->EditValue = $this->BYSETUJUI->CurrentValue;
        $this->BYSETUJUI->PlaceHolder = RemoveHtml($this->BYSETUJUI->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->NOFPK);
                    $doc->exportCaption($this->NMPOLI);
                    $doc->exportCaption($this->STATUSKLAIM);
                    $doc->exportCaption($this->RESPON);
                    $doc->exportCaption($this->BYSETUJUI);
                } else {
                    $doc->exportCaption($this->NOKARTU);
                    $doc->exportCaption($this->NOSEP);
                    $doc->exportCaption($this->KDINACBG);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->NOFPK);
                        $doc->exportField($this->NMPOLI);
                        $doc->exportField($this->STATUSKLAIM);
                        $doc->exportField($this->RESPON);
                        $doc->exportField($this->BYSETUJUI);
                    } else {
                        $doc->exportField($this->NOKARTU);
                        $doc->exportField($this->NOSEP);
                        $doc->exportField($this->KDINACBG);
