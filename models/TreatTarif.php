...
/**
 * Table class for TREAT_TARIF
 */
class TreatTarif extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREAT_TARIF';
        $this->TableName = 'TREAT_TARIF';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREAT_TARIF]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // KODE
        $this->KODE = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_KODE', 'KODE', '[KODE]', '[KODE]', 200, 255, -1, false, '[KODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->KODE->Sortable = true; // Allow sort
        $this->KODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->KODE->Param, "CustomMsg");
        $this->Fields['KODE'] = &$this->KODE;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PERDA_ID
        $this->PERDA_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_PERDA_ID', 'PERDA_ID', '[PERDA_ID]', 'CAST([PERDA_ID] AS NVARCHAR)', 2, 2, -1, false, '[PERDA_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->PERDA_ID->Sortable = true; // Allow sort
        $this->PERDA_ID->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->PERDA_ID->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->PERDA_ID->Lookup = new Lookup('PERDA_ID', 'PERDA_TARIF', false, 'PERDA_ID', ["PERDA_NO","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->PERDA_ID->Lookup = new Lookup('PERDA_ID', 'PERDA_TARIF', false, 'PERDA_ID', ["PERDA_NO","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // TREAT_ID
        $this->TREAT_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_TREAT_ID', 'TREAT_ID', '[TREAT_ID]', '[TREAT_ID]', 200, 25, -1, false, '[TREAT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISPLAY_TARIF
        $this->DISPLAY_TARIF = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_DISPLAY_TARIF', 'DISPLAY_TARIF', '[DISPLAY_TARIF]', '[DISPLAY_TARIF]', 200, 50, -1, false, '[DISPLAY_TARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_NAME
        $this->TARIF_NAME = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_TARIF_NAME', 'TARIF_NAME', '[TARIF_NAME]', '[TARIF_NAME]', 200, 200, -1, false, '[TARIF_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // LEVEL_ID
        $this->LEVEL_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_LEVEL_ID', 'LEVEL_ID', '[LEVEL_ID]', 'CAST([LEVEL_ID] AS NVARCHAR)', 17, 1, -1, false, '[LEVEL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OTHER_ID
        $this->OTHER_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_OTHER_ID', 'OTHER_ID', '[OTHER_ID]', '[OTHER_ID]', 200, 50, -1, false, '[OTHER_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_TYPE
        $this->TARIF_TYPE = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_TARIF_TYPE', 'TARIF_TYPE', '[TARIF_TYPE]', '[TARIF_TYPE]', 200, 25, -1, false, '[TARIF_TYPE]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->TARIF_TYPE->Sortable = true; // Allow sort
        $this->TARIF_TYPE->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->TARIF_TYPE->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->TARIF_TYPE->Lookup = new Lookup('TARIF_TYPE', 'TARIF_TYPE', false, 'TARIF_TYPE', ["TARIF_TYPE_NAME","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->TARIF_TYPE->Lookup = new Lookup('TARIF_TYPE', 'TARIF_TYPE', false, 'TARIF_TYPE', ["TARIF_TYPE_NAME","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // IMPLEMENTED
        $this->IMPLEMENTED = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_IMPLEMENTED', 'IMPLEMENTED', '[IMPLEMENTED]', '[IMPLEMENTED]', 129, 1, -1, false, '[IMPLEMENTED]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        $this->IMPLEMENTED->Sortable = true; // Allow sort
        $this->IMPLEMENTED->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->IMPLEMENTED->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        switch ($CurrentLanguage) {
            case "en":
                $this->IMPLEMENTED->Lookup = new Lookup('IMPLEMENTED', 'TREAT_TARIF', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->IMPLEMENTED->Lookup = new Lookup('IMPLEMENTED', 'TREAT_TARIF', false, '', ["","","",""], [], [], [], [], [], [], '', '');
                break;
        }
        $this->IMPLEMENTED->OptionCount = 2;
        ...
        // ACTIVITY_ID
        $this->ACTIVITY_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_ACTIVITY_ID', 'ACTIVITY_ID', '[ACTIVITY_ID]', 'CAST([ACTIVITY_ID] AS NVARCHAR)', 17, 1, -1, false, '[ACTIVITY_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        switch ($CurrentLanguage) {
            case "en":
                $this->ACTIVITY_ID->Lookup = new Lookup('ACTIVITY_ID', 'ACTIVITY', false, 'ACTIVITY_ID', ["ACTIVITY","","",""], [], [], [], [], [], [], '', '');
                break;
            default:
                $this->ACTIVITY_ID->Lookup = new Lookup('ACTIVITY_ID', 'ACTIVITY', false, 'ACTIVITY_ID', ["ACTIVITY","","",""], [], [], [], [], [], [], '', '');
                break;
        ...
        // FA_V
        $this->FA_V = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_FA_V', 'FA_V', '[FA_V]', 'CAST([FA_V] AS NVARCHAR)', 2, 2, -1, false, '[FA_V]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCITO
        $this->ISCITO = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_ISCITO', 'ISCITO', '[ISCITO]', '[ISCITO]', 129, 1, -1, false, '[ISCITO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ISCITO->Sortable = true; // Allow sort
        $this->ISCITO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ISCITO->Param, "CustomMsg");
        $this->ISCITO->AdvancedSearch->SearchValueDefault = "0";
        $this->ISCITO->AdvancedSearch->SearchOperatorDefault = "LIKE";
        $this->ISCITO->AdvancedSearch->SearchOperatorDefault2 = "";
        $this->ISCITO->AdvancedSearch->SearchConditionDefault = "AND";
        $this->Fields['ISCITO'] = &$this->ISCITO;

        // AMOUNT_PAID
        $this->AMOUNT_PAID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_AMOUNT_PAID', 'AMOUNT_PAID', '[AMOUNT_PAID]', 'CAST([AMOUNT_PAID] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASEMIX_ID
        $this->CASEMIX_ID = new DbField('TREAT_TARIF', 'TREAT_TARIF', 'x_CASEMIX_ID', 'CASEMIX_ID', '[CASEMIX_ID]', 'CAST([CASEMIX_ID] AS NVARCHAR)', 17, 1, -1, false, '[CASEMIX_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREAT_TARIF]";
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "[IMPLEMENTED] = 1";
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [TARIF_ID] = '@TARIF_ID@'";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->TARIF_ID->CurrentValue = $keys[1];
            } else {
                $this->TARIF_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatTarifList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "TreatTarifEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatTarifAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatTarifView";
            case Config("API_ADD_ACTION"):
                return "TreatTarifAdd";
            case Config("API_EDIT_ACTION"):
                return "TreatTarifEdit";
            case Config("API_DELETE_ACTION"):
                return "TreatTarifDelete";
            case Config("API_LIST_ACTION"):
                return "TreatTarifList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatTarifView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatTarifView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatTarifAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatTarifAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TreatTarifEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatTarifAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatTarifDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->TARIF_ID->CurrentValue = $key[1];
            } else {
                $this->TARIF_ID->OldValue = $key[1];
            }
