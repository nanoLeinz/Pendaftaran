...
/**
 * Table class for USER_MENU1
 */
class UserMenu1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'USER_MENU1';
        $this->TableName = 'USER_MENU1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[USER_MENU1]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('USER_MENU1', 'USER_MENU1', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // GROUP_ID
        $this->GROUP_ID = new DbField('USER_MENU1', 'USER_MENU1', 'x_GROUP_ID', 'GROUP_ID', '[GROUP_ID]', 'CAST([GROUP_ID] AS NVARCHAR)', 2, 2, -1, false, '[GROUP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MENU_ID
        $this->MENU_ID = new DbField('USER_MENU1', 'USER_MENU1', 'x_MENU_ID', 'MENU_ID', '[MENU_ID]', '[MENU_ID]', 200, 50, -1, false, '[MENU_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STYPE_ID
        $this->STYPE_ID = new DbField('USER_MENU1', 'USER_MENU1', 'x_STYPE_ID', 'STYPE_ID', '[STYPE_ID]', 'CAST([STYPE_ID] AS NVARCHAR)', 2, 2, -1, false, '[STYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[USER_MENU1]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserMenu1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "UserMenu1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "UserMenu1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UserMenu1Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "UserMenu1View";
            case Config("API_ADD_ACTION"):
                return "UserMenu1Add";
            case Config("API_EDIT_ACTION"):
                return "UserMenu1Edit";
            case Config("API_DELETE_ACTION"):
                return "UserMenu1Delete";
            case Config("API_LIST_ACTION"):
                return "UserMenu1List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserMenu1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UserMenu1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UserMenu1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "UserMenu1Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UserMenu1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserMenu1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UserMenu1Delete", $this->getUrlParm());
    }
