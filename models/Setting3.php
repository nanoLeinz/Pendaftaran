...
/**
 * Table class for SETTING3
 */
class Setting3 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'SETTING3';
        $this->TableName = 'SETTING3';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[SETTING3]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // pop3
        $this->pop3 = new DbField('SETTING3', 'SETTING3', 'x_pop3', 'pop3', '[pop3]', '[pop3]', 200, 200, -1, false, '[pop3]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // smtp
        $this->smtp = new DbField('SETTING3', 'SETTING3', 'x_smtp', 'smtp', '[smtp]', '[smtp]', 200, 200, -1, false, '[smtp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email_usr
        $this->email_usr = new DbField('SETTING3', 'SETTING3', 'x_email_usr', 'email_usr', '[email_usr]', '[email_usr]', 200, 50, -1, false, '[email_usr]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // email_psw
        $this->email_psw = new DbField('SETTING3', 'SETTING3', 'x_email_psw', 'email_psw', '[email_psw]', '[email_psw]', 200, 50, -1, false, '[email_psw]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // website
        $this->website = new DbField('SETTING3', 'SETTING3', 'x_website', 'website', '[website]', '[website]', 200, 500, -1, false, '[website]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // odbc_portal
        $this->odbc_portal = new DbField('SETTING3', 'SETTING3', 'x_odbc_portal', 'odbc_portal', '[odbc_portal]', '[odbc_portal]', 200, 50, -1, false, '[odbc_portal]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // odbc_eservice
        $this->odbc_eservice = new DbField('SETTING3', 'SETTING3', 'x_odbc_eservice', 'odbc_eservice', '[odbc_eservice]', '[odbc_eservice]', 200, 255, -1, false, '[odbc_eservice]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // direktori
        $this->direktori = new DbField('SETTING3', 'SETTING3', 'x_direktori', 'direktori', '[direktori]', '[direktori]', 200, 255, -1, false, '[direktori]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_news
        $this->dir_news = new DbField('SETTING3', 'SETTING3', 'x_dir_news', 'dir_news', '[dir_news]', '[dir_news]', 200, 255, -1, false, '[dir_news]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_agenda
        $this->dir_agenda = new DbField('SETTING3', 'SETTING3', 'x_dir_agenda', 'dir_agenda', '[dir_agenda]', '[dir_agenda]', 200, 255, -1, false, '[dir_agenda]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_surat
        $this->dir_surat = new DbField('SETTING3', 'SETTING3', 'x_dir_surat', 'dir_surat', '[dir_surat]', '[dir_surat]', 200, 255, -1, false, '[dir_surat]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_deseas
        $this->dir_deseas = new DbField('SETTING3', 'SETTING3', 'x_dir_deseas', 'dir_deseas', '[dir_deseas]', '[dir_deseas]', 200, 255, -1, false, '[dir_deseas]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_tips
        $this->dir_tips = new DbField('SETTING3', 'SETTING3', 'x_dir_tips', 'dir_tips', '[dir_tips]', '[dir_tips]', 200, 255, -1, false, '[dir_tips]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_org
        $this->dir_org = new DbField('SETTING3', 'SETTING3', 'x_dir_org', 'dir_org', '[dir_org]', '[dir_org]', 200, 255, -1, false, '[dir_org]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_emp
        $this->dir_emp = new DbField('SETTING3', 'SETTING3', 'x_dir_emp', 'dir_emp', '[dir_emp]', '[dir_emp]', 200, 255, -1, false, '[dir_emp]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // dir_kliping
        $this->dir_kliping = new DbField('SETTING3', 'SETTING3', 'x_dir_kliping', 'dir_kliping', '[dir_kliping]', '[dir_kliping]', 200, 255, -1, false, '[dir_kliping]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[SETTING3]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("Setting3List");
    }
    ...
    {
        global $Language;
        if ($pageName == "Setting3View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Setting3Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Setting3Add") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Setting3View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("Setting3View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "Setting3Add?" . $this->getUrlParm($parm);
        } else {
            $url = "Setting3Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("Setting3Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Setting3Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("Setting3Delete", $this->getUrlParm());
    }
