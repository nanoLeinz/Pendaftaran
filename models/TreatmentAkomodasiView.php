 ...
 * Page class
 */
class TreatmentAkomodasiView extends TreatmentAkomodasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentAkomodasiView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ID") ?? Route("ID")) !== null) {
                ...
                $returnUrl = "TreatmentAkomodasiList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "TreatmentAkomodasiList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "TreatmentAkomodasiList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
