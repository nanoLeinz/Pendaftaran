...
/**
 * Table class for register_perpoli_bulanan
 */
class RegisterPerpoliBulanan extends ReportTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'register_perpoli_bulanan';
        $this->TableName = 'register_perpoli_bulanan';
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_VISIT_ID', 'VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIANTAR_OLEH
        $this->DIANTAR_OLEH = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_DIANTAR_OLEH', 'DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 200, 255, -1, false, 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_VISIT_DATE', 'VISIT_DATE', 'dbo.PASIEN_VISITATION.VISIT_DATE', CastDateFieldForLike("dbo.PASIEN_VISITATION.VISIT_DATE", 11, "DB"), 135, 8, 11, false, 'dbo.PASIEN_VISITATION.VISIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAYOR_ID
        $this->PAYOR_ID = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_PAYOR_ID', 'PAYOR_ID', 'dbo.PASIEN_VISITATION.PAYOR_ID', 'dbo.PASIEN_VISITATION.PAYOR_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.PAYOR_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_CLASS_ID', 'CLASS_ID', 'dbo.PASIEN_VISITATION.CLASS_ID', 'CAST(dbo.PASIEN_VISITATION.CLASS_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.PASIEN_VISITATION.CLASS_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ISRJ
        $this->ISRJ = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_ISRJ', 'ISRJ', 'dbo.PASIEN_VISITATION.ISRJ', 'dbo.PASIEN_VISITATION.ISRJ', 129, 1, -1, false, 'dbo.PASIEN_VISITATION.ISRJ', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_CLINIC_ID', 'CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 200, 8, -1, false, 'dbo.PASIEN_VISITATION.CLINIC_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->CLINIC_ID->AdvancedSearch->SearchValueDefault = INIT_VALUE;
        $this->CLINIC_ID->SourceTableVar = 'V_KUNJUNGAN';
        $this->Fields['CLINIC_ID'] = &$this->CLINIC_ID;

        // MONTH
        $this->MONTH = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_MONTH', 'MONTH', 'Month(dbo.PASIEN_VISITATION.VISIT_DATE)', 'CAST(Month(dbo.PASIEN_VISITATION.VISIT_DATE) AS NVARCHAR)', 3, 4, -1, false, 'Month(dbo.PASIEN_VISITATION.VISIT_DATE)', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        $this->MONTH->AdvancedSearch->SearchValueDefault = INIT_VALUE;
        $this->MONTH->SourceTableVar = 'V_KUNJUNGAN';
        $this->Fields['MONTH'] = &$this->MONTH;

        // YEAR
        $this->YEAR = new ReportField('register_perpoli_bulanan', 'register_perpoli_bulanan', 'x_YEAR', 'YEAR', 'Year(dbo.PASIEN_VISITATION.VISIT_DATE)', 'CAST(Year(dbo.PASIEN_VISITATION.VISIT_DATE) AS NVARCHAR)', 3, 4, -1, false, 'Year(dbo.PASIEN_VISITATION.VISIT_DATE)', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // Chart1
        $this->Chart1 = new DbChart($this, 'Chart1', 'Chart1', 'MONTH', 'VISIT_DATE', 1001, '', 0, 'COUNT', 600, 500);
        $this->Chart1->SortType = 0;
        $this->Chart1->SortSequence = "";
        $this->Chart1->SqlSelect = $this->getQueryBuilder()->select("Month(dbo.PASIEN_VISITATION.VISIT_DATE)", "''", "COUNT(dbo.PASIEN_VISITATION.VISIT_DATE)");
        $this->Chart1->SqlGroupBy = "Month(dbo.PASIEN_VISITATION.VISIT_DATE)";
        $this->Chart1->SqlOrderBy = "";
        $this->Chart1->SeriesDateType = "";
        $this->Chart1->ID = "register_perpoli_bulanan_Chart1"; // Chart ID
    ...
    {
        $this->CLINIC_ID->ViewValue = GetDropDownDisplayValue($this->CLINIC_ID->CurrentValue, "", 0);
