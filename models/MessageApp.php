...
/**
 * Table class for MessageApp
 */
class MessageApp extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'MessageApp';
        $this->TableName = 'MessageApp';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[MessageApp]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id
        $this->Id = new DbField('MessageApp', 'MessageApp', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 3, 4, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // SendTime
        $this->SendTime = new DbField('MessageApp', 'MessageApp', 'x_SendTime', 'SendTime', '[SendTime]', CastDateFieldForLike("[SendTime]", 0, "DB"), 135, 8, 0, false, '[SendTime]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReceiveTime
        $this->ReceiveTime = new DbField('MessageApp', 'MessageApp', 'x_ReceiveTime', 'ReceiveTime', '[ReceiveTime]', CastDateFieldForLike("[ReceiveTime]", 0, "DB"), 135, 8, 0, false, '[ReceiveTime]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageFrom
        $this->MessageFrom = new DbField('MessageApp', 'MessageApp', 'x_MessageFrom', 'MessageFrom', '[MessageFrom]', '[MessageFrom]', 202, 80, -1, false, '[MessageFrom]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageTo
        $this->MessageTo = new DbField('MessageApp', 'MessageApp', 'x_MessageTo', 'MessageTo', '[MessageTo]', '[MessageTo]', 202, 80, -1, false, '[MessageTo]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SMSC
        $this->SMSC = new DbField('MessageApp', 'MessageApp', 'x_SMSC', 'SMSC', '[SMSC]', '[SMSC]', 202, 80, -1, false, '[SMSC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageText
        $this->MessageText = new DbField('MessageApp', 'MessageApp', 'x_MessageText', 'MessageText', '[MessageText]', '[MessageText]', 203, 0, -1, false, '[MessageText]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // MessageType
        $this->MessageType = new DbField('MessageApp', 'MessageApp', 'x_MessageType', 'MessageType', '[MessageType]', '[MessageType]', 202, 80, -1, false, '[MessageType]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessagePDU
        $this->MessagePDU = new DbField('MessageApp', 'MessageApp', 'x_MessagePDU', 'MessagePDU', '[MessagePDU]', '[MessagePDU]', 203, 0, -1, false, '[MessagePDU]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Gateway
        $this->Gateway = new DbField('MessageApp', 'MessageApp', 'x_Gateway', 'Gateway', '[Gateway]', '[Gateway]', 202, 80, -1, false, '[Gateway]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserId
        $this->_UserId = new DbField('MessageApp', 'MessageApp', 'x__UserId', 'UserId', '[UserId]', '[UserId]', 202, 80, -1, false, '[UserId]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // verifystatus
        $this->verifystatus = new DbField('MessageApp', 'MessageApp', 'x_verifystatus', 'verifystatus', '[verifystatus]', '[verifystatus]', 202, 80, -1, false, '[verifystatus]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // verifydate
        $this->verifydate = new DbField('MessageApp', 'MessageApp', 'x_verifydate', 'verifydate', '[verifydate]', CastDateFieldForLike("[verifydate]", 0, "DB"), 135, 8, 0, false, '[verifydate]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[MessageApp]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MessageAppList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MessageAppView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MessageAppEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MessageAppAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MessageAppView";
            case Config("API_ADD_ACTION"):
                return "MessageAppAdd";
            case Config("API_EDIT_ACTION"):
                return "MessageAppEdit";
            case Config("API_DELETE_ACTION"):
                return "MessageAppDelete";
            case Config("API_LIST_ACTION"):
                return "MessageAppList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MessageAppView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MessageAppView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MessageAppAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MessageAppAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MessageAppEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MessageAppAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MessageAppDelete", $this->getUrlParm());
    }
