...
/**
 * Table class for USER_ACCESS
 */
class UserAccess extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'USER_ACCESS';
        $this->TableName = 'USER_ACCESS';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[USER_ACCESS]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USERNAME
        $this->_USERNAME = new DbField('USER_ACCESS', 'USER_ACCESS', 'x__USERNAME', 'USERNAME', '[USERNAME]', '[USERNAME]', 200, 16, -1, false, '[USERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USE_ORG_UNIT_CODE
        $this->USE_ORG_UNIT_CODE = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_USE_ORG_UNIT_CODE', 'USE_ORG_UNIT_CODE', '[USE_ORG_UNIT_CODE]', '[USE_ORG_UNIT_CODE]', 200, 50, -1, false, '[USE_ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->USE_ORG_UNIT_CODE->IsPrimaryKey = true; // Primary key field
        $this->USE_ORG_UNIT_CODE->Nullable = false; // NOT NULL field
        $this->USE_ORG_UNIT_CODE->Required = true; // Required field
        $this->USE_ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->USE_ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->USE_ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['USE_ORG_UNIT_CODE'] = &$this->USE_ORG_UNIT_CODE;

        // GROUP_ID
        $this->GROUP_ID = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_GROUP_ID', 'GROUP_ID', '[GROUP_ID]', 'CAST([GROUP_ID] AS NVARCHAR)', 2, 2, -1, false, '[GROUP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('USER_ACCESS', 'USER_ACCESS', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[USER_ACCESS]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('USE_ORG_UNIT_CODE', $rs)) {
                AddFilter($where, QuotedName('USE_ORG_UNIT_CODE', $this->Dbid) . '=' . QuotedValue($rs['USE_ORG_UNIT_CODE'], $this->USE_ORG_UNIT_CODE->DataType, $this->Dbid));
            }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->USE_ORG_UNIT_CODE->DbValue = $row['USE_ORG_UNIT_CODE'];
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [USERNAME] = '@_USERNAME@' AND [USE_ORG_UNIT_CODE] = '@USE_ORG_UNIT_CODE@' AND [GROUP_ID] = @GROUP_ID@";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->USE_ORG_UNIT_CODE->CurrentValue : $this->USE_ORG_UNIT_CODE->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 4) {
            ...
            if ($current) {
                $this->USE_ORG_UNIT_CODE->CurrentValue = $keys[2];
            } else {
                $this->USE_ORG_UNIT_CODE->OldValue = $keys[2];
            }
            if ($current) {
                $this->GROUP_ID->CurrentValue = $keys[3];
            } else {
                $this->GROUP_ID->OldValue = $keys[3];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('USE_ORG_UNIT_CODE', $row) ? $row['USE_ORG_UNIT_CODE'] : null;
        } else {
            $val = $this->USE_ORG_UNIT_CODE->OldValue !== null ? $this->USE_ORG_UNIT_CODE->OldValue : $this->USE_ORG_UNIT_CODE->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@USE_ORG_UNIT_CODE@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        if (is_array($row)) {
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserAccessList");
    }
    ...
    {
        global $Language;
        if ($pageName == "UserAccessView") {
            return $Language->phrase("View");
        } elseif ($pageName == "UserAccessEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UserAccessAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserAccessView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UserAccessView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UserAccessAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UserAccessAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UserAccessEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserAccessAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UserAccessDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",USE_ORG_UNIT_CODE:" . JsonEncode($this->USE_ORG_UNIT_CODE->CurrentValue, "string");
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->USE_ORG_UNIT_CODE->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->USE_ORG_UNIT_CODE->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("USE_ORG_UNIT_CODE") ?? Route("USE_ORG_UNIT_CODE")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->USE_ORG_UNIT_CODE->CurrentValue = $key[2];
            } else {
                $this->USE_ORG_UNIT_CODE->OldValue = $key[2];
            }
            if ($setCurrent) {
                $this->GROUP_ID->CurrentValue = $key[3];
            } else {
                $this->GROUP_ID->OldValue = $key[3];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->USE_ORG_UNIT_CODE->setDbValue($row['USE_ORG_UNIT_CODE']);
    ...
    public function renderListRow()
    {
        ...
        // USE_ORG_UNIT_CODE
        $this->USE_ORG_UNIT_CODE->ViewValue = $this->USE_ORG_UNIT_CODE->CurrentValue;
        $this->USE_ORG_UNIT_CODE->ViewCustomAttributes = "";
        ...
        // USE_ORG_UNIT_CODE
        $this->USE_ORG_UNIT_CODE->LinkCustomAttributes = "";
        $this->USE_ORG_UNIT_CODE->HrefValue = "";
        $this->USE_ORG_UNIT_CODE->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // USE_ORG_UNIT_CODE
        $this->USE_ORG_UNIT_CODE->EditAttrs["class"] = "form-control";
        $this->USE_ORG_UNIT_CODE->EditCustomAttributes = "";
        if (!$this->USE_ORG_UNIT_CODE->Raw) {
            $this->USE_ORG_UNIT_CODE->CurrentValue = HtmlDecode($this->USE_ORG_UNIT_CODE->CurrentValue);
        }
        $this->USE_ORG_UNIT_CODE->EditValue = $this->USE_ORG_UNIT_CODE->CurrentValue;
        $this->USE_ORG_UNIT_CODE->PlaceHolder = RemoveHtml($this->USE_ORG_UNIT_CODE->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->USE_ORG_UNIT_CODE);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->USE_ORG_UNIT_CODE);
