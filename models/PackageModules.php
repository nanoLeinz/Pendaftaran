...
/**
 * Table class for PACKAGE_MODULES
 */
class PackageModules extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'PACKAGE_MODULES';
        $this->TableName = 'PACKAGE_MODULES';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[PACKAGE_MODULES]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PACKAGE_ID
        $this->PACKAGE_ID = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_PACKAGE_ID', 'PACKAGE_ID', '[PACKAGE_ID]', '[PACKAGE_ID]', 200, 50, -1, false, '[PACKAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODULE_ID
        $this->MODULE_ID = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_MODULE_ID', 'MODULE_ID', '[MODULE_ID]', '[MODULE_ID]', 200, 50, -1, false, '[MODULE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODULE_ID->IsPrimaryKey = true; // Primary key field
        $this->MODULE_ID->Nullable = false; // NOT NULL field
        $this->MODULE_ID->Required = true; // Required field
        ...
        // MODULE_NAME
        $this->MODULE_NAME = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_MODULE_NAME', 'MODULE_NAME', '[MODULE_NAME]', '[MODULE_NAME]', 200, 100, -1, false, '[MODULE_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODULE_NAME->Sortable = true; // Allow sort
        $this->MODULE_NAME->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODULE_NAME->Param, "CustomMsg");
        $this->Fields['MODULE_NAME'] = &$this->MODULE_NAME;

        // TARIF_ID
        $this->TARIF_ID = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SK_DATE
        $this->SK_DATE = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_SK_DATE', 'SK_DATE', '[SK_DATE]', CastDateFieldForLike("[SK_DATE]", 0, "DB"), 135, 8, 0, false, '[SK_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SK_NO
        $this->SK_NO = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_SK_NO', 'SK_NO', '[SK_NO]', '[SK_NO]', 200, 75, -1, false, '[SK_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('PACKAGE_MODULES', 'PACKAGE_MODULES', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[PACKAGE_MODULES]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('MODULE_ID', $rs)) {
                AddFilter($where, QuotedName('MODULE_ID', $this->Dbid) . '=' . QuotedValue($rs['MODULE_ID'], $this->MODULE_ID->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->MODULE_NAME->DbValue = $row['MODULE_NAME'];
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [MODULE_ID] = '@MODULE_ID@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->MODULE_ID->CurrentValue : $this->MODULE_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->MODULE_ID->CurrentValue = $keys[1];
            } else {
                $this->MODULE_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('MODULE_ID', $row) ? $row['MODULE_ID'] : null;
        } else {
            $val = $this->MODULE_ID->OldValue !== null ? $this->MODULE_ID->OldValue : $this->MODULE_ID->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@MODULE_ID@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PackageModulesList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PackageModulesView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PackageModulesEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PackageModulesAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PackageModulesView";
            case Config("API_ADD_ACTION"):
                return "PackageModulesAdd";
            case Config("API_EDIT_ACTION"):
                return "PackageModulesEdit";
            case Config("API_DELETE_ACTION"):
                return "PackageModulesDelete";
            case Config("API_LIST_ACTION"):
                return "PackageModulesList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PackageModulesView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PackageModulesView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PackageModulesAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PackageModulesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PackageModulesEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PackageModulesAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PackageModulesDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",MODULE_ID:" . JsonEncode($this->MODULE_ID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->MODULE_ID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->MODULE_ID->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("MODULE_ID") ?? Route("MODULE_ID")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->MODULE_ID->CurrentValue = $key[1];
            } else {
                $this->MODULE_ID->OldValue = $key[1];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->MODULE_NAME->setDbValue($row['MODULE_NAME']);
    ...
    public function renderListRow()
    {
        ...
        // MODULE_NAME
        $this->MODULE_NAME->ViewValue = $this->MODULE_NAME->CurrentValue;
        $this->MODULE_NAME->ViewCustomAttributes = "";
        ...
        // MODULE_NAME
        $this->MODULE_NAME->LinkCustomAttributes = "";
        $this->MODULE_NAME->HrefValue = "";
        $this->MODULE_NAME->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // MODULE_NAME
        $this->MODULE_NAME->EditAttrs["class"] = "form-control";
        $this->MODULE_NAME->EditCustomAttributes = "";
        if (!$this->MODULE_NAME->Raw) {
            $this->MODULE_NAME->CurrentValue = HtmlDecode($this->MODULE_NAME->CurrentValue);
        }
        $this->MODULE_NAME->EditValue = $this->MODULE_NAME->CurrentValue;
        $this->MODULE_NAME->PlaceHolder = RemoveHtml($this->MODULE_NAME->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->MODULE_NAME);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->MODULE_NAME);
