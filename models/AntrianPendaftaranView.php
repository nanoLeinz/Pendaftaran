 ...
 * Page class
 */
class AntrianPendaftaranView extends AntrianPendaftaran
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AntrianPendaftaranView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("Id") ?? Route("Id")) !== null) {
                ...
                $returnUrl = "AntrianPendaftaranList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "AntrianPendaftaranList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "AntrianPendaftaranList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
