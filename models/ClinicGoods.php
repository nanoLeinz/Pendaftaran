...
/**
 * Table class for CLINIC_GOODS
 */
class ClinicGoods extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CLINIC_GOODS';
        $this->TableName = 'CLINIC_GOODS';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CLINIC_GOODS]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CLINIC_GOODS', 'CLINIC_GOODS', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('CLINIC_GOODS', 'CLINIC_GOODS', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('CLINIC_GOODS', 'CLINIC_GOODS', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CLINIC_GOODS]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [CLINIC_ID] = '@CLINIC_ID@' AND [BRAND_ID] = '@BRAND_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClinicGoodsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ClinicGoodsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ClinicGoodsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ClinicGoodsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ClinicGoodsView";
            case Config("API_ADD_ACTION"):
                return "ClinicGoodsAdd";
            case Config("API_EDIT_ACTION"):
                return "ClinicGoodsEdit";
            case Config("API_DELETE_ACTION"):
                return "ClinicGoodsDelete";
            case Config("API_LIST_ACTION"):
                return "ClinicGoodsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClinicGoodsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ClinicGoodsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ClinicGoodsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ClinicGoodsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ClinicGoodsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicGoodsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ClinicGoodsDelete", $this->getUrlParm());
    }
