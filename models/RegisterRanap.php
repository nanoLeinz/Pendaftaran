...
class RegisterRanap extends ReportTable
{
    ...
    public function __construct()
    {
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new ReportField('register_ranap', 'register_ranap', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // GENDER
        $this->GENDER = new ReportField('register_ranap', 'register_ranap', 'x_GENDER', 'GENDER', 'dbo.PASIEN_VISITATION.GENDER', 'dbo.PASIEN_VISITATION.GENDER', 129, 1, -1, false, 'dbo.PASIEN_VISITATION.GENDER', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // TREATMENT
        $this->TREATMENT = new ReportField('register_ranap', 'register_ranap', 'x_TREATMENT', 'TREATMENT', 'dbo.TREATMENT_AKOMODASI.TREATMENT', 'dbo.TREATMENT_AKOMODASI.TREATMENT', 200, 200, -1, false, 'dbo.TREATMENT_AKOMODASI.TREATMENT', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        $this->TREATMENT->SourceTableVar = 'V_KUNJUNGAN_PASIEN';
        $this->Fields['TREATMENT'] = &$this->TREATMENT;

        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new ReportField('register_ranap', 'register_ranap', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', 200, 16, -1, false, 'dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // BED_ID
        $this->BED_ID = new ReportField('register_ranap', 'register_ranap', 'x_BED_ID', 'BED_ID', 'dbo.TREATMENT_AKOMODASI.BED_ID', 'CAST(dbo.TREATMENT_AKOMODASI.BED_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.BED_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR
        $this->DOCTOR = new ReportField('register_ranap', 'register_ranap', 'x_DOCTOR', 'DOCTOR', 'dbo.TREATMENT_AKOMODASI.DOCTOR', 'dbo.TREATMENT_AKOMODASI.DOCTOR', 200, 100, -1, false, 'dbo.TREATMENT_AKOMODASI.DOCTOR', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DOCTOR->Sortable = true; // Allow sort
        $this->DOCTOR->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DOCTOR->Param, "CustomMsg");
        $this->DOCTOR->SourceTableVar = 'V_KUNJUNGAN_PASIEN';
        $this->Fields['DOCTOR'] = &$this->DOCTOR;

        // SERVED_INAP
        $this->SERVED_INAP = new ReportField('register_ranap', 'register_ranap', 'x_SERVED_INAP', 'SERVED_INAP', 'dbo.PASIEN_VISITATION.SERVED_INAP', CastDateFieldForLike("dbo.PASIEN_VISITATION.SERVED_INAP", 7, "DB"), 135, 8, 7, false, 'dbo.PASIEN_VISITATION.SERVED_INAP', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new ReportField('register_ranap', 'register_ranap', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', 'CAST(dbo.PASIEN_VISITATION.STATUS_PASIEN_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // ISRJ
        $this->ISRJ = new ReportField('register_ranap', 'register_ranap', 'x_ISRJ', 'ISRJ', 'dbo.PASIEN_VISITATION.ISRJ', 'dbo.PASIEN_VISITATION.ISRJ', 129, 1, -1, false, 'dbo.PASIEN_VISITATION.ISRJ', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new ReportField('register_ranap', 'register_ranap', 'x_VISIT_ID', 'VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDXDAFTAR
        $this->IDXDAFTAR = new ReportField('register_ranap', 'register_ranap', 'x_IDXDAFTAR', 'IDXDAFTAR', 'dbo.PASIEN_VISITATION.IDXDAFTAR', 'CAST(dbo.PASIEN_VISITATION.IDXDAFTAR AS NVARCHAR)', 3, 4, -1, false, 'dbo.PASIEN_VISITATION.IDXDAFTAR', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // DIANTAR_OLEH
        $this->DIANTAR_OLEH = new ReportField('register_ranap', 'register_ranap', 'x_DIANTAR_OLEH', 'DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 200, 255, -1, false, 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new ReportField('register_ranap', 'register_ranap', 'x_EXIT_DATE', 'EXIT_DATE', 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', CastDateFieldForLike("dbo.TREATMENT_AKOMODASI.EXIT_DATE", 0, "DB"), 135, 8, 0, false, 'dbo.TREATMENT_AKOMODASI.EXIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new ReportField('register_ranap', 'register_ranap', 'x_KELUAR_ID', 'KELUAR_ID', 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', 'CAST(dbo.TREATMENT_AKOMODASI.KELUAR_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.KELUAR_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new ReportField('register_ranap', 'register_ranap', 'x_AGEYEAR', 'AGEYEAR', 'dbo.TREATMENT_AKOMODASI.AGEYEAR', 'CAST(dbo.TREATMENT_AKOMODASI.AGEYEAR AS NVARCHAR)', 17, 1, -1, false, 'dbo.TREATMENT_AKOMODASI.AGEYEAR', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getSqlSelect() // Select
    {
        ...
        $select = $this->getQueryBuilder()->select("dbo.PASIEN_VISITATION.NO_REGISTRATION, dbo.PASIEN_VISITATION.STATUS_PASIEN_ID, dbo.PASIEN_VISITATION.GENDER, dbo.PASIEN_VISITATION.IDXDAFTAR, dbo.PASIEN_VISITATION.ISRJ, dbo.PASIEN_VISITATION.SERVED_INAP, dbo.PASIEN_VISITATION.VISIT_ID, dbo.TREATMENT_AKOMODASI.TREATMENT, dbo.TREATMENT_AKOMODASI.CLASS_ROOM_ID, dbo.TREATMENT_AKOMODASI.DOCTOR, dbo.TREATMENT_AKOMODASI.BED_ID, dbo.PASIEN_VISITATION.DIANTAR_OLEH, dbo.TREATMENT_AKOMODASI.EXIT_DATE, dbo.TREATMENT_AKOMODASI.KELUAR_ID, dbo.TREATMENT_AKOMODASI.AGEYEAR");
        return $select;
    }
