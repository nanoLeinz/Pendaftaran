...
/**
 * Table class for MessageBill
 */
class MessageBill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'MessageBill';
        $this->TableName = 'MessageBill';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[MessageBill]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id
        $this->Id = new DbField('MessageBill', 'MessageBill', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 3, 4, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // SendTime
        $this->SendTime = new DbField('MessageBill', 'MessageBill', 'x_SendTime', 'SendTime', '[SendTime]', CastDateFieldForLike("[SendTime]", 0, "DB"), 135, 8, 0, false, '[SendTime]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ReceiveTime
        $this->ReceiveTime = new DbField('MessageBill', 'MessageBill', 'x_ReceiveTime', 'ReceiveTime', '[ReceiveTime]', CastDateFieldForLike("[ReceiveTime]", 0, "DB"), 135, 8, 0, false, '[ReceiveTime]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageFrom
        $this->MessageFrom = new DbField('MessageBill', 'MessageBill', 'x_MessageFrom', 'MessageFrom', '[MessageFrom]', '[MessageFrom]', 202, 80, -1, false, '[MessageFrom]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageTo
        $this->MessageTo = new DbField('MessageBill', 'MessageBill', 'x_MessageTo', 'MessageTo', '[MessageTo]', '[MessageTo]', 202, 80, -1, false, '[MessageTo]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SMSC
        $this->SMSC = new DbField('MessageBill', 'MessageBill', 'x_SMSC', 'SMSC', '[SMSC]', '[SMSC]', 202, 80, -1, false, '[SMSC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessageText
        $this->MessageText = new DbField('MessageBill', 'MessageBill', 'x_MessageText', 'MessageText', '[MessageText]', '[MessageText]', 203, 0, -1, false, '[MessageText]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // MessageType
        $this->MessageType = new DbField('MessageBill', 'MessageBill', 'x_MessageType', 'MessageType', '[MessageType]', '[MessageType]', 202, 80, -1, false, '[MessageType]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MessagePDU
        $this->MessagePDU = new DbField('MessageBill', 'MessageBill', 'x_MessagePDU', 'MessagePDU', '[MessagePDU]', '[MessagePDU]', 203, 0, -1, false, '[MessagePDU]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // Gateway
        $this->Gateway = new DbField('MessageBill', 'MessageBill', 'x_Gateway', 'Gateway', '[Gateway]', '[Gateway]', 202, 80, -1, false, '[Gateway]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UserId
        $this->_UserId = new DbField('MessageBill', 'MessageBill', 'x__UserId', 'UserId', '[UserId]', '[UserId]', 202, 80, -1, false, '[UserId]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // verifystatus
        $this->verifystatus = new DbField('MessageBill', 'MessageBill', 'x_verifystatus', 'verifystatus', '[verifystatus]', '[verifystatus]', 202, 80, -1, false, '[verifystatus]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->verifystatus->Sortable = true; // Allow sort
        $this->verifystatus->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->verifystatus->Param, "CustomMsg");
        $this->Fields['verifystatus'] = &$this->verifystatus;

        // verifydate
        $this->verifydate = new DbField('MessageBill', 'MessageBill', 'x_verifydate', 'verifydate', '[verifydate]', CastDateFieldForLike("[verifydate]", 0, "DB"), 135, 8, 0, false, '[verifydate]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->verifydate->Sortable = true; // Allow sort
        $this->verifydate->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->verifydate->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->verifydate->Param, "CustomMsg");
        $this->Fields['verifydate'] = &$this->verifydate;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[MessageBill]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->verifystatus->DbValue = $row['verifystatus'];
        $this->verifydate->DbValue = $row['verifydate'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MessageBillList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MessageBillView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MessageBillEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MessageBillAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MessageBillView";
            case Config("API_ADD_ACTION"):
                return "MessageBillAdd";
            case Config("API_EDIT_ACTION"):
                return "MessageBillEdit";
            case Config("API_DELETE_ACTION"):
                return "MessageBillDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MessageBillView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MessageBillView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MessageBillAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MessageBillAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MessageBillEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MessageBillAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MessageBillDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->verifystatus->setDbValue($row['verifystatus']);
        $this->verifydate->setDbValue($row['verifydate']);
    }
    ...
    public function renderListRow()
    {
        ...
        // verifystatus
        $this->verifystatus->ViewValue = $this->verifystatus->CurrentValue;
        $this->verifystatus->ViewCustomAttributes = "";

        // verifydate
        $this->verifydate->ViewValue = $this->verifydate->CurrentValue;
        $this->verifydate->ViewValue = FormatDateTime($this->verifydate->ViewValue, 0);
        $this->verifydate->ViewCustomAttributes = "";
        ...
        // verifystatus
        $this->verifystatus->LinkCustomAttributes = "";
        $this->verifystatus->HrefValue = "";
        $this->verifystatus->TooltipValue = "";

        // verifydate
        $this->verifydate->LinkCustomAttributes = "";
        $this->verifydate->HrefValue = "";
        $this->verifydate->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // verifystatus
        $this->verifystatus->EditAttrs["class"] = "form-control";
        $this->verifystatus->EditCustomAttributes = "";
        if (!$this->verifystatus->Raw) {
            $this->verifystatus->CurrentValue = HtmlDecode($this->verifystatus->CurrentValue);
        }
        $this->verifystatus->EditValue = $this->verifystatus->CurrentValue;
        $this->verifystatus->PlaceHolder = RemoveHtml($this->verifystatus->caption());

        // verifydate
        $this->verifydate->EditAttrs["class"] = "form-control";
        $this->verifydate->EditCustomAttributes = "";
        $this->verifydate->EditValue = FormatDateTime($this->verifydate->CurrentValue, 8);
        $this->verifydate->PlaceHolder = RemoveHtml($this->verifydate->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->verifystatus);
                    $doc->exportCaption($this->verifydate);
                } else {
                    $doc->exportCaption($this->Id);
                    $doc->exportCaption($this->SendTime);
                    $doc->exportCaption($this->ReceiveTime);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->verifystatus);
                        $doc->exportField($this->verifydate);
                    } else {
                        $doc->exportField($this->Id);
                        $doc->exportField($this->SendTime);
                        $doc->exportField($this->ReceiveTime);
