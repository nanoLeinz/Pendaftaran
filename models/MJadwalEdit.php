 ...
 * Page class
 */
class MJadwalEdit extends MJadwal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MJadwalEdit";
    ...
    protected function validateForm()
    {
        ...
        if ($this->id_jadwal->Required) {
            if (!$this->id_jadwal->IsDetailKey && EmptyValue($this->id_jadwal->FormValue)) {
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // hari_kerja
            $this->hari_kerja->setDbValueDef($rsnew, $this->hari_kerja->CurrentValue, null, $this->hari_kerja->ReadOnly);
            ...
            // kouta
            $this->kouta->setDbValueDef($rsnew, $this->kouta->CurrentValue, null, $this->kouta->ReadOnly);
