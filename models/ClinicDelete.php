 ...
 * Page class
 */
class ClinicDelete extends Clinic
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ClinicDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ClinicList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ClinicList"); // Return to list
                return;
            }
        }
