 ...
 * Page class
 */
class PayorTypeDelete extends PayorType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PayorTypeDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("PayorTypeList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("PayorTypeList"); // Return to list
                return;
            }
        }
