 ...
 * Page class
 */
class BookingOperasiDelete extends BookingOperasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BookingOperasiDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("BookingOperasiList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("BookingOperasiList"); // Return to list
                return;
            }
        }
