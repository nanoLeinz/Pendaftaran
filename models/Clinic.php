...
/**
 * Table class for CLINIC
 */
class Clinic extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CLINIC';
        $this->TableName = 'CLINIC';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CLINIC]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CLINIC', 'CLINIC', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('CLINIC', 'CLINIC', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAME_OF_CLINIC
        $this->NAME_OF_CLINIC = new DbField('CLINIC', 'CLINIC', 'x_NAME_OF_CLINIC', 'NAME_OF_CLINIC', '[NAME_OF_CLINIC]', '[NAME_OF_CLINIC]', 200, 100, -1, false, '[NAME_OF_CLINIC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('CLINIC', 'CLINIC', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STYPE_ID
        $this->STYPE_ID = new DbField('CLINIC', 'CLINIC', 'x_STYPE_ID', 'STYPE_ID', '[STYPE_ID]', 'CAST([STYPE_ID] AS NVARCHAR)', 17, 1, -1, false, '[STYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_TYPE
        $this->CLINIC_TYPE = new DbField('CLINIC', 'CLINIC', 'x_CLINIC_TYPE', 'CLINIC_TYPE', '[CLINIC_TYPE]', 'CAST([CLINIC_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[CLINIC_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OTHER_ID
        $this->OTHER_ID = new DbField('CLINIC', 'CLINIC', 'x_OTHER_ID', 'OTHER_ID', '[OTHER_ID]', '[OTHER_ID]', 200, 25, -1, false, '[OTHER_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('CLINIC', 'CLINIC', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FA_V
        $this->FA_V = new DbField('CLINIC', 'CLINIC', 'x_FA_V', 'FA_V', '[FA_V]', 'CAST([FA_V] AS NVARCHAR)', 3, 4, -1, false, '[FA_V]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PROFIT_ID
        $this->PROFIT_ID = new DbField('CLINIC', 'CLINIC', 'x_PROFIT_ID', 'PROFIT_ID', '[PROFIT_ID]', '[PROFIT_ID]', 200, 50, -1, false, '[PROFIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUPPLIED_MM
        $this->SUPPLIED_MM = new DbField('CLINIC', 'CLINIC', 'x_SUPPLIED_MM', 'SUPPLIED_MM', '[SUPPLIED_MM]', '[SUPPLIED_MM]', 200, 25, -1, false, '[SUPPLIED_MM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KDPOLI
        $this->KDPOLI = new DbField('CLINIC', 'CLINIC', 'x_KDPOLI', 'KDPOLI', '[KDPOLI]', '[KDPOLI]', 200, 5, -1, false, '[KDPOLI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PICTUREFILE
        $this->PICTUREFILE = new DbField('CLINIC', 'CLINIC', 'x_PICTUREFILE', 'PICTUREFILE', '[PICTUREFILE]', '[PICTUREFILE]', 201, 0, -1, false, '[PICTUREFILE]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // PROFILES
        $this->PROFILES = new DbField('CLINIC', 'CLINIC', 'x_PROFILES', 'PROFILES', '[PROFILES]', '[PROFILES]', 201, 0, -1, false, '[PROFILES]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        $this->PROFILES->Sortable = true; // Allow sort
        $this->PROFILES->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PROFILES->Param, "CustomMsg");
        $this->Fields['PROFILES'] = &$this->PROFILES;

        // SPESIALISTIK
        $this->SPESIALISTIK = new DbField('CLINIC', 'CLINIC', 'x_SPESIALISTIK', 'SPESIALISTIK', '[SPESIALISTIK]', '[SPESIALISTIK]', 200, 3, -1, false, '[SPESIALISTIK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CLINIC]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->PROFILES->DbValue = $row['PROFILES'];
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [CLINIC_ID] = '@CLINIC_ID@'";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->CLINIC_ID->CurrentValue = $keys[1];
            } else {
                $this->CLINIC_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClinicList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "ClinicEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ClinicAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClinicView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ClinicView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ClinicAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ClinicAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ClinicEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ClinicDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->CLINIC_ID->CurrentValue = $key[1];
            } else {
                $this->CLINIC_ID->OldValue = $key[1];
            }
    ...
    public function renderEditRow()
    {
        ...
        $this->PROFILES->EditValue = $this->PROFILES->CurrentValue;
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->PROFILES);
