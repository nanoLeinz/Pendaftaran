 ...
 * Page class
 */
class RegisterPasienSummary extends RegisterPasien
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'register_pasien';

    // Page object name
    public $PageObjName = "RegisterPasienSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (register_pasien)
        if (!isset($GLOBALS["register_pasien"]) || get_class($GLOBALS["register_pasien"]) == PROJECT_NAMESPACE . "register_pasien") {
            $GLOBALS["register_pasien"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'register_pasien');
        }
