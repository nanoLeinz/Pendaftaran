...
/**
 * Table class for GOOD_LOCATION
 */
class GoodLocation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'GOOD_LOCATION';
        $this->TableName = 'GOOD_LOCATION';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[GOOD_LOCATION]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITEM_ID
        $this->ITEM_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ITEM_ID', 'ITEM_ID', '[ITEM_ID]', '[ITEM_ID]', 200, 50, -1, false, '[ITEM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_ID
        $this->ORG_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH_NO
        $this->BATCH_NO = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_BATCH_NO', 'BATCH_NO', '[BATCH_NO]', '[BATCH_NO]', 200, 75, -1, false, '[BATCH_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ROOMS_ID
        $this->ROOMS_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ROOMS_ID', 'ROOMS_ID', '[ROOMS_ID]', '[ROOMS_ID]', 200, 10, -1, false, '[ROOMS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SHELF_NO
        $this->SHELF_NO = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_SHELF_NO', 'SHELF_NO', '[SHELF_NO]', 'CAST([SHELF_NO] AS NVARCHAR)', 2, 2, -1, false, '[SHELF_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPIRY_DATE
        $this->EXPIRY_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_EXPIRY_DATE', 'EXPIRY_DATE', '[EXPIRY_DATE]', CastDateFieldForLike("[EXPIRY_DATE]", 0, "DB"), 135, 8, 0, false, '[EXPIRY_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERIAL_NB
        $this->SERIAL_NB = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_SERIAL_NB', 'SERIAL_NB', '[SERIAL_NB]', '[SERIAL_NB]', 200, 200, -1, false, '[SERIAL_NB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FROM_ROOMS_ID
        $this->FROM_ROOMS_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_FROM_ROOMS_ID', 'FROM_ROOMS_ID', '[FROM_ROOMS_ID]', '[FROM_ROOMS_ID]', 200, 10, -1, false, '[FROM_ROOMS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISOUTLET
        $this->ISOUTLET = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ISOUTLET', 'ISOUTLET', '[ISOUTLET]', '[ISOUTLET]', 129, 1, -1, false, '[ISOUTLET]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISTRIBUTION_TYPE
        $this->DISTRIBUTION_TYPE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DISTRIBUTION_TYPE', 'DISTRIBUTION_TYPE', '[DISTRIBUTION_TYPE]', 'CAST([DISTRIBUTION_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[DISTRIBUTION_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONDITION
        $this->CONDITION = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_CONDITION', 'CONDITION', '[CONDITION]', 'CAST([CONDITION] AS NVARCHAR)', 17, 1, -1, false, '[CONDITION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALLOCATED_DATE
        $this->ALLOCATED_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ALLOCATED_DATE', 'ALLOCATED_DATE', '[ALLOCATED_DATE]', CastDateFieldForLike("[ALLOCATED_DATE]", 0, "DB"), 135, 8, 0, false, '[ALLOCATED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCKOPNAME_DATE
        $this->STOCKOPNAME_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOCKOPNAME_DATE', 'STOCKOPNAME_DATE', '[STOCKOPNAME_DATE]', CastDateFieldForLike("[STOCKOPNAME_DATE]", 0, "DB"), 135, 8, 0, false, '[STOCKOPNAME_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INVOICE_ID
        $this->INVOICE_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_INVOICE_ID', 'INVOICE_ID', '[INVOICE_ID]', '[INVOICE_ID]', 200, 50, -1, false, '[INVOICE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALLOCATED_FROM
        $this->ALLOCATED_FROM = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ALLOCATED_FROM', 'ALLOCATED_FROM', '[ALLOCATED_FROM]', '[ALLOCATED_FROM]', 200, 255, -1, false, '[ALLOCATED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRICE
        $this->PRICE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_PRICE', 'PRICE', '[PRICE]', 'CAST([PRICE] AS NVARCHAR)', 6, 8, -1, false, '[PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT
        $this->DISCOUNT = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DISCOUNT', 'DISCOUNT', '[DISCOUNT]', 'CAST([DISCOUNT] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT2
        $this->DISCOUNT2 = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DISCOUNT2', 'DISCOUNT2', '[DISCOUNT2]', 'CAST([DISCOUNT2] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNTOFF
        $this->DISCOUNTOFF = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DISCOUNTOFF', 'DISCOUNTOFF', '[DISCOUNTOFF]', 'CAST([DISCOUNTOFF] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNTOFF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_FROM
        $this->ORG_UNIT_FROM = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ORG_UNIT_FROM', 'ORG_UNIT_FROM', '[ORG_UNIT_FROM]', '[ORG_UNIT_FROM]', 200, 50, -1, false, '[ORG_UNIT_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITEM_ID_FROM
        $this->ITEM_ID_FROM = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ITEM_ID_FROM', 'ITEM_ID_FROM', '[ITEM_ID_FROM]', '[ITEM_ID_FROM]', 200, 50, -1, false, '[ITEM_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // STOCK_OPNAME
        $this->STOCK_OPNAME = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOCK_OPNAME', 'STOCK_OPNAME', '[STOCK_OPNAME]', 'CAST([STOCK_OPNAME] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_OPNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOK_AWAL
        $this->STOK_AWAL = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOK_AWAL', 'STOK_AWAL', '[STOK_AWAL]', 'CAST([STOK_AWAL] AS NVARCHAR)', 131, 8, -1, false, '[STOK_AWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_LALU
        $this->STOCK_LALU = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOCK_LALU', 'STOCK_LALU', '[STOCK_LALU]', 'CAST([STOCK_LALU] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_LALU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_KOREKSI
        $this->STOCK_KOREKSI = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOCK_KOREKSI', 'STOCK_KOREKSI', '[STOCK_KOREKSI]', 'CAST([STOCK_KOREKSI] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DITERIMA
        $this->DITERIMA = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DITERIMA', 'DITERIMA', '[DITERIMA]', 'CAST([DITERIMA] AS NVARCHAR)', 131, 8, -1, false, '[DITERIMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISTRIBUSI
        $this->DISTRIBUSI = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DISTRIBUSI', 'DISTRIBUSI', '[DISTRIBUSI]', 'CAST([DISTRIBUSI] AS NVARCHAR)', 131, 8, -1, false, '[DISTRIBUSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIJUAL
        $this->DIJUAL = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DIJUAL', 'DIJUAL', '[DIJUAL]', 'CAST([DIJUAL] AS NVARCHAR)', 131, 8, -1, false, '[DIJUAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIHAPUS
        $this->DIHAPUS = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DIHAPUS', 'DIHAPUS', '[DIHAPUS]', 'CAST([DIHAPUS] AS NVARCHAR)', 131, 8, -1, false, '[DIHAPUS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIMINTA
        $this->DIMINTA = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DIMINTA', 'DIMINTA', '[DIMINTA]', 'CAST([DIMINTA] AS NVARCHAR)', 131, 8, -1, false, '[DIMINTA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIRETUR
        $this->DIRETUR = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DIRETUR', 'DIRETUR', '[DIRETUR]', 'CAST([DIRETUR] AS NVARCHAR)', 131, 8, -1, false, '[DIRETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PO
        $this->PO = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_PO', 'PO', '[PO]', '[PO]', 200, 50, -1, false, '[PO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMPANY_ID
        $this->COMPANY_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_COMPANY_ID', 'COMPANY_ID', '[COMPANY_ID]', '[COMPANY_ID]', 200, 50, -1, false, '[COMPANY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FUND_ID
        $this->FUND_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_FUND_ID', 'FUND_ID', '[FUND_ID]', 'CAST([FUND_ID] AS NVARCHAR)', 17, 1, -1, false, '[FUND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INVOICE_ID2
        $this->INVOICE_ID2 = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_INVOICE_ID2', 'INVOICE_ID2', '[INVOICE_ID2]', '[INVOICE_ID2]', 200, 50, -1, false, '[INVOICE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID3
        $this->MEASURE_ID3 = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MEASURE_ID3', 'MEASURE_ID3', '[MEASURE_ID3]', 'CAST([MEASURE_ID3] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID3]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_KEMASAN
        $this->SIZE_KEMASAN = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_SIZE_KEMASAN', 'SIZE_KEMASAN', '[SIZE_KEMASAN]', 'CAST([SIZE_KEMASAN] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_KEMASAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_NAME
        $this->BRAND_NAME = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_BRAND_NAME', 'BRAND_NAME', '[BRAND_NAME]', '[BRAND_NAME]', 200, 150, -1, false, '[BRAND_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID2
        $this->MEASURE_ID2 = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MEASURE_ID2', 'MEASURE_ID2', '[MEASURE_ID2]', 'CAST([MEASURE_ID2] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RETUR_ID
        $this->RETUR_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_RETUR_ID', 'RETUR_ID', '[RETUR_ID]', '[RETUR_ID]', 200, 50, -1, false, '[RETUR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SIZE_GOODS
        $this->SIZE_GOODS = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_SIZE_GOODS', 'SIZE_GOODS', '[SIZE_GOODS]', 'CAST([SIZE_GOODS] AS NVARCHAR)', 131, 8, -1, false, '[SIZE_GOODS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_DOSIS
        $this->MEASURE_DOSIS = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MEASURE_DOSIS', 'MEASURE_DOSIS', '[MEASURE_DOSIS]', 'CAST([MEASURE_DOSIS] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_DOSIS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_PRICE
        $this->ORDER_PRICE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ORDER_PRICE', 'ORDER_PRICE', '[ORDER_PRICE]', 'CAST([ORDER_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[ORDER_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_AVAILABLE
        $this->STOCK_AVAILABLE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STOCK_AVAILABLE', 'STOCK_AVAILABLE', '[STOCK_AVAILABLE]', 'CAST([STOCK_AVAILABLE] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_AVAILABLE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MONTH_ID
        $this->MONTH_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_MONTH_ID', 'MONTH_ID', '[MONTH_ID]', 'CAST([MONTH_ID] AS NVARCHAR)', 17, 1, -1, false, '[MONTH_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_DOC
        $this->CORRECTION_DOC = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_CORRECTION_DOC', 'CORRECTION_DOC', '[CORRECTION_DOC]', '[CORRECTION_DOC]', 200, 50, -1, false, '[CORRECTION_DOC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTIONS
        $this->CORRECTIONS = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_CORRECTIONS', 'CORRECTIONS', '[CORRECTIONS]', '[CORRECTIONS]', 200, 255, -1, false, '[CORRECTIONS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_DATE
        $this->CORRECTION_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_CORRECTION_DATE', 'CORRECTION_DATE', '[CORRECTION_DATE]', CastDateFieldForLike("[CORRECTION_DATE]", 0, "DB"), 135, 8, 0, false, '[CORRECTION_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOC_NO
        $this->DOC_NO = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_DOC_NO', 'DOC_NO', '[DOC_NO]', '[DOC_NO]', 200, 50, -1, false, '[DOC_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_ID
        $this->ORDER_ID = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ORDER_ID', 'ORDER_ID', '[ORDER_ID]', '[ORDER_ID]', 200, 50, -1, false, '[ORDER_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 0, "DB"), 135, 8, 0, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 17, 1, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // avgprice
        $this->avgprice = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_avgprice', 'avgprice', '[avgprice]', 'CAST([avgprice] AS NVARCHAR)', 6, 8, -1, false, '[avgprice]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // idx
        $this->idx = new DbField('GOOD_LOCATION', 'GOOD_LOCATION', 'x_idx', 'idx', '[idx]', 'CAST([idx] AS NVARCHAR)', 3, 4, -1, false, '[idx]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[GOOD_LOCATION]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GoodLocationList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GoodLocationView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GoodLocationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GoodLocationAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GoodLocationView";
            case Config("API_ADD_ACTION"):
                return "GoodLocationAdd";
            case Config("API_EDIT_ACTION"):
                return "GoodLocationEdit";
            case Config("API_DELETE_ACTION"):
                return "GoodLocationDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GoodLocationView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GoodLocationView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GoodLocationAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GoodLocationAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GoodLocationEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GoodLocationAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GoodLocationDelete", $this->getUrlParm());
    }
