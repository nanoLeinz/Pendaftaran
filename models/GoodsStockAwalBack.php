...
/**
 * Table class for goods_stock_awal_back
 */
class GoodsStockAwalBack extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'goods_stock_awal_back';
        $this->TableName = 'goods_stock_awal_back';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[goods_stock_awal_back]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ITEM_ID
        $this->ITEM_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_ITEM_ID', 'ITEM_ID', '[ITEM_ID]', '[ITEM_ID]', 200, 50, -1, false, '[ITEM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ROOMS_ID
        $this->ROOMS_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_ROOMS_ID', 'ROOMS_ID', '[ROOMS_ID]', '[ROOMS_ID]', 200, 10, -1, false, '[ROOMS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALLOCATED_DATE
        $this->ALLOCATED_DATE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_ALLOCATED_DATE', 'ALLOCATED_DATE', '[ALLOCATED_DATE]', CastDateFieldForLike("[ALLOCATED_DATE]", 0, "DB"), 135, 8, 0, false, '[ALLOCATED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BATCH_NO
        $this->BATCH_NO = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_BATCH_NO', 'BATCH_NO', '[BATCH_NO]', '[BATCH_NO]', 200, 50, -1, false, '[BATCH_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_NAME
        $this->BRAND_NAME = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_BRAND_NAME', 'BRAND_NAME', '[BRAND_NAME]', '[BRAND_NAME]', 200, 150, -1, false, '[BRAND_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRICE
        $this->PRICE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_PRICE', 'PRICE', '[PRICE]', 'CAST([PRICE] AS NVARCHAR)', 6, 8, -1, false, '[PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AVGPRICE
        $this->AVGPRICE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_AVGPRICE', 'AVGPRICE', '[AVGPRICE]', 'CAST([AVGPRICE] AS NVARCHAR)', 6, 8, -1, false, '[AVGPRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXPIRY_DATE
        $this->EXPIRY_DATE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_EXPIRY_DATE', 'EXPIRY_DATE', '[EXPIRY_DATE]', CastDateFieldForLike("[EXPIRY_DATE]", 0, "DB"), 135, 8, 0, false, '[EXPIRY_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISTRIBUTION_TYPE
        $this->DISTRIBUTION_TYPE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_DISTRIBUTION_TYPE', 'DISTRIBUTION_TYPE', '[DISTRIBUTION_TYPE]', 'CAST([DISTRIBUTION_TYPE] AS NVARCHAR)', 2, 2, -1, false, '[DISTRIBUTION_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MONTH_ID
        $this->MONTH_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_MONTH_ID', 'MONTH_ID', '[MONTH_ID]', 'CAST([MONTH_ID] AS NVARCHAR)', 17, 1, -1, false, '[MONTH_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_OPNAME
        $this->STOCK_OPNAME = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_STOCK_OPNAME', 'STOCK_OPNAME', '[STOCK_OPNAME]', 'CAST([STOCK_OPNAME] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_OPNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOK_AWAL
        $this->STOK_AWAL = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_STOK_AWAL', 'STOK_AWAL', '[STOK_AWAL]', 'CAST([STOK_AWAL] AS NVARCHAR)', 131, 8, -1, false, '[STOK_AWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_LALU
        $this->STOCK_LALU = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_STOCK_LALU', 'STOCK_LALU', '[STOCK_LALU]', 'CAST([STOCK_LALU] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_LALU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_KOREKSI
        $this->STOCK_KOREKSI = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_STOCK_KOREKSI', 'STOCK_KOREKSI', '[STOCK_KOREKSI]', 'CAST([STOCK_KOREKSI] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 150, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // ISCETAK
        $this->ISCETAK = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 17, 1, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 0, "DB"), 135, 8, 0, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // IDX
        $this->IDX = new DbField('goods_stock_awal_back', 'goods_stock_awal_back', 'x_IDX', 'IDX', '[IDX]', 'CAST([IDX] AS NVARCHAR)', 3, 4, -1, false, '[IDX]', false, false, false, 'FORMATTED TEXT', 'NO');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[goods_stock_awal_back]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GoodsStockAwalBackList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GoodsStockAwalBackView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GoodsStockAwalBackEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GoodsStockAwalBackAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GoodsStockAwalBackView";
            case Config("API_ADD_ACTION"):
                return "GoodsStockAwalBackAdd";
            case Config("API_EDIT_ACTION"):
                return "GoodsStockAwalBackEdit";
            case Config("API_DELETE_ACTION"):
                return "GoodsStockAwalBackDelete";
            case Config("API_LIST_ACTION"):
                return "GoodsStockAwalBackList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GoodsStockAwalBackView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GoodsStockAwalBackView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GoodsStockAwalBackAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GoodsStockAwalBackAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GoodsStockAwalBackEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GoodsStockAwalBackAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GoodsStockAwalBackDelete", $this->getUrlParm());
    }
