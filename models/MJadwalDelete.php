 ...
 * Page class
 */
class MJadwalDelete extends MJadwal
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MJadwalDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MJadwalList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MJadwalList"); // Return to list
                return;
            }
        }
