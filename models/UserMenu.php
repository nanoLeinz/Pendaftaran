...
/**
 * Table class for USER_MENU
 */
class UserMenu extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'USER_MENU';
        $this->TableName = 'USER_MENU';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[USER_MENU]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('USER_MENU', 'USER_MENU', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GROUP_ID
        $this->GROUP_ID = new DbField('USER_MENU', 'USER_MENU', 'x_GROUP_ID', 'GROUP_ID', '[GROUP_ID]', 'CAST([GROUP_ID] AS NVARCHAR)', 2, 2, -1, false, '[GROUP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MENU_ID
        $this->MENU_ID = new DbField('USER_MENU', 'USER_MENU', 'x_MENU_ID', 'MENU_ID', '[MENU_ID]', '[MENU_ID]', 200, 50, -1, false, '[MENU_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STYPE_ID
        $this->STYPE_ID = new DbField('USER_MENU', 'USER_MENU', 'x_STYPE_ID', 'STYPE_ID', '[STYPE_ID]', 'CAST([STYPE_ID] AS NVARCHAR)', 2, 2, -1, false, '[STYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // C
        $this->C = new DbField('USER_MENU', 'USER_MENU', 'x_C', 'C', '[C]', '[C]', 200, 1, -1, false, '[C]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // R
        $this->R = new DbField('USER_MENU', 'USER_MENU', 'x_R', 'R', '[R]', '[R]', 200, 1, -1, false, '[R]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // U
        $this->U = new DbField('USER_MENU', 'USER_MENU', 'x_U', 'U', '[U]', '[U]', 200, 1, -1, false, '[U]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // D
        $this->D = new DbField('USER_MENU', 'USER_MENU', 'x_D', 'D', '[D]', '[D]', 200, 1, -1, false, '[D]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('USER_MENU', 'USER_MENU', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('USER_MENU', 'USER_MENU', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[USER_MENU]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [GROUP_ID] = @GROUP_ID@ AND [MENU_ID] = '@MENU_ID@' AND [STYPE_ID] = @STYPE_ID@";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("UserMenuList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "UserMenuEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "UserMenuAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("UserMenuView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("UserMenuView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "UserMenuAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "UserMenuAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("UserMenuEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("UserMenuAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("UserMenuDelete", $this->getUrlParm());
    }
