...
/**
 * Table class for DETAIL_BILL
 */
class DetailBill extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'DETAIL_BILL';
        $this->TableName = 'DETAIL_BILL';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[DETAIL_BILL]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_BILL_ID', 'BILL_ID', '[BILL_ID]', '[BILL_ID]', 200, 50, -1, false, '[BILL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_ID
        $this->COMP_ID = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_COMP_ID', 'COMP_ID', '[COMP_ID]', 'CAST([COMP_ID] AS NVARCHAR)', 17, 1, -1, false, '[COMP_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_TYPE
        $this->COMP_TYPE = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_COMP_TYPE', 'COMP_TYPE', '[COMP_TYPE]', 'CAST([COMP_TYPE] AS NVARCHAR)', 2, 2, -1, false, '[COMP_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMP_NAME
        $this->COMP_NAME = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_COMP_NAME', 'COMP_NAME', '[COMP_NAME]', '[COMP_NAME]', 200, 100, -1, false, '[COMP_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PERCENTAGE
        $this->PERCENTAGE = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_PERCENTAGE', 'PERCENTAGE', '[PERCENTAGE]', 'CAST([PERCENTAGE] AS NVARCHAR)', 131, 8, -1, false, '[PERCENTAGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 100, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('DETAIL_BILL', 'DETAIL_BILL', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 100, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[DETAIL_BILL]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [BILL_ID] = '@BILL_ID@' AND [TARIF_ID] = '@TARIF_ID@' AND [COMP_ID] = @COMP_ID@";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 4) {
            ...
            if ($current) {
                $this->TARIF_ID->CurrentValue = $keys[2];
            } else {
                $this->TARIF_ID->OldValue = $keys[2];
            }
            if ($current) {
                $this->COMP_ID->CurrentValue = $keys[3];
            } else {
                $this->COMP_ID->OldValue = $keys[3];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DetailBillList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DetailBillView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DetailBillEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DetailBillAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DetailBillView";
            case Config("API_ADD_ACTION"):
                return "DetailBillAdd";
            case Config("API_EDIT_ACTION"):
                return "DetailBillEdit";
            case Config("API_DELETE_ACTION"):
                return "DetailBillDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DetailBillView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DetailBillView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DetailBillAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DetailBillAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DetailBillEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetailBillAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DetailBillDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->TARIF_ID->CurrentValue = $key[2];
            } else {
                $this->TARIF_ID->OldValue = $key[2];
            }
            if ($setCurrent) {
                $this->COMP_ID->CurrentValue = $key[3];
            } else {
                $this->COMP_ID->OldValue = $key[3];
            }
