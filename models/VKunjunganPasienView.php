 ...
 * Page class
 */
class VKunjunganPasienView extends VKunjunganPasien
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VKunjunganPasienView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("VISIT_ID") ?? Route("VISIT_ID")) !== null) {
                ...
                $returnUrl = "VKunjunganPasienList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VKunjunganPasienList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VKunjunganPasienList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
