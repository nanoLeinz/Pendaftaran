...
/**
 * Table class for RANGE_DISCOUNT
 */
class RangeDiscount extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'RANGE_DISCOUNT';
        $this->TableName = 'RANGE_DISCOUNT';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[RANGE_DISCOUNT]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RANGE_ID
        $this->RANGE_ID = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_RANGE_ID', 'RANGE_ID', '[RANGE_ID]', '[RANGE_ID]', 200, 50, -1, false, '[RANGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISPLAY
        $this->DISPLAY = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_DISPLAY', 'DISPLAY', '[DISPLAY]', '[DISPLAY]', 200, 100, -1, false, '[DISPLAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOWERB
        $this->LOWERB = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_LOWERB', 'LOWERB', '[LOWERB]', 'CAST([LOWERB] AS NVARCHAR)', 6, 8, -1, false, '[LOWERB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // UPPERB
        $this->UPPERB = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_UPPERB', 'UPPERB', '[UPPERB]', 'CAST([UPPERB] AS NVARCHAR)', 6, 8, -1, false, '[UPPERB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MARGIN
        $this->MARGIN = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_MARGIN', 'MARGIN', '[MARGIN]', 'CAST([MARGIN] AS NVARCHAR)', 131, 8, -1, false, '[MARGIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // STATUS_OBAT
        $this->STATUS_OBAT = new DbField('RANGE_DISCOUNT', 'RANGE_DISCOUNT', 'x_STATUS_OBAT', 'STATUS_OBAT', '[STATUS_OBAT]', 'CAST([STATUS_OBAT] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_OBAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[RANGE_DISCOUNT]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RangeDiscountList");
    }
    ...
    {
        global $Language;
        if ($pageName == "RangeDiscountView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RangeDiscountEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RangeDiscountAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "RangeDiscountView";
            case Config("API_ADD_ACTION"):
                return "RangeDiscountAdd";
            case Config("API_EDIT_ACTION"):
                return "RangeDiscountEdit";
            case Config("API_DELETE_ACTION"):
                return "RangeDiscountDelete";
            case Config("API_LIST_ACTION"):
                return "RangeDiscountList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RangeDiscountView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RangeDiscountView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RangeDiscountAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RangeDiscountAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RangeDiscountEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RangeDiscountAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RangeDiscountDelete", $this->getUrlParm());
    }
