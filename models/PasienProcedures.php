...
/**
 * Table class for PASIEN_PROCEDURES
 */
class PasienProcedures extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'PASIEN_PROCEDURES';
        $this->TableName = 'PASIEN_PROCEDURES';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[PASIEN_PROCEDURES]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // PASIEN_DIAGNOSA_ID
        $this->PASIEN_DIAGNOSA_ID = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_PASIEN_DIAGNOSA_ID', 'PASIEN_DIAGNOSA_ID', '[PASIEN_DIAGNOSA_ID]', '[PASIEN_DIAGNOSA_ID]', 200, 50, -1, false, '[PASIEN_DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 50, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_NAME
        $this->DIAGNOSA_NAME = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_DIAGNOSA_NAME', 'DIAGNOSA_NAME', '[DIAGNOSA_NAME]', '[DIAGNOSA_NAME]', 200, 250, -1, false, '[DIAGNOSA_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_DESC
        $this->DIAGNOSA_DESC = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_DIAGNOSA_DESC', 'DIAGNOSA_DESC', '[DIAGNOSA_DESC]', '[DIAGNOSA_DESC]', 200, 250, -1, false, '[DIAGNOSA_DESC]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTIONS
        $this->DESCRIPTIONS = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_DESCRIPTIONS', 'DESCRIPTIONS', '[DESCRIPTIONS]', '[DESCRIPTIONS]', 200, 250, -1, false, '[DESCRIPTIONS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTIONS->Sortable = true; // Allow sort
        $this->DESCRIPTIONS->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTIONS->Param, "CustomMsg");
        $this->Fields['DESCRIPTIONS'] = &$this->DESCRIPTIONS;

        // DIAG_TYPE
        $this->DIAG_TYPE = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_DIAG_TYPE', 'DIAG_TYPE', '[DIAG_TYPE]', '[DIAG_TYPE]', 200, 50, -1, false, '[DIAG_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIAG_TYPE->Sortable = true; // Allow sort
        $this->DIAG_TYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DIAG_TYPE->Param, "CustomMsg");
        $this->Fields['DIAG_TYPE'] = &$this->DIAG_TYPE;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('PASIEN_PROCEDURES', 'PASIEN_PROCEDURES', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[PASIEN_PROCEDURES]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->DESCRIPTIONS->DbValue = $row['DESCRIPTIONS'];
        $this->DIAG_TYPE->DbValue = $row['DIAG_TYPE'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PasienProceduresList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PasienProceduresView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PasienProceduresEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PasienProceduresAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "PasienProceduresView";
            case Config("API_ADD_ACTION"):
                return "PasienProceduresAdd";
            case Config("API_EDIT_ACTION"):
                return "PasienProceduresEdit";
            case Config("API_DELETE_ACTION"):
                return "PasienProceduresDelete";
            case Config("API_LIST_ACTION"):
                return "PasienProceduresList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PasienProceduresView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PasienProceduresView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PasienProceduresAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PasienProceduresAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PasienProceduresEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PasienProceduresAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PasienProceduresDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->DESCRIPTIONS->setDbValue($row['DESCRIPTIONS']);
        $this->DIAG_TYPE->setDbValue($row['DIAG_TYPE']);
    ...
    public function renderListRow()
    {
        ...
        // DESCRIPTIONS
        $this->DESCRIPTIONS->ViewValue = $this->DESCRIPTIONS->CurrentValue;
        $this->DESCRIPTIONS->ViewCustomAttributes = "";

        // DIAG_TYPE
        $this->DIAG_TYPE->ViewValue = $this->DIAG_TYPE->CurrentValue;
        $this->DIAG_TYPE->ViewCustomAttributes = "";
        ...
        // DESCRIPTIONS
        $this->DESCRIPTIONS->LinkCustomAttributes = "";
        $this->DESCRIPTIONS->HrefValue = "";
        $this->DESCRIPTIONS->TooltipValue = "";

        // DIAG_TYPE
        $this->DIAG_TYPE->LinkCustomAttributes = "";
        $this->DIAG_TYPE->HrefValue = "";
        $this->DIAG_TYPE->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // DESCRIPTIONS
        $this->DESCRIPTIONS->EditAttrs["class"] = "form-control";
        $this->DESCRIPTIONS->EditCustomAttributes = "";
        if (!$this->DESCRIPTIONS->Raw) {
            $this->DESCRIPTIONS->CurrentValue = HtmlDecode($this->DESCRIPTIONS->CurrentValue);
        }
        $this->DESCRIPTIONS->EditValue = $this->DESCRIPTIONS->CurrentValue;
        $this->DESCRIPTIONS->PlaceHolder = RemoveHtml($this->DESCRIPTIONS->caption());

        // DIAG_TYPE
        $this->DIAG_TYPE->EditAttrs["class"] = "form-control";
        $this->DIAG_TYPE->EditCustomAttributes = "";
        if (!$this->DIAG_TYPE->Raw) {
            $this->DIAG_TYPE->CurrentValue = HtmlDecode($this->DIAG_TYPE->CurrentValue);
        }
        $this->DIAG_TYPE->EditValue = $this->DIAG_TYPE->CurrentValue;
        $this->DIAG_TYPE->PlaceHolder = RemoveHtml($this->DIAG_TYPE->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->DESCRIPTIONS);
                    $doc->exportCaption($this->DIAG_TYPE);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->DESCRIPTIONS);
                        $doc->exportField($this->DIAG_TYPE);
