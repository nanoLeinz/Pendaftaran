...
/**
 * Table class for CLINIC_TARIF
 */
class ClinicTarif extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CLINIC_TARIF';
        $this->TableName = 'CLINIC_TARIF';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CLINIC_TARIF]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CLINIC_TARIF', 'CLINIC_TARIF', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('CLINIC_TARIF', 'CLINIC_TARIF', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('CLINIC_TARIF', 'CLINIC_TARIF', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CLINIC_TARIF]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [CLINIC_ID] = '@CLINIC_ID@' AND [TARIF_ID] = '@TARIF_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClinicTarifList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ClinicTarifView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ClinicTarifEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ClinicTarifAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ClinicTarifView";
            case Config("API_ADD_ACTION"):
                return "ClinicTarifAdd";
            case Config("API_EDIT_ACTION"):
                return "ClinicTarifEdit";
            case Config("API_DELETE_ACTION"):
                return "ClinicTarifDelete";
            case Config("API_LIST_ACTION"):
                return "ClinicTarifList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClinicTarifView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ClinicTarifView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ClinicTarifAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ClinicTarifAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ClinicTarifEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicTarifAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ClinicTarifDelete", $this->getUrlParm());
    }
