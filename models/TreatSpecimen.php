...
/**
 * Table class for TREAT_SPECIMEN
 */
class TreatSpecimen extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREAT_SPECIMEN';
        $this->TableName = 'TREAT_SPECIMEN';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREAT_SPECIMEN]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPECIMEN_ID
        $this->SPECIMEN_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_SPECIMEN_ID', 'SPECIMEN_ID', '[SPECIMEN_ID]', '[SPECIMEN_ID]', 200, 50, -1, false, '[SPECIMEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPECIMEN_ID->IsPrimaryKey = true; // Primary key field
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SPEC_TYPE
        $this->SPEC_TYPE = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_SPEC_TYPE', 'SPEC_TYPE', '[SPEC_TYPE]', '[SPEC_TYPE]', 200, 50, -1, false, '[SPEC_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPEC_TYPE->Sortable = true; // Allow sort
        $this->SPEC_TYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPEC_TYPE->Param, "CustomMsg");
        $this->Fields['SPEC_TYPE'] = &$this->SPEC_TYPE;

        // CLINIC_ID
        $this->CLINIC_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TEST_DATE
        $this->TEST_DATE = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_TEST_DATE', 'TEST_DATE', '[TEST_DATE]', CastDateFieldForLike("[TEST_DATE]", 0, "DB"), 135, 8, 0, false, '[TEST_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->TEST_DATE->Sortable = true; // Allow sort
        $this->TEST_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->TEST_DATE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->TEST_DATE->Param, "CustomMsg");
        $this->Fields['TEST_DATE'] = &$this->TEST_DATE;

        // SPECIMEN_NO
        $this->SPECIMEN_NO = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_SPECIMEN_NO', 'SPECIMEN_NO', '[SPECIMEN_NO]', '[SPECIMEN_NO]', 200, 50, -1, false, '[SPECIMEN_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SPECIMEN_NO->Sortable = true; // Allow sort
        $this->SPECIMEN_NO->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->SPECIMEN_NO->Param, "CustomMsg");
        $this->Fields['SPECIMEN_NO'] = &$this->SPECIMEN_NO;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 200, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // THENAME
        $this->THENAME = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 150, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_THEID', 'THEID', '[THEID]', '[THEID]', 200, 50, -1, false, '[THEID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 17, 1, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 17, 1, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 17, 1, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // DOCTOR
        $this->DOCTOR = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_DOCTOR', 'DOCTOR', '[DOCTOR]', '[DOCTOR]', 200, 150, -1, false, '[DOCTOR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 15, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('TREAT_SPECIMEN', 'TREAT_SPECIMEN', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREAT_SPECIMEN]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('SPECIMEN_ID', $rs)) {
                AddFilter($where, QuotedName('SPECIMEN_ID', $this->Dbid) . '=' . QuotedValue($rs['SPECIMEN_ID'], $this->SPECIMEN_ID->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->SPEC_TYPE->DbValue = $row['SPEC_TYPE'];
        $this->CLINIC_ID->DbValue = $row['CLINIC_ID'];
        $this->TEST_DATE->DbValue = $row['TEST_DATE'];
        $this->SPECIMEN_NO->DbValue = $row['SPECIMEN_NO'];
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [SPECIMEN_ID] = '@SPECIMEN_ID@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->SPECIMEN_ID->CurrentValue : $this->SPECIMEN_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->SPECIMEN_ID->CurrentValue = $keys[1];
            } else {
                $this->SPECIMEN_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('SPECIMEN_ID', $row) ? $row['SPECIMEN_ID'] : null;
        } else {
            $val = $this->SPECIMEN_ID->OldValue !== null ? $this->SPECIMEN_ID->OldValue : $this->SPECIMEN_ID->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@SPECIMEN_ID@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatSpecimenList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TreatSpecimenView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TreatSpecimenEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatSpecimenAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatSpecimenView";
            case Config("API_ADD_ACTION"):
                return "TreatSpecimenAdd";
            case Config("API_EDIT_ACTION"):
                return "TreatSpecimenEdit";
            case Config("API_DELETE_ACTION"):
                return "TreatSpecimenDelete";
            case Config("API_LIST_ACTION"):
                return "TreatSpecimenList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatSpecimenView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatSpecimenView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatSpecimenAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatSpecimenAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatSpecimenEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatSpecimenAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatSpecimenDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",SPECIMEN_ID:" . JsonEncode($this->SPECIMEN_ID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->SPECIMEN_ID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->SPECIMEN_ID->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("SPECIMEN_ID") ?? Route("SPECIMEN_ID")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->SPECIMEN_ID->CurrentValue = $key[1];
            } else {
                $this->SPECIMEN_ID->OldValue = $key[1];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->SPEC_TYPE->setDbValue($row['SPEC_TYPE']);
        $this->CLINIC_ID->setDbValue($row['CLINIC_ID']);
        $this->TEST_DATE->setDbValue($row['TEST_DATE']);
        $this->SPECIMEN_NO->setDbValue($row['SPECIMEN_NO']);
    ...
    public function renderListRow()
    {
        ...
        // SPEC_TYPE
        $this->SPEC_TYPE->ViewValue = $this->SPEC_TYPE->CurrentValue;
        $this->SPEC_TYPE->ViewCustomAttributes = "";
        ...
        // TEST_DATE
        $this->TEST_DATE->ViewValue = $this->TEST_DATE->CurrentValue;
        $this->TEST_DATE->ViewValue = FormatDateTime($this->TEST_DATE->ViewValue, 0);
        $this->TEST_DATE->ViewCustomAttributes = "";

        // SPECIMEN_NO
        $this->SPECIMEN_NO->ViewValue = $this->SPECIMEN_NO->CurrentValue;
        $this->SPECIMEN_NO->ViewCustomAttributes = "";
        ...
        // SPEC_TYPE
        $this->SPEC_TYPE->LinkCustomAttributes = "";
        $this->SPEC_TYPE->HrefValue = "";
        $this->SPEC_TYPE->TooltipValue = "";
        ...
        // TEST_DATE
        $this->TEST_DATE->LinkCustomAttributes = "";
        $this->TEST_DATE->HrefValue = "";
        $this->TEST_DATE->TooltipValue = "";

        // SPECIMEN_NO
        $this->SPECIMEN_NO->LinkCustomAttributes = "";
        $this->SPECIMEN_NO->HrefValue = "";
        $this->SPECIMEN_NO->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // SPEC_TYPE
        $this->SPEC_TYPE->EditAttrs["class"] = "form-control";
        $this->SPEC_TYPE->EditCustomAttributes = "";
        if (!$this->SPEC_TYPE->Raw) {
            $this->SPEC_TYPE->CurrentValue = HtmlDecode($this->SPEC_TYPE->CurrentValue);
        }
        $this->SPEC_TYPE->EditValue = $this->SPEC_TYPE->CurrentValue;
        $this->SPEC_TYPE->PlaceHolder = RemoveHtml($this->SPEC_TYPE->caption());
        ...
        // TEST_DATE
        $this->TEST_DATE->EditAttrs["class"] = "form-control";
        $this->TEST_DATE->EditCustomAttributes = "";
        $this->TEST_DATE->EditValue = FormatDateTime($this->TEST_DATE->CurrentValue, 8);
        $this->TEST_DATE->PlaceHolder = RemoveHtml($this->TEST_DATE->caption());

        // SPECIMEN_NO
        $this->SPECIMEN_NO->EditAttrs["class"] = "form-control";
        $this->SPECIMEN_NO->EditCustomAttributes = "";
        if (!$this->SPECIMEN_NO->Raw) {
            $this->SPECIMEN_NO->CurrentValue = HtmlDecode($this->SPECIMEN_NO->CurrentValue);
        }
        $this->SPECIMEN_NO->EditValue = $this->SPECIMEN_NO->CurrentValue;
        $this->SPECIMEN_NO->PlaceHolder = RemoveHtml($this->SPECIMEN_NO->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->SPEC_TYPE);
                    $doc->exportCaption($this->CLINIC_ID);
                    $doc->exportCaption($this->TEST_DATE);
                    $doc->exportCaption($this->SPECIMEN_NO);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->SPEC_TYPE);
                        $doc->exportField($this->CLINIC_ID);
                        $doc->exportField($this->TEST_DATE);
                        $doc->exportField($this->SPECIMEN_NO);
