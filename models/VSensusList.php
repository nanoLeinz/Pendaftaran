 ...
 * Page class
 */
class VSensusList extends VSensus
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'V_SENSUS';

    // Page object name
    public $PageObjName = "VSensusList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fV_SENSUSlist";
    ...
    public function __construct()
    {
        ...
        // Table object (V_SENSUS)
        if (!isset($GLOBALS["V_SENSUS"]) || get_class($GLOBALS["V_SENSUS"]) == PROJECT_NAMESPACE . "V_SENSUS") {
            $GLOBALS["V_SENSUS"] = &$this;
        }
        ...
        $this->AddUrl = "VSensusAdd";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiDeleteUrl = "VSensusDelete";
        $this->MultiUpdateUrl = "VSensusUpdate";

        // Table name (for backward compatibility only)
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'V_SENSUS');
        }
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fV_SENSUSlistsrch";
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("V_SENSUS"));
                $doc->Text = @$content;
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fV_SENSUSlistsrch", $filters);
    ...
    protected function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->NAME_OF_CLINIC, $default, false); // NAME_OF_CLINIC
        ...
        if (!$default && $this->Command == "search") {
            ...
            $this->NAME_OF_CLINIC->AdvancedSearch->save(); // NAME_OF_CLINIC
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->NAME_OF_CLINIC->AdvancedSearch->issetSession()) {
            return true;
        }
    ...
    protected function resetAdvancedSearchParms()
    {
                ...
                $this->NAME_OF_CLINIC->AdvancedSearch->unsetSession();
    ...
    protected function restoreSearchParms()
    {
        ...
        // Restore advanced search values
                ...
                $this->NAME_OF_CLINIC->AdvancedSearch->load();
    ...
    public function renderListOptions()
    {
        ...
        $opt->Body = "<div class=\"custom-control custom-checkbox d-inline-block\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"custom-control-input ew-multi-select\" value=\"" . HtmlEncode($this->NO_REGISTRATION->CurrentValue) . "\" onclick=\"ew.clickMultiCheckbox(event);\"><label class=\"custom-control-label\" for=\"key_m_" . $this->RowCount . "\"></label></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fV_SENSUSlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fV_SENSUSlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fV_SENSUSlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function loadSearchValues()
    {
        ...
        // NAME_OF_CLINIC
        if (!$this->isAddOrEdit() && $this->NAME_OF_CLINIC->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->NAME_OF_CLINIC->AdvancedSearch->SearchValue != "" || $this->NAME_OF_CLINIC->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->NAME_OF_CLINIC->Raw) {
                $this->NAME_OF_CLINIC->AdvancedSearch->SearchValue = HtmlDecode($this->NAME_OF_CLINIC->AdvancedSearch->SearchValue);
            }
            $this->NAME_OF_CLINIC->EditValue = HtmlEncode($this->NAME_OF_CLINIC->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckStdDate($this->VISIT_DATE->AdvancedSearch->SearchValue)) {
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fV_SENSUSlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
