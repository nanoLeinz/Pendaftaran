 ...
 * Page class
 */
class MAlatCssdDelete extends MAlatCssd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MAlatCssdDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("MAlatCssdList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("MAlatCssdList"); // Return to list
                return;
            }
        }
