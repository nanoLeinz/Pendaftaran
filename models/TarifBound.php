...
/**
 * Table class for TARIF_BOUND
 */
class TarifBound extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TARIF_BOUND';
        $this->TableName = 'TARIF_BOUND';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TARIF_BOUND]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TARIF_BOUND', 'TARIF_BOUND', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('TARIF_BOUND', 'TARIF_BOUND', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REAGENT_ID
        $this->REAGENT_ID = new DbField('TARIF_BOUND', 'TARIF_BOUND', 'x_REAGENT_ID', 'REAGENT_ID', '[REAGENT_ID]', '[REAGENT_ID]', 200, 50, -1, false, '[REAGENT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TARIF_BOUND]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [TARIF_ID] = '@TARIF_ID@' AND [REAGENT_ID] = '@REAGENT_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifBoundList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TarifBoundView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifBoundEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifBoundAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TarifBoundView";
            case Config("API_ADD_ACTION"):
                return "TarifBoundAdd";
            case Config("API_EDIT_ACTION"):
                return "TarifBoundEdit";
            case Config("API_DELETE_ACTION"):
                return "TarifBoundDelete";
            case Config("API_LIST_ACTION"):
                return "TarifBoundList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifBoundView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifBoundView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifBoundAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TarifBoundAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TarifBoundEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifBoundAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifBoundDelete", $this->getUrlParm());
    }
