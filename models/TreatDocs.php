...
/**
 * Table class for TREAT_DOCS
 */
class TreatDocs extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREAT_DOCS';
        $this->TableName = 'TREAT_DOCS';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREAT_DOCS]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOC_ID
        $this->DOC_ID = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_DOC_ID', 'DOC_ID', '[DOC_ID]', '[DOC_ID]', 200, 50, -1, false, '[DOC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_NOTA_NO', 'NOTA_NO', '[NOTA_NO]', '[NOTA_NO]', 200, 50, -1, false, '[NOTA_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCFILES
        $this->DOCFILES = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_DOCFILES', 'DOCFILES', '[DOCFILES]', '[DOCFILES]', 200, 250, -1, false, '[DOCFILES]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DOCFILES->Sortable = true; // Allow sort
        $this->DOCFILES->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DOCFILES->Param, "CustomMsg");
        $this->Fields['DOCFILES'] = &$this->DOCFILES;

        // UPLOAD_DATE
        $this->UPLOAD_DATE = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_UPLOAD_DATE', 'UPLOAD_DATE', '[UPLOAD_DATE]', CastDateFieldForLike("[UPLOAD_DATE]", 0, "DB"), 135, 8, 0, false, '[UPLOAD_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->UPLOAD_DATE->Sortable = true; // Allow sort
        $this->UPLOAD_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->UPLOAD_DATE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->UPLOAD_DATE->Param, "CustomMsg");
        $this->Fields['UPLOAD_DATE'] = &$this->UPLOAD_DATE;

        // UPLOAD_BY
        $this->UPLOAD_BY = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_UPLOAD_BY', 'UPLOAD_BY', '[UPLOAD_BY]', '[UPLOAD_BY]', 200, 50, -1, false, '[UPLOAD_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->UPLOAD_BY->Sortable = true; // Allow sort
        $this->UPLOAD_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->UPLOAD_BY->Param, "CustomMsg");
        $this->Fields['UPLOAD_BY'] = &$this->UPLOAD_BY;

        // CONCLUSION
        $this->CONCLUSION = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_CONCLUSION', 'CONCLUSION', '[CONCLUSION]', '[CONCLUSION]', 201, 0, -1, false, '[CONCLUSION]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TREAT_DOCS', 'TREAT_DOCS', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREAT_DOCS]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->DOCFILES->DbValue = $row['DOCFILES'];
        $this->UPLOAD_DATE->DbValue = $row['UPLOAD_DATE'];
        $this->UPLOAD_BY->DbValue = $row['UPLOAD_BY'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatDocsList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TreatDocsView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TreatDocsEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatDocsAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatDocsView";
            case Config("API_ADD_ACTION"):
                return "TreatDocsAdd";
            case Config("API_EDIT_ACTION"):
                return "TreatDocsEdit";
            case Config("API_DELETE_ACTION"):
                return "TreatDocsDelete";
            case Config("API_LIST_ACTION"):
                return "TreatDocsList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatDocsView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatDocsView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatDocsAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatDocsAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TreatDocsEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatDocsAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatDocsDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->DOCFILES->setDbValue($row['DOCFILES']);
        $this->UPLOAD_DATE->setDbValue($row['UPLOAD_DATE']);
        $this->UPLOAD_BY->setDbValue($row['UPLOAD_BY']);
    ...
    public function renderListRow()
    {
        ...
        // DOCFILES
        $this->DOCFILES->ViewValue = $this->DOCFILES->CurrentValue;
        $this->DOCFILES->ViewCustomAttributes = "";

        // UPLOAD_DATE
        $this->UPLOAD_DATE->ViewValue = $this->UPLOAD_DATE->CurrentValue;
        $this->UPLOAD_DATE->ViewValue = FormatDateTime($this->UPLOAD_DATE->ViewValue, 0);
        $this->UPLOAD_DATE->ViewCustomAttributes = "";

        // UPLOAD_BY
        $this->UPLOAD_BY->ViewValue = $this->UPLOAD_BY->CurrentValue;
        $this->UPLOAD_BY->ViewCustomAttributes = "";
        ...
        // DOCFILES
        $this->DOCFILES->LinkCustomAttributes = "";
        $this->DOCFILES->HrefValue = "";
        $this->DOCFILES->TooltipValue = "";
        ...
        // UPLOAD_BY
        $this->UPLOAD_BY->LinkCustomAttributes = "";
        $this->UPLOAD_BY->HrefValue = "";
        $this->UPLOAD_BY->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // DOCFILES
        $this->DOCFILES->EditAttrs["class"] = "form-control";
        $this->DOCFILES->EditCustomAttributes = "";
        if (!$this->DOCFILES->Raw) {
            $this->DOCFILES->CurrentValue = HtmlDecode($this->DOCFILES->CurrentValue);
        }
        $this->DOCFILES->EditValue = $this->DOCFILES->CurrentValue;
        $this->DOCFILES->PlaceHolder = RemoveHtml($this->DOCFILES->caption());

        // UPLOAD_DATE
        $this->UPLOAD_DATE->EditAttrs["class"] = "form-control";
        $this->UPLOAD_DATE->EditCustomAttributes = "";
        $this->UPLOAD_DATE->EditValue = FormatDateTime($this->UPLOAD_DATE->CurrentValue, 8);
        $this->UPLOAD_DATE->PlaceHolder = RemoveHtml($this->UPLOAD_DATE->caption());

        // UPLOAD_BY
        $this->UPLOAD_BY->EditAttrs["class"] = "form-control";
        $this->UPLOAD_BY->EditCustomAttributes = "";
        if (!$this->UPLOAD_BY->Raw) {
            $this->UPLOAD_BY->CurrentValue = HtmlDecode($this->UPLOAD_BY->CurrentValue);
        }
        $this->UPLOAD_BY->EditValue = $this->UPLOAD_BY->CurrentValue;
        $this->UPLOAD_BY->PlaceHolder = RemoveHtml($this->UPLOAD_BY->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->DOCFILES);
                    $doc->exportCaption($this->UPLOAD_DATE);
                    $doc->exportCaption($this->UPLOAD_BY);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->DOCFILES);
                        $doc->exportField($this->UPLOAD_DATE);
                        $doc->exportField($this->UPLOAD_BY);
