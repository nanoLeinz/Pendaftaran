 ...
 * Page class
 */
class LPembiayaanDelete extends LPembiayaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LPembiayaanDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("LPembiayaanList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("LPembiayaanList"); // Return to list
                return;
            }
        }
