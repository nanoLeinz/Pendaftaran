...
class Tasks extends DbTable
{
    ...
    public function __construct()
    {
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TASKS', 'TASKS', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TASK_ID
        $this->TASK_ID = new DbField('TASKS', 'TASKS', 'x_TASK_ID', 'TASK_ID', '[TASK_ID]', 'CAST([TASK_ID] AS NVARCHAR)', 2, 2, -1, false, '[TASK_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TASKNAME
        $this->TASKNAME = new DbField('TASKS', 'TASKS', 'x_TASKNAME', 'TASKNAME', '[TASKNAME]', '[TASKNAME]', 200, 100, -1, false, '[TASKNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TASKS]";
    }
    ...
    {
        global $Language;
        if ($pageName == "TasksView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TasksEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TasksAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TasksView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TasksView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TasksAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TasksAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TasksEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TasksAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TasksDelete", $this->getUrlParm());
    }
