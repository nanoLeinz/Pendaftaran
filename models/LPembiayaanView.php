 ...
 * Page class
 */
class LPembiayaanView extends LPembiayaan
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "LPembiayaanView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("id_pembiayaan") ?? Route("id_pembiayaan")) !== null) {
            $this->RecKey["id_pembiayaan"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id_pembiayaan") ?? Route("id_pembiayaan")) !== null) {
                ...
                $this->RecKey["id_pembiayaan"] = $this->id_pembiayaan->QueryStringValue;
            } elseif (Post("id_pembiayaan") !== null) {
                $this->id_pembiayaan->setFormValue(Post("id_pembiayaan"));
                $this->RecKey["id_pembiayaan"] = $this->id_pembiayaan->FormValue;
            } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
                $this->id_pembiayaan->setQueryStringValue($keyValue);
                $this->RecKey["id_pembiayaan"] = $this->id_pembiayaan->QueryStringValue;
            } else {
                $returnUrl = "LPembiayaanList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "LPembiayaanList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "LPembiayaanList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
