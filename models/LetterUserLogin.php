...
/**
 * Table class for LETTER_USER_LOGIN
 */
class LetterUserLogin extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'LETTER_USER_LOGIN';
        $this->TableName = 'LETTER_USER_LOGIN';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[LETTER_USER_LOGIN]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USERNAME
        $this->_USERNAME = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x__USERNAME', 'USERNAME', '[USERNAME]', '[USERNAME]', 200, 16, -1, false, '[USERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FULLNAME
        $this->FULLNAME = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_FULLNAME', 'FULLNAME', '[FULLNAME]', '[FULLNAME]', 200, 200, -1, false, '[FULLNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PASSWORD
        $this->_PASSWORD = new DbField('LETTER_USER_LOGIN', 'LETTER_USER_LOGIN', 'x__PASSWORD', 'PASSWORD', '[PASSWORD]', '[PASSWORD]', 200, 50, -1, false, '[PASSWORD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[LETTER_USER_LOGIN]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [USERNAME] = '@_USERNAME@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LetterUserLoginList");
    }
    ...
    {
        global $Language;
        if ($pageName == "LetterUserLoginView") {
            return $Language->phrase("View");
        } elseif ($pageName == "LetterUserLoginEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LetterUserLoginAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LetterUserLoginView";
            case Config("API_ADD_ACTION"):
                return "LetterUserLoginAdd";
            case Config("API_EDIT_ACTION"):
                return "LetterUserLoginEdit";
            case Config("API_DELETE_ACTION"):
                return "LetterUserLoginDelete";
            case Config("API_LIST_ACTION"):
                return "LetterUserLoginList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LetterUserLoginView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LetterUserLoginView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LetterUserLoginAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LetterUserLoginAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LetterUserLoginEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LetterUserLoginAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LetterUserLoginDelete", $this->getUrlParm());
    }
