...
/**
 * Table class for PRICE_QUOTATION
 */
class PriceQuotation extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'PRICE_QUOTATION';
        $this->TableName = 'PRICE_QUOTATION';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[PRICE_QUOTATION]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUOTE_ID
        $this->QUOTE_ID = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_QUOTE_ID', 'QUOTE_ID', '[QUOTE_ID]', '[QUOTE_ID]', 200, 15, -1, false, '[QUOTE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->QUOTE_ID->IsPrimaryKey = true; // Primary key field
        $this->QUOTE_ID->Nullable = false; // NOT NULL field
        $this->QUOTE_ID->Required = true; // Required field
        $this->QUOTE_ID->Sortable = true; // Allow sort
        $this->QUOTE_ID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->QUOTE_ID->Param, "CustomMsg");
        $this->Fields['QUOTE_ID'] = &$this->QUOTE_ID;

        // BRAND_ID
        $this->BRAND_ID = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NET_PRICE
        $this->NET_PRICE = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_NET_PRICE', 'NET_PRICE', '[NET_PRICE]', 'CAST([NET_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[NET_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // START_DATE
        $this->START_DATE = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_START_DATE', 'START_DATE', '[START_DATE]', CastDateFieldForLike("[START_DATE]", 0, "DB"), 135, 8, 0, false, '[START_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // END_DATE
        $this->END_DATE = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_END_DATE', 'END_DATE', '[END_DATE]', CastDateFieldForLike("[END_DATE]", 0, "DB"), 135, 8, 0, false, '[END_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('PRICE_QUOTATION', 'PRICE_QUOTATION', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[PRICE_QUOTATION]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [QUOTE_ID] = '@QUOTE_ID@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->QUOTE_ID->CurrentValue : $this->QUOTE_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->QUOTE_ID->CurrentValue = $keys[1];
            } else {
                $this->QUOTE_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("PriceQuotationList");
    }
    ...
    {
        global $Language;
        if ($pageName == "PriceQuotationView") {
            return $Language->phrase("View");
        } elseif ($pageName == "PriceQuotationEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "PriceQuotationAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "PriceQuotationAdd";
            case Config("API_EDIT_ACTION"):
                return "PriceQuotationEdit";
            case Config("API_DELETE_ACTION"):
                return "PriceQuotationDelete";
            case Config("API_LIST_ACTION"):
                return "PriceQuotationList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("PriceQuotationView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("PriceQuotationView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "PriceQuotationAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "PriceQuotationAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PriceQuotationEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("PriceQuotationAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("PriceQuotationDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",QUOTE_ID:" . JsonEncode($this->QUOTE_ID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->QUOTE_ID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->QUOTE_ID->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("QUOTE_ID") ?? Route("QUOTE_ID")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->QUOTE_ID->CurrentValue = $key[1];
            } else {
                $this->QUOTE_ID->OldValue = $key[1];
            }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->QUOTE_ID->Raw) {
            $this->QUOTE_ID->CurrentValue = HtmlDecode($this->QUOTE_ID->CurrentValue);
        }
        $this->QUOTE_ID->EditValue = $this->QUOTE_ID->CurrentValue;
        $this->QUOTE_ID->PlaceHolder = RemoveHtml($this->QUOTE_ID->caption());
