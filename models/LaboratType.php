...
/**
 * Table class for laborat_type
 */
class LaboratType extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'laborat_type';
        $this->TableName = 'laborat_type';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[laborat_type]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // activity_id
        $this->activity_id = new DbField('laborat_type', 'laborat_type', 'x_activity_id', 'activity_id', '[activity_id]', 'CAST([activity_id] AS NVARCHAR)', 20, 8, -1, false, '[activity_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // display_tarif
        $this->display_tarif = new DbField('laborat_type', 'laborat_type', 'x_display_tarif', 'display_tarif', '[display_tarif]', '[display_tarif]', 200, 200, -1, false, '[display_tarif]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // treat_id
        $this->treat_id = new DbField('laborat_type', 'laborat_type', 'x_treat_id', 'treat_id', '[treat_id]', '[treat_id]', 200, 25, -1, false, '[treat_id]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[laborat_type]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LaboratTypeList");
    }
    ...
    {
        global $Language;
        if ($pageName == "LaboratTypeView") {
            return $Language->phrase("View");
        } elseif ($pageName == "LaboratTypeEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LaboratTypeAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LaboratTypeView";
            case Config("API_ADD_ACTION"):
                return "LaboratTypeAdd";
            case Config("API_EDIT_ACTION"):
                return "LaboratTypeEdit";
            case Config("API_DELETE_ACTION"):
                return "LaboratTypeDelete";
            case Config("API_LIST_ACTION"):
                return "LaboratTypeList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LaboratTypeView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LaboratTypeView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LaboratTypeAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LaboratTypeAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("LaboratTypeEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LaboratTypeAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LaboratTypeDelete", $this->getUrlParm());
    }
