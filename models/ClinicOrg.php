...
/**
 * Table class for CLINIC_ORG
 */
class ClinicOrg extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CLINIC_ORG';
        $this->TableName = 'CLINIC_ORG';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CLINIC_ORG]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('CLINIC_ORG', 'CLINIC_ORG', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CLINIC_ORG', 'CLINIC_ORG', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CLINIC_ORG]";
    }
    ...
    {
        return "[CLINIC_ID] = '@CLINIC_ID@' AND [ORG_UNIT_CODE] = '@ORG_UNIT_CODE@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClinicOrgList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ClinicOrgView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ClinicOrgEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ClinicOrgAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ClinicOrgView";
            case Config("API_ADD_ACTION"):
                return "ClinicOrgAdd";
            case Config("API_EDIT_ACTION"):
                return "ClinicOrgEdit";
            case Config("API_DELETE_ACTION"):
                return "ClinicOrgDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClinicOrgView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ClinicOrgView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ClinicOrgAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ClinicOrgAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("ClinicOrgEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicOrgAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ClinicOrgDelete", $this->getUrlParm());
    }
