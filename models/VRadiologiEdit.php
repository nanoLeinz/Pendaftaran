 ...
 * Page class
 */
class VRadiologiEdit extends VRadiologi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRadiologiEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("VRadiologiList"); // No matching record, return to list
                    return;
                }
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "VRadiologiList") {
