 ...
 * Page class
 */
class PayorTypeEdit extends PayorType
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PayorTypeEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("PAYOR_TYPE") ?? Key(0) ?? Route(2)) !== null) {
                $this->PAYOR_TYPE->setQueryStringValue($keyValue);
                $this->PAYOR_TYPE->setOldValue($this->PAYOR_TYPE->QueryStringValue);
            } elseif (Post("PAYOR_TYPE") !== null) {
                $this->PAYOR_TYPE->setFormValue(Post("PAYOR_TYPE"));
                $this->PAYOR_TYPE->setOldValue($this->PAYOR_TYPE->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_PAYOR_TYPE")) {
            $this->PAYOR_TYPE->setOldValue($CurrentForm->getValue("o_PAYOR_TYPE"));
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // PAYOR_TYPE
            $this->PAYOR_TYPE->setDbValueDef($rsnew, $this->PAYOR_TYPE->CurrentValue, 0, $this->PAYOR_TYPE->ReadOnly);
