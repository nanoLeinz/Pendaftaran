...
/**
 * Table class for INASIS_GET_PROCEDURE
 */
class InasisGetProcedure extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'INASIS_GET_PROCEDURE';
        $this->TableName = 'INASIS_GET_PROCEDURE';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[INASIS_GET_PROCEDURE]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // KDDIAG
        $this->KDDIAG = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_KDDIAG', 'KDDIAG', '[KDDIAG]', '[KDDIAG]', 129, 10, -1, false, '[KDDIAG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NMDIAG
        $this->NMDIAG = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_NMDIAG', 'NMDIAG', '[NMDIAG]', '[NMDIAG]', 200, 250, -1, false, '[NMDIAG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_CODE
        $this->REST_CODE = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_REST_CODE', 'REST_CODE', '[REST_CODE]', '[REST_CODE]', 129, 3, -1, false, '[REST_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_MESSAGE
        $this->REST_MESSAGE = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_REST_MESSAGE', 'REST_MESSAGE', '[REST_MESSAGE]', '[REST_MESSAGE]', 200, 50, -1, false, '[REST_MESSAGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_DATE
        $this->REST_DATE = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_REST_DATE', 'REST_DATE', '[REST_DATE]', CastDateFieldForLike("[REST_DATE]", 0, "DB"), 135, 8, 0, false, '[REST_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_METHOD
        $this->REST_METHOD = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_REST_METHOD', 'REST_METHOD', '[REST_METHOD]', '[REST_METHOD]', 200, 50, -1, false, '[REST_METHOD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // RESPON
        $this->RESPON = new DbField('INASIS_GET_PROCEDURE', 'INASIS_GET_PROCEDURE', 'x_RESPON', 'RESPON', '[RESPON]', '[RESPON]', 201, 0, -1, false, '[RESPON]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[INASIS_GET_PROCEDURE]";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->KDDIAG->CurrentValue = $keys[0];
            } else {
                $this->KDDIAG->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("InasisGetProcedureList");
    }
    ...
    {
        global $Language;
        if ($pageName == "InasisGetProcedureView") {
            return $Language->phrase("View");
        } elseif ($pageName == "InasisGetProcedureEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "InasisGetProcedureAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "InasisGetProcedureView";
            case Config("API_ADD_ACTION"):
                return "InasisGetProcedureAdd";
            case Config("API_EDIT_ACTION"):
                return "InasisGetProcedureEdit";
            case Config("API_DELETE_ACTION"):
                return "InasisGetProcedureDelete";
            case Config("API_LIST_ACTION"):
                return "InasisGetProcedureList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("InasisGetProcedureView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("InasisGetProcedureView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "InasisGetProcedureAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "InasisGetProcedureAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetProcedureEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetProcedureAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("InasisGetProcedureDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->KDDIAG->CurrentValue = $key;
            } else {
                $this->KDDIAG->OldValue = $key;
            }
