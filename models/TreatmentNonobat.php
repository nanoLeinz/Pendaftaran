...
/**
 * Table class for TREATMENT_NONOBAT
 */
class TreatmentNonobat extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'TREATMENT_NONOBAT';
        $this->TableName = 'TREATMENT_NONOBAT';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[TREATMENT_NONOBAT]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BILL_ID
        $this->BILL_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_BILL_ID', 'BILL_ID', '[BILL_ID]', '[BILL_ID]', 200, 50, -1, false, '[BILL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 15, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // CLINIC_ID_FROM
        $this->CLINIC_ID_FROM = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CLINIC_ID_FROM', 'CLINIC_ID_FROM', '[CLINIC_ID_FROM]', '[CLINIC_ID_FROM]', 200, 15, -1, false, '[CLINIC_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREATMENT
        $this->TREATMENT = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_TREATMENT', 'TREATMENT', '[TREATMENT]', '[TREATMENT]', 200, 200, -1, false, '[TREATMENT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_DATE
        $this->TREAT_DATE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_TREAT_DATE', 'TREAT_DATE', '[TREAT_DATE]', CastDateFieldForLike("[TREAT_DATE]", 0, "DB"), 135, 8, 0, false, '[TREAT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 16, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // DOCTOR
        $this->DOCTOR = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_DOCTOR', 'DOCTOR', '[DOCTOR]', '[DOCTOR]', 200, 100, -1, false, '[DOCTOR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EXIT_DATE
        $this->EXIT_DATE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_EXIT_DATE', 'EXIT_DATE', '[EXIT_DATE]', CastDateFieldForLike("[EXIT_DATE]", 0, "DB"), 135, 8, 0, false, '[EXIT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID_FROM
        $this->EMPLOYEE_ID_FROM = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_EMPLOYEE_ID_FROM', 'EMPLOYEE_ID_FROM', '[EMPLOYEE_ID_FROM]', '[EMPLOYEE_ID_FROM]', 200, 50, -1, false, '[EMPLOYEE_ID_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DOCTOR_FROM
        $this->DOCTOR_FROM = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_DOCTOR_FROM', 'DOCTOR_FROM', '[DOCTOR_FROM]', '[DOCTOR_FROM]', 200, 50, -1, false, '[DOCTOR_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 150, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_THEID', 'THEID', '[THEID]', '[THEID]', 200, 25, -1, false, '[THEID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERIAL_NB
        $this->SERIAL_NB = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_SERIAL_NB', 'SERIAL_NB', '[SERIAL_NB]', '[SERIAL_NB]', 200, 50, -1, false, '[SERIAL_NB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 17, 1, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 17, 1, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 17, 1, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // KARYAWAN
        $this->KARYAWAN = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_KARYAWAN', 'KARYAWAN', '[KARYAWAN]', '[KARYAWAN]', 200, 50, -1, false, '[KARYAWAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 200, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // POTONGAN
        $this->POTONGAN = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_POTONGAN', 'POTONGAN', '[POTONGAN]', 'CAST([POTONGAN] AS NVARCHAR)', 6, 8, -1, false, '[POTONGAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BAYAR
        $this->BAYAR = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_BAYAR', 'BAYAR', '[BAYAR]', 'CAST([BAYAR] AS NVARCHAR)', 6, 8, -1, false, '[BAYAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RETUR
        $this->RETUR = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_RETUR', 'RETUR', '[RETUR]', 'CAST([RETUR] AS NVARCHAR)', 6, 8, -1, false, '[RETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_TYPE
        $this->TARIF_TYPE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_TARIF_TYPE', 'TARIF_TYPE', '[TARIF_TYPE]', '[TARIF_TYPE]', 200, 50, -1, false, '[TARIF_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPNVALUE
        $this->PPNVALUE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_PPNVALUE', 'PPNVALUE', '[PPNVALUE]', 'CAST([PPNVALUE] AS NVARCHAR)', 6, 8, -1, false, '[PPNVALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TAGIHAN
        $this->TAGIHAN = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_TAGIHAN', 'TAGIHAN', '[TAGIHAN]', 'CAST([TAGIHAN] AS NVARCHAR)', 6, 8, -1, false, '[TAGIHAN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KOREKSI
        $this->KOREKSI = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_KOREKSI', 'KOREKSI', '[KOREKSI]', 'CAST([KOREKSI] AS NVARCHAR)', 6, 8, -1, false, '[KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT_PAID
        $this->AMOUNT_PAID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_AMOUNT_PAID', 'AMOUNT_PAID', '[AMOUNT_PAID]', 'CAST([AMOUNT_PAID] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT_PAID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISKON
        $this->DISKON = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_DISKON', 'DISKON', '[DISKON]', 'CAST([DISKON] AS NVARCHAR)', 6, 8, -1, false, '[DISKON]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NOTA_NO
        $this->NOTA_NO = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_NOTA_NO', 'NOTA_NO', '[NOTA_NO]', '[NOTA_NO]', 200, 50, -1, false, '[NOTA_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SELL_PRICE
        $this->SELL_PRICE = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_SELL_PRICE', 'SELL_PRICE', '[SELL_PRICE]', 'CAST([SELL_PRICE] AS NVARCHAR)', 6, 8, -1, false, '[SELL_PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // subsidi
        $this->subsidi = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_subsidi', 'subsidi', '[subsidi]', 'CAST([subsidi] AS NVARCHAR)', 6, 8, -1, false, '[subsidi]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISCOUNT
        $this->DISCOUNT = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_DISCOUNT', 'DISCOUNT', '[DISCOUNT]', 'CAST([DISCOUNT] AS NVARCHAR)', 131, 8, -1, false, '[DISCOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PPN
        $this->PPN = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_PPN', 'PPN', '[PPN]', 'CAST([PPN] AS NVARCHAR)', 131, 8, -1, false, '[PPN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SUBSIDISAT
        $this->SUBSIDISAT = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_SUBSIDISAT', 'SUBSIDISAT', '[SUBSIDISAT]', 'CAST([SUBSIDISAT] AS NVARCHAR)', 6, 8, -1, false, '[SUBSIDISAT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 2, 2, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_TARIF
        $this->STATUS_TARIF = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_STATUS_TARIF', 'STATUS_TARIF', '[STATUS_TARIF]', 'CAST([STATUS_TARIF] AS NVARCHAR)', 2, 2, -1, false, '[STATUS_TARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PACKAGE_ID
        $this->PACKAGE_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_PACKAGE_ID', 'PACKAGE_ID', '[PACKAGE_ID]', '[PACKAGE_ID]', 200, 50, -1, false, '[PACKAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODULE_ID
        $this->MODULE_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_MODULE_ID', 'MODULE_ID', '[MODULE_ID]', '[MODULE_ID]', 200, 50, -1, false, '[MODULE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEORDER
        $this->THEORDER = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_THEORDER', 'THEORDER', '[THEORDER]', 'CAST([THEORDER] AS NVARCHAR)', 2, 2, -1, false, '[THEORDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_ID
        $this->CORRECTION_ID = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CORRECTION_ID', 'CORRECTION_ID', '[CORRECTION_ID]', '[CORRECTION_ID]', 200, 50, -1, false, '[CORRECTION_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CORRECTION_BY
        $this->CORRECTION_BY = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CORRECTION_BY', 'CORRECTION_BY', '[CORRECTION_BY]', '[CORRECTION_BY]', 200, 50, -1, false, '[CORRECTION_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CASHIER
        $this->CASHIER = new DbField('TREATMENT_NONOBAT', 'TREATMENT_NONOBAT', 'x_CASHIER', 'CASHIER', '[CASHIER]', '[CASHIER]', 200, 50, -1, false, '[CASHIER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[TREATMENT_NONOBAT]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TreatmentNonobatList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TreatmentNonobatView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TreatmentNonobatEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TreatmentNonobatAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "TreatmentNonobatView";
            case Config("API_ADD_ACTION"):
                return "TreatmentNonobatAdd";
            case Config("API_EDIT_ACTION"):
                return "TreatmentNonobatEdit";
            case Config("API_DELETE_ACTION"):
                return "TreatmentNonobatDelete";
            case Config("API_LIST_ACTION"):
                return "TreatmentNonobatList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TreatmentNonobatView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TreatmentNonobatView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TreatmentNonobatAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TreatmentNonobatAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatmentNonobatEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TreatmentNonobatAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TreatmentNonobatDelete", $this->getUrlParm());
    }
