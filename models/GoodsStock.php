...
/**
 * Table class for GOODS_STOCK
 */
class GoodsStock extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $DITERIMA;
    public $DITERIMAMUTASI;
    public $DITERIMARETUR;
    public $DISTRIBUSI;
    public $DIJUAL;
    public $DIPAKAI;
    public $DIHAPUS;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'GOODS_STOCK';
        $this->TableName = 'GOODS_STOCK';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[GOODS_STOCK]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_NAME
        $this->BRAND_NAME = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_BRAND_NAME', 'BRAND_NAME', '[BRAND_NAME]', '[BRAND_NAME]', 200, 150, -1, false, '[BRAND_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ROOMS_ID
        $this->ROOMS_ID = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_ROOMS_ID', 'ROOMS_ID', '[ROOMS_ID]', '[ROOMS_ID]', 200, 10, -1, false, '[ROOMS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ALLOCATED_DATE
        $this->ALLOCATED_DATE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_ALLOCATED_DATE', 'ALLOCATED_DATE', '[ALLOCATED_DATE]', CastDateFieldForLike("[ALLOCATED_DATE]", 0, "DB"), 135, 8, 0, false, '[ALLOCATED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ALLOCATED_DATE->IsPrimaryKey = true; // Primary key field
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', 'CAST([MEASURE_ID] AS NVARCHAR)', 2, 2, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRICE
        $this->PRICE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_PRICE', 'PRICE', '[PRICE]', 'CAST([PRICE] AS NVARCHAR)', 6, 8, -1, false, '[PRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VALUEAWAL
        $this->VALUEAWAL = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_VALUEAWAL', 'VALUEAWAL', '[VALUEAWAL]', 'CAST([VALUEAWAL] AS NVARCHAR)', 6, 8, -1, false, '[VALUEAWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->VALUEAWAL->Sortable = true; // Allow sort
        $this->VALUEAWAL->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->VALUEAWAL->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->VALUEAWAL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->VALUEAWAL->Param, "CustomMsg");
        $this->Fields['VALUEAWAL'] = &$this->VALUEAWAL;

        // VALUEIN
        $this->VALUEIN = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_VALUEIN', 'VALUEIN', '[VALUEIN]', 'CAST([VALUEIN] AS NVARCHAR)', 6, 8, -1, false, '[VALUEIN]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->VALUEIN->Sortable = true; // Allow sort
        $this->VALUEIN->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->VALUEIN->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->VALUEIN->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->VALUEIN->Param, "CustomMsg");
        $this->Fields['VALUEIN'] = &$this->VALUEIN;

        // AVGPRICE
        $this->AVGPRICE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_AVGPRICE', 'AVGPRICE', '[AVGPRICE]', 'CAST([AVGPRICE] AS NVARCHAR)', 6, 8, -1, false, '[AVGPRICE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_OPNAME
        $this->STOCK_OPNAME = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_STOCK_OPNAME', 'STOCK_OPNAME', '[STOCK_OPNAME]', 'CAST([STOCK_OPNAME] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_OPNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOK_AWAL
        $this->STOK_AWAL = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_STOK_AWAL', 'STOK_AWAL', '[STOK_AWAL]', 'CAST([STOK_AWAL] AS NVARCHAR)', 131, 8, -1, false, '[STOK_AWAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_LALU
        $this->STOCK_LALU = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_STOCK_LALU', 'STOCK_LALU', '[STOCK_LALU]', 'CAST([STOCK_LALU] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_LALU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STOCK_KOREKSI
        $this->STOCK_KOREKSI = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_STOCK_KOREKSI', 'STOCK_KOREKSI', '[STOCK_KOREKSI]', 'CAST([STOCK_KOREKSI] AS NVARCHAR)', 131, 8, -1, false, '[STOCK_KOREKSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DITERIMA
        $this->DITERIMA = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DITERIMA', 'DITERIMA', '[DITERIMA]', 'CAST([DITERIMA] AS NVARCHAR)', 131, 8, -1, false, '[DITERIMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DITERIMAMUTASI
        $this->DITERIMAMUTASI = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DITERIMAMUTASI', 'DITERIMAMUTASI', '[DITERIMAMUTASI]', 'CAST([DITERIMAMUTASI] AS NVARCHAR)', 131, 8, -1, false, '[DITERIMAMUTASI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DITERIMAMUTASI->Sortable = true; // Allow sort
        $this->DITERIMAMUTASI->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DITERIMAMUTASI->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DITERIMAMUTASI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DITERIMAMUTASI->Param, "CustomMsg");
        $this->Fields['DITERIMAMUTASI'] = &$this->DITERIMAMUTASI;

        // DITERIMARETUR
        $this->DITERIMARETUR = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DITERIMARETUR', 'DITERIMARETUR', '[DITERIMARETUR]', 'CAST([DITERIMARETUR] AS NVARCHAR)', 131, 8, -1, false, '[DITERIMARETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DITERIMARETUR->Sortable = true; // Allow sort
        $this->DITERIMARETUR->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DITERIMARETUR->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DITERIMARETUR->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DITERIMARETUR->Param, "CustomMsg");
        $this->Fields['DITERIMARETUR'] = &$this->DITERIMARETUR;

        // DISTRIBUSI
        $this->DISTRIBUSI = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DISTRIBUSI', 'DISTRIBUSI', '[DISTRIBUSI]', 'CAST([DISTRIBUSI] AS NVARCHAR)', 131, 8, -1, false, '[DISTRIBUSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIJUAL
        $this->DIJUAL = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIJUAL', 'DIJUAL', '[DIJUAL]', 'CAST([DIJUAL] AS NVARCHAR)', 131, 8, -1, false, '[DIJUAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIPAKAI
        $this->DIPAKAI = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIPAKAI', 'DIPAKAI', '[DIPAKAI]', 'CAST([DIPAKAI] AS NVARCHAR)', 131, 8, -1, false, '[DIPAKAI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIPAKAI->Sortable = true; // Allow sort
        $this->DIPAKAI->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DIPAKAI->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DIPAKAI->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DIPAKAI->Param, "CustomMsg");
        $this->Fields['DIPAKAI'] = &$this->DIPAKAI;

        // DIHAPUS
        $this->DIHAPUS = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIHAPUS', 'DIHAPUS', '[DIHAPUS]', 'CAST([DIHAPUS] AS NVARCHAR)', 131, 8, -1, false, '[DIHAPUS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIRETUR
        $this->DIRETUR = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIRETUR', 'DIRETUR', '[DIRETUR]', 'CAST([DIRETUR] AS NVARCHAR)', 131, 8, -1, false, '[DIRETUR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIRETURJUAL
        $this->DIRETURJUAL = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIRETURJUAL', 'DIRETURJUAL', '[DIRETURJUAL]', 'CAST([DIRETURJUAL] AS NVARCHAR)', 131, 8, -1, false, '[DIRETURJUAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIRETURJUAL->Sortable = true; // Allow sort
        $this->DIRETURJUAL->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DIRETURJUAL->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DIRETURJUAL->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DIRETURJUAL->Param, "CustomMsg");
        $this->Fields['DIRETURJUAL'] = &$this->DIRETURJUAL;

        // DIRETURUSE
        $this->DIRETURUSE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIRETURUSE', 'DIRETURUSE', '[DIRETURUSE]', 'CAST([DIRETURUSE] AS NVARCHAR)', 131, 8, -1, false, '[DIRETURUSE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIRETURUSE->Sortable = true; // Allow sort
        $this->DIRETURUSE->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DIRETURUSE->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DIRETURUSE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DIRETURUSE->Param, "CustomMsg");
        $this->Fields['DIRETURUSE'] = &$this->DIRETURUSE;

        // DIRETUREXT
        $this->DIRETUREXT = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIRETUREXT', 'DIRETUREXT', '[DIRETUREXT]', 'CAST([DIRETUREXT] AS NVARCHAR)', 131, 8, -1, false, '[DIRETUREXT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DIRETUREXT->Sortable = true; // Allow sort
        $this->DIRETUREXT->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->DIRETUREXT->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->DIRETUREXT->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DIRETUREXT->Param, "CustomMsg");
        $this->Fields['DIRETUREXT'] = &$this->DIRETUREXT;

        // DIMINTA
        $this->DIMINTA = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DIMINTA', 'DIMINTA', '[DIMINTA]', 'CAST([DIMINTA] AS NVARCHAR)', 131, 8, -1, false, '[DIMINTA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISCETAK
        $this->ISCETAK = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_ISCETAK', 'ISCETAK', '[ISCETAK]', '[ISCETAK]', 129, 1, -1, false, '[ISCETAK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTQ
        $this->PRINTQ = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_PRINTQ', 'PRINTQ', '[PRINTQ]', 'CAST([PRINTQ] AS NVARCHAR)', 17, 1, -1, false, '[PRINTQ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINTED_BY
        $this->PRINTED_BY = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_PRINTED_BY', 'PRINTED_BY', '[PRINTED_BY]', '[PRINTED_BY]', 200, 50, -1, false, '[PRINTED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PRINT_DATE
        $this->PRINT_DATE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_PRINT_DATE', 'PRINT_DATE', '[PRINT_DATE]', CastDateFieldForLike("[PRINT_DATE]", 0, "DB"), 135, 8, 0, false, '[PRINT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // EXPIRY_DATE
        $this->EXPIRY_DATE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_EXPIRY_DATE', 'EXPIRY_DATE', '[EXPIRY_DATE]', CastDateFieldForLike("[EXPIRY_DATE]", 0, "DB"), 135, 8, 0, false, '[EXPIRY_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISTRIBUTION_TYPE
        $this->DISTRIBUTION_TYPE = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_DISTRIBUTION_TYPE', 'DISTRIBUTION_TYPE', '[DISTRIBUTION_TYPE]', 'CAST([DISTRIBUTION_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[DISTRIBUTION_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MONTH_ID
        $this->MONTH_ID = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_MONTH_ID', 'MONTH_ID', '[MONTH_ID]', 'CAST([MONTH_ID] AS NVARCHAR)', 17, 1, -1, false, '[MONTH_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // IDX
        $this->IDX = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_IDX', 'IDX', '[IDX]', 'CAST([IDX] AS NVARCHAR)', 3, 4, -1, false, '[IDX]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // BATCH_NO
        $this->BATCH_NO = new DbField('GOODS_STOCK', 'GOODS_STOCK', 'x_BATCH_NO', 'BATCH_NO', '[BATCH_NO]', '[BATCH_NO]', 200, 50, -1, false, '[BATCH_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[GOODS_STOCK]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('ALLOCATED_DATE', $rs)) {
                AddFilter($where, QuotedName('ALLOCATED_DATE', $this->Dbid) . '=' . QuotedValue($rs['ALLOCATED_DATE'], $this->ALLOCATED_DATE->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->VALUEAWAL->DbValue = $row['VALUEAWAL'];
        $this->VALUEIN->DbValue = $row['VALUEIN'];
        ...
        $this->DITERIMAMUTASI->DbValue = $row['DITERIMAMUTASI'];
        $this->DITERIMARETUR->DbValue = $row['DITERIMARETUR'];
        $this->DISTRIBUSI->DbValue = $row['DISTRIBUSI'];
        $this->DIJUAL->DbValue = $row['DIJUAL'];
        $this->DIPAKAI->DbValue = $row['DIPAKAI'];
        $this->DIHAPUS->DbValue = $row['DIHAPUS'];
        $this->DIRETUR->DbValue = $row['DIRETUR'];
        $this->DIRETURJUAL->DbValue = $row['DIRETURJUAL'];
        $this->DIRETURUSE->DbValue = $row['DIRETURUSE'];
        $this->DIRETUREXT->DbValue = $row['DIRETUREXT'];
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [BRAND_ID] = '@BRAND_ID@' AND [ROOMS_ID] = '@ROOMS_ID@' AND [ALLOCATED_DATE] = '@ALLOCATED_DATE@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->ALLOCATED_DATE->CurrentValue : $this->ALLOCATED_DATE->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 4) {
            ...
            if ($current) {
                $this->ALLOCATED_DATE->CurrentValue = $keys[3];
            } else {
                $this->ALLOCATED_DATE->OldValue = $keys[3];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('ALLOCATED_DATE', $row) ? $row['ALLOCATED_DATE'] : null;
        } else {
            $val = $this->ALLOCATED_DATE->OldValue !== null ? $this->ALLOCATED_DATE->OldValue : $this->ALLOCATED_DATE->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@ALLOCATED_DATE@", AdjustSql(UnFormatDateTime($val, 0), $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("GoodsStockList");
    }
    ...
    {
        global $Language;
        if ($pageName == "GoodsStockView") {
            return $Language->phrase("View");
        } elseif ($pageName == "GoodsStockEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "GoodsStockAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "GoodsStockView";
            case Config("API_ADD_ACTION"):
                return "GoodsStockAdd";
            case Config("API_EDIT_ACTION"):
                return "GoodsStockEdit";
            case Config("API_DELETE_ACTION"):
                return "GoodsStockDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("GoodsStockView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("GoodsStockView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "GoodsStockAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "GoodsStockAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("GoodsStockEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("GoodsStockAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("GoodsStockDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",ALLOCATED_DATE:" . JsonEncode($this->ALLOCATED_DATE->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->ALLOCATED_DATE->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->ALLOCATED_DATE->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("ALLOCATED_DATE") ?? Route("ALLOCATED_DATE")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->ALLOCATED_DATE->CurrentValue = $key[3];
            } else {
                $this->ALLOCATED_DATE->OldValue = $key[3];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->VALUEAWAL->setDbValue($row['VALUEAWAL']);
        $this->VALUEIN->setDbValue($row['VALUEIN']);
        ...
        $this->DITERIMAMUTASI->setDbValue($row['DITERIMAMUTASI']);
        $this->DITERIMARETUR->setDbValue($row['DITERIMARETUR']);
        $this->DISTRIBUSI->setDbValue($row['DISTRIBUSI']);
        $this->DIJUAL->setDbValue($row['DIJUAL']);
        $this->DIPAKAI->setDbValue($row['DIPAKAI']);
        $this->DIHAPUS->setDbValue($row['DIHAPUS']);
        $this->DIRETUR->setDbValue($row['DIRETUR']);
        $this->DIRETURJUAL->setDbValue($row['DIRETURJUAL']);
        $this->DIRETURUSE->setDbValue($row['DIRETURUSE']);
        $this->DIRETUREXT->setDbValue($row['DIRETUREXT']);
    ...
    public function renderListRow()
    {
        ...
        // VALUEAWAL
        $this->VALUEAWAL->ViewValue = $this->VALUEAWAL->CurrentValue;
        $this->VALUEAWAL->ViewValue = FormatNumber($this->VALUEAWAL->ViewValue, 2, -2, -2, -2);
        $this->VALUEAWAL->ViewCustomAttributes = "";

        // VALUEIN
        $this->VALUEIN->ViewValue = $this->VALUEIN->CurrentValue;
        $this->VALUEIN->ViewValue = FormatNumber($this->VALUEIN->ViewValue, 2, -2, -2, -2);
        $this->VALUEIN->ViewCustomAttributes = "";
        ...
        // DITERIMAMUTASI
        $this->DITERIMAMUTASI->ViewValue = $this->DITERIMAMUTASI->CurrentValue;
        $this->DITERIMAMUTASI->ViewValue = FormatNumber($this->DITERIMAMUTASI->ViewValue, 2, -2, -2, -2);
        $this->DITERIMAMUTASI->ViewCustomAttributes = "";

        // DITERIMARETUR
        $this->DITERIMARETUR->ViewValue = $this->DITERIMARETUR->CurrentValue;
        $this->DITERIMARETUR->ViewValue = FormatNumber($this->DITERIMARETUR->ViewValue, 2, -2, -2, -2);
        $this->DITERIMARETUR->ViewCustomAttributes = "";
        ...
        // DIPAKAI
        $this->DIPAKAI->ViewValue = $this->DIPAKAI->CurrentValue;
        $this->DIPAKAI->ViewValue = FormatNumber($this->DIPAKAI->ViewValue, 2, -2, -2, -2);
        $this->DIPAKAI->ViewCustomAttributes = "";
        ...
        // DIRETURJUAL
        $this->DIRETURJUAL->ViewValue = $this->DIRETURJUAL->CurrentValue;
        $this->DIRETURJUAL->ViewValue = FormatNumber($this->DIRETURJUAL->ViewValue, 2, -2, -2, -2);
        $this->DIRETURJUAL->ViewCustomAttributes = "";

        // DIRETURUSE
        $this->DIRETURUSE->ViewValue = $this->DIRETURUSE->CurrentValue;
        $this->DIRETURUSE->ViewValue = FormatNumber($this->DIRETURUSE->ViewValue, 2, -2, -2, -2);
        $this->DIRETURUSE->ViewCustomAttributes = "";

        // DIRETUREXT
        $this->DIRETUREXT->ViewValue = $this->DIRETUREXT->CurrentValue;
        $this->DIRETUREXT->ViewValue = FormatNumber($this->DIRETUREXT->ViewValue, 2, -2, -2, -2);
        $this->DIRETUREXT->ViewCustomAttributes = "";
        ...
        // VALUEAWAL
        $this->VALUEAWAL->LinkCustomAttributes = "";
        $this->VALUEAWAL->HrefValue = "";
        $this->VALUEAWAL->TooltipValue = "";

        // VALUEIN
        $this->VALUEIN->LinkCustomAttributes = "";
        $this->VALUEIN->HrefValue = "";
        $this->VALUEIN->TooltipValue = "";
        ...
        // DITERIMAMUTASI
        $this->DITERIMAMUTASI->LinkCustomAttributes = "";
        $this->DITERIMAMUTASI->HrefValue = "";
        $this->DITERIMAMUTASI->TooltipValue = "";

        // DITERIMARETUR
        $this->DITERIMARETUR->LinkCustomAttributes = "";
        $this->DITERIMARETUR->HrefValue = "";
        $this->DITERIMARETUR->TooltipValue = "";
        ...
        // DIPAKAI
        $this->DIPAKAI->LinkCustomAttributes = "";
        $this->DIPAKAI->HrefValue = "";
        $this->DIPAKAI->TooltipValue = "";
        ...
        // DIRETURJUAL
        $this->DIRETURJUAL->LinkCustomAttributes = "";
        $this->DIRETURJUAL->HrefValue = "";
        $this->DIRETURJUAL->TooltipValue = "";

        // DIRETURUSE
        $this->DIRETURUSE->LinkCustomAttributes = "";
        $this->DIRETURUSE->HrefValue = "";
        $this->DIRETURUSE->TooltipValue = "";

        // DIRETUREXT
        $this->DIRETUREXT->LinkCustomAttributes = "";
        $this->DIRETUREXT->HrefValue = "";
        $this->DIRETUREXT->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // VALUEAWAL
        $this->VALUEAWAL->EditAttrs["class"] = "form-control";
        $this->VALUEAWAL->EditCustomAttributes = "";
        $this->VALUEAWAL->EditValue = $this->VALUEAWAL->CurrentValue;
        $this->VALUEAWAL->PlaceHolder = RemoveHtml($this->VALUEAWAL->caption());
        if (strval($this->VALUEAWAL->EditValue) != "" && is_numeric($this->VALUEAWAL->EditValue)) {
            $this->VALUEAWAL->EditValue = FormatNumber($this->VALUEAWAL->EditValue, -2, -2, -2, -2);
        }

        // VALUEIN
        $this->VALUEIN->EditAttrs["class"] = "form-control";
        $this->VALUEIN->EditCustomAttributes = "";
        $this->VALUEIN->EditValue = $this->VALUEIN->CurrentValue;
        $this->VALUEIN->PlaceHolder = RemoveHtml($this->VALUEIN->caption());
        if (strval($this->VALUEIN->EditValue) != "" && is_numeric($this->VALUEIN->EditValue)) {
            $this->VALUEIN->EditValue = FormatNumber($this->VALUEIN->EditValue, -2, -2, -2, -2);
        }
        ...
        // DITERIMAMUTASI
        $this->DITERIMAMUTASI->EditAttrs["class"] = "form-control";
        $this->DITERIMAMUTASI->EditCustomAttributes = "";
        $this->DITERIMAMUTASI->EditValue = $this->DITERIMAMUTASI->CurrentValue;
        $this->DITERIMAMUTASI->PlaceHolder = RemoveHtml($this->DITERIMAMUTASI->caption());
        if (strval($this->DITERIMAMUTASI->EditValue) != "" && is_numeric($this->DITERIMAMUTASI->EditValue)) {
            $this->DITERIMAMUTASI->EditValue = FormatNumber($this->DITERIMAMUTASI->EditValue, -2, -2, -2, -2);
        }

        // DITERIMARETUR
        $this->DITERIMARETUR->EditAttrs["class"] = "form-control";
        $this->DITERIMARETUR->EditCustomAttributes = "";
        $this->DITERIMARETUR->EditValue = $this->DITERIMARETUR->CurrentValue;
        $this->DITERIMARETUR->PlaceHolder = RemoveHtml($this->DITERIMARETUR->caption());
        if (strval($this->DITERIMARETUR->EditValue) != "" && is_numeric($this->DITERIMARETUR->EditValue)) {
            $this->DITERIMARETUR->EditValue = FormatNumber($this->DITERIMARETUR->EditValue, -2, -2, -2, -2);
        }
        ...
        // DIPAKAI
        $this->DIPAKAI->EditAttrs["class"] = "form-control";
        $this->DIPAKAI->EditCustomAttributes = "";
        $this->DIPAKAI->EditValue = $this->DIPAKAI->CurrentValue;
        $this->DIPAKAI->PlaceHolder = RemoveHtml($this->DIPAKAI->caption());
        if (strval($this->DIPAKAI->EditValue) != "" && is_numeric($this->DIPAKAI->EditValue)) {
            $this->DIPAKAI->EditValue = FormatNumber($this->DIPAKAI->EditValue, -2, -2, -2, -2);
        }
        ...
        // DIRETURJUAL
        $this->DIRETURJUAL->EditAttrs["class"] = "form-control";
        $this->DIRETURJUAL->EditCustomAttributes = "";
        $this->DIRETURJUAL->EditValue = $this->DIRETURJUAL->CurrentValue;
        $this->DIRETURJUAL->PlaceHolder = RemoveHtml($this->DIRETURJUAL->caption());
        if (strval($this->DIRETURJUAL->EditValue) != "" && is_numeric($this->DIRETURJUAL->EditValue)) {
            $this->DIRETURJUAL->EditValue = FormatNumber($this->DIRETURJUAL->EditValue, -2, -2, -2, -2);
        }

        // DIRETURUSE
        $this->DIRETURUSE->EditAttrs["class"] = "form-control";
        $this->DIRETURUSE->EditCustomAttributes = "";
        $this->DIRETURUSE->EditValue = $this->DIRETURUSE->CurrentValue;
        $this->DIRETURUSE->PlaceHolder = RemoveHtml($this->DIRETURUSE->caption());
        if (strval($this->DIRETURUSE->EditValue) != "" && is_numeric($this->DIRETURUSE->EditValue)) {
            $this->DIRETURUSE->EditValue = FormatNumber($this->DIRETURUSE->EditValue, -2, -2, -2, -2);
        }

        // DIRETUREXT
        $this->DIRETUREXT->EditAttrs["class"] = "form-control";
        $this->DIRETUREXT->EditCustomAttributes = "";
        $this->DIRETUREXT->EditValue = $this->DIRETUREXT->CurrentValue;
        $this->DIRETUREXT->PlaceHolder = RemoveHtml($this->DIRETUREXT->caption());
        if (strval($this->DIRETUREXT->EditValue) != "" && is_numeric($this->DIRETUREXT->EditValue)) {
            $this->DIRETUREXT->EditValue = FormatNumber($this->DIRETUREXT->EditValue, -2, -2, -2, -2);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->VALUEAWAL);
                    $doc->exportCaption($this->VALUEIN);
                    ...
                    $doc->exportCaption($this->DITERIMAMUTASI);
                    $doc->exportCaption($this->DITERIMARETUR);
                    $doc->exportCaption($this->DISTRIBUSI);
                    $doc->exportCaption($this->DIJUAL);
                    $doc->exportCaption($this->DIPAKAI);
                    $doc->exportCaption($this->DIHAPUS);
                    $doc->exportCaption($this->DIRETUR);
                    $doc->exportCaption($this->DIRETURJUAL);
                    $doc->exportCaption($this->DIRETURUSE);
                    $doc->exportCaption($this->DIRETUREXT);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->VALUEAWAL);
                        $doc->exportField($this->VALUEIN);
                        ...
                        $doc->exportField($this->DITERIMAMUTASI);
                        $doc->exportField($this->DITERIMARETUR);
                        $doc->exportField($this->DISTRIBUSI);
                        $doc->exportField($this->DIJUAL);
                        $doc->exportField($this->DIPAKAI);
                        $doc->exportField($this->DIHAPUS);
                        $doc->exportField($this->DIRETUR);
                        $doc->exportField($this->DIRETURJUAL);
                        $doc->exportField($this->DIRETURUSE);
                        $doc->exportField($this->DIRETUREXT);
