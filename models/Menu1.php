...
/**
 * Table class for MENU1
 */
class Menu1 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'MENU1';
        $this->TableName = 'MENU1';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[MENU1]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // MENU_ID
        $this->MENU_ID = new DbField('MENU1', 'MENU1', 'x_MENU_ID', 'MENU_ID', '[MENU_ID]', '[MENU_ID]', 202, 255, -1, false, '[MENU_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STYPE_ID
        $this->STYPE_ID = new DbField('MENU1', 'MENU1', 'x_STYPE_ID', 'STYPE_ID', '[STYPE_ID]', 'CAST([STYPE_ID] AS NVARCHAR)', 5, 8, -1, false, '[STYPE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->STYPE_ID->Sortable = true; // Allow sort
        $this->STYPE_ID->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->STYPE_ID->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        ...
        // MENU
        $this->_MENU = new DbField('MENU1', 'MENU1', 'x__MENU', 'MENU', '[MENU]', '[MENU]', 202, 255, -1, false, '[MENU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REFER_TO
        $this->REFER_TO = new DbField('MENU1', 'MENU1', 'x_REFER_TO', 'REFER_TO', '[REFER_TO]', '[REFER_TO]', 202, 255, -1, false, '[REFER_TO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SORTED_NB
        $this->SORTED_NB = new DbField('MENU1', 'MENU1', 'x_SORTED_NB', 'SORTED_NB', '[SORTED_NB]', 'CAST([SORTED_NB] AS NVARCHAR)', 5, 8, -1, false, '[SORTED_NB]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->SORTED_NB->Sortable = true; // Allow sort
        $this->SORTED_NB->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->SORTED_NB->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        ...
        // DISPLAYED
        $this->DISPLAYED = new DbField('MENU1', 'MENU1', 'x_DISPLAYED', 'DISPLAYED', '[DISPLAYED]', '[DISPLAYED]', 202, 255, -1, false, '[DISPLAYED]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISWINDOW
        $this->ISWINDOW = new DbField('MENU1', 'MENU1', 'x_ISWINDOW', 'ISWINDOW', '[ISWINDOW]', '[ISWINDOW]', 202, 255, -1, false, '[ISWINDOW]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ID_GROUP_MENU
        $this->ID_GROUP_MENU = new DbField('MENU1', 'MENU1', 'x_ID_GROUP_MENU', 'ID_GROUP_MENU', '[ID_GROUP_MENU]', 'CAST([ID_GROUP_MENU] AS NVARCHAR)', 5, 8, -1, false, '[ID_GROUP_MENU]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ID_GROUP_MENU->Sortable = true; // Allow sort
        $this->ID_GROUP_MENU->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->ID_GROUP_MENU->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->ID_GROUP_MENU->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ID_GROUP_MENU->Param, "CustomMsg");
        $this->Fields['ID_GROUP_MENU'] = &$this->ID_GROUP_MENU;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[MENU1]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->ID_GROUP_MENU->DbValue = $row['ID_GROUP_MENU'];
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("Menu1List");
    }
    ...
    {
        global $Language;
        if ($pageName == "Menu1View") {
            return $Language->phrase("View");
        } elseif ($pageName == "Menu1Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "Menu1Add") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("Menu1View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("Menu1View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "Menu1Add?" . $this->getUrlParm($parm);
        } else {
            $url = "Menu1Add";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("Menu1Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("Menu1Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("Menu1Delete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->ID_GROUP_MENU->setDbValue($row['ID_GROUP_MENU']);
    }
    ...
    public function renderListRow()
    {
        ...
        $this->STYPE_ID->ViewValue = FormatNumber($this->STYPE_ID->ViewValue, 2, -2, -2, -2);
        ...
        $this->SORTED_NB->ViewValue = FormatNumber($this->SORTED_NB->ViewValue, 2, -2, -2, -2);
        ...
        // ID_GROUP_MENU
        $this->ID_GROUP_MENU->ViewValue = $this->ID_GROUP_MENU->CurrentValue;
        $this->ID_GROUP_MENU->ViewValue = FormatNumber($this->ID_GROUP_MENU->ViewValue, 2, -2, -2, -2);
        $this->ID_GROUP_MENU->ViewCustomAttributes = "";
        ...
        // ID_GROUP_MENU
        $this->ID_GROUP_MENU->LinkCustomAttributes = "";
        $this->ID_GROUP_MENU->HrefValue = "";
        $this->ID_GROUP_MENU->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->STYPE_ID->EditValue) != "" && is_numeric($this->STYPE_ID->EditValue)) {
            $this->STYPE_ID->EditValue = FormatNumber($this->STYPE_ID->EditValue, -2, -2, -2, -2);
        }
        ...
        if (strval($this->SORTED_NB->EditValue) != "" && is_numeric($this->SORTED_NB->EditValue)) {
            $this->SORTED_NB->EditValue = FormatNumber($this->SORTED_NB->EditValue, -2, -2, -2, -2);
        }
        ...
        // ID_GROUP_MENU
        $this->ID_GROUP_MENU->EditAttrs["class"] = "form-control";
        $this->ID_GROUP_MENU->EditCustomAttributes = "";
        $this->ID_GROUP_MENU->EditValue = $this->ID_GROUP_MENU->CurrentValue;
        $this->ID_GROUP_MENU->PlaceHolder = RemoveHtml($this->ID_GROUP_MENU->caption());
        if (strval($this->ID_GROUP_MENU->EditValue) != "" && is_numeric($this->ID_GROUP_MENU->EditValue)) {
            $this->ID_GROUP_MENU->EditValue = FormatNumber($this->ID_GROUP_MENU->EditValue, -2, -2, -2, -2);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->ID_GROUP_MENU);
                } else {
                    $doc->exportCaption($this->MENU_ID);
                    $doc->exportCaption($this->STYPE_ID);
                    $doc->exportCaption($this->_MENU);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->ID_GROUP_MENU);
                    } else {
                        $doc->exportField($this->MENU_ID);
                        $doc->exportField($this->STYPE_ID);
                        $doc->exportField($this->_MENU);
