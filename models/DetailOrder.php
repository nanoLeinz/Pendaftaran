...
/**
 * Table class for DETAIL_ORDER
 */
class DetailOrder extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'DETAIL_ORDER';
        $this->TableName = 'DETAIL_ORDER';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[DETAIL_ORDER]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORDER_ID
        $this->ORDER_ID = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_ORDER_ID', 'ORDER_ID', '[ORDER_ID]', '[ORDER_ID]', 200, 15, -1, false, '[ORDER_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BRAND_ID
        $this->BRAND_ID = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_BRAND_ID', 'BRAND_ID', '[BRAND_ID]', '[BRAND_ID]', 200, 50, -1, false, '[BRAND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // QUANTITY
        $this->QUANTITY = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_QUANTITY', 'QUANTITY', '[QUANTITY]', 'CAST([QUANTITY] AS NVARCHAR)', 131, 8, -1, false, '[QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MEASURE_ID
        $this->MEASURE_ID = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_MEASURE_ID', 'MEASURE_ID', '[MEASURE_ID]', '[MEASURE_ID]', 200, 50, -1, false, '[MEASURE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('DETAIL_ORDER', 'DETAIL_ORDER', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[DETAIL_ORDER]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DetailOrderList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DetailOrderView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DetailOrderEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DetailOrderAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "DetailOrderAdd";
            case Config("API_EDIT_ACTION"):
                return "DetailOrderEdit";
            case Config("API_DELETE_ACTION"):
                return "DetailOrderDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DetailOrderView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DetailOrderView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DetailOrderAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DetailOrderAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DetailOrderEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DetailOrderAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DetailOrderDelete", $this->getUrlParm());
    }
