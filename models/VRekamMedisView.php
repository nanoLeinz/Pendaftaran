 ...
 * Page class
 */
class VRekamMedisView extends VRekamMedis
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRekamMedisView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("IDXDAFTAR") ?? Route("IDXDAFTAR")) !== null) {
                ...
                $returnUrl = "VRekamMedisList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "VRekamMedisList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "VRekamMedisList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
