 ...
 * Page class
 */
class MutationDocsView extends MutationDocs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "MutationDocsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("ORG_UNIT_CODE") ?? Route("ORG_UNIT_CODE")) !== null) {
                ...
                $returnUrl = "MutationDocsList"; // Return to list
            }
            if (($keyValue = Get("DOC_NO") ?? Route("DOC_NO")) !== null) {
                $this->DOC_NO->setQueryStringValue($keyValue);
                $this->RecKey["DOC_NO"] = $this->DOC_NO->QueryStringValue;
            } elseif (Post("DOC_NO") !== null) {
                $this->DOC_NO->setFormValue(Post("DOC_NO"));
                $this->RecKey["DOC_NO"] = $this->DOC_NO->FormValue;
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "MutationDocsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "MutationDocsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
