 ...
 * Page class
 */
class KedatanganPasienSummary extends KedatanganPasien
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'kedatangan_pasien';

    // Page object name
    public $PageObjName = "KedatanganPasienSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (kedatangan_pasien)
        if (!isset($GLOBALS["kedatangan_pasien"]) || get_class($GLOBALS["kedatangan_pasien"]) == PROJECT_NAMESPACE . "kedatangan_pasien") {
            $GLOBALS["kedatangan_pasien"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'kedatangan_pasien');
        }
