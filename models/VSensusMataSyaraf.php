...
/**
 * Table class for V_SENSUS_MATA_SYARAF
 */
class VSensusMataSyaraf extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_SENSUS_MATA_SYARAF';
        $this->TableName = 'V_SENSUS_MATA_SYARAF';
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('V_SENSUS_MATA_SYARAF', 'V_SENSUS_MATA_SYARAF', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', 'dbo.PASIEN_DIAGNOSA.DIAGNOSA_ID', 'dbo.PASIEN_DIAGNOSA.DIAGNOSA_ID', 200, 50, -1, false, 'dbo.PASIEN_DIAGNOSA.DIAGNOSA_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // GENDER
        $this->GENDER = new DbField('V_SENSUS_MATA_SYARAF', 'V_SENSUS_MATA_SYARAF', 'x_GENDER', 'GENDER', 'dbo.PASIEN_DIAGNOSA.GENDER', 'dbo.PASIEN_DIAGNOSA.GENDER', 129, 1, -1, false, 'dbo.PASIEN_DIAGNOSA.GENDER', false, false, false, 'FORMATTED TEXT', 'SELECT');
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.PASIEN_DIAGNOSA.DIAGNOSA_ID, dbo.PASIEN_DIAGNOSA.GENDER");
    }
    ...
    public function getSqlWhere() // Where
    {
        ...
        $this->DefaultFilter = "[DIAGNOSA_ID] = 'R47.0' or [DIAGNOSA_ID] = 'R47.1'";
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VSensusMataSyarafList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VSensusMataSyarafView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VSensusMataSyarafEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VSensusMataSyarafAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VSensusMataSyarafView";
            case Config("API_ADD_ACTION"):
                return "VSensusMataSyarafAdd";
            case Config("API_EDIT_ACTION"):
                return "VSensusMataSyarafEdit";
            case Config("API_DELETE_ACTION"):
                return "VSensusMataSyarafDelete";
            case Config("API_LIST_ACTION"):
                return "VSensusMataSyarafList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VSensusMataSyarafView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VSensusMataSyarafView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VSensusMataSyarafAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VSensusMataSyarafAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VSensusMataSyarafEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("VSensusMataSyarafAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VSensusMataSyarafDelete", $this->getUrlParm());
    }
