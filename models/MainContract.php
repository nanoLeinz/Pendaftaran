...
/**
 * Table class for MAIN_CONTRACT
 */
class MainContract extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'MAIN_CONTRACT';
        $this->TableName = 'MAIN_CONTRACT';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[MAIN_CONTRACT]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->ORG_UNIT_CODE->Sortable = true; // Allow sort
        $this->ORG_UNIT_CODE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->ORG_UNIT_CODE->Param, "CustomMsg");
        $this->Fields['ORG_UNIT_CODE'] = &$this->ORG_UNIT_CODE;

        // ORG_ID
        $this->ORG_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_ORG_ID', 'ORG_ID', '[ORG_ID]', '[ORG_ID]', 200, 50, -1, false, '[ORG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 50, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ACCOUNT_ID
        $this->ACCOUNT_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_ACCOUNT_ID', 'ACCOUNT_ID', '[ACCOUNT_ID]', '[ACCOUNT_ID]', 200, 50, -1, false, '[ACCOUNT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRACT_NO
        $this->CONTRACT_NO = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_CONTRACT_NO', 'CONTRACT_NO', '[CONTRACT_NO]', '[CONTRACT_NO]', 200, 25, -1, false, '[CONTRACT_NO]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRACT_TYPE
        $this->CONTRACT_TYPE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_CONTRACT_TYPE', 'CONTRACT_TYPE', '[CONTRACT_TYPE]', 'CAST([CONTRACT_TYPE] AS NVARCHAR)', 2, 2, -1, false, '[CONTRACT_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRACT_DATE
        $this->CONTRACT_DATE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_CONTRACT_DATE', 'CONTRACT_DATE', '[CONTRACT_DATE]', CastDateFieldForLike("[CONTRACT_DATE]", 0, "DB"), 135, 8, 0, false, '[CONTRACT_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // FUND_ID
        $this->FUND_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_FUND_ID', 'FUND_ID', '[FUND_ID]', 'CAST([FUND_ID] AS NVARCHAR)', 17, 1, -1, false, '[FUND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // COMPANY_ID
        $this->COMPANY_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_COMPANY_ID', 'COMPANY_ID', '[COMPANY_ID]', '[COMPANY_ID]', 200, 50, -1, false, '[COMPANY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CONTRACT_VALUE
        $this->CONTRACT_VALUE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_CONTRACT_VALUE', 'CONTRACT_VALUE', '[CONTRACT_VALUE]', 'CAST([CONTRACT_VALUE] AS NVARCHAR)', 6, 8, -1, false, '[CONTRACT_VALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // RECEIVED_VALUE
        $this->RECEIVED_VALUE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_RECEIVED_VALUE', 'RECEIVED_VALUE', '[RECEIVED_VALUE]', 'CAST([RECEIVED_VALUE] AS NVARCHAR)', 6, 8, -1, false, '[RECEIVED_VALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PAID_VALUE
        $this->PAID_VALUE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_PAID_VALUE', 'PAID_VALUE', '[PAID_VALUE]', 'CAST([PAID_VALUE] AS NVARCHAR)', 6, 8, -1, false, '[PAID_VALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PIHAK1
        $this->PIHAK1 = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_PIHAK1', 'PIHAK1', '[PIHAK1]', '[PIHAK1]', 200, 255, -1, false, '[PIHAK1]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PIHAK1->Sortable = true; // Allow sort
        $this->PIHAK1->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PIHAK1->Param, "CustomMsg");
        $this->Fields['PIHAK1'] = &$this->PIHAK1;

        // PIHAK2
        $this->PIHAK2 = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_PIHAK2', 'PIHAK2', '[PIHAK2]', '[PIHAK2]', 200, 255, -1, false, '[PIHAK2]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PIHAK2->Sortable = true; // Allow sort
        $this->PIHAK2->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PIHAK2->Param, "CustomMsg");
        $this->Fields['PIHAK2'] = &$this->PIHAK2;

        // START_DATE
        $this->START_DATE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_START_DATE', 'START_DATE', '[START_DATE]', CastDateFieldForLike("[START_DATE]", 0, "DB"), 135, 8, 0, false, '[START_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // END_DATE
        $this->END_DATE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_END_DATE', 'END_DATE', '[END_DATE]', CastDateFieldForLike("[END_DATE]", 0, "DB"), 135, 8, 0, false, '[END_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // YEAR_ID
        $this->YEAR_ID = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_YEAR_ID', 'YEAR_ID', '[YEAR_ID]', 'CAST([YEAR_ID] AS NVARCHAR)', 2, 2, -1, false, '[YEAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISOK
        $this->ISOK = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_ISOK', 'ISOK', '[ISOK]', '[ISOK]', 129, 1, -1, false, '[ISOK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 255, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // PP_VALUE
        $this->PP_VALUE = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_PP_VALUE', 'PP_VALUE', '[PP_VALUE]', 'CAST([PP_VALUE] AS NVARCHAR)', 6, 8, -1, false, '[PP_VALUE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->PP_VALUE->Sortable = true; // Allow sort
        $this->PP_VALUE->DefaultDecimalPrecision = 2; // Default decimal precision
        $this->PP_VALUE->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->PP_VALUE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->PP_VALUE->Param, "CustomMsg");
        $this->Fields['PP_VALUE'] = &$this->PP_VALUE;

        // NUM
        $this->NUM = new DbField('MAIN_CONTRACT', 'MAIN_CONTRACT', 'x_NUM', 'NUM', '[NUM]', 'CAST([NUM] AS NVARCHAR)', 2, 2, -1, false, '[NUM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[MAIN_CONTRACT]";
    }
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->PIHAK1->DbValue = $row['PIHAK1'];
        $this->PIHAK2->DbValue = $row['PIHAK2'];
        ...
        $this->PP_VALUE->DbValue = $row['PP_VALUE'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("MainContractList");
    }
    ...
    {
        global $Language;
        if ($pageName == "MainContractView") {
            return $Language->phrase("View");
        } elseif ($pageName == "MainContractEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "MainContractAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "MainContractView";
            case Config("API_ADD_ACTION"):
                return "MainContractAdd";
            case Config("API_EDIT_ACTION"):
                return "MainContractEdit";
            case Config("API_DELETE_ACTION"):
                return "MainContractDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("MainContractView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("MainContractView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "MainContractAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "MainContractAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("MainContractEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("MainContractAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("MainContractDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->PIHAK1->setDbValue($row['PIHAK1']);
        $this->PIHAK2->setDbValue($row['PIHAK2']);
        ...
        $this->PP_VALUE->setDbValue($row['PP_VALUE']);
    ...
    public function renderListRow()
    {
        ...
        // PIHAK1
        $this->PIHAK1->ViewValue = $this->PIHAK1->CurrentValue;
        $this->PIHAK1->ViewCustomAttributes = "";

        // PIHAK2
        $this->PIHAK2->ViewValue = $this->PIHAK2->CurrentValue;
        $this->PIHAK2->ViewCustomAttributes = "";
        ...
        // PP_VALUE
        $this->PP_VALUE->ViewValue = $this->PP_VALUE->CurrentValue;
        $this->PP_VALUE->ViewValue = FormatNumber($this->PP_VALUE->ViewValue, 2, -2, -2, -2);
        $this->PP_VALUE->ViewCustomAttributes = "";
        ...
        // PIHAK1
        $this->PIHAK1->LinkCustomAttributes = "";
        $this->PIHAK1->HrefValue = "";
        $this->PIHAK1->TooltipValue = "";

        // PIHAK2
        $this->PIHAK2->LinkCustomAttributes = "";
        $this->PIHAK2->HrefValue = "";
        $this->PIHAK2->TooltipValue = "";
        ...
        // PP_VALUE
        $this->PP_VALUE->LinkCustomAttributes = "";
        $this->PP_VALUE->HrefValue = "";
        $this->PP_VALUE->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // PIHAK1
        $this->PIHAK1->EditAttrs["class"] = "form-control";
        $this->PIHAK1->EditCustomAttributes = "";
        if (!$this->PIHAK1->Raw) {
            $this->PIHAK1->CurrentValue = HtmlDecode($this->PIHAK1->CurrentValue);
        }
        $this->PIHAK1->EditValue = $this->PIHAK1->CurrentValue;
        $this->PIHAK1->PlaceHolder = RemoveHtml($this->PIHAK1->caption());

        // PIHAK2
        $this->PIHAK2->EditAttrs["class"] = "form-control";
        $this->PIHAK2->EditCustomAttributes = "";
        if (!$this->PIHAK2->Raw) {
            $this->PIHAK2->CurrentValue = HtmlDecode($this->PIHAK2->CurrentValue);
        }
        $this->PIHAK2->EditValue = $this->PIHAK2->CurrentValue;
        $this->PIHAK2->PlaceHolder = RemoveHtml($this->PIHAK2->caption());
        ...
        // PP_VALUE
        $this->PP_VALUE->EditAttrs["class"] = "form-control";
        $this->PP_VALUE->EditCustomAttributes = "";
        $this->PP_VALUE->EditValue = $this->PP_VALUE->CurrentValue;
        $this->PP_VALUE->PlaceHolder = RemoveHtml($this->PP_VALUE->caption());
        if (strval($this->PP_VALUE->EditValue) != "" && is_numeric($this->PP_VALUE->EditValue)) {
            $this->PP_VALUE->EditValue = FormatNumber($this->PP_VALUE->EditValue, -2, -2, -2, -2);
        }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->PIHAK1);
                    $doc->exportCaption($this->PIHAK2);
                    ...
                    $doc->exportCaption($this->PP_VALUE);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->PIHAK1);
                        $doc->exportField($this->PIHAK2);
