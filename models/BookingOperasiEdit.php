 ...
 * Page class
 */
class BookingOperasiEdit extends BookingOperasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "BookingOperasiEdit";
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // no_rawat
            $this->no_rawat->setDbValueDef($rsnew, $this->no_rawat->CurrentValue, null, $this->no_rawat->ReadOnly);

            // kode_paket
            $this->kode_paket->setDbValueDef($rsnew, $this->kode_paket->CurrentValue, null, $this->kode_paket->ReadOnly);

            // tanggal
            $this->tanggal->setDbValueDef($rsnew, UnFormatDateTime($this->tanggal->CurrentValue, 0), null, $this->tanggal->ReadOnly);

            // jam_mulai
            $this->jam_mulai->setDbValueDef($rsnew, UnFormatDateTime($this->jam_mulai->CurrentValue, 4), null, $this->jam_mulai->ReadOnly);

            // jam_selesai
            $this->jam_selesai->setDbValueDef($rsnew, UnFormatDateTime($this->jam_selesai->CurrentValue, 4), null, $this->jam_selesai->ReadOnly);
            ...
            // kd_ruang_ok
            $this->kd_ruang_ok->setDbValueDef($rsnew, $this->kd_ruang_ok->CurrentValue, null, $this->kd_ruang_ok->ReadOnly);
