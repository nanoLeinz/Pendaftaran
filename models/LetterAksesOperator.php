...
/**
 * Table class for LETTER_AKSES_OPERATOR
 */
class LetterAksesOperator extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'LETTER_AKSES_OPERATOR';
        $this->TableName = 'LETTER_AKSES_OPERATOR';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[LETTER_AKSES_OPERATOR]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // USERNAME
        $this->_USERNAME = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x__USERNAME', 'USERNAME', '[USERNAME]', '[USERNAME]', 200, 16, -1, false, '[USERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // MODIFIED_FROM
        $this->MODIFIED_FROM = new DbField('LETTER_AKSES_OPERATOR', 'LETTER_AKSES_OPERATOR', 'x_MODIFIED_FROM', 'MODIFIED_FROM', '[MODIFIED_FROM]', '[MODIFIED_FROM]', 200, 50, -1, false, '[MODIFIED_FROM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[LETTER_AKSES_OPERATOR]";
    }
    ...
    {
        return "[USERNAME] = '@_USERNAME@' AND [ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [CLINIC_ID] = '@CLINIC_ID@'";
    }
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 3) {
            ...
            if ($current) {
                $this->CLINIC_ID->CurrentValue = $keys[2];
            } else {
                $this->CLINIC_ID->OldValue = $keys[2];
            }
        }
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("LetterAksesOperatorList");
    }
    ...
    {
        global $Language;
        if ($pageName == "LetterAksesOperatorView") {
            return $Language->phrase("View");
        } elseif ($pageName == "LetterAksesOperatorEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "LetterAksesOperatorAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "LetterAksesOperatorView";
            case Config("API_ADD_ACTION"):
                return "LetterAksesOperatorAdd";
            case Config("API_EDIT_ACTION"):
                return "LetterAksesOperatorEdit";
            case Config("API_DELETE_ACTION"):
                return "LetterAksesOperatorDelete";
            case Config("API_LIST_ACTION"):
                return "LetterAksesOperatorList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("LetterAksesOperatorView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("LetterAksesOperatorView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "LetterAksesOperatorAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "LetterAksesOperatorAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LetterAksesOperatorEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("LetterAksesOperatorAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("LetterAksesOperatorDelete", $this->getUrlParm());
    }
...
SORTHTML;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->CLINIC_ID->CurrentValue = $key[2];
            } else {
                $this->CLINIC_ID->OldValue = $key[2];
            }
