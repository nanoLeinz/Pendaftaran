...
/**
 * Table class for BLOOD_USAGE
 */
class BloodUsage extends DbTable
{
    protected $SqlFrom = "";
    ...
    public $KELUAR_ID;
    public $KAL_ID;
    public $BLOOD_USAGE_TYPE;
    public $BLOOD_QUANTITY;
    public $BLOOD_USAGE_CATEGORY;
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'BLOOD_USAGE';
        $this->TableName = 'BLOOD_USAGE';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[BLOOD_USAGE]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USAGE_ID
        $this->USAGE_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_USAGE_ID', 'USAGE_ID', '[USAGE_ID]', '[USAGE_ID]', 200, 50, -1, false, '[USAGE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->USAGE_ID->IsPrimaryKey = true; // Primary key field
        $this->USAGE_ID->Nullable = false; // NOT NULL field
        $this->USAGE_ID->Required = true; // Required field
        $this->USAGE_ID->Sortable = true; // Allow sort
        $this->USAGE_ID->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->USAGE_ID->Param, "CustomMsg");
        $this->Fields['USAGE_ID'] = &$this->USAGE_ID;

        // BLOOD_BANK
        $this->BLOOD_BANK = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_BLOOD_BANK', 'BLOOD_BANK', '[BLOOD_BANK]', '[BLOOD_BANK]', 200, 50, -1, false, '[BLOOD_BANK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 50, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USAGE_DATE
        $this->USAGE_DATE = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_USAGE_DATE', 'USAGE_DATE', '[USAGE_DATE]', CastDateFieldForLike("[USAGE_DATE]", 0, "DB"), 135, 8, 0, false, '[USAGE_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->USAGE_DATE->Sortable = true; // Allow sort
        $this->USAGE_DATE->DefaultErrorMessage = str_replace("%s", $GLOBALS["DATE_FORMAT"], $Language->phrase("IncorrectDate"));
        $this->USAGE_DATE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->USAGE_DATE->Param, "CustomMsg");
        $this->Fields['USAGE_DATE'] = &$this->USAGE_DATE;

        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 50, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 255, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // THENAME
        $this->THENAME = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 100, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEADDRESS
        $this->THEADDRESS = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_THEADDRESS', 'THEADDRESS', '[THEADDRESS]', '[THEADDRESS]', 200, 150, -1, false, '[THEADDRESS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THEID
        $this->THEID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_THEID', 'THEID', '[THEID]', '[THEID]', 200, 50, -1, false, '[THEID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISRJ
        $this->ISRJ = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_ISRJ', 'ISRJ', '[ISRJ]', '[ISRJ]', 129, 1, -1, false, '[ISRJ]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEYEAR
        $this->AGEYEAR = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_AGEYEAR', 'AGEYEAR', '[AGEYEAR]', 'CAST([AGEYEAR] AS NVARCHAR)', 17, 1, -1, false, '[AGEYEAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEMONTH
        $this->AGEMONTH = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_AGEMONTH', 'AGEMONTH', '[AGEMONTH]', 'CAST([AGEMONTH] AS NVARCHAR)', 17, 1, -1, false, '[AGEMONTH]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AGEDAY
        $this->AGEDAY = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_AGEDAY', 'AGEDAY', '[AGEDAY]', 'CAST([AGEDAY] AS NVARCHAR)', 17, 1, -1, false, '[AGEDAY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', '[STATUS_PASIEN_ID]', 'CAST([STATUS_PASIEN_ID] AS NVARCHAR)', 17, 1, -1, false, '[STATUS_PASIEN_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // GENDER
        $this->GENDER = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_GENDER', 'GENDER', '[GENDER]', '[GENDER]', 129, 1, -1, false, '[GENDER]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->GENDER->Sortable = true; // Allow sort
        $this->GENDER->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->GENDER->Param, "CustomMsg");
        $this->Fields['GENDER'] = &$this->GENDER;

        // PETUGAS_ID
        $this->PETUGAS_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_PETUGAS_ID', 'PETUGAS_ID', '[PETUGAS_ID]', '[PETUGAS_ID]', 200, 15, -1, false, '[PETUGAS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // PETUGAS
        $this->PETUGAS = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_PETUGAS', 'PETUGAS', '[PETUGAS]', '[PETUGAS]', 200, 100, -1, false, '[PETUGAS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ROOM_ID
        $this->CLASS_ROOM_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_CLASS_ROOM_ID', 'CLASS_ROOM_ID', '[CLASS_ROOM_ID]', '[CLASS_ROOM_ID]', 200, 15, -1, false, '[CLASS_ROOM_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BED_ID
        $this->BED_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_BED_ID', 'BED_ID', '[BED_ID]', 'CAST([BED_ID] AS NVARCHAR)', 17, 1, -1, false, '[BED_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KELUAR_ID
        $this->KELUAR_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_KELUAR_ID', 'KELUAR_ID', '[KELUAR_ID]', 'CAST([KELUAR_ID] AS NVARCHAR)', 17, 1, -1, false, '[KELUAR_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // KAL_ID
        $this->KAL_ID = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_KAL_ID', 'KAL_ID', '[KAL_ID]', '[KAL_ID]', 200, 50, -1, false, '[KAL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BLOOD_USAGE_TYPE
        $this->BLOOD_USAGE_TYPE = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_BLOOD_USAGE_TYPE', 'BLOOD_USAGE_TYPE', '[BLOOD_USAGE_TYPE]', 'CAST([BLOOD_USAGE_TYPE] AS NVARCHAR)', 17, 1, -1, false, '[BLOOD_USAGE_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BLOOD_USAGE_TYPE->Sortable = true; // Allow sort
        $this->BLOOD_USAGE_TYPE->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->BLOOD_USAGE_TYPE->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BLOOD_USAGE_TYPE->Param, "CustomMsg");
        $this->Fields['BLOOD_USAGE_TYPE'] = &$this->BLOOD_USAGE_TYPE;

        // BLOOD_QUANTITY
        $this->BLOOD_QUANTITY = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_BLOOD_QUANTITY', 'BLOOD_QUANTITY', '[BLOOD_QUANTITY]', 'CAST([BLOOD_QUANTITY] AS NVARCHAR)', 3, 4, -1, false, '[BLOOD_QUANTITY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BLOOD_QUANTITY->Sortable = true; // Allow sort
        $this->BLOOD_QUANTITY->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->BLOOD_QUANTITY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BLOOD_QUANTITY->Param, "CustomMsg");
        $this->Fields['BLOOD_QUANTITY'] = &$this->BLOOD_QUANTITY;

        // BLOOD_USAGE_CATEGORY
        $this->BLOOD_USAGE_CATEGORY = new DbField('BLOOD_USAGE', 'BLOOD_USAGE', 'x_BLOOD_USAGE_CATEGORY', 'BLOOD_USAGE_CATEGORY', '[BLOOD_USAGE_CATEGORY]', 'CAST([BLOOD_USAGE_CATEGORY] AS NVARCHAR)', 17, 1, -1, false, '[BLOOD_USAGE_CATEGORY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->BLOOD_USAGE_CATEGORY->Sortable = true; // Allow sort
        $this->BLOOD_USAGE_CATEGORY->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->BLOOD_USAGE_CATEGORY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->BLOOD_USAGE_CATEGORY->Param, "CustomMsg");
        $this->Fields['BLOOD_USAGE_CATEGORY'] = &$this->BLOOD_USAGE_CATEGORY;
    }
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[BLOOD_USAGE]";
    }
    ...
    protected function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            ...
            if (array_key_exists('USAGE_ID', $rs)) {
                AddFilter($where, QuotedName('USAGE_ID', $this->Dbid) . '=' . QuotedValue($rs['USAGE_ID'], $this->USAGE_ID->DataType, $this->Dbid));
            }
        }
        $filter = ($curfilter) ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->BLOOD_USAGE_TYPE->DbValue = $row['BLOOD_USAGE_TYPE'];
        $this->BLOOD_QUANTITY->DbValue = $row['BLOOD_QUANTITY'];
        $this->BLOOD_USAGE_CATEGORY->DbValue = $row['BLOOD_USAGE_CATEGORY'];
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [USAGE_ID] = '@USAGE_ID@'";
    }
    ...
    public function getKey($current = false)
    {
        ...
        $val = $current ? $this->USAGE_ID->CurrentValue : $this->USAGE_ID->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false)
    {
        ...
        if (count($keys) == 2) {
            ...
            if ($current) {
                $this->USAGE_ID->CurrentValue = $keys[1];
            } else {
                $this->USAGE_ID->OldValue = $keys[1];
            }
        }
    }
    ...
    public function getRecordFilter($row = null)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('USAGE_ID', $row) ? $row['USAGE_ID'] : null;
        } else {
            $val = $this->USAGE_ID->OldValue !== null ? $this->USAGE_ID->OldValue : $this->USAGE_ID->CurrentValue;
        }
        if ($val === null) {
            return "0=1"; // Invalid key
        } else {
            $keyFilter = str_replace("@USAGE_ID@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BloodUsageList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BloodUsageView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BloodUsageEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BloodUsageAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            ...
            case Config("API_ADD_ACTION"):
                return "BloodUsageAdd";
            case Config("API_EDIT_ACTION"):
                return "BloodUsageEdit";
            case Config("API_DELETE_ACTION"):
                return "BloodUsageDelete";
            case Config("API_LIST_ACTION"):
                return "BloodUsageList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BloodUsageView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BloodUsageView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BloodUsageAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BloodUsageAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("BloodUsageEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BloodUsageAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BloodUsageDelete", $this->getUrlParm());
    }
    ...
    public function keyToJson($htmlEncode = false)
    {
        ...
        $json .= ",USAGE_ID:" . JsonEncode($this->USAGE_ID->CurrentValue, "string");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        ...
        if ($this->USAGE_ID->CurrentValue !== null) {
            $url .= "/" . rawurlencode($this->USAGE_ID->CurrentValue);
        } else {
            return "javascript:ew.alert(ew.language.phrase('InvalidRecord'));";
        }
        if ($parm != "") {
...
SORTHTML;
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            if (($keyValue = Param("USAGE_ID") ?? Route("USAGE_ID")) !== null) {
                $arKey[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->USAGE_ID->CurrentValue = $key[1];
            } else {
                $this->USAGE_ID->OldValue = $key[1];
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->USAGE_ID->setDbValue($row['USAGE_ID']);
        $this->BLOOD_BANK->setDbValue($row['BLOOD_BANK']);
        $this->NO_REGISTRATION->setDbValue($row['NO_REGISTRATION']);
        $this->VISIT_ID->setDbValue($row['VISIT_ID']);
        $this->USAGE_DATE->setDbValue($row['USAGE_DATE']);
        ...
        $this->BLOOD_USAGE_TYPE->setDbValue($row['BLOOD_USAGE_TYPE']);
        $this->BLOOD_QUANTITY->setDbValue($row['BLOOD_QUANTITY']);
        $this->BLOOD_USAGE_CATEGORY->setDbValue($row['BLOOD_USAGE_CATEGORY']);
    }
    ...
    public function renderListRow()
    {
        ...
        // USAGE_ID
        $this->USAGE_ID->ViewValue = $this->USAGE_ID->CurrentValue;
        $this->USAGE_ID->ViewCustomAttributes = "";
        ...
        // USAGE_DATE
        $this->USAGE_DATE->ViewValue = $this->USAGE_DATE->CurrentValue;
        $this->USAGE_DATE->ViewValue = FormatDateTime($this->USAGE_DATE->ViewValue, 0);
        $this->USAGE_DATE->ViewCustomAttributes = "";
        ...
        // BLOOD_USAGE_TYPE
        $this->BLOOD_USAGE_TYPE->ViewValue = $this->BLOOD_USAGE_TYPE->CurrentValue;
        $this->BLOOD_USAGE_TYPE->ViewValue = FormatNumber($this->BLOOD_USAGE_TYPE->ViewValue, 0, -2, -2, -2);
        $this->BLOOD_USAGE_TYPE->ViewCustomAttributes = "";

        // BLOOD_QUANTITY
        $this->BLOOD_QUANTITY->ViewValue = $this->BLOOD_QUANTITY->CurrentValue;
        $this->BLOOD_QUANTITY->ViewValue = FormatNumber($this->BLOOD_QUANTITY->ViewValue, 0, -2, -2, -2);
        $this->BLOOD_QUANTITY->ViewCustomAttributes = "";

        // BLOOD_USAGE_CATEGORY
        $this->BLOOD_USAGE_CATEGORY->ViewValue = $this->BLOOD_USAGE_CATEGORY->CurrentValue;
        $this->BLOOD_USAGE_CATEGORY->ViewValue = FormatNumber($this->BLOOD_USAGE_CATEGORY->ViewValue, 0, -2, -2, -2);
        $this->BLOOD_USAGE_CATEGORY->ViewCustomAttributes = "";
        ...
        // USAGE_ID
        $this->USAGE_ID->LinkCustomAttributes = "";
        $this->USAGE_ID->HrefValue = "";
        $this->USAGE_ID->TooltipValue = "";
        ...
        // USAGE_DATE
        $this->USAGE_DATE->LinkCustomAttributes = "";
        $this->USAGE_DATE->HrefValue = "";
        $this->USAGE_DATE->TooltipValue = "";
        ...
        // BLOOD_USAGE_TYPE
        $this->BLOOD_USAGE_TYPE->LinkCustomAttributes = "";
        $this->BLOOD_USAGE_TYPE->HrefValue = "";
        $this->BLOOD_USAGE_TYPE->TooltipValue = "";

        // BLOOD_QUANTITY
        $this->BLOOD_QUANTITY->LinkCustomAttributes = "";
        $this->BLOOD_QUANTITY->HrefValue = "";
        $this->BLOOD_QUANTITY->TooltipValue = "";

        // BLOOD_USAGE_CATEGORY
        $this->BLOOD_USAGE_CATEGORY->LinkCustomAttributes = "";
        $this->BLOOD_USAGE_CATEGORY->HrefValue = "";
        $this->BLOOD_USAGE_CATEGORY->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // USAGE_ID
        $this->USAGE_ID->EditAttrs["class"] = "form-control";
        $this->USAGE_ID->EditCustomAttributes = "";
        if (!$this->USAGE_ID->Raw) {
            $this->USAGE_ID->CurrentValue = HtmlDecode($this->USAGE_ID->CurrentValue);
        }
        $this->USAGE_ID->EditValue = $this->USAGE_ID->CurrentValue;
        $this->USAGE_ID->PlaceHolder = RemoveHtml($this->USAGE_ID->caption());
        ...
        // USAGE_DATE
        $this->USAGE_DATE->EditAttrs["class"] = "form-control";
        $this->USAGE_DATE->EditCustomAttributes = "";
        $this->USAGE_DATE->EditValue = FormatDateTime($this->USAGE_DATE->CurrentValue, 8);
        $this->USAGE_DATE->PlaceHolder = RemoveHtml($this->USAGE_DATE->caption());
        ...
        // BLOOD_USAGE_TYPE
        $this->BLOOD_USAGE_TYPE->EditAttrs["class"] = "form-control";
        $this->BLOOD_USAGE_TYPE->EditCustomAttributes = "";
        $this->BLOOD_USAGE_TYPE->EditValue = $this->BLOOD_USAGE_TYPE->CurrentValue;
        $this->BLOOD_USAGE_TYPE->PlaceHolder = RemoveHtml($this->BLOOD_USAGE_TYPE->caption());

        // BLOOD_QUANTITY
        $this->BLOOD_QUANTITY->EditAttrs["class"] = "form-control";
        $this->BLOOD_QUANTITY->EditCustomAttributes = "";
        $this->BLOOD_QUANTITY->EditValue = $this->BLOOD_QUANTITY->CurrentValue;
        $this->BLOOD_QUANTITY->PlaceHolder = RemoveHtml($this->BLOOD_QUANTITY->caption());

        // BLOOD_USAGE_CATEGORY
        $this->BLOOD_USAGE_CATEGORY->EditAttrs["class"] = "form-control";
        $this->BLOOD_USAGE_CATEGORY->EditCustomAttributes = "";
        $this->BLOOD_USAGE_CATEGORY->EditValue = $this->BLOOD_USAGE_CATEGORY->CurrentValue;
        $this->BLOOD_USAGE_CATEGORY->PlaceHolder = RemoveHtml($this->BLOOD_USAGE_CATEGORY->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->BLOOD_USAGE_TYPE);
                    $doc->exportCaption($this->BLOOD_QUANTITY);
                    $doc->exportCaption($this->BLOOD_USAGE_CATEGORY);
                } else {
                    $doc->exportCaption($this->ORG_UNIT_CODE);
                    $doc->exportCaption($this->USAGE_ID);
                    $doc->exportCaption($this->BLOOD_BANK);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->BLOOD_USAGE_TYPE);
                        $doc->exportField($this->BLOOD_QUANTITY);
                        $doc->exportField($this->BLOOD_USAGE_CATEGORY);
                    } else {
                        $doc->exportField($this->ORG_UNIT_CODE);
                        $doc->exportField($this->USAGE_ID);
                        $doc->exportField($this->BLOOD_BANK);
