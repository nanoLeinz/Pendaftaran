 ...
 * Page class
 */
class TreatmentAkomodasiList extends TreatmentAkomodasi
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "TreatmentAkomodasiList";

    // Rendering View
    public $RenderingView = false;

    // Grid form hidden field names
    public $FormName = "fTREATMENT_AKOMODASIlist";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "TreatmentAkomodasiDelete";
        $this->MultiUpdateUrl = "TreatmentAkomodasiUpdate";
        ...
        $this->FilterOptions->TagClassName = "ew-filter-option fTREATMENT_AKOMODASIlistsrch";
    ...
    protected function processFilterList()
    {
        ...
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            $UserProfile->setSearchFilters(CurrentUserName(), "fTREATMENT_AKOMODASIlistsrch", $filters);
    ...
    protected function basicSearchSql($arKeywords, $type)
    {
        ...
        $this->buildBasicSearchSql($where, $this->RESPON, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->NOKARTU, $arKeywords, $type);
        ...
        $this->buildBasicSearchSql($where, $this->SPPBILL, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->SPPBILLUSER, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->SPPKASIR, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->SPPKASIRUSER, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->SPPPOLI, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->SPPPOLIUSER, $arKeywords, $type);
        $this->buildBasicSearchSql($where, $this->NO_SURAT_KET, $arKeywords, $type);
        return $where;
    }
    ...
    protected function setupOtherOptions()
    {
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fTREATMENT_AKOMODASIlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fTREATMENT_AKOMODASIlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions->Items as $listaction) {
            if ($listaction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<a class="ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" href="#" onclick="return ew.submitAction(event,jQuery.extend({f:document.fTREATMENT_AKOMODASIlist},' . $listaction->toJson(true) . '));">' . $icon . '</a>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" href=\"#\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"fTREATMENT_AKOMODASIlistsrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
