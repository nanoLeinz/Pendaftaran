...
/**
 * Table class for tarif
 */
class Tarif extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('tarif', 'tarif', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 25, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TREAT_ID
        $this->TREAT_ID = new DbField('tarif', 'tarif', 'x_TREAT_ID', 'TREAT_ID', '[TREAT_ID]', '[TREAT_ID]', 200, 25, -1, false, '[TREAT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DISPLAY_TARIF
        $this->DISPLAY_TARIF = new DbField('tarif', 'tarif', 'x_DISPLAY_TARIF', 'DISPLAY_TARIF', '[DISPLAY_TARIF]', '[DISPLAY_TARIF]', 200, 50, -1, false, '[DISPLAY_TARIF]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_NAME
        $this->TARIF_NAME = new DbField('tarif', 'tarif', 'x_TARIF_NAME', 'TARIF_NAME', '[TARIF_NAME]', '[TARIF_NAME]', 200, 200, -1, false, '[TARIF_NAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLASS_ID
        $this->CLASS_ID = new DbField('tarif', 'tarif', 'x_CLASS_ID', 'CLASS_ID', '[CLASS_ID]', 'CAST([CLASS_ID] AS NVARCHAR)', 17, 1, -1, false, '[CLASS_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LEVEL_ID
        $this->LEVEL_ID = new DbField('tarif', 'tarif', 'x_LEVEL_ID', 'LEVEL_ID', '[LEVEL_ID]', 'CAST([LEVEL_ID] AS NVARCHAR)', 17, 1, -1, false, '[LEVEL_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // harga
        $this->harga = new DbField('tarif', 'tarif', 'x_harga', 'harga', '[harga]', 'CAST([harga] AS NVARCHAR)', 6, 8, -1, false, '[harga]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[tarif]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("TarifList");
    }
    ...
    {
        global $Language;
        if ($pageName == "TarifView") {
            return $Language->phrase("View");
        } elseif ($pageName == "TarifEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "TarifAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("TarifView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("TarifView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "TarifAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "TarifAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("TarifEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("TarifAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("TarifDelete", $this->getUrlParm());
    }
