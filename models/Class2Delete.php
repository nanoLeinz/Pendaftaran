 ...
 * Page class
 */
class Class2Delete extends Class2
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "Class2Delete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("Class2List"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("Class2List"); // Return to list
                return;
            }
        }
