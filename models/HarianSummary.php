 ...
 * Page class
 */
class HarianSummary extends Harian
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'harian';

    // Page object name
    public $PageObjName = "HarianSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (harian)
        if (!isset($GLOBALS["harian"]) || get_class($GLOBALS["harian"]) == PROJECT_NAMESPACE . "harian") {
            $GLOBALS["harian"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'harian');
        }
    ...
    public function loadRowValues($record)
    {
        ...
        $data["NAME_OF_STATUS_PASIEN"] = $record['NAME_OF_STATUS_PASIEN'];
        $this->Rows[] = $data;
        ...
        $this->NAME_OF_STATUS_PASIEN->setDbValue($record['NAME_OF_STATUS_PASIEN']);
    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_SEARCH) { // Search row
            ...
            $this->NAME_OF_STATUS_PASIEN->CellCssClass = ($this->RecordCount % 2 != 1 ? "ew-table-alt-row" : "ew-table-row");
        ...
        if ($this->RowType == ROWTYPE_TOTAL) { // Summary row
            ...
            // NAME_OF_STATUS_PASIEN
            $currentValue = $this->NAME_OF_STATUS_PASIEN->CurrentValue;
            $viewValue = &$this->NAME_OF_STATUS_PASIEN->ViewValue;
            $viewAttrs = &$this->NAME_OF_STATUS_PASIEN->ViewAttrs;
            $cellAttrs = &$this->NAME_OF_STATUS_PASIEN->CellAttrs;
            $hrefValue = &$this->NAME_OF_STATUS_PASIEN->HrefValue;
            $linkAttrs = &$this->NAME_OF_STATUS_PASIEN->LinkAttrs;
            $this->cellRendered($this->NAME_OF_STATUS_PASIEN, $currentValue, $viewValue, $viewAttrs, $cellAttrs, $hrefValue, $linkAttrs);
        }
    ...
    protected function setupFieldCount()
    {
        ...
        if ($this->NAME_OF_STATUS_PASIEN->Visible) {
            $this->DetailColumnCount += 1;
        }
    }
