 ...
 * Page class
 */
class PasienDiagnosaEdit extends PasienDiagnosa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "PasienDiagnosaEdit";
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'INSTRUCTION' first before field var 'x_INSTRUCTION'
        $val = $CurrentForm->hasValue("INSTRUCTION") ? $CurrentForm->getValue("INSTRUCTION") : $CurrentForm->getValue("x_INSTRUCTION");
        if (!$this->INSTRUCTION->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->INSTRUCTION->Visible = false; // Disable update for API request
            } else {
                $this->INSTRUCTION->setFormValue($val);
            }
        }
        ...
        // Check field name 'DIAGNOSA_ID_10' first before field var 'x_DIAGNOSA_ID_10'
        $val = $CurrentForm->hasValue("DIAGNOSA_ID_10") ? $CurrentForm->getValue("DIAGNOSA_ID_10") : $CurrentForm->getValue("x_DIAGNOSA_ID_10");
        if (!$this->DIAGNOSA_ID_10->IsDetailKey) {
            if (IsApi() && $val === null) {
                $this->DIAGNOSA_ID_10->Visible = false; // Disable update for API request
            } else {
                $this->DIAGNOSA_ID_10->setFormValue($val);
            }
        }
    ...
    public function restoreFormValues()
    {
        ...
        $this->INSTRUCTION->CurrentValue = $this->INSTRUCTION->FormValue;
        ...
        $this->DIAGNOSA_ID_10->CurrentValue = $this->DIAGNOSA_ID_10->FormValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->INSTRUCTION->EditValue = HtmlEncode($this->INSTRUCTION->CurrentValue);
            ...
            $this->DIAGNOSA_ID_10->EditValue = HtmlEncode($this->DIAGNOSA_ID_10->CurrentValue);
    ...
    protected function validateForm()
    {
        ...
        if ($this->INSTRUCTION->Required) {
            if (!$this->INSTRUCTION->IsDetailKey && EmptyValue($this->INSTRUCTION->FormValue)) {
                $this->INSTRUCTION->addErrorMessage(str_replace("%s", $this->INSTRUCTION->caption(), $this->INSTRUCTION->RequiredErrorMessage));
            }
        }
        ...
        if ($this->DIAGNOSA_ID_10->Required) {
            if (!$this->DIAGNOSA_ID_10->IsDetailKey && EmptyValue($this->DIAGNOSA_ID_10->FormValue)) {
                $this->DIAGNOSA_ID_10->addErrorMessage(str_replace("%s", $this->DIAGNOSA_ID_10->caption(), $this->DIAGNOSA_ID_10->RequiredErrorMessage));
            }
        }
    ...
    protected function editRow()
    {
        ...
        if (!$rsold) {
            ...
            // INSTRUCTION
            $this->INSTRUCTION->setDbValueDef($rsnew, $this->INSTRUCTION->CurrentValue, null, $this->INSTRUCTION->ReadOnly);

            // SUFFER_TYPE
            $this->SUFFER_TYPE->setDbValueDef($rsnew, $this->SUFFER_TYPE->CurrentValue, null, $this->SUFFER_TYPE->ReadOnly);

            // EMPLOYEE_ID
            $this->EMPLOYEE_ID->setDbValueDef($rsnew, $this->EMPLOYEE_ID->CurrentValue, null, $this->EMPLOYEE_ID->ReadOnly);

            // MORFOLOGI_NEOPLASMA
            $this->MORFOLOGI_NEOPLASMA->setDbValueDef($rsnew, $this->MORFOLOGI_NEOPLASMA->CurrentValue, null, $this->MORFOLOGI_NEOPLASMA->ReadOnly);

            // DESCRIPTION
            $this->DESCRIPTION->setDbValueDef($rsnew, $this->DESCRIPTION->CurrentValue, null, $this->DESCRIPTION->ReadOnly);

            // KOMPLIKASI
            $this->KOMPLIKASI->setDbValueDef($rsnew, $this->KOMPLIKASI->CurrentValue, null, $this->KOMPLIKASI->ReadOnly);

            // DIAGNOSA_ID_02
            $this->DIAGNOSA_ID_02->setDbValueDef($rsnew, $this->DIAGNOSA_ID_02->CurrentValue, null, $this->DIAGNOSA_ID_02->ReadOnly);

            // DIAGNOSA_ID_03
            $this->DIAGNOSA_ID_03->setDbValueDef($rsnew, $this->DIAGNOSA_ID_03->CurrentValue, null, $this->DIAGNOSA_ID_03->ReadOnly);

            // DIAGNOSA_ID_04
            $this->DIAGNOSA_ID_04->setDbValueDef($rsnew, $this->DIAGNOSA_ID_04->CurrentValue, null, $this->DIAGNOSA_ID_04->ReadOnly);

            // DIAGNOSA_ID_05
            $this->DIAGNOSA_ID_05->setDbValueDef($rsnew, $this->DIAGNOSA_ID_05->CurrentValue, null, $this->DIAGNOSA_ID_05->ReadOnly);

            // DIAGNOSA_ID_06
            $this->DIAGNOSA_ID_06->setDbValueDef($rsnew, $this->DIAGNOSA_ID_06->CurrentValue, null, $this->DIAGNOSA_ID_06->ReadOnly);

            // DIAGNOSA_ID_09
            $this->DIAGNOSA_ID_09->setDbValueDef($rsnew, $this->DIAGNOSA_ID_09->CurrentValue, null, $this->DIAGNOSA_ID_09->ReadOnly);

            // DIAGNOSA_ID_10
            $this->DIAGNOSA_ID_10->setDbValueDef($rsnew, $this->DIAGNOSA_ID_10->CurrentValue, null, $this->DIAGNOSA_ID_10->ReadOnly);

            // PROCEDURE_03
            $this->PROCEDURE_03->setDbValueDef($rsnew, $this->PROCEDURE_03->CurrentValue, null, $this->PROCEDURE_03->ReadOnly);

            // PROCEDURE_05
            $this->PROCEDURE_05->setDbValueDef($rsnew, $this->PROCEDURE_05->CurrentValue, null, $this->PROCEDURE_05->ReadOnly);

            // PROCEDURE_06
            $this->PROCEDURE_06->setDbValueDef($rsnew, $this->PROCEDURE_06->CurrentValue, null, $this->PROCEDURE_06->ReadOnly);
            ...
            // PEMERIKSAAN_02
            $this->PEMERIKSAAN_02->setDbValueDef($rsnew, $this->PEMERIKSAAN_02->CurrentValue, null, $this->PEMERIKSAAN_02->ReadOnly);

            // height
            $this->height->setDbValueDef($rsnew, $this->height->CurrentValue, null, $this->height->ReadOnly);

            // TEMPERATURE
            $this->TEMPERATURE->setDbValueDef($rsnew, $this->TEMPERATURE->CurrentValue, null, $this->TEMPERATURE->ReadOnly);

            // TENSION_UPPER
            $this->TENSION_UPPER->setDbValueDef($rsnew, $this->TENSION_UPPER->CurrentValue, null, $this->TENSION_UPPER->ReadOnly);

            // NADI
            $this->NADI->setDbValueDef($rsnew, $this->NADI->CurrentValue, null, $this->NADI->ReadOnly);

            // NAFAS
            $this->NAFAS->setDbValueDef($rsnew, $this->NAFAS->CurrentValue, null, $this->NAFAS->ReadOnly);
