 ...
 * Page class
 */
class CvVisitView extends CvVisit
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "CvVisitView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("IDXDAFTAR") ?? Route("IDXDAFTAR")) !== null) {
                ...
                $returnUrl = "CvVisitList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "CvVisitList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "CvVisitList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
