...
/**
 * Table class for DOCTOR_sch
 */
class DoctorSch extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'DOCTOR_sch';
        $this->TableName = 'DOCTOR_sch';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[DOCTOR_sch]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', '[EMPLOYEE_ID]', '[EMPLOYEE_ID]', 200, 15, -1, false, '[EMPLOYEE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCHEDULE_ID
        $this->SCHEDULE_ID = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_SCHEDULE_ID', 'SCHEDULE_ID', '[SCHEDULE_ID]', 'CAST([SCHEDULE_ID] AS NVARCHAR)', 2, 2, -1, false, '[SCHEDULE_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DAY_ID
        $this->DAY_ID = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_DAY_ID', 'DAY_ID', '[DAY_ID]', 'CAST([DAY_ID] AS NVARCHAR)', 2, 2, -1, false, '[DAY_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // START_TIME
        $this->START_TIME = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_START_TIME', 'START_TIME', '[START_TIME]', CastDateFieldForLike("[START_TIME]", 0, "DB"), 135, 8, 0, false, '[START_TIME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // END_TIME
        $this->END_TIME = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_END_TIME', 'END_TIME', '[END_TIME]', CastDateFieldForLike("[END_TIME]", 0, "DB"), 135, 8, 0, false, '[END_TIME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIF_ID
        $this->TARIF_ID = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_TARIF_ID', 'TARIF_ID', '[TARIF_ID]', '[TARIF_ID]', 200, 50, -1, false, '[TARIF_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // AMOUNT
        $this->AMOUNT = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_AMOUNT', 'AMOUNT', '[AMOUNT]', 'CAST([AMOUNT] AS NVARCHAR)', 6, 8, -1, false, '[AMOUNT]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 150, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // DOCTOR_TYPE
        $this->DOCTOR_TYPE = new DbField('DOCTOR_sch', 'DOCTOR_sch', 'x_DOCTOR_TYPE', 'DOCTOR_TYPE', '[DOCTOR_TYPE]', 'CAST([DOCTOR_TYPE] AS NVARCHAR)', 3, 4, -1, false, '[DOCTOR_TYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[DOCTOR_sch]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [EMPLOYEE_ID] = '@EMPLOYEE_ID@' AND [SCHEDULE_ID] = @SCHEDULE_ID@";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DoctorSchList");
    }
    ...
    {
        global $Language;
        if ($pageName == "DoctorSchView") {
            return $Language->phrase("View");
        } elseif ($pageName == "DoctorSchEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DoctorSchAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DoctorSchView";
            case Config("API_ADD_ACTION"):
                return "DoctorSchAdd";
            case Config("API_EDIT_ACTION"):
                return "DoctorSchEdit";
            case Config("API_DELETE_ACTION"):
                return "DoctorSchDelete";
            case Config("API_LIST_ACTION"):
                return "DoctorSchList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DoctorSchView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DoctorSchView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DoctorSchAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "DoctorSchAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("DoctorSchEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DoctorSchAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DoctorSchDelete", $this->getUrlParm());
    }
