...
/**
 * Table class for CLINIC_DIAGNOSA
 */
class ClinicDiagnosa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'CLINIC_DIAGNOSA';
        $this->TableName = 'CLINIC_DIAGNOSA';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[CLINIC_DIAGNOSA]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('CLINIC_DIAGNOSA', 'CLINIC_DIAGNOSA', 'x_CLINIC_ID', 'CLINIC_ID', '[CLINIC_ID]', '[CLINIC_ID]', 200, 8, -1, false, '[CLINIC_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIAGNOSA_ID
        $this->DIAGNOSA_ID = new DbField('CLINIC_DIAGNOSA', 'CLINIC_DIAGNOSA', 'x_DIAGNOSA_ID', 'DIAGNOSA_ID', '[DIAGNOSA_ID]', '[DIAGNOSA_ID]', 200, 50, -1, false, '[DIAGNOSA_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('CLINIC_DIAGNOSA', 'CLINIC_DIAGNOSA', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[CLINIC_DIAGNOSA]";
    }
    ...
    {
        return "[CLINIC_ID] = '@CLINIC_ID@' AND [DIAGNOSA_ID] = '@DIAGNOSA_ID@' AND [ORG_UNIT_CODE] = '@ORG_UNIT_CODE@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ClinicDiagnosaList");
    }
    ...
    {
        global $Language;
        if ($pageName == "ClinicDiagnosaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "ClinicDiagnosaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "ClinicDiagnosaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "ClinicDiagnosaView";
            case Config("API_ADD_ACTION"):
                return "ClinicDiagnosaAdd";
            case Config("API_EDIT_ACTION"):
                return "ClinicDiagnosaEdit";
            case Config("API_DELETE_ACTION"):
                return "ClinicDiagnosaDelete";
            case Config("API_LIST_ACTION"):
                return "ClinicDiagnosaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ClinicDiagnosaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("ClinicDiagnosaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "ClinicDiagnosaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "ClinicDiagnosaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicDiagnosaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ClinicDiagnosaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("ClinicDiagnosaDelete", $this->getUrlParm());
    }
