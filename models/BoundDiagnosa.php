...
/**
 * Table class for BOUND_DIAGNOSA
 */
class BoundDiagnosa extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'BOUND_DIAGNOSA';
        $this->TableName = 'BOUND_DIAGNOSA';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[BOUND_DIAGNOSA]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // ORG_UNIT_CODE
        $this->ORG_UNIT_CODE = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_ORG_UNIT_CODE', 'ORG_UNIT_CODE', '[ORG_UNIT_CODE]', '[ORG_UNIT_CODE]', 200, 50, -1, false, '[ORG_UNIT_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BOUND_ID
        $this->BOUND_ID = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_BOUND_ID', 'BOUND_ID', '[BOUND_ID]', '[BOUND_ID]', 200, 50, -1, false, '[BOUND_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REAGENT_ID
        $this->REAGENT_ID = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_REAGENT_ID', 'REAGENT_ID', '[REAGENT_ID]', '[REAGENT_ID]', 200, 50, -1, false, '[REAGENT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // BOUND
        $this->BOUND = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_BOUND', 'BOUND', '[BOUND]', '[BOUND]', 200, 200, -1, false, '[BOUND]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESCRIPTION
        $this->DESCRIPTION = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_DESCRIPTION', 'DESCRIPTION', '[DESCRIPTION]', '[DESCRIPTION]', 200, 200, -1, false, '[DESCRIPTION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->DESCRIPTION->Sortable = true; // Allow sort
        $this->DESCRIPTION->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->DESCRIPTION->Param, "CustomMsg");
        $this->Fields['DESCRIPTION'] = &$this->DESCRIPTION;

        // DIAGNOSA
        $this->DIAGNOSA = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_DIAGNOSA', 'DIAGNOSA', '[DIAGNOSA]', '[DIAGNOSA]', 200, 255, -1, false, '[DIAGNOSA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // ISNORMAL
        $this->ISNORMAL = new DbField('BOUND_DIAGNOSA', 'BOUND_DIAGNOSA', 'x_ISNORMAL', 'ISNORMAL', '[ISNORMAL]', '[ISNORMAL]', 129, 1, -1, false, '[ISNORMAL]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[BOUND_DIAGNOSA]";
    }
    ...
    {
        return "[ORG_UNIT_CODE] = '@ORG_UNIT_CODE@' AND [BOUND_ID] = '@BOUND_ID@'";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("BoundDiagnosaList");
    }
    ...
    {
        global $Language;
        if ($pageName == "BoundDiagnosaView") {
            return $Language->phrase("View");
        } elseif ($pageName == "BoundDiagnosaEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "BoundDiagnosaAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "BoundDiagnosaView";
            case Config("API_ADD_ACTION"):
                return "BoundDiagnosaAdd";
            case Config("API_EDIT_ACTION"):
                return "BoundDiagnosaEdit";
            case Config("API_DELETE_ACTION"):
                return "BoundDiagnosaDelete";
            case Config("API_LIST_ACTION"):
                return "BoundDiagnosaList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("BoundDiagnosaView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("BoundDiagnosaView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "BoundDiagnosaAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "BoundDiagnosaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BoundDiagnosaEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("BoundDiagnosaAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("BoundDiagnosaDelete", $this->getUrlParm());
    }
