...
/**
 * Table class for RAJAL
 */
class Rajal extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'RAJAL';
        $this->TableName = 'RAJAL';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[RAJAL]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // CM
        $this->CM = new DbField('RAJAL', 'RAJAL', 'x_CM', 'CM', '[CM]', '[CM]', 200, 25, -1, false, '[CM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TANGGAL_MASUK
        $this->TANGGAL_MASUK = new DbField('RAJAL', 'RAJAL', 'x_TANGGAL_MASUK', 'TANGGAL_MASUK', '[TANGGAL_MASUK]', CastDateFieldForLike("[TANGGAL_MASUK]", 0, "DB"), 135, 8, 0, false, '[TANGGAL_MASUK]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TANGGAL_KELUAR
        $this->TANGGAL_KELUAR = new DbField('RAJAL', 'RAJAL', 'x_TANGGAL_KELUAR', 'TANGGAL_KELUAR', '[TANGGAL_KELUAR]', CastDateFieldForLike("[TANGGAL_KELUAR]", 0, "DB"), 135, 8, 0, false, '[TANGGAL_KELUAR]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // INACBG
        $this->INACBG = new DbField('RAJAL', 'RAJAL', 'x_INACBG', 'INACBG', '[INACBG]', CastDateFieldForLike("[INACBG]", 0, "DB"), 135, 8, 0, false, '[INACBG]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DESKRIPSI
        $this->DESKRIPSI = new DbField('RAJAL', 'RAJAL', 'x_DESKRIPSI', 'DESKRIPSI', '[DESKRIPSI]', '[DESKRIPSI]', 200, 250, -1, false, '[DESKRIPSI]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TARIFKLAIM
        $this->TARIFKLAIM = new DbField('RAJAL', 'RAJAL', 'x_TARIFKLAIM', 'TARIFKLAIM', '[TARIFKLAIM]', 'CAST([TARIFKLAIM] AS NVARCHAR)', 131, 8, -1, false, '[TARIFKLAIM]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA
        $this->NAMA = new DbField('RAJAL', 'RAJAL', 'x_NAMA', 'NAMA', '[NAMA]', '[NAMA]', 200, 100, -1, false, '[NAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = true; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // DPJP
        $this->DPJP = new DbField('RAJAL', 'RAJAL', 'x_DPJP', 'DPJP', '[DPJP]', '[DPJP]', 200, 100, -1, false, '[DPJP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SEP
        $this->SEP = new DbField('RAJAL', 'RAJAL', 'x_SEP', 'SEP', '[SEP]', '[SEP]', 200, 50, -1, false, '[SEP]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[RAJAL]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("RajalList");
    }
    ...
    {
        global $Language;
        if ($pageName == "RajalView") {
            return $Language->phrase("View");
        } elseif ($pageName == "RajalEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "RajalAdd") {
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("RajalView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("RajalView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "RajalAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "RajalAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        $url = $this->keyUrl("RajalEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("RajalAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("RajalDelete", $this->getUrlParm());
    }
