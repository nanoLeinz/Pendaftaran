...
/**
 * Table class for ANTRIAN_FARMASI
 */
class AntrianFarmasi extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'ANTRIAN_FARMASI';
        $this->TableName = 'ANTRIAN_FARMASI';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[ANTRIAN_FARMASI]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Id
        $this->Id = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_Id', 'Id', '[Id]', 'CAST([Id] AS NVARCHAR)', 3, 4, -1, false, '[Id]', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // no_urut
        $this->no_urut = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_no_urut', 'no_urut', '[no_urut]', 'CAST([no_urut] AS NVARCHAR)', 20, 8, -1, false, '[no_urut]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_daftar
        $this->tanggal_daftar = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_tanggal_daftar', 'tanggal_daftar', '[tanggal_daftar]', CastDateFieldForLike("[tanggal_daftar]", 0, "DB"), 135, 8, 0, false, '[tanggal_daftar]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // tanggal_panggil
        $this->tanggal_panggil = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_tanggal_panggil', 'tanggal_panggil', '[tanggal_panggil]', CastDateFieldForLike("[tanggal_panggil]", 0, "DB"), 135, 8, 0, false, '[tanggal_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // loket
        $this->loket = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_loket', 'loket', '[loket]', '[loket]', 200, 10, -1, false, '[loket]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // status_panggil
        $this->status_panggil = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_status_panggil', 'status_panggil', '[status_panggil]', 'CAST([status_panggil] AS NVARCHAR)', 3, 4, -1, false, '[status_panggil]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_NO_REGISTRATION', 'NO_REGISTRATION', '[NO_REGISTRATION]', '[NO_REGISTRATION]', 200, 25, -1, false, '[NO_REGISTRATION]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // THENAME
        $this->THENAME = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_THENAME', 'THENAME', '[THENAME]', '[THENAME]', 200, 150, -1, false, '[THENAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('ANTRIAN_FARMASI', 'ANTRIAN_FARMASI', 'x_VISIT_ID', 'VISIT_ID', '[VISIT_ID]', '[VISIT_ID]', 200, 50, -1, false, '[VISIT_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[ANTRIAN_FARMASI]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("AntrianFarmasiList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        } elseif ($pageName == "AntrianFarmasiEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "AntrianFarmasiAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "AntrianFarmasiView";
            case Config("API_ADD_ACTION"):
                return "AntrianFarmasiAdd";
            case Config("API_EDIT_ACTION"):
                return "AntrianFarmasiEdit";
            case Config("API_DELETE_ACTION"):
                return "AntrianFarmasiDelete";
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("AntrianFarmasiView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("AntrianFarmasiView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "AntrianFarmasiAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "AntrianFarmasiAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AntrianFarmasiEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("AntrianFarmasiAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("AntrianFarmasiDelete", $this->getUrlParm());
    }
