...
class PasienVisitationSearch extends PasienVisitation
{
    ...
    // Page object name
    public $PageObjName = "PasienVisitationSearch";
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "PasienVisitationList" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->Faskes); // Faskes
        $this->buildSearchUrl($srchUrl, $this->SEP); // SEP
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->Faskes->AdvancedSearch->post()) {
            $hasValue = true;
        }
        if ($this->SEP->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            $this->COVERAGE_ID->EditValue = HtmlEncode($this->COVERAGE_ID->AdvancedSearch->SearchValue);
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->COVERAGE_ID->AdvancedSearch->SearchValue)) {
