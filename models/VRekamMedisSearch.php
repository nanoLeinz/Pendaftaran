 ...
 * Page class
 */
class VRekamMedisSearch extends VRekamMedis
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'V_REKAM_MEDIS';

    // Page object name
    public $PageObjName = "VRekamMedisSearch";
    ...
    public function __construct()
    {
        ...
        // Table object (V_REKAM_MEDIS)
        if (!isset($GLOBALS["V_REKAM_MEDIS"]) || get_class($GLOBALS["V_REKAM_MEDIS"]) == PROJECT_NAMESPACE . "V_REKAM_MEDIS") {
            $GLOBALS["V_REKAM_MEDIS"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'V_REKAM_MEDIS');
        }
    ...
    public function terminate($url = "")
    {
        ...
        if ($this->CustomExport && $this->CustomExport == $this->Export && array_key_exists($this->CustomExport, Config("EXPORT_CLASSES"))) {
            ...
            if (class_exists($class)) {
                $doc = new $class(Container("V_REKAM_MEDIS"));
                $doc->Text = @$content;
        ...
        if ($this->isPageRequest()) {
            ...
            if ($this->isSearch()) {
                ...
                if ($srchStr != "") {
                    ...
                    $srchStr = "VRekamMedisList" . "?" . $srchStr;
    ...
    protected function buildAdvancedSearch()
    {
        ...
        $this->buildSearchUrl($srchUrl, $this->CETAK_DOC); // CETAK_DOC
    ...
    protected function loadSearchValues()
    {
        ...
        if ($this->CETAK_DOC->AdvancedSearch->post()) {
            $hasValue = true;
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == ROWTYPE_VIEW) {
            ...
            if (!$this->ISNEW->Raw) {
                $this->ISNEW->AdvancedSearch->SearchValue = HtmlDecode($this->ISNEW->AdvancedSearch->SearchValue);
            }
            $this->ISNEW->EditValue = HtmlEncode($this->ISNEW->AdvancedSearch->SearchValue);
            ...
            if (!$this->CETAK_DOC->Raw) {
                $this->CETAK_DOC->AdvancedSearch->SearchValue = HtmlDecode($this->CETAK_DOC->AdvancedSearch->SearchValue);
            }
            $this->CETAK_DOC->EditValue = HtmlEncode($this->CETAK_DOC->AdvancedSearch->SearchValue);
    ...
    public function loadAdvancedSearch()
    {
        ...
        $this->CETAK_DOC->AdvancedSearch->load();
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("VRekamMedisList"), "", $this->TableVar, true);
        $pageId = "search";
