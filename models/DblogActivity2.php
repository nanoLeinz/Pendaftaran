...
/**
 * Table class for DBLOG_ACTIVITY2
 */
class DblogActivity2 extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'DBLOG_ACTIVITY2';
        $this->TableName = 'DBLOG_ACTIVITY2';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[DBLOG_ACTIVITY2]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // LOG_ID
        $this->LOG_ID = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_LOG_ID', 'LOG_ID', '[LOG_ID]', '[LOG_ID]', 200, 50, -1, false, '[LOG_ID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOG_DATE
        $this->LOG_DATE = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_LOG_DATE', 'LOG_DATE', '[LOG_DATE]', CastDateFieldForLike("[LOG_DATE]", 0, "DB"), 135, 8, 0, false, '[LOG_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // LOGINNAME
        $this->LOGINNAME = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_LOGINNAME', 'LOGINNAME', '[LOGINNAME]', '[LOGINNAME]', 200, 200, -1, false, '[LOGINNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // USERID
        $this->_USERID = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x__USERID', 'USERID', '[USERID]', '[USERID]', 200, 200, -1, false, '[USERID]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SERVERNAME
        $this->SERVERNAME = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_SERVERNAME', 'SERVERNAME', '[SERVERNAME]', '[SERVERNAME]', 200, 200, -1, false, '[SERVERNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DBNAME
        $this->DBNAME = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_DBNAME', 'DBNAME', '[DBNAME]', '[DBNAME]', 200, 200, -1, false, '[DBNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OBJECTTYPE
        $this->OBJECTTYPE = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_OBJECTTYPE', 'OBJECTTYPE', '[OBJECTTYPE]', '[OBJECTTYPE]', 200, 200, -1, false, '[OBJECTTYPE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // OBJECTNAME
        $this->OBJECTNAME = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_OBJECTNAME', 'OBJECTNAME', '[OBJECTNAME]', '[OBJECTNAME]', 200, 200, -1, false, '[OBJECTNAME]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // EVENTS
        $this->EVENTS = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_EVENTS', 'EVENTS', '[EVENTS]', '[EVENTS]', 200, 200, -1, false, '[EVENTS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // SCHEMAS
        $this->SCHEMAS = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_SCHEMAS', 'SCHEMAS', '[SCHEMAS]', '[SCHEMAS]', 200, 200, -1, false, '[SCHEMAS]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // TSQL
        $this->TSQL = new DbField('DBLOG_ACTIVITY2', 'DBLOG_ACTIVITY2', 'x_TSQL', 'TSQL', '[TSQL]', '[TSQL]', 201, 0, -1, false, '[TSQL]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[DBLOG_ACTIVITY2]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("DblogActivity2List");
    }
    ...
    {
        global $Language;
        if ($pageName == "DblogActivity2View") {
            return $Language->phrase("View");
        } elseif ($pageName == "DblogActivity2Edit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "DblogActivity2Add") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "DblogActivity2View";
            case Config("API_ADD_ACTION"):
                return "DblogActivity2Add";
            case Config("API_EDIT_ACTION"):
                return "DblogActivity2Edit";
            case Config("API_DELETE_ACTION"):
                return "DblogActivity2Delete";
            case Config("API_LIST_ACTION"):
                return "DblogActivity2List";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("DblogActivity2View", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("DblogActivity2View", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "DblogActivity2Add?" . $this->getUrlParm($parm);
        } else {
            $url = "DblogActivity2Add";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DblogActivity2Edit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("DblogActivity2Add", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("DblogActivity2Delete", $this->getUrlParm());
    }
