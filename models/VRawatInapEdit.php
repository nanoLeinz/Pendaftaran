 ...
 * Page class
 */
class VRawatInapEdit extends VRawatInap
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "VRawatInapEdit";
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$loaded) { // Load record based on key
                    ...
                    $this->terminate("VRawatInapList"); // No matching record, return to list
                    return;
                }
                break;
            case "update": // Update
                $returnUrl = $this->getReturnUrl();
                if (GetPageName($returnUrl) == "VRawatInapList") {
