...
/**
 * Table class for V_RIWAYAT_RM
 */
class VRiwayatRm extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'V_RIWAYAT_RM';
        $this->TableName = 'V_RIWAYAT_RM';
        ...
        // NO_REGISTRATION
        $this->NO_REGISTRATION = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_NO_REGISTRATION', 'NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 'dbo.PASIEN_VISITATION.NO_REGISTRATION', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.NO_REGISTRATION', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // DIANTAR_OLEH
        $this->DIANTAR_OLEH = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_DIANTAR_OLEH', 'DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', 200, 255, -1, false, 'dbo.PASIEN_VISITATION.DIANTAR_OLEH', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // STATUS_PASIEN_ID
        $this->STATUS_PASIEN_ID = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_STATUS_PASIEN_ID', 'STATUS_PASIEN_ID', 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', 'CAST(dbo.PASIEN_VISITATION.STATUS_PASIEN_ID AS NVARCHAR)', 17, 1, -1, false, 'dbo.PASIEN_VISITATION.STATUS_PASIEN_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // VISIT_DATE
        $this->VISIT_DATE = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_VISIT_DATE', 'VISIT_DATE', 'dbo.PASIEN_VISITATION.VISIT_DATE', CastDateFieldForLike("dbo.PASIEN_VISITATION.VISIT_DATE", 11, "DB"), 135, 8, 11, false, 'dbo.PASIEN_VISITATION.VISIT_DATE', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CLINIC_ID
        $this->CLINIC_ID = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_CLINIC_ID', 'CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 'dbo.PASIEN_VISITATION.CLINIC_ID', 200, 8, -1, false, 'dbo.PASIEN_VISITATION.CLINIC_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // EMPLOYEE_ID
        $this->EMPLOYEE_ID = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_EMPLOYEE_ID', 'EMPLOYEE_ID', 'dbo.PASIEN_VISITATION.EMPLOYEE_ID', 'dbo.PASIEN_VISITATION.EMPLOYEE_ID', 200, 15, -1, false, 'dbo.PASIEN_VISITATION.EMPLOYEE_ID', false, false, false, 'FORMATTED TEXT', 'SELECT');
        ...
        // IDXDAFTAR
        $this->IDXDAFTAR = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_IDXDAFTAR', 'IDXDAFTAR', 'dbo.PASIEN_VISITATION.IDXDAFTAR', 'CAST(dbo.PASIEN_VISITATION.IDXDAFTAR AS NVARCHAR)', 3, 4, -1, false, 'dbo.PASIEN_VISITATION.IDXDAFTAR', false, false, false, 'FORMATTED TEXT', 'NO');
        ...
        // VISIT_ID
        $this->VISIT_ID = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_VISIT_ID', 'VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 'dbo.PASIEN_VISITATION.VISIT_ID', 200, 50, -1, false, 'dbo.PASIEN_VISITATION.VISIT_ID', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // CETAK
        $this->CETAK = new DbField('V_RIWAYAT_RM', 'V_RIWAYAT_RM', 'x_CETAK', 'CETAK', '\'\'', '\'\'', 200, 1, -1, false, '\'\'', false, false, false, 'FORMATTED TEXT', 'TEXT');
    ...
    public function getDetailUrl()
    {
        // Detail url
        $detailUrl = "";
        if ($this->getCurrentDetailTable() == "PASIEN_DIAGNOSA") {
            $detailUrl = Container("PASIEN_DIAGNOSA")->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
            $detailUrl .= "&" . GetForeignKeyUrl("fk_VISIT_ID", $this->VISIT_ID->CurrentValue);
        }
        if ($detailUrl == "") {
            $detailUrl = "VRiwayatRmList";
        }
        return $detailUrl;
    }
    ...
    {
        return $this->SqlSelect ?? $this->getQueryBuilder()->select("dbo.PASIEN_VISITATION.NO_REGISTRATION, dbo.PASIEN_VISITATION.STATUS_PASIEN_ID, dbo.PASIEN_VISITATION.VISIT_DATE, dbo.PASIEN_VISITATION.CLINIC_ID, dbo.PASIEN_VISITATION.EMPLOYEE_ID, dbo.PASIEN_VISITATION.IDXDAFTAR, dbo.PASIEN_VISITATION.VISIT_ID, dbo.PASIEN_VISITATION.DIANTAR_OLEH, '' AS [CETAK]");
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("VRiwayatRmList");
    }
    ...
    {
        global $Language;
        if ($pageName == "VRiwayatRmView") {
            return $Language->phrase("View");
        } elseif ($pageName == "VRiwayatRmEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "VRiwayatRmAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "VRiwayatRmView";
            case Config("API_ADD_ACTION"):
                return "VRiwayatRmAdd";
            case Config("API_EDIT_ACTION"):
                return "VRiwayatRmEdit";
            case Config("API_DELETE_ACTION"):
                return "VRiwayatRmDelete";
            case Config("API_LIST_ACTION"):
                return "VRiwayatRmList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRiwayatRmView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRiwayatRmView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "VRiwayatRmAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "VRiwayatRmAdd";
        }
        return $this->addMasterUrl($url);
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRiwayatRmEdit", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRiwayatRmEdit", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("VRiwayatRmAdd", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("VRiwayatRmAdd", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("VRiwayatRmDelete", $this->getUrlParm());
    }
