 ...
 * Page class
 */
class ReferensiMobilejknBpjsDelete extends ReferensiMobilejknBpjs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReferensiMobilejknBpjsDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ReferensiMobilejknBpjsList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("ReferensiMobilejknBpjsList"); // Return to list
                return;
            }
        }
