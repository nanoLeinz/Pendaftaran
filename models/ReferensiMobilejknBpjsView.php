 ...
 * Page class
 */
class ReferensiMobilejknBpjsView extends ReferensiMobilejknBpjs
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ReferensiMobilejknBpjsView";
    ...
    public function run()
    {
        ...
        if ($this->isPageRequest()) { // Validate request
            if (($keyValue = Get("id") ?? Route("id")) !== null) {
                ...
                $returnUrl = "ReferensiMobilejknBpjsList"; // Return to list
            }
            ...
            switch ($this->CurrentAction) {
                case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ReferensiMobilejknBpjsList"; // No matching record, return to list
                    }
                    break;
            }
        } else {
            $returnUrl = "ReferensiMobilejknBpjsList"; // Not page request, return to list
        }
        if ($returnUrl != "") {
