...
/**
 * Table class for INASIS_GET_SPESIALISTIK
 */
class InasisGetSpesialistik extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = 'INASIS_GET_SPESIALISTIK';
        $this->TableName = 'INASIS_GET_SPESIALISTIK';
        $this->TableType = 'TABLE';

        // Update Table
        $this->UpdateTable = "[dbo].[INASIS_GET_SPESIALISTIK]";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // KODE
        $this->KODE = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_KODE', 'KODE', '[KODE]', '[KODE]', 129, 3, -1, false, '[KODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // NAMA
        $this->NAMA = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_NAMA', 'NAMA', '[NAMA]', '[NAMA]', 200, 100, -1, false, '[NAMA]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->NAMA->Sortable = true; // Allow sort
        $this->NAMA->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->NAMA->Param, "CustomMsg");
        $this->Fields['NAMA'] = &$this->NAMA;

        // REST_CODE
        $this->REST_CODE = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_REST_CODE', 'REST_CODE', '[REST_CODE]', '[REST_CODE]', 129, 3, -1, false, '[REST_CODE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_MESSAGE
        $this->REST_MESSAGE = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_REST_MESSAGE', 'REST_MESSAGE', '[REST_MESSAGE]', '[REST_MESSAGE]', 200, 50, -1, false, '[REST_MESSAGE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_DATE
        $this->REST_DATE = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_REST_DATE', 'REST_DATE', '[REST_DATE]', CastDateFieldForLike("[REST_DATE]", 0, "DB"), 135, 8, 0, false, '[REST_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // REST_METHOD
        $this->REST_METHOD = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_REST_METHOD', 'REST_METHOD', '[REST_METHOD]', '[REST_METHOD]', 200, 10, -1, false, '[REST_METHOD]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_DATE
        $this->MODIFIED_DATE = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_MODIFIED_DATE', 'MODIFIED_DATE', '[MODIFIED_DATE]', CastDateFieldForLike("[MODIFIED_DATE]", 0, "DB"), 135, 8, 0, false, '[MODIFIED_DATE]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        ...
        // MODIFIED_BY
        $this->MODIFIED_BY = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_MODIFIED_BY', 'MODIFIED_BY', '[MODIFIED_BY]', '[MODIFIED_BY]', 200, 50, -1, false, '[MODIFIED_BY]', false, false, false, 'FORMATTED TEXT', 'TEXT');
        $this->MODIFIED_BY->Sortable = true; // Allow sort
        $this->MODIFIED_BY->CustomMsg = $Language->FieldPhrase($this->TableVar, $this->MODIFIED_BY->Param, "CustomMsg");
        $this->Fields['MODIFIED_BY'] = &$this->MODIFIED_BY;

        // RESPON
        $this->RESPON = new DbField('INASIS_GET_SPESIALISTIK', 'INASIS_GET_SPESIALISTIK', 'x_RESPON', 'RESPON', '[RESPON]', '[RESPON]', 201, 0, -1, false, '[RESPON]', false, false, false, 'FORMATTED TEXT', 'TEXTAREA');
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[INASIS_GET_SPESIALISTIK]";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("InasisGetSpesialistikList");
    }
    ...
    {
        global $Language;
        if ($pageName == "InasisGetSpesialistikView") {
            return $Language->phrase("View");
        } elseif ($pageName == "InasisGetSpesialistikEdit") {
            return $Language->phrase("Edit");
        } elseif ($pageName == "InasisGetSpesialistikAdd") {
    ...
    public function getApiPageName($action)
    {
        switch (strtolower($action)) {
            case Config("API_VIEW_ACTION"):
                return "InasisGetSpesialistikView";
            case Config("API_ADD_ACTION"):
                return "InasisGetSpesialistikAdd";
            case Config("API_EDIT_ACTION"):
                return "InasisGetSpesialistikEdit";
            case Config("API_DELETE_ACTION"):
                return "InasisGetSpesialistikDelete";
            case Config("API_LIST_ACTION"):
                return "InasisGetSpesialistikList";
            default:
                return "";
        }
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("InasisGetSpesialistikView", $this->getUrlParm($parm));
        } else {
            $url = $this->keyUrl("InasisGetSpesialistikView", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
        }
    ...
    {
        if ($parm != "") {
            $url = "InasisGetSpesialistikAdd?" . $this->getUrlParm($parm);
        } else {
            $url = "InasisGetSpesialistikAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetSpesialistikEdit", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("InasisGetSpesialistikAdd", $this->getUrlParm($parm));
        return $this->addMasterUrl($url);
    }
    ...
    {
        return $this->keyUrl("InasisGetSpesialistikDelete", $this->getUrlParm());
    }
