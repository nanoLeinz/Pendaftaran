 ...
 * Page class
 */
class DiagnosaDelete extends Diagnosa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "DiagnosaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("DiagnosaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                ...
                $this->terminate("DiagnosaList"); // Return to list
                return;
            }
        }
