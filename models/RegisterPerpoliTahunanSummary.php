 ...
 * Page class
 */
class RegisterPerpoliTahunanSummary extends RegisterPerpoliTahunan
{
    use MessagesTrait;
    ...
    // Table name
    public $TableName = 'register_perpoli_tahunan';

    // Page object name
    public $PageObjName = "RegisterPerpoliTahunanSummary";
    ...
    public function __construct()
    {
        ...
        // Table object (register_perpoli_tahunan)
        if (!isset($GLOBALS["register_perpoli_tahunan"]) || get_class($GLOBALS["register_perpoli_tahunan"]) == PROJECT_NAMESPACE . "register_perpoli_tahunan") {
            $GLOBALS["register_perpoli_tahunan"] = &$this;
        }
        ...
        if (!defined(PROJECT_NAMESPACE . "TABLE_NAME")) {
            define(PROJECT_NAMESPACE . "TABLE_NAME", 'register_perpoli_tahunan');
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<a class="ew-export-link ew-email" title="' . HtmlEncode($Language->phrase("ExportToEmail", true)) . '" data-caption="' . HtmlEncode($Language->phrase("ExportToEmail", true)) . '" id="emf_register_perpoli_tahunan" href="#" onclick="return ew.emailDialogShow({ lnk: \'emf_register_perpoli_tahunan\', hdr: ew.language.phrase(\'ExportToEmailText\'), url: \'' . $url . '\', exportid: \'' . session_id() . '\', el: this });">' . $Language->phrase("ExportToEmail") . '</a>';
