...
// Product version
define(PROJECT_NAMESPACE . "PRODUCT_VERSION", "17.0.11");

// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "SIMRSSQLSERVER"); // Project name
define(PROJECT_NAMESPACE . "PROJECT_ID", "{67E7B67B-A753-4E5E-ACF9-6EF1B38EF4E3}"); // Project ID
...
define(PROJECT_NAMESPACE . "IS_MSSQL", true); // SQL Server
