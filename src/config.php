...
$CONFIG = [
    ...
    "RANDOM_KEY" => 'g9z02pemhDjSd1dM', // Random key for encryption
    "ENCRYPTION_KEY" => '', // Encryption key for data protection
    "PROJECT_STYLESHEET_FILENAME" => "css/SIMRSSQLSERVER.css", // Project stylesheet file name
    ...
    "SIDEBAR_CLASS" => "main-sidebar sidebar-light-success",
    ...
    "ADMIN_USER_NAME" => "sysadmin", // Administrator user name
    "ADMIN_PASSWORD" => "sys54321", // Administrator password
